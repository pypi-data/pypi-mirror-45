...
from apronpy.coeff import PyDoubleScalarCoeff, PyMPFRScalarCoeff
...
t = PyTexpr1(x)
c = PyTcons1.make(t, ConsTyp.AP_CONS_SUPEQ)
print(c)
...
#         x2a.set_coeff(PyVar('h2'), PyMPFRScalarCoeff(-2))
#         x2a.set_cst(PyMPFRScalarCoeff(4))
#         x2b = PyLinexpr1(e)
#         x2b.set_coeff(PyVar('h1'), PyMPFRScalarCoeff(-3))

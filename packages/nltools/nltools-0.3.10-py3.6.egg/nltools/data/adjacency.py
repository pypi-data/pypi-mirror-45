...
class Adjacency(object):
    ...
    def between_cluster_mean(self, clusters = None):
        ''' This function calculates mean between cluster labels
        ...
        out = {}
        for i in list(set(clusters)):
            out[i] = np.mean(distance.loc[clusters==i,clusters!=i].values)
        return out

...
def demo():
    ...
    f.print_message(22, 6, "Avec notre grand champion Cava Jeter",
                    2, False)
    Film.delay(1)
    ...
    Film.delay(1)
    Film.clearsc()
    f.print_message(20, 6, "Epoustouflant lancer du smart-o de Cava Jeter !",
                    2.5, False)
...
SuperFlix")
    ...
    # Vol stationnaire
    f1.deplacement = 0
    f1.projection(10, 2, 2)
    # vol en déplacement de 1
    f1.deplacement = 1
    f1.projection(84, 2, 2)
    f1.deplacement = 0
    f1.projection(10, 84, 2)
    Film.delay(1)
    Film.clearsc()
    Film.delay(1)
    ...
    d1 = {
        (12, 22): "         T'as pas vu ?           ",
        (29, 39): "          Non, quoi ?            ",
        (46, 56): "  Rien, j'ai cru voir un mouton  ",
        (63, 73): " qui volait avec un drôle de peï ",
    }
...
on ne vit deux fois")
    ...
    f1.projection(84, 2, 2, delai=0.025)
    f1.deplacement = 0
...
de l'esprit frappeur")
    ...
    # vol en déplacement de 1
    f1.deplacement = 1
    f1.projection(85, 2, 2, 1)
    f1.deplacement = 0
    f1.projection(10, 85, 2)
    Film.delay(1)
    Film.clearsc()
...
ah ah !", rev=False)
    ...
    f2.projection(66, 2, 2, 0, 0.2)
    f.print_message(27, 6, "Sniff ! Que c'était beau !", rev=False)
    Film.clearsc()
    Film.delay(1)

    f3.print_message(27, 6, "2. " + f3.titre)
    Film.delay(1)
    ...
    f4.print_message(27, 6, "3. " + f4.titre)
    f4.print_message(27, 6, "Ha ha !", rev=False)
    f4.projection(45, 2, 2, 0, 0.2)
    Film.delay(1)

    Film.clearsc()
    f4.print_message(27, 6, "C'est fini ! Sniff !")
    f4.print_message(27, 6, "A vous de jouer !")

...
class Film:
    ...
    def get_nb_frames_per_file(self):
        """Retourne 0 si aucune frame n'est définie, 1 si il y a 1 fichier
        par frame (cas de frames), le nombre de frames dans le fichier si
        il s'agit d'un fichier unique
        """
    ...
    def get_deplacement(self):
        """Retourne la valeur du déplacement entre 2 frames successive"""
        return self._deplacement

    def set_deplacement(self, deplacement):
        """Décide la valeur du déplacement entre 2 frames successive"""
    ...
    # other methods
    def projection(self, nb_frames=0, x=2, y=2, trace=0, delai=0.1):

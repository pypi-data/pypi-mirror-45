...
from server.core.checks import Error, Tags, register
...
def _check_lazy_references(apps, ignore=None):
    ...
    known_lazy = {
        ('server.db.models.fields.related', 'resolve_related_class'): field_error,
        ('server.db.models.fields.related', 'set_managed'): None,
        ('server.dispatch.dispatcher', 'connect'): signal_connect_error,
    }

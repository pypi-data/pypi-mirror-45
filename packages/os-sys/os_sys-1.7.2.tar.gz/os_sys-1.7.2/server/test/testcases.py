...
from server.core import mail
from server.core.exceptions import ValidationError
from server.core.files import locks
from server.core.handlers.wsgi import WSGIHandler, get_path_info
from server.core.management import call_command
from server.core.management.color import no_style
from server.core.management.sql import emit_post_migrate_signal
from server.core.servers.basehttp import ThreadedWSGIServer, WSGIRequestHandler
from server.db import DEFAULT_DB_ALIAS, connection, connections, transaction
from server.forms.fields import CharField
from server.http import QueryDict
from server.http.request import split_domain_port, validate_host
from server.test.client import Client
from server.test.html import HTMLParseError, parse_html
from server.test.signals import setting_changed, template_rendered
from server.test.utils import (
    CaptureQueriesContext, ContextList, compare_xml, modify_settings,
    override_settings,
)
from server.utils.decorators import classproperty
...
class FSFilesHandler(WSGIHandler):
    ...
    def get_response(self, request):
        from server.http import Http404
    ...
    def serve(self, request):
        ...
        # Emulate behavior of server.contrib.staticfiles.views.serve() when it

from server.contrib.staticfiles.testing import StaticLiveServerTestCase
from server.test import modify_settings
from server.test.selenium import SeleniumTestCase
...
@modify_settings(MIDDLEWARE={'append': 'server.contrib.admin.tests.CSPMiddleware'})
class AdminSeleniumTestCase(SeleniumTestCase, StaticLiveServerTestCase):
    ...
    def get_css_value(self, selector, attribute):
        ...
        return self.selenium.execute_script(
            'return server.jQuery("%s").css("%s")' % (selector, attribute))

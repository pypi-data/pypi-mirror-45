...
from server.contrib.postgres import lookups
from server.contrib.postgres.forms import SimpleArrayField
from server.contrib.postgres.validators import ArrayMaxLengthValidator
from server.core import checks, exceptions
from server.db.models import Field, IntegerField, Transform
from server.db.models.lookups import Exact, In
...
class ArrayField(CheckFieldDefaultMixin, Field):
    ...
    def deconstruct(self):
        ...
        if path == 'server.contrib.postgres.fields.array.ArrayField':
            path = 'server.contrib.postgres.fields.ArrayField'
        kwargs.update({

...
from server.contrib.gis.gdal import GDALException
from server.contrib.gis.geos import GEOSException, GEOSGeometry
from server.forms.widgets import Textarea
from server.utils import translation

# Creating a template context that contains Django settings
# values needed by admin map templates.
geo_context = {'LANGUAGE_BIDI': translation.get_language_bidi()}
logger = logging.getLogger('server.contrib.gis')
...
class OpenLayersWidget(Textarea):
    ...
    def get_context(self, name, value, attrs):
        ...
        self.params['module'] = 'geoserver_%s' % js_safe_name

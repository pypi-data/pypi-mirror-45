from server.contrib.gis.gdal import OGRGeomType
from server.db.backends.postgresql.introspection import DatabaseIntrospection
...
class PostGISIntrospection(DatabaseIntrospection):
    ...
    def get_geometry_type(self, table_name, geo_col):
        ...
        with self.connection.cursor() as cursor:
            ...
            field_type = OGRGeomType(row[2]).server

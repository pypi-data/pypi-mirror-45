...
from server.apps.registry import Apps, apps as global_apps
from server.conf import settings
from server.db import models
from server.db.models.fields.proxy import OrderWrt
from server.db.models.fields.related import RECURSIVE_RELATIONSHIP_CONSTANT
from server.db.models.options import DEFAULT_NAMES, normalize_together
...
class StateApps(Apps):
    ...
    def __init__(self, real_apps, models, ignore_swappable=False):
        ...
        from server.core.checks.model_checks import _check_lazy_references

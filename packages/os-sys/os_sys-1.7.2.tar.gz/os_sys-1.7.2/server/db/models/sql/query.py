...
from server.db import DEFAULT_DB_ALIAS, NotSupportedError, connections
from server.db.models.aggregates import Count
from server.db.models.constants import LOOKUP_SEP
from server.db.models.expressions import Col, Ref
from server.db.models.fields import Field
from server.db.models.fields.related_lookups import MultiColSource
from server.db.models.lookups import Lookup
from server.db.models.query_utils import (
    Q, check_rel_lookup_compatibility, refs_expression,
)
from server.db.models.sql.constants import (
    INNER, LOUTER, ORDER_DIR, ORDER_PATTERN, SINGLE,
)
from server.db.models.sql.datastructures import (
    BaseTable, Empty, Join, MultiJoin,
)
from server.db.models.sql.where import (
    AND, OR, ExtraWhere, NothingNode, WhereNode,
)
from server.utils.encoding import force_text
from server.utils.functional import cached_property
from server.utils.tree import Node
...
class Query:
    ...
    def get_aggregation(self, using, added_aggregate_names):
        ...
        if (isinstance(self.group_by, tuple) or has_limit or has_existing_annotations or
            ...
            from server.db.models.sql.subqueries import AggregateQuery

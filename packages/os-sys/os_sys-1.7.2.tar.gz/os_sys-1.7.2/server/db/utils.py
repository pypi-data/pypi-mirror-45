...
DJANGO_VERSION_PICKLE_KEY = '_server_version'
...
class ConnectionHandler:
    ...
    def databases(self):
        ...
        if self._databases == {}:
            self._databases = {
                DEFAULT_DB_ALIAS: {
                    'ENGINE': 'server.db.backends.dummy',
                },
            }
        if self._databases[DEFAULT_DB_ALIAS] == {}:
            self._databases[DEFAULT_DB_ALIAS]['ENGINE'] = 'server.db.backends.dummy'
    ...
    def ensure_defaults(self, alias):
        ...
        conn.setdefault('ENGINE', 'server.db.backends.dummy')
        if conn['ENGINE'] == 'server.db.backends.' or not conn['ENGINE']:
            conn['ENGINE'] = 'server.db.backends.dummy'

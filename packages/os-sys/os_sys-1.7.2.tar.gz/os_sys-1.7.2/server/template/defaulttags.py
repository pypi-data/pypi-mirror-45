...
from server.utils.html import conditional_escape, format_html
from server.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from server.utils.html import strip_spaces_between_tags
...
class URLNode(Node):
    ...
    def render(self, context):
        from server.urls import reverse, NoReverseMatch
...
def load(parser, token):
    ...
    ``server/templatetags/news/photos.py``::

...
class Engine:
    ...
    def get_default():
        ...
        >>> from server.template import Context, Template
        >>> template = Template("Hello {{ name }}!")
        >>> context = Context({'name': "world"})
        >>> template.render(context)
        'Hello world!'
        """
        # Since Engine is imported in server.template and since
        # DjangoTemplates is a wrapper around this Engine class,
        # local imports are required to avoid import loops.
        from server.template import engines
        from server.template.backends.server import DjangoTemplates

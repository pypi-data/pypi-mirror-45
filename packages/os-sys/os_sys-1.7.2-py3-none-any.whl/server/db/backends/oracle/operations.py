...
from server.db.backends.utils import strip_quotes, truncate_name
from server.db.utils import DatabaseError
...
/"""
    ...
    # https://groups.google.com/forum/#!msg/server-developers/zwQju7hbG78/9l934yelwfsJ
    ...
    def fetch_returned_insert_id(self, cursor):
        try:
            ...
            raise DatabaseError(
                ...
                'Oracle OCI library (see https://code.serverproject.com/ticket/28859).'
            )
    ...
    def compiler_module(self):
        ...
        return 'server.db.backends.oracle.compiler'

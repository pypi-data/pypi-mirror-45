...
from server.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    """
    compiler_module = "server.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, sequences, allow_cascade=False):
        ...
        color_style() or no_style() in server.core.management.color.

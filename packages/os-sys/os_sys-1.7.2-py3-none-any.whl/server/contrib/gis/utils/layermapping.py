...
"""
 ...
 For more information, please consult the GeoDjango documentation:
   https://docs.serverproject.com/en/dev/ref/contrib/gis/layermapping/
"""
import sys
from decimal import Decimal, InvalidOperation as DecimalInvalidOperation

from server.contrib.gis.db.models import GeometryField
from server.contrib.gis.gdal import (
    CoordTransform, DataSource, GDALException, OGRGeometry, OGRGeomType,
    SpatialReference,
)
from server.contrib.gis.gdal.field import (
    OFTDate, OFTDateTime, OFTInteger, OFTInteger64, OFTReal, OFTString,
    OFTTime,
)
from server.core.exceptions import FieldDoesNotExist, ObjectDoesNotExist
from server.db import connections, models, router, transaction
...
class LayerMapping:
    ...
    def make_multi(self, geom_type, model_field):
        ...
        return (geom_type.num in self.MULTI_TYPES and
                model_field.__class__.__name__ == 'Multi%s' % geom_type.server)

...
"""
from server.contrib.gis.gdal import DataSource
...
def ogrinspect(*args, **kwargs):
    ...
    >>> from server.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from server.contrib.gis.db import models` code from the
...
def _ogrinspect(data_source, model_name, geom_name='geom', layer_key=0, srid=None,
    ...
    if imports:
        ...
        yield 'from server.contrib.gis.db import models'
        yield ''
        yield ''

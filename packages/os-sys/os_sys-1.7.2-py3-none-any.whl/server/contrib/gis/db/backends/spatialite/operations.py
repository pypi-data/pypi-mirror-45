...
"""
from server.contrib.gis.db.backends.base.operations import (
    BaseSpatialOperations,
)
from server.contrib.gis.db.backends.spatialite.adapter import SpatiaLiteAdapter
from server.contrib.gis.db.backends.utils import SpatialOperator
from server.contrib.gis.db.models import aggregates
from server.contrib.gis.geos.geometry import GEOSGeometry, GEOSGeometryBase
from server.contrib.gis.geos.prototypes.io import wkb_r, wkt_r
from server.contrib.gis.measure import Distance
from server.core.exceptions import ImproperlyConfigured
from server.db.backends.sqlite3.operations import DatabaseOperations
from server.utils.functional import cached_property
from server.utils.version import get_version_tuple
...
class SpatiaLiteOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from server.contrib.gis.db.backends.spatialite.models import SpatialiteGeometryColumns
        return SpatialiteGeometryColumns

    def spatial_ref_sys(self):
        from server.contrib.gis.db.backends.spatialite.models import SpatialiteSpatialRefSys

...
from server.contrib.gis import forms, gdal
from server.contrib.gis.db.models.proxy import SpatialProxy
from server.contrib.gis.gdal.error import GDALException
from server.contrib.gis.geos import (
...
def get_srid_info(srid, connection):
    ...
    """
    from server.contrib.gis.gdal import SpatialReference
    global _srid_cache
...
class RasterField(BaseSpatialField):
    ...
    def get_transform(self, name):
        from server.contrib.gis.db.models.lookups import RasterBandTransform
        try:
            band_index = int(name)
            return type(

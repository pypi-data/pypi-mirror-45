...
from server.contrib.sessions.exceptions import SuspiciousSession
from server.core.exceptions import SuspiciousOperation
...
class SessionBase:
    ...
    def _hash(self, value):
        key_salt = "server.contrib.sessions" + self.__class__.__name__

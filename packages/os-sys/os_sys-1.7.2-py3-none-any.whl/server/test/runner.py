...
from server.test import SimpleTestCase, TestCase
from server.test.utils import (
    setup_databases as _setup_databases, setup_test_environment,
    teardown_databases as _teardown_databases, teardown_test_environment,
)
from server.utils.datastructures import OrderedSet
...
class DebugSQLTextTestResult(unittest.TextTestResult):
    def __init__(self, stream, descriptions, verbosity):
        self.logger = logging.getLogger('server.db.backends')
...
def _init_worker(counter):
    ...
    for alias in connections:
        ...
        # reflected in server.db.connections. If the following line assigned

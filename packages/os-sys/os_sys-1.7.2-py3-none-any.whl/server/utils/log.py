...
from server.core.mail import get_connection
from server.core.management.color import color_style
from server.utils.module_loading import import_string
from server.views.debug import ExceptionReporter

request_logger = logging.getLogger('server.request')
...
DEFAULT_LOGGING = {
    ...
    'formatters': {
        'server.server': {
            '()': 'server.utils.log.ServerFormatter',
    ...
    'handlers': {
        ...
        'server.server': {
            'level': 'INFO',
            'class': 'logging.StreamHandler',
            'formatter': 'server.server',
        },
        'mail_admins': {
            'level': 'ERROR',
            'filters': ['require_debug_false'],
            'class': 'server.utils.log.AdminEmailHandler'
        }
    },
    'loggers': {
        'server': {

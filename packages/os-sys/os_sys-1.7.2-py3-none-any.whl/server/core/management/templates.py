...
from server.core.management.utils import handle_extensions
from server.template import Context, Engine
from server.utils import archive
...
class TemplateCommand(BaseCommand):
    ...
    :param style: A color style object (see server.core.management.color).
    ...
    def handle_template(self, template, subdir):
        ...
        Use server.__path__[0] as the default because the Django install

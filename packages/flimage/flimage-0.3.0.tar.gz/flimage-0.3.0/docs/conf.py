...
# -*- coding: utf-8 -*-
#
# flimage documentation build configuration file, created by
...
# Get version number from flimage._version file
import mock
import os
...
if "READTHEDOCS_VERSION" in os.environ:
    ...
    rtd_version = "latest"
# Used for linking to libraries in the flimage universe
...
rst_prolog = """
:github_url: https://github.com/RI-imaging/flimage
"""
...
# This gets 'version'
exec(open(op.join(pdir, "flimage/_version.py")).read())
...
latex_documents = [
    (master_doc, 'flimage.tex', 'flimage Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'flimage', 'flimage Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'flimage', 'flimage Documentation',
     author, 'flimage', 'One line description of project.',
     'Miscellaneous'),
]

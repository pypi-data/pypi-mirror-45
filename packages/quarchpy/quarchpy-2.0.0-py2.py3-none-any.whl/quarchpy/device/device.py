...
class quarchDevice:
    ...
    def checkCommand(self, CommandString):
        ...
        if "rec" in CommandString:
            if "stream" in CommandString or "stop" in CommandString or "ave" in CommandString:

...
def generate_graph_files(opt, path):
    ...
    os.system(fbs_cmd)
    os.system(ggnn_cmd)
    os.remove(path.split(".")[0] + ".fbs")
    os.remove(path.split(".")[0] + "_train.txt")
...
def main():
    ...
    parser.add_argument('--model_path', default="/model/ggnn.aggregation=1.distributed_function=0.hidden_layer_size=200.num_hidden_layer=1.node_dim=200", help='path to save the model')
    ...
    with tf.Session() as sess:
        ...
        with open(html_file, 'a') as f:
            ...
            f.write("<h3 style='foreground-color:black;'> Classification probablities (softmax values)</h3> <pre style='foreground-color:black;'>")
            ...
            f.write("</pre> <h3 style='foreground-color:black;'> Predicted Class </h3> <pre style='foreground-color:black;'>")
            # print(correct_labels[0], f)

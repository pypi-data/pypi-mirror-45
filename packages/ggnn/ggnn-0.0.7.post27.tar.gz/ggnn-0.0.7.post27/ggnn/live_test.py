...
def main():
    ...
    with tf.Session() as sess:
        ...
        with open(html_file, 'a') as f:
            ...
            f.write("<h3 style='background-color:black;'> Classification probablities (softmax values)</h3> <pre style='background-color:black;'>")
            np.savetxt(f, softmax_values_data, delimiter='\n')
            plt.figure(figsize=(6,3))
            plot_value_array(0, predictions, correct_labels)
            ...
            f.write("</pre> <h3 style='background-color:black;'> Predicted Class </h3> <pre style='background-color:black;'>")

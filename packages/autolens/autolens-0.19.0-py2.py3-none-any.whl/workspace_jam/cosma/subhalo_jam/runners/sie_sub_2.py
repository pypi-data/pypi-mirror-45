...
from workspace_jam.pipelines.no_lens_light.subhalo.from_initializer import lens_sie_shear_subhalo_source_sersic

pipeline_initializer = lens_sie_shear_source_sersic.make_pipeline(phase_folders=[data_name], positions_threshold=0.2)
pipeline_subhalo = lens_sie_shear_subhalo_source_sersic.make_pipeline(phase_folders=[data_name], positions_threshold=0.2)

pipeline = pipeline_initializer + pipeline_subhalo

...
def make_pipeline(phase_folders=None, tag_phases=True, sub_grid_size=2, bin_up_factor=None, positions_threshold=None,
    ...
    pipeline_name = 'pipeline_subhalo__lens_pl_shear_subhalo_source_sersic_lens_cen'
    ...
    class GridPhase(autofit_ph.as_grid_search(ph.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass.centre = \
                results.from_phase('phase_1_lens_pl_shear_source_sersic').variable_absolute(a=0.05).lens.mass.centre

            self.lens_galaxies.lens.mass.axis_ratio = \
                results.from_phase('phase_1_lens_pl_shear_source_sersic').constant.lens.mass.axis_ratio

            self.lens_galaxies.lens.mass.phi = \
                results.from_phase('phase_1_lens_pl_shear_source_sersic').constant.lens.mass.phi

            self.lens_galaxies.lens.mass.slope = \
                results.from_phase('phase_1_lens_pl_shear_source_sersic').constant.lens.mass.slope

            self.lens_galaxies.lens.shear = \
                results.from_phase('phase_1_lens_pl_shear_source_sersic').constant.lens.shear

            self.lens_galaxies.lens.mass.einstein_radius_in_units = \
                results.from_phase('phase_1_lens_pl_shear_source_sersic').variable_relative(r=0.2).lens.mass.einstein_radius_in_units

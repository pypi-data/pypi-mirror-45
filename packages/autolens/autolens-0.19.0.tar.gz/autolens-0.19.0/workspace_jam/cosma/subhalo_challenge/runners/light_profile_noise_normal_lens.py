...
from workspace_jam.pipelines.no_lens_light.subhalo.from_power_law import lens_pl_shear_subhalo_source_sersic_lens
...
pipeline_subhalo = lens_pl_shear_subhalo_source_sersic_lens.make_pipeline(phase_folders=[data_type, data_level, data_name])

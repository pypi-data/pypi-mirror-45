...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.2651390.svg)](https://doi.org/10.5281/zenodo.2651390)
...
```
Samapriya Roy. (2019, April 25). samapriya/porder: porder: Simple CLI for Planet ordersV2 API (Version 0.2.7). Zenodo.
http://doi.org/10.5281/zenodo.2651390
```

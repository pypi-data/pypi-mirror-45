...
class CloudBilling(Base):
    ...
    def create_billing_subaccount(self, master, displayName=None):
        ...
        return billingAccounts.insert(body=body).execute()
    ...
    # Budgets
    #
    def create_budget(self, billingAccountName, budget):
        """Create a budget in the given billing account."""
        params = {
            'billingAccountName': billingAccountName,
            'body': budget,
        }
        return self.billing.budgets().create(**params).execute()
    ...
    def delete_budget(self, billingAccountName, budgetName):
        ...
        return self.billing.budgets().delete(**params).execute()
    ...
    def get_budget(self, billingAccountName, budgetName):
        ...
        return self.billing.budgets().get(**params).execute()
    ...
    def get_budgets(self, billingAccountName):
        ...
        budgets = self.billing.budgets()
        request = budgets.list(**params)
        return self.get_list_items(budgets, request, 'budgets')

    def update_budget(self, billingAccountName, budget):
        """Update a budget in the given billing account."""
        params = {
            'billingAccountName': billingAccountName,
            'body': budget,
        }
        return self.billing.budgets().update(**params).execute()
#
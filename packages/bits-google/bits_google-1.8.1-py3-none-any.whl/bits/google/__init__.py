...
class Google(object):
    ...
    def licensing(self):
        ...
        return Licensing(self.http, self.gsuite_licenses)
    ...
    class Bitsdb(object):
        ...
        def billingaccount(self, g):
            ...
            cost_object = None
            if re.match('(|Disabled )Broad Institute - [0-9]{7}(|-[0-9]{7})', g['displayName']):
                cost_object = g['displayName'].replace('Disabled Broad Institute - ', '').replace('Broad Institute - ', '')

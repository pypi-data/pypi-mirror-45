...
def do_stuff(args):
    ...
    #try :
    if True :
        experiment_name,project_folder,script,framework,cluster_name,storage_account,storage_key,storage_path,data,dependencies,vm_size,max_nodes=args["experiment_name"],args["project_folder"],args["script"],args["framework"],args["cluster_name"],args["storage_account"],args["storage_key"],args["storage_path"],args["data"],args["dependencies"],args["vm_size"],args["max_nodes"]
        import shutil
        import os
        logging.info(args)

...
""")
    ...
    def module_build(self):
        ...
        if self.args.watch:
            try:
                ...
                print('Watch is terminated. Use module-build-watch command to watch again.')
                raise
    ...
    def retire(self):
        ...
        elif os.path.isfile(os.path.join(self.cmd.path, 'dead.module')):
            self.log.warn('dead.module found, module probably already '
                          'retired - will not remove files from git or '
                          'overwrite existing dead.module file')
        else:

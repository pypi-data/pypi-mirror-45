...
class TestWMLClientWithXGBoost(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.model_path = os.path.join(os.getcwd(), 'artifacts', 'xgboost_model_' + datetime.now().isoformat())
    ...
    def test_6_score(self):
        ...
        predictions = self.client.deployments.score(TestWMLClientWithXGBoost.scoring_url, scoring_data, transaction_id='test')

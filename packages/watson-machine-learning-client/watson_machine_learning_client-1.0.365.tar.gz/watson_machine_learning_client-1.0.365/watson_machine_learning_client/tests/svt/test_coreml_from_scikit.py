...
from watson_machine_learning_client.utils import delete_directory, extract_mlmodel_from_archive
...
class TestWMLClientWithScikit2CoreML(unittest.TestCase):
    ...
    def test_05_convert_2_coreml(self):
        ...
        deployment_details = self.client.deployments.create(TestWMLClientWithScikit2CoreML.model_uid, deployment_type='virtual')

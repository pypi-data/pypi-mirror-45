...
def is_first_order(signal, time_constant, init_value, final_value, tol, during=None, strictness=1):
    """
    ...
    """
    return _impl.is_first_order(signal, time_constant, init_value,final_value, tol, during, strictness)
...
def assert_is_first_order(signal, time_constant, init_value, final_value, tol, during=None, strictness=1):
    """
    ...
    """
    return _impl.assert_is_first_order(signal, time_constant, init_value, final_value, tol, during, strictness)
...
def assert_follows_reference(signal, ref_signal, tol, during=None, strictness=1):
    """
    ...
    """
    return _impl.assert_follows_reference(signal, ref_signal, tol, during, strictness)
...
def pandas_first_order(tau, init, final, duration=1, Ts=1e-4):
    """
    ...
    pd = _impl.pd
    t = sp.arange(0, duration, Ts)
    y = final + (init - final) * sp.exp(-t  / tau)

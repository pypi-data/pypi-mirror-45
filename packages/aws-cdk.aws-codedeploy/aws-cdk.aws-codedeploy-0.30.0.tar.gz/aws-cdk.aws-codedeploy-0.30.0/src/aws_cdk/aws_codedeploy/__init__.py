...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codedeploy", "0.30.0", __name__, "aws-codedeploy@0.30.0.jsii.tgz")
...
class LambdaApplication(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codedeploy.LambdaApplication"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, application_name: str) -> "ILambdaApplication":
        ...
        Arguments:
            ...
            props: the properties of the referenced Application.
            applicationName: The physical, human-readable name of the Lambda Application we're referencing. The Application must be in the same account and region as the root Stack.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codedeploy.LambdaApplicationImportProps", jsii_struct_bases=[])
class LambdaApplicationImportProps(jsii.compat.TypedDict):
    ...
    """
    applicationName: str
    """The physical, human-readable name of the Lambda Application we're referencing. The Application must be in the same account and region as the root Stack."""
...
class LambdaDeploymentGroup(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codedeploy.LambdaDeploymentGroup"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, application: "ILambdaApplication", deployment_group_name: str) -> "ILambdaDeploymentGroup":
        ...
        Arguments:
            scope: the parent Construct for this new Construct.
            id: the logical ID of this new Construct.
            props: the properties of the referenced Deployment Group.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codedeploy.LambdaDeploymentGroupImportProps", jsii_struct_bases=[])
...
class ServerApplication(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codedeploy.ServerApplication"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, application_name: str) -> "IServerApplication":
        ...
        Arguments:
            ...
            id: the logical ID of this new Construct.
            props: the properties of the referenced Application.
            applicationName: The physical, human-readable name of the CodeDeploy EC2/on-premise Application we're referencing. The Application must be in the same account and region as the root Stack.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codedeploy.ServerApplicationImportProps", jsii_struct_bases=[])
...
class ServerDeploymentConfig(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codedeploy.ServerDeploymentConfig"):
    ...
    @jsii.member(jsii_name="import")
    @classmethod
    def import_(cls, _scope: aws_cdk.cdk.Construct, _id: str, *, deployment_config_name: str) -> "IServerDeploymentConfig":
        ...
        Arguments:
            ...
            _id: the logical ID of this new Construct.
            props: the properties of the referenced custom Deployment Configuration.
            deploymentConfigName: The physical, human-readable name of the custom CodeDeploy EC2/on-premise Deployment Configuration that we are referencing.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codedeploy.ServerDeploymentConfigImportProps", jsii_struct_bases=[])
...
class ServerDeploymentGroup(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codedeploy.ServerDeploymentGroup"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, alarms: typing.Optional[typing.List[aws_cdk.aws_cloudwatch.Alarm]]=None, application: typing.Optional["IServerApplication"]=None, auto_rollback: typing.Optional["AutoRollbackConfig"]=None, auto_scaling_groups: typing.Optional[typing.List[aws_cdk.aws_autoscaling.AutoScalingGroup]]=None, deployment_config: typing.Optional["IServerDeploymentConfig"]=None, deployment_group_name: typing.Optional[str]=None, ec2_instance_tags: typing.Optional["InstanceTagSet"]=None, ignore_poll_alarms_failure: typing.Optional[bool]=None, install_agent: typing.Optional[bool]=None, load_balancer: typing.Optional[aws_cdk.aws_codedeploy_api.ILoadBalancer]=None, on_premise_instance_tags: typing.Optional["InstanceTagSet"]=None, role: typing.Optional[aws_cdk.aws_iam.Role]=None) -> None:
        ...
        Arguments:
            ...
            props: -
            alarms: The CloudWatch alarms associated with this Deployment Group. CodeDeploy will stop (and optionally roll back) a deployment if during it any of the alarms trigger. Alarms can also be added after the Deployment Group is created using the {@link #addAlarm} method. Default: []
            application: The CodeDeploy EC2/on-premise Application this Deployment Group belongs to. If you don't provide one, a new Application will be created.
            autoRollback: The auto-rollback configuration for this Deployment Group.
            autoScalingGroups: The auto-scaling groups belonging to this Deployment Group. Auto-scaling groups can also be added after the Deployment Group is created using the {@link #addAutoScalingGroup} method. Default: []
            ...
            loadBalancer: The load balancer to place in front of this Deployment Group. Can be either a classic Elastic Load Balancer, or an Application Load Balancer / Network Load Balancer Target Group. Default: the Deployment Group will not have a load balancer defined
            ...
            role: The service Role of this Deployment Group. If you don't provide one, a new Role will be created.
        """
    ...
    def add_auto_scaling_group(self, asg: aws_cdk.aws_autoscaling.AutoScalingGroup) -> None:
        ...
        Arguments:
            asg: the auto-scaling group to add to this Deployment Group.
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codedeploy.ServerDeploymentGroupImportProps", jsii_struct_bases=[_ServerDeploymentGroupImportProps])
...
class ServerDeploymentGroupProps(jsii.compat.TypedDict, total=False):
    ...
    Default:
        the Deployment Group will not have a load balancer defined
    """

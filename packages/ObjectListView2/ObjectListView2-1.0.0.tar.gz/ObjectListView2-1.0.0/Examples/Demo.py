...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.text_ctrl_1_copy_2_copy = wx.TextCtrl(self.notebook_1_pane_5, -1, "A GroupListView can partition its objects into logical divisions, and then present those groups to the user. The groups are collapsible. ", style=wx.TE_MULTILINE|wx.TE_READONLY|wx.TE_BESTWRAP)
        ...
        self.radio_btn_1.Bind(wx.EVT_RADIOBUTTON, self.OnListViewDetails)
        self.radio_btn_2.Bind(wx.EVT_RADIOBUTTON, self.OnListViewList)
        self.radio_btn_3.Bind(wx.EVT_RADIOBUTTON, self.OnListViewSmallIcon)
        self.radio_btn_4.Bind(wx.EVT_RADIOBUTTON, self.OnListViewLargeIcon)
        self.button_1.Bind(wx.EVT_BUTTON, self.OnRepopulate)
        self.button_2.Bind(wx.EVT_BUTTON, self.OnAdd1000)
        self.button_6.Bind(wx.EVT_BUTTON, self.OnUpdateSelected)
        self.button_7.Bind(wx.EVT_BUTTON, self.OnClearListSimple)
        self.button_3.Bind(wx.EVT_BUTTON, self.OnSelectAll)
        self.button_4.Bind(wx.EVT_BUTTON, self.OnSelectU2s)
        self.button_5.Bind(wx.EVT_BUTTON, self.OnSelectNone)
        self.radio_btn_1_copy.Bind(wx.EVT_RADIOBUTTON, self.OnListViewDetailsComplex)
        self.radio_btn_2_copy.Bind(wx.EVT_RADIOBUTTON, self.OnListViewListComplex)
        self.radio_btn_3_copy.Bind(wx.EVT_RADIOBUTTON, self.OnListViewSmallIconComplex)
        self.radio_btn_4_copy.Bind(wx.EVT_RADIOBUTTON, self.OnListViewLargeIconComplex)
        self.button_1_copy.Bind(wx.EVT_BUTTON, self.OnRepopulateComplex)
        self.button_2_copy.Bind(wx.EVT_BUTTON, self.OnAdd1000Complex)
        self.button_6_copy.Bind(wx.EVT_BUTTON, self.OnUpdateSelectedComplex)
        self.button_7_copy_1.Bind(wx.EVT_BUTTON, self.OnClearListComplex)
        self.button_3_copy.Bind(wx.EVT_BUTTON, self.OnSelectAllComplex)
        self.button_4_copy.Bind(wx.EVT_BUTTON, self.OnSelectU2sComplex)
        self.button_5_copy.Bind(wx.EVT_BUTTON, self.OnSelectNoneComplex)
        self.button_7_copy.Bind(wx.EVT_BUTTON, self.OnRepopulateVirtual)
        self.button_8_copy.Bind(wx.EVT_BUTTON, self.OnAdd1000Virtual)
        self.button_9_copy.Bind(wx.EVT_BUTTON, self.OnUpdateSelectedVirtual)
        self.button_7_copy_2.Bind(wx.EVT_BUTTON, self.OnClearListVirtual)
        self.button_10_copy.Bind(wx.EVT_BUTTON, self.OnSelectAllVirtual)
        self.button_11_copy.Bind(wx.EVT_BUTTON, self.OnSelectNoneVirtual)
        self.button_12_copy.Bind(wx.EVT_BUTTON, self.OnRepopulateFast)
        self.button_13_copy.Bind(wx.EVT_BUTTON, self.OnAdd1000Fast)
        self.button_14_copy.Bind(wx.EVT_BUTTON, self.OnUpdateSelectedFast)
        self.button_7_copy_3.Bind(wx.EVT_BUTTON, self.OnClearListFast)
        self.button_15_copy.Bind(wx.EVT_BUTTON, self.OnSelectAllFast)
        self.button_16_copy.Bind(wx.EVT_BUTTON, self.OnSelectU2sFast)
        self.button_17_copy.Bind(wx.EVT_BUTTON, self.OnSelectNoneFast)
        self.cbShowGroups.Bind(wx.EVT_CHECKBOX, self.OnShowGroupChecked)
        self.cbLockGroup.Bind(wx.EVT_CHECKBOX, self.OnLockGroupChecked)
        self.cbShowItemCount.Bind(wx.EVT_CHECKBOX, self.OnShowItemCountChecked)
        self.button_8.Bind(wx.EVT_BUTTON, self.OnExpandAllGroups)
        self.button_9.Bind(wx.EVT_BUTTON, self.OnCollapseAllGroups)
        self.button_12_copy_copy.Bind(wx.EVT_BUTTON, self.OnRepopulateGroup)
        self.button_13_copy_copy.Bind(wx.EVT_BUTTON, self.OnAdd1000Group)
        self.button_14_copy_copy.Bind(wx.EVT_BUTTON, self.OnUpdateSelectedGroup)
        self.button_7_copy_3_copy.Bind(wx.EVT_BUTTON, self.OnClearListGroup)
        self.button_15_copy_copy.Bind(wx.EVT_BUTTON, self.OnSelectAllGroup)
        self.button_16_copy_copy.Bind(wx.EVT_BUTTON, self.OnSelectU2sGroup)
        self.button_17_copy_copy.Bind(wx.EVT_BUTTON, self.OnSelectNoneGroup)
        self.button_10.Bind(wx.EVT_BUTTON, self.OnPrintPreview)
        self.button_11.Bind(wx.EVT_BUTTON, self.OnPageSetup)
        self.button_12.Bind(wx.EVT_BUTTON, self.OnPrint)
        self.cbSimple.Bind(wx.EVT_CHECKBOX, self.OnSourceChange)
        self.cbComplex.Bind(wx.EVT_CHECKBOX, self.OnSourceChange)
        self.cbFast.Bind(wx.EVT_CHECKBOX, self.OnSourceChange)
        self.cbGroups.Bind(wx.EVT_CHECKBOX, self.OnSourceChange)
        self.radioBoxFormatting.Bind(wx.EVT_RADIOBOX, self.OnFormatting)
        self.cbShrinkToFit.Bind(wx.EVT_CHECKBOX, self.OnPreviewOptionChange)
        self.cbIncludeImages.Bind(wx.EVT_CHECKBOX, self.OnPreviewOptionChange)
        self.cbWrapCells.Bind(wx.EVT_CHECKBOX, self.OnPreviewOptionChange)
        self.cbColumnHeaderOnEachPage.Bind(wx.EVT_CHECKBOX, self.OnPreviewOptionChange)
        self.cbUseListCtrlTextFormat.Bind(wx.EVT_CHECKBOX, self.OnPreviewOptionChange)
        self.tcPageHeaderLeft.Bind(wx.EVT_TEXT, self.OnPrintingTextChanged)
        self.tcPageHeaderCenter.Bind(wx.EVT_TEXT, self.OnPrintingTextChanged)
        self.tcPageHeaderRight.Bind(wx.EVT_TEXT, self.OnPrintingTextChanged)
        self.tcPageFooterLeft.Bind(wx.EVT_TEXT, self.OnPrintingTextChanged)
        self.tcPageFooterCenter.Bind(wx.EVT_TEXT, self.OnPrintingTextChanged)
        self.tcPageFooterRight.Bind(wx.EVT_TEXT, self.OnPrintingTextChanged)
        self.tcWatermark.Bind(wx.EVT_TEXT, self.OnPrintingTextChanged)
        self.cbWatermarkOnTop.Bind(wx.EVT_CHECKBOX, self.OnWatermarkOnTop)
        self.button_13.Bind(wx.EVT_BUTTON, self.OnFirstPage)
        self.button_13_copy_1.Bind(wx.EVT_BUTTON, self.OnPreviousPage)
        self.button_13_copy_2.Bind(wx.EVT_BUTTON, self.OnNextPage)
        self.button_13_copy_2_copy.Bind(wx.EVT_BUTTON, self.OnLastPage)
        self.choiceZoom.Bind(wx.EVT_CHOICE, self.OnZoom)
        # end wxGlade

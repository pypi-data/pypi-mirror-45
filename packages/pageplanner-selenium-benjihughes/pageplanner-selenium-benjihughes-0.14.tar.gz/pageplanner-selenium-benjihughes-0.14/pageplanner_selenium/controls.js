(function(){
    ...
    function createUIControls(){
        ...
        container.style = "border: 1px solid #dae1e7; border-radius: 8px; background:#f1f5f8; top:0;right:0;position:fixed;z-index: 999999;margin:3rem; padding:2rem; margin-top:6rem; box-shadow: 3px 5px 5px rgba(0,0,0,0.4); max-width: 410px; width: 410px; max-height: 500px; overflow-y: auto;";
        ...
        var instructions = [
            ...
            '(Optional) Add the CSS selector for the main content.',
        ...
        var tableHeaders = ['Rank', 'Page Link', 'Selector', 'Remove'];
    ...
    function addLink(href){
        caughtLinks.push({'rank': findRank(href), 'url': href, 'selector': null});
        updateLinksUI();
    }
    ...
    function updateLinkSelector(index, newValue){
        caughtLinks[index]['selector'] = newValue;
        updateLinksUI();
    }
    ...
    function updateLinksUI(){
        ...
        for(var i = 0; i < caughtLinks.length; i++){
            ...
            hrefInput.type = 'text';
            hrefInput.style = "display:block; width:202px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding:3px; border: 1px solid #dae1e7; border-radius: 2px; background:#fbfbfb;";
            ...
            selectorInput.style = "display:block; width:85px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding:3px; border: 1px solid #dae1e7; border-radius: 2px; background:#fbfbfb;";
            selectorInput.title = currentLink['selector'];
            selectorInput.value = currentLink['selector'];
            selectorInput.setAttribute('data-link-index', i.toString());
            selectorInput.addEventListener('blur', function(){
                var index = this.getAttribute('data-link-index');
                updateLinkSelector(index, this.value);
            });

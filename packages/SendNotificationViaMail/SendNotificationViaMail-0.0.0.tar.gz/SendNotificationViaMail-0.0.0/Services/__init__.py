...
class Email(object):
    ...
    def MailGrid(self, sendermail,recivermail,subject,emailbody,htmlcontent,attach):
        message = Mail(
    ...
    def SMTPMail(self,sendermail,senderpassword,recivermail,subject,emailbody,attach):

        subject = subject
        body = emailbody
        sender_email = sendermail
        receiver_email = recivermail

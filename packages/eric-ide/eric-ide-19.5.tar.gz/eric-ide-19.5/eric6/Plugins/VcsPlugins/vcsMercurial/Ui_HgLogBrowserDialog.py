...
# Form implementation generated from reading ui file 'eric6/Plugins/VcsPlugins/vcsMercurial/HgLogBrowserDialog.ui'
#
...
class Ui_HgLogBrowserDialog(object):
    def setupUi(self, HgLogBrowserDialog):
        ...
        self.widget = QtWidgets.QWidget(self.mainSplitter)
        self.widget.setObjectName("widget")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.logTree = QtWidgets.QTreeWidget(self.widget)
        ...
        self.limitSpinBox = QtWidgets.QSpinBox(self.widget)
        ...
        self.stopCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.sbsSelectLabel = QtWidgets.QLabel(self.widget)
        ...
        self.diffSelectLabel = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.saveLabel = QtWidgets.QLabel(self.layoutWidget)

...
# Form implementation generated from reading ui file 'eric6/Debugger/EditBreakpointDialog.ui'
#
...
class Ui_EditBreakpointDialog(object):
    def setupUi(self, EditBreakpointDialog):
        ...
        self.conditionCombo.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToMinimumContentsLength)

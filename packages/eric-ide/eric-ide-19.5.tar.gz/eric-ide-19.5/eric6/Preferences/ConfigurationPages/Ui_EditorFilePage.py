...
# Form implementation generated from reading ui file 'eric6/Preferences/ConfigurationPages/EditorFilePage.ui'
#
...
class Ui_EditorFilePage(object):
    def setupUi(self, EditorFilePage):
        ...
        EditorFilePage.resize(600, 1622)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(EditorFilePage)
        ...
        self.gridLayout_4.addWidget(self.previewMarkdownExtensionsEdit, 0, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.previewMarkdownNLtoBreakCheckBox, 1, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.previewMarkdownHTMLFormatComboBox, 2, 2, 1, 1)
        ...
        EditorFilePage.setTabOrder(self.deleteFileFilterButton, self.previewHtmlExtensionsEdit)
        EditorFilePage.setTabOrder(self.previewHtmlExtensionsEdit, self.previewMarkdownExtensionsEdit)
        EditorFilePage.setTabOrder(self.previewMarkdownExtensionsEdit, self.previewMarkdownNLtoBreakCheckBox)
        EditorFilePage.setTabOrder(self.previewMarkdownNLtoBreakCheckBox, self.previewMarkdownHTMLFormatComboBox)
        EditorFilePage.setTabOrder(self.previewMarkdownHTMLFormatComboBox, self.previewRestExtensionsEdit)
...
"<p>Select to use the advanced encoding detection based on the &quot;universal character encoding detector&quot; from <a href=\"http://chardet.feedparser.org\">http://chardet.feedparser.org</a>.</p>"))
        ...
        self.label_12.setText(_translate("EditorFilePage", "Extensions:"))
        ...
        self.label_11.setText(_translate("EditorFilePage", "Extensions:"))
        ...
        self.label_9.setText(_translate("EditorFilePage", "Extensions:"))
        ...
        self.label_10.setText(_translate("EditorFilePage", "Extensions:"))

...
# Form implementation generated from reading ui file 'eric6/PipInterface/PipPackageDetailsDialog.ui'
#
...
class Ui_PipPackageDetailsDialog(object):
    def setupUi(self, PipPackageDetailsDialog):
        ...
        self.label_12 = QtWidgets.QLabel(self.details)
        ...
        self.downloadsDayLabel = QtWidgets.QLabel(self.details)
        self.downloadsDayLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.downloadsDayLabel.setObjectName("downloadsDayLabel")
        self.gridLayout.addWidget(self.downloadsDayLabel, 0, 1, 1, 1)
        ...
        self.downloadsWeekLabel = QtWidgets.QLabel(self.details)
        self.downloadsWeekLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.downloadsWeekLabel.setObjectName("downloadsWeekLabel")
        self.gridLayout.addWidget(self.downloadsWeekLabel, 1, 1, 1, 1)
        self.label_15 = QtWidgets.QLabel(self.details)
        self.label_15.setObjectName("label_15")
        self.gridLayout.addWidget(self.label_15, 2, 0, 1, 1)
        self.downloadsMonthLabel = QtWidgets.QLabel(self.details)
        self.downloadsMonthLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.downloadsMonthLabel.setObjectName("downloadsMonthLabel")
        self.gridLayout.addWidget(self.downloadsMonthLabel, 2, 1, 1, 1)
        self.gridLayout_2.addLayout(self.gridLayout, 10, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.classifiersList, 11, 1, 1, 1)
    ...
    def retranslateUi(self, PipPackageDetailsDialog):
        ...
        self.label_12.setText(_translate("PipPackageDetailsDialog", "Downloads:"))
        self.label_13.setText(_translate("PipPackageDetailsDialog", "Last Day:"))
        self.label_14.setText(_translate("PipPackageDetailsDialog", "Last Week:"))
        self.label_15.setText(_translate("PipPackageDetailsDialog", "Last Month:"))
        ...
        self.downloadUrlsList.headerItem().setText(3, _translate("PipPackageDetailsDialog", "Downloads"))
        self.downloadUrlsList.headerItem().setText(4, _translate("PipPackageDetailsDialog", "Uploaded on"))
        self.downloadUrlsList.headerItem().setText(5, _translate("PipPackageDetailsDialog", "Size"))

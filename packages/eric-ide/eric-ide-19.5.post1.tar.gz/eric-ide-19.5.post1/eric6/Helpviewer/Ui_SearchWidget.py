...
# Form implementation generated from reading ui file 'eric6/Helpviewer/SearchWidget.ui'
#
...
class Ui_SearchWidget(object):
    def setupUi(self, SearchWidget):
        ...
        self.horizontalLayout_2.addWidget(self.highlightAllCheckBox)

...
class Ui_PythonPage(object):
    def setupUi(self, PythonPage):
        ...
        self.py2EnvironmentEdit = QtWidgets.QLineEdit(self.groupBox_4)
        self.py2EnvironmentEdit.setReadOnly(True)
        self.py2EnvironmentEdit.setObjectName("py2EnvironmentEdit")
        self.gridLayout_3.addWidget(self.py2EnvironmentEdit, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.py3EnvironmentEdit, 1, 1, 1, 1)
        ...
        PythonPage.setTabOrder(self.ioEncodingComboBox, self.py2ExtensionsEdit)
        PythonPage.setTabOrder(self.py2ExtensionsEdit, self.py3ExtensionsEdit)
        PythonPage.setTabOrder(self.py3ExtensionsEdit, self.py2EnvironmentEdit)
        PythonPage.setTabOrder(self.py2EnvironmentEdit, self.py3EnvironmentEdit)
    ...
    def retranslateUi(self, PythonPage):
        ...
        self.label_7.setText(_translate("PythonPage", "Python 2:"))

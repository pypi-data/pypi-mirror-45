...
# Form implementation generated from reading ui file 'eric6/PipInterface/PipPackagesWidget.ui'
#
...
class Ui_PipPackagesWidget(object):
    def setupUi(self, PipPackagesWidget):
        ...
        self.searchTermCombineComboBox = QtWidgets.QComboBox(self.searchWidget)
        self.searchTermCombineComboBox.setObjectName("searchTermCombineComboBox")
        self.searchTermCombineComboBox.addItem("")
        self.searchTermCombineComboBox.setItemText(0, "and")
        self.searchTermCombineComboBox.addItem("")
        self.searchTermCombineComboBox.setItemText(1, "or")
        self.gridLayout.addWidget(self.searchTermCombineComboBox, 0, 2, 2, 1)
        self.label_2 = QtWidgets.QLabel(self.searchWidget)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.searchEditSummary = QtWidgets.QLineEdit(self.searchWidget)
        self.searchEditSummary.setObjectName("searchEditSummary")
        self.gridLayout.addWidget(self.searchEditSummary, 1, 1, 1, 1)
        self.searchButton = QtWidgets.QToolButton(self.searchWidget)
        self.searchButton.setEnabled(False)
        self.searchButton.setObjectName("searchButton")
        self.gridLayout.addWidget(self.searchButton, 0, 3, 2, 1)
        ...
        PipPackagesWidget.setTabOrder(self.searchEditName, self.searchTermCombineComboBox)
        PipPackagesWidget.setTabOrder(self.searchTermCombineComboBox, self.searchEditSummary)
        PipPackagesWidget.setTabOrder(self.searchEditSummary, self.searchButton)
    ...
    def retranslateUi(self, PipPackagesWidget):
        ...
        self.label.setText(_translate("PipPackagesWidget", "Name:"))
        ...
        self.searchTermCombineComboBox.setToolTip(_translate("PipPackagesWidget", "Select the search term combination operation"))
        self.label_2.setText(_translate("PipPackagesWidget", "Summary:"))
        self.searchEditSummary.setToolTip(_translate("PipPackagesWidget", "Enter the search term for the package summary"))
        self.searchEditSummary.setPlaceholderText(_translate("PipPackagesWidget", "Enter search term"))
        self.searchButton.setToolTip(_translate("PipPackagesWidget", "Press to start the search"))
        self.searchResultList.setSortingEnabled(True)
        self.searchResultList.headerItem().setText(0, _translate("PipPackagesWidget", "Package"))
        self.searchResultList.headerItem().setText(1, _translate("PipPackagesWidget", "Score"))
        self.searchResultList.headerItem().setText(2, _translate("PipPackagesWidget", "Description"))

...
def get_logger(logger_name=gmsaas.__application__, version=gmsaas.__version__):
    """
    ...
    file_log_handler = logging.FileHandler(os.path.join(CONFIG_DIR, "gmsaas.log"))
    ...
    if "GM_LOG_TO_STDERR" in os.environ:

...
from promium.core.support.settings import SettingsFirefox
...
def test_set_windows_size():
    SettingsFirefox.device = Device(123, 321, 'xxx')
...
def test_set_windows_size_with_device():
    device = Device(123, 321, 'user xxx')
...
def test_get_preferences_with_user_agent(user_agent):
    SettingsFirefox.device = Device(123, 321, user_agent)
    profile = SettingsFirefox.get_preferences()
...
def test_get_preferences_with_user_agent():
    SettingsFirefox.device = Device(321, 123, 'user agent xxx')
    profile = SettingsFirefox.get_preferences()

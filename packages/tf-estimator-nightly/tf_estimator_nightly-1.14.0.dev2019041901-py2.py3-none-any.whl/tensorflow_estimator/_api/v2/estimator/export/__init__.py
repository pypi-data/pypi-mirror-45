...
_DEPRECATED_TO_CANONICAL = {
    "build_parsing_serving_input_receiver_fn": "estimator.export.build_parsing_serving_input_receiver_fn",
    "ClassificationOutput": "estimator.export.ClassificationOutput",
    "ExportOutput": "estimator.export.ExportOutput",
    "build_raw_serving_input_receiver_fn": "estimator.export.build_raw_serving_input_receiver_fn",
    "RegressionOutput": "estimator.export.RegressionOutput",
    "TensorServingInputReceiver": "estimator.export.TensorServingInputReceiver",
    "PredictOutput": "estimator.export.PredictOutput",
    "ServingInputReceiver": "estimator.export.ServingInputReceiver",
}
...
if not isinstance(_sys.modules[__name__], _deprecation_wrapper.DeprecationWrapper):
  _sys.modules[__name__] = _deprecation_wrapper.DeprecationWrapper(
      _sys.modules[__name__], "estimator.export", _DEPRECATED_TO_CANONICAL)

...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-eks", "0.30.0", __name__, "aws-eks@0.30.0.jsii.tgz")
...
class Cluster(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-eks.Cluster"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, cluster_arn: str, cluster_certificate_authority_data: str, cluster_endpoint: str, cluster_name: str, security_groups: typing.List[aws_cdk.aws_ec2.SecurityGroupImportProps], vpc: aws_cdk.aws_ec2.VpcNetworkImportProps) -> "ICluster":
        ...
        Arguments:
            ...
            props: the cluster properties to use for importing information.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-eks.ClusterImportProps", jsii_struct_bases=[])
...
__all__ = ["AddAutoScalingGroupOptions", "AddWorkerNodesOptions", "CfnCluster", "CfnClusterProps", "Cluster", "ClusterImportProps", "ClusterProps", "EksOptimizedAmi", "EksOptimizedAmiProps", "ICluster", "NodeType", "__jsii_assembly__"]

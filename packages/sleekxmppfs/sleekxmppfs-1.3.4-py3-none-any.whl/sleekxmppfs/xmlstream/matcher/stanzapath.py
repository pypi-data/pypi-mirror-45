# -*- coding: utf-8 -*-
"""
    sleekxmppfs.xmlstream.matcher.stanzapath
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from sleekxmppfs.xmlstream.stanzabase import fix_ns
...
class StanzaPath(MatcherBase):
    ...
    def match(self, stanza):
        ...
        :meth:`~sleekxmppfs.xmlstream.stanzabase.ElementBase.match()` method
        for more information.

        :param stanza: The :class:`~sleekxmppfs.xmlstream.stanzabase.ElementBase`

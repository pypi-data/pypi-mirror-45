# -*- coding: utf-8 -*-
"""
    sleekxmppfs.xmlstream.handler.waiter
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from sleekxmppfs.util import Queue, QueueEmpty
from sleekxmppfs.xmlstream.handler.base import BaseHandler
...
class Waiter(BaseHandler):
    ...
    :param matcher: A :class:`~sleekxmppfs.xmlstream.matcher.base.MatcherBase`
                    derived object for matching stanza objects.
    :param stream: The :class:`~sleekxmppfs.xmlstream.xmlstream.XMLStream`
    ...
    def prerun(self, payload):
        ...
        :param payload: The matched
            :class:`~sleekxmppfs.xmlstream.stanzabase.ElementBase` object.
        """
    ...
    def wait(self, timeout=None):
        ...
        :param int timeout: The number of seconds to wait for the stanza
            ...
            :class:`~sleekxmppfs.xmlstream.xmlstream.XMLStream.response_timeout`
            value.
        """
        if timeout is None:

...
from sleekxmppfs.util import safedict
from sleekxmppfs.xmlstream import JID
...
class StanzaBase(ElementBase):
    ...
    **Stanza Interfaces:**
    ...
    :param XMLStream stream: Optional :class:`sleekxmppfs.xmlstream.XMLStream`
    ...
    :param sto: Optional string or :class:`sleekxmppfs.xmlstream.JID`
                object of the recipient's JID.
    :param sfrom: Optional string or :class:`sleekxmppfs.xmlstream.JID`
    ...
    def set_to(self, value):
        ...
        :param value: A string or :class:`sleekxmppfs.xmlstream.JID` object

"""
    sleekxmppfs.xmlstream.xmlstream
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
import sleekxmppfs
from sleekxmppfs.util import Queue, QueueEmpty, safedict
from sleekxmppfs.thirdparty.statemachine import StateMachine
from sleekxmppfs.xmlstream import Scheduler, tostring, cert
from sleekxmppfs.xmlstream.stanzabase import StanzaBase, ET, ElementBase
from sleekxmppfs.xmlstream.handler import Waiter, XMLCallback
from sleekxmppfs.xmlstream.matcher import MatchXMLMask
from sleekxmppfs.xmlstream.resolver import resolve, default_resolver

# In Python 2.x, file socket objects are broken. A patched socket
# wrapper is provided for this case in filesocket.py.
if sys.version_info < (3, 0):
    from sleekxmppfs.xmlstream.filesocket import FileSocket, Socket26
...
class XMLStream(object):
    ...
    def __init__(self, socket=None, host='', port=0, certfile=None,
        ...
        #: A :class:`~sleekxmppfs.xmlstream.scheduler.Scheduler` instance for
    ...
    def _connect_proxy(self):
        ...
        headers = ['CONNECT %s:%s HTTP/1.0' % self.address,
                   ...
                   'Pragma: no-cache',
                   'User-Agent: SleekXMPP/%s' % sleekxmppfs.__version__]
        if cred:
    ...
    def register_stanza(self, stanza_class):
        ...
        sleekxmppfs.xmlstream.stanzabase.
    ...
    def register_handler(self, handler, before=None, after=None):
        ...
        :param handler:
                The :class:`~sleekxmppfs.xmlstream.handler.base.BaseHandler`
    ...
    def send(self, data, mask=None, timeout=None, now=False, use_filters=True):
        ...
        :param data: The :class:`~sleekxmppfs.xmlstream.stanzabase.ElementBase`
    ...
    def _build_stanza(self, xml, default_ns=None):
        ...
        a generic :class:`~sleekxmppfs.xmlstream.stanzabase.StanzaBase`

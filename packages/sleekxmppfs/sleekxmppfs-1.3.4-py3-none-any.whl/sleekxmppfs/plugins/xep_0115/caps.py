...
from sleekxmppfs import __version__
from sleekxmppfs.stanza import StreamFeatures, Presence, Iq
...
from sleekxmppfs.exceptions import XMPPError, IqError, IqTimeout
from sleekxmppfs.plugins import BasePlugin
from sleekxmppfs.plugins.xep_0115 import stanza, StaticCaps
...
class XEP_0115(BasePlugin):
    ...
    def plugin_init(self):
        ...
        if self.caps_node is None:
            self.caps_node = 'http://sleekxmppfs.com/ver/%s' % __version__

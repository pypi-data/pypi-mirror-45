...
from sleekxmppfs import plugins, roster, stanza
from sleekxmppfs.api import APIRegistry
from sleekxmppfs.exceptions import IqError, IqTimeout

from sleekxmppfs.stanza import Message, Presence, Iq, StreamError
from sleekxmppfs.stanza.roster import Roster
from sleekxmppfs.stanza.nick import Nick

from sleekxmppfs.xmlstream import XMLStream, JID
from sleekxmppfs.xmlstream import ET, register_stanza_plugin
from sleekxmppfs.xmlstream.matcher import MatchXPath
from sleekxmppfs.xmlstream.handler import Callback
from sleekxmppfs.xmlstream.stanzabase import XML_NS

from sleekxmppfs.plugins import PluginManager, load_plugin
...
if sys.version_info < (3, 0):
    from sleekxmppfs.util.misc_ops import setdefaultencoding
...
class BaseXMPP(XMLStream):
    ...
    def __init__(self, jid='', default_ns='jabber:client', **kwargs):
        ...
        #: A reference to :mod:`sleekxmppfs.stanza` to make accessing
    ...
    def make_iq(self, id=0, ifrom=None, ito=None, itype=None, iquery=None):
        ...
        :param id: An ideally unique ID value for this stanza thread.
                   Defaults to 0.
        :param ifrom: The from :class:`~sleekxmppfs.xmlstream.jid.JID`
                      to use for this stanza.
        :param ito: The destination :class:`~sleekxmppfs.xmlstream.jid.JID`
                    for this stanza.
        :param itype: The :class:`~sleekxmppfs.stanza.iq.Iq`'s type,
    ...
    def make_iq_get(self, queryxmlns=None, ito=None, ifrom=None, iq=None):
        """Create an :class:`~sleekxmppfs.stanza.iq.Iq` stanza of type ``'get'``.
    ...
    def make_iq_result(self, id=None, ito=None, ifrom=None, iq=None):
        """
        Create an :class:`~sleekxmppfs.stanza.iq.Iq` stanza of type
    ...
    def make_iq_set(self, sub=None, ito=None, ifrom=None, iq=None):
        """
        Create an :class:`~sleekxmppfs.stanza.iq.Iq` stanza of type ``'set'``.

        Optionally, a substanza may be given to use as the
        stanza's payload.

        :param sub: Either an
                    :class:`~sleekxmppfs.xmlstream.stanzabase.ElementBase`
                    stanza object or an
                    :class:`~xml.etree.ElementTree.Element` XML object
                    to use as the :class:`~sleekxmppfs.stanza.iq.Iq`'s payload.
        :param ito: The destination :class:`~sleekxmppfs.xmlstream.jid.JID`
                    for this stanza.
        :param ifrom: The ``'from'`` :class:`~sleekxmppfs.xmlstream.jid.JID`
                      to use for this stanza.
    ...
    def make_iq_error(self, id, type='cancel',
        ...
        """
        Create an :class:`~sleekxmppfs.stanza.iq.Iq` stanza of type ``'error'``.
    ...
    def make_iq_query(self, iq=None, xmlns='', ito=None, ifrom=None):
        """
        Create or modify an :class:`~sleekxmppfs.stanza.iq.Iq` stanza
    ...
    def make_message(self, mto, mbody=None, msubject=None, mtype=None,
        ...
        :class:`~sleekxmppfs.stanza.message.Message` stanza.
    ...
    def make_presence(self, pshow=None, pstatus=None, ppriority=None,
        ...
        """
        Create and initialize a new
        :class:`~sleekxmppfs.stanza.presence.Presence` stanza.
    ...
    def send_presence_subscription(self, pto, pfrom=None,
        ...
        """
        Create, initialize, and send a new
        :class:`~sleekxmppfs.stanza.presence.Presence` stanza of
        type ``'subscribe'``.
    ...
    def exception(self, exception):
        ...
        :class:`~sleekxmppfs.exceptions.IqError` and
        :class:`~sleekxmppfs.exceptions.IqTimeout` exceptions.

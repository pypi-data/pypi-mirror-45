...
from sleekxmppfs.stanza.rootstanza import RootStanza
from sleekxmppfs.xmlstream import StanzaBase, ET
from sleekxmppfs.xmlstream.handler import Waiter, Callback
from sleekxmppfs.xmlstream.matcher import MatchIDSender, MatcherId
from sleekxmppfs.exceptions import IqTimeout, IqError
    ...
    def send(self, block=True, timeout=None, callback=None, now=False, timeout_callback=None):
        ...
        Arguments:
            ...
            timeout  -- The length of time (in seconds) to wait for a response
                        ...
                        Defaults to sleekxmppfs.xmlstream.RESPONSE_TIMEOUT

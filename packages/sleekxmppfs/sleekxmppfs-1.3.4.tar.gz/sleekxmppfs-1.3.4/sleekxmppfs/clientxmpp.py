...
from sleekxmppfs.xmlstream import XMLStream
from sleekxmppfs.xmlstream.matcher import StanzaPath, MatchXPath
...
class ClientXMPP(BaseXMPP):
    ...
    :param plugin_whitelist: A list of approved plugins that
                    ...
                    :meth:`~sleekxmppfs.basexmpp.BaseXMPP.register_plugins()`.
    ...
    def update_roster(self, jid, **kwargs):
        ...
        :param timeout: The length of time (in seconds) to wait
                        ...
                        is used. Defaults to
            :attr:`~sleekxmppfs.xmlstream.xmlstream.XMLStream.response_timeout`.
    ...
    def _handle_session_bind(self, jid):
        ...
        :param :class:`sleekxmppfs.xmlstream.jid.JID` jid: The bound JID as

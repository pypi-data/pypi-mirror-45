...
from sleekxmppfs.xmlstream.stanzabase import ET
...
class MatchXMLMask(MatcherBase):
    ...
    :class:`~sleekxmppfs.xmlstream.matcher.xpath.MatchXPath` or
    :class:`~sleekxmppfs.xmlstream.matcher.stanzapath.StanzaPath`

...
class XMPPError(Exception):
    ...
    :class:`~sleekxmppfs.stanza.rootstanza.RootStanza` will create an error
...
class IqTimeout(XMPPError):
    ...
    def __init__(self, iq):
        ...
        #: The :class:`~sleekxmppfs.stanza.iq.Iq` stanza whose response
...
class IqError(XMPPError):
    ...
    def __init__(self, iq):
        ...
        #: The :class:`~sleekxmppfs.stanza.iq.Iq` error result stanza.
        self.iq = iq

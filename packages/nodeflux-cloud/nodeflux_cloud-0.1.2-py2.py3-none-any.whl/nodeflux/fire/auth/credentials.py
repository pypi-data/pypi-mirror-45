...
"""
    nodeflux.fire.auth.credentials
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from nodeflux.fire import environment_vars as env
from nodeflux.fire.exceptions import NoCredentialsError


class Credentials:
    """Credentials for Nodeflux API authentication."""
...
class EnvCredentialsFileLoader(
    ...
    def __init__(self) -> None:
        ...
        self.path = os.environ.get(
            env.NODEFLUX_CREDENTIALS_FILE, "~/.nodeflux/credentials.yml"
        )

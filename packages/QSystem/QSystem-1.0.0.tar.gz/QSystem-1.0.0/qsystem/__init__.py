...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_qsystem')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_qsystem')
    _qsystem = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_qsystem', [dirname(__file__)])
        except ImportError:
            import _qsystem
            return _qsystem
        try:
            _mod = imp.load_module('_qsystem', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class SwigPyIterator(_object):
    ...
    def __iter__(self):
        return self
SwigPyIterator_swigregister = _qsystem.SwigPyIterator_swigregister
SwigPyIterator_swigregister(SwigPyIterator)

class vec_size_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vec_size_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vec_size_t, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _qsystem.new_vec_size_t(*args)
        try:
    ...
    __del__ = lambda self: None
vec_size_t_swigregister = _qsystem.vec_size_t_swigregister
vec_size_t_swigregister(vec_size_t)

class vec_complex(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vec_complex, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vec_complex, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _qsystem.new_vec_complex(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
vec_complex_swigregister = _qsystem.vec_complex_swigregister
vec_complex_swigregister(vec_complex)

class vec_int(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vec_int, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vec_int, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _qsystem.new_vec_int(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
vec_int_swigregister = _qsystem.vec_int_swigregister
vec_int_swigregister(vec_int)

class vec_float(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vec_float, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vec_float, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _qsystem.new_vec_float(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
vec_float_swigregister = _qsystem.vec_float_swigregister
vec_float_swigregister(vec_float)
...
class vec_str(_object):
    ...
    def __init__(self, *args):
        this = _qsystem.new_vec_str(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
vec_str_swigregister = _qsystem.vec_str_swigregister
vec_str_swigregister(vec_str)

class QSystem(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, QSystem, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, QSystem, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _qsystem.new_QSystem(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def evol(self, gate, qbit, count=1, inver=False):
        return _qsystem.QSystem_evol(self, gate, qbit, count, inver)
    ...
    def qft(self, qbegin, qend, inver=False):
        return _qsystem.QSystem_qft(self, qbegin, qend, inver)
    ...
    def state(self):
        return _qsystem.QSystem_state(self)
    ...
    def change_to(self, new_state):
        return _qsystem.QSystem_change_to(self, new_state)

    def get_qbits(self):
        return _qsystem.QSystem_get_qbits(self)

    def set_qbits(self, row_ind, col_ptr, values, nqbits, state):
        return _qsystem.QSystem_set_qbits(self, row_ind, col_ptr, values, nqbits, state)

    def add_ancillas(self, nqbits):
        return _qsystem.QSystem_add_ancillas(self, nqbits)

    def rm_ancillas(self):
        return _qsystem.QSystem_rm_ancillas(self)
QSystem_swigregister = _qsystem.QSystem_swigregister
QSystem_swigregister(QSystem)

class Gates(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Gates, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Gates, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _qsystem.new_Gates(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def get(self, gate):
        return _qsystem.Gates_get(self, gate)

    def mget(self, gate):
        return _qsystem.Gates_mget(self, gate)

    def make_gate(self, name, matrix):
        return _qsystem.Gates_make_gate(self, name, matrix)

    def make_mgate(self, name, size, row, col, value):
        return _qsystem.Gates_make_mgate(self, name, size, row, col, value)

    def make_cgate(self, name, gates, control):
        return _qsystem.Gates_make_cgate(self, name, gates, control)

    def make_fgate(self, *args):
        return _qsystem.Gates_make_fgate(self, *args)

    def __str__(self):
        return _qsystem.Gates___str__(self)

    def save(self, path):
        return _qsystem.Gates_save(self, path)
    __swig_destroy__ = _qsystem.delete_Gates
    __del__ = lambda self: None
Gates_swigregister = _qsystem.Gates_swigregister
Gates_swigregister(Gates)

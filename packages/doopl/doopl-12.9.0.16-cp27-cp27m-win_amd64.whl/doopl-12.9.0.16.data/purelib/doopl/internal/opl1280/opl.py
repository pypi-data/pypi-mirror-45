...
class IloNumArray(_object):
    ...
    def get_Num(self, index: '__int64') -> "double":
...
class IloIntArray(_object):
    ...
    def get_Int(self, index: '__int64') -> "__int64":
...
class IloTupleSet(_object):
    ...
    def commit(self, line: 'IloTupleCellArray', check: 'IloBool') -> "__int64":
        return _opl.IloTupleSet_commit(self, line, check)

    def end(self) -> "void":
        return _opl.IloTupleSet_end(self)

    def commit2HashTable(self, array: 'IloTupleCellArray', check: 'IloBool') -> "__int64":
    ...
    def setIntColumnValues(self, idx: '__int64', values: '__int64 *', size: '__int64') -> "void":
        return _opl.IloTupleSet_setIntColumnValues(self, idx, values, size)

    def setNumColumnValues(self, idx: '__int64', values: 'double *', size: '__int64') -> "void":
        return _opl.IloTupleSet_setNumColumnValues(self, idx, values, size)

    def setStringColumnValues(self, idx: '__int64', values: 'char **', size: '__int64') -> "void":
        return _opl.IloTupleSet_setStringColumnValues(self, idx, values, size)

    def getIntColumnValues(self, i: '__int64') -> "IloIntArray":
        return _opl.IloTupleSet_getIntColumnValues(self, i)

    def getNumColumnValues(self, i: '__int64') -> "IloNumArray":
        return _opl.IloTupleSet_getNumColumnValues(self, i)

    def getSymbolColumnValues(self, i: '__int64') -> "IloAnyArray":
...
class IloTupleSchema(_object):
    ...
    def getColumnName(self, idx: '__int64') -> "char const *":
    ...
    def _getTupleColumn(self, i: '__int64') -> "IloTupleSchema":
        return _opl.IloTupleSchema__getTupleColumn(self, i)

    def _isTuple(self, i: '__int64') -> "IloBool":
...
class IloOplModel(_object):
    ...
    def runSeed(self, n: '__int64') -> "void":
    ...
    def _printConflict(self) -> "__int64":
        return _opl.IloOplModel__printConflict(self)

    def _printRelaxation(self) -> "__int64":
...
class IloOplElementDefinition(_object):
    ...
    def getElementDefinitionType_asInt(self) -> "__int64":
...
class IloCplex(_object):
    ...
    def getCplexStatus_asInt(self) -> "__int64":
    ...
    def _getQualityEnumName(self, index: '__int64') -> "char const *":
        return _opl.IloCplex__getQualityEnumName(self, index)

    def _getQualityEnumSize(self) -> "__int64":

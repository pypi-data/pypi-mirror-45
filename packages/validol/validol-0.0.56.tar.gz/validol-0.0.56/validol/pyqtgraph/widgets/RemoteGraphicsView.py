...
class RemoteGraphicsView(QtGui.QWidget):
    ...
    def __init__(self, parent=None, *args, **kwds):
        ...
        self.pg = self._proc._import('validol.pyqtgraph')
        self.pg.setConfigOptions(**CONFIG_OPTIONS)
        rpgRemote = self._proc._import('validol.pyqtgraph.widgets.RemoteGraphicsView')
...
class Renderer(GraphicsView):
    ...
    def __init__(self, *args, **kwds):
        ...
        if sys.platform.startswith('win'):
            ...
            self.shmFile.write_df(b'\x00' * (mmap.PAGESIZE + 1))

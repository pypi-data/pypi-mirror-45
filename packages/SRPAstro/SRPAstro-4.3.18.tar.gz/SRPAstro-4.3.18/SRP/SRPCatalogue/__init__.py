...
__all__ = ['AGNOptRefStarsClass', 'APASSClass', 'AstroWiseStandardStarsClass', 'BrightStarClass',
           'CatalogueConstants', 'GetVizierCat', 'IGAIAClass', 'NIRStandardStarsClass','ParseVisierCat',
           'SDSSClass', 'SimbadNameClass', 'SkyBotClass', 'SimbadClass', 'SmithetalStandardStarsClass',
           'StetsonJohnsonStandardStarsClass', 'TWOMASSClass','USNOB1Class', 'USNOClass']

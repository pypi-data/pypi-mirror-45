...
class StackService(Authenticator):
    ...
    def backupInstallationToBucket(self, installation, signed_metadata_url, signed_filedata_url, signed_dbdata_url, callback_url):

...
class Test(unittest.TestCase):
    ...
    def test_file_store_example(self):
        self.assertEqual(len(_test_ipynb(os.path.abspath(self.examples_dir + 'file_store_example.ipynb'))), 0)

    def test_memory_ts_example(self):
        self.assertEqual(len(_test_ipynb(os.path.abspath(self.examples_dir + 'memory_time_series_example.ipynb'))), 0)
    ...
    def test_autocorrelation_example(self):
        self.assertEqual(len(_test_ipynb(os.path.abspath(self.examples_dir + 'statistics/autocorrelation.ipynb'))), 0)
    ...
    def test_kiwis_adapter(self):
        self.assertEqual(len(_test_ipynb(os.path.abspath(self.examples_dir + 'kiwis_adapter/basic_example.ipynb'))), 0)

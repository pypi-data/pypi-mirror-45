...
class KiWISStore(TimeSeriesStore):
    ...
    def _get_time_series_list(self, ts_filter: str = None,
    ...
    def _get_time_series(self, ts_id: int = None, path: str = None, params: Mapping[str, Any] = None) -> TimeSeries:
        ...
        """
        res = self._get_time_series_list(ts_filter=path, id_list=[ts_id] if ts_id is not None else None, params=params)
        if len(res) != 1:

...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-fsx", "0.29.0", __name__, "aws-fsx@0.29.0.jsii.tgz")
class CfnFileSystem(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-fsx.CfnFileSystem"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-fsx.CfnFileSystem.TagEntryProperty", jsii_struct_bases=[])

...
PRODUCTION_PACKAGES = ('detoxed',)
SUPPORT_PACKAGES = ('samples',)
...
setup(
    ...
    description='Integration test harness for Azure IoT deployments',
    long_description=LONG_DESCRIPTION,
    long_description_content_type='text/markdown',
    url='https://github.com/Microsoft/Detoxed',

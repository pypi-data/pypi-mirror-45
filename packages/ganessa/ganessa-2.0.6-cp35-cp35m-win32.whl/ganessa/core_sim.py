...
from ganessa.util import winstr, quotefilename, hhmmss, is_text, tostr, PY3
...
#****
try:
    tsdemandlen = _dll_api.demand_tslen
except AttributeError:
...
#****f* sFunctions/hstepcount, tslen, mslen, tsval, msval, tsvalbymts, tsinterv, refdate
# PURPOSE

...
setup(
    name='PP6Generator',
    version=get_version('PP6Generator'),
    license='MIT',
    description='A toolkit for generating ProPresenter6 files.',
    long_description='\n\n'.join(get_long_description()),
    author='kikeh',
    author_email='heisba@gmail.com',
    maintainer='kikeh',
    url='https://github.com/kikeh/PP6Generator',
    project_urls=OrderedDict((
        ('Issues', 'https://github.com/kikeh/PP6Generator/issues'),
    )),

...
usage: vibhu [-h] [-name] [-resume] [-profile] [-location] [-contact] [-need]
             [-summary] [-skills] [-handles] [-education] [-foss] [-work]
             [-org]
...
optional arguments:
  ...
  -summary    Fetches information about which tools I've worked with and how
              much.
  -skills     Lists down my skill set.
  -handles    Lists down my various public profiles on various platforms
              (GitHub, LinkedIn, ...)

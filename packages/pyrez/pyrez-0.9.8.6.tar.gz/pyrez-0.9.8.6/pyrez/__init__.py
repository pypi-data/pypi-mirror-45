...
__copyright__ = "Copyright (c) 2018 Luis (Lugg) Gustavo"
__build__ = 0x000908
...
version_info = namedtuple("VersionInfo", "major minor micro releaselevel serial")(major=0, minor=9, micro=8, releaselevel="beta", serial=6)

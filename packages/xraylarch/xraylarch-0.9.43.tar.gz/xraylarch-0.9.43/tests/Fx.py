...
class TestScripts(TestCase):
    ...
    def test15_feffdat3(self):
        self.runscript('doc_feffdat3.lar', dirname='../examples/feffit/')
        assert(len(self.session.get_errors()) == 0)

    def test16_feffdat3extra(self):
        self.runscript('doc_feffdat3.lar', dirname='../examples/feffit/')
        assert(len(self.session.get_errors()) == 0)

        self.runscript('doc_feffdat3_extra.lar', dirname='../examples/feffit/')
    ...
    def test16_feffdat4(self):
        self.runscript('doc_feffdat4.lar', dirname='../examples/feffit/')
        assert(len(self.session.get_errors()) == 0)

...
class FieldsTestCase(unittest.TestCase):
    ...
    def test_char(self):
        ...
        self.assertTrue(char5)

        char6, = CharSize.create([{
                    'char': 'Test',
                    }])
        self.assertTrue(char6)
        ...
        self.assertTrue(char7)
        self.assertEqual(char7.char, 'é')
    ...
    def test_text(self):
        ...
        self.assertTrue(text5)

        text6, = TextSize.create([{
                    'text': 'Test',
                    }])
        self.assertTrue(text6)
        ...
        self.assertTrue(text7)

        text8, = Text.create([{
                    'text': 'é',
                    }])
        self.assertTrue(text8)
        self.assertEqual(text8.text, 'é')
    ...
    def test_date(self):
        ...
        self.assertTrue(date6)

        date7, = Date.create([{
                    'date': None,
                    }])
        self.assertTrue(date7)

        date8, = Date.create([{
                    'date': None,
                    }])
        self.assertTrue(date8)
    ...
    def test_time(self):
        ...
        self.assertTrue(time6)

        time7, = Time.create([{
                    'time': None,
                    }])
        self.assertTrue(time7)

        time9, = Time.create([{
                    'time': evening.replace(microsecond=1),
                    }])
        self.assertTrue(time9)
        self.assertEqual(time9.time, evening)

        # Test format
        self.assertTrue(TimeFormat.create([{
    ...
    def test_property(self):
        ...
        self.assertTrue(char_a)

        char_b, = Char.create([{'char': 'FooBar'}])
        self.assertTrue(char_b)
    ...
    def test_dict(self):
        ...
        self.assertTrue(dict1.dico == {'a': 1, 'b': 2})

        Dict.write([dict1], {'dico': {'z': 26}})
        self.assertTrue(dict1.dico == {'z': 26})
    ...
    def test_binary(self):
        ...
        self.assertTrue(bin1.binary == fields.Binary.cast(b'foo'))

        Binary.write([bin1], {'binary': fields.Binary.cast(b'bar')})
        self.assertTrue(bin1.binary == fields.Binary.cast(b'bar'))

        with transaction.set_context({'test.binary.binary': 'size'}):
            bin1_size = Binary(bin1.id)
            self.assertTrue(bin1_size.binary == len(b'bar'))
            self.assertTrue(bin1_size.binary != fields.Binary.cast(b'bar'))

        bin2, = Binary.create([{}])
        self.assertTrue(bin2.binary is None)

        bin3, = BinaryDefault.create([{}])
        self.assertTrue(bin3.binary == fields.Binary.cast(b'default'))
        ...
        self.assertTrue(bin4.binary == fields.Binary.cast(b'baz'))
    ...
    def test_timedelta(self):
        ...
        self.assertTrue(timedelta6)

        timedelta7, = Timedelta.create([{
                    'timedelta': None,
                    }])
        self.assertTrue(timedelta7)

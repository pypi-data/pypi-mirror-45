...
class Config(_object):
    ...
    __swig_setmethods__["metaDataFile"] = _infomap.Config_metaDataFile_set
    __swig_getmethods__["metaDataFile"] = _infomap.Config_metaDataFile_get
    if _newclass:
        metaDataFile = _swig_property(_infomap.Config_metaDataFile_get, _infomap.Config_metaDataFile_set)
    __swig_setmethods__["metaDataRate"] = _infomap.Config_metaDataRate_set
    __swig_getmethods__["metaDataRate"] = _infomap.Config_metaDataRate_get
    if _newclass:
        metaDataRate = _swig_property(_infomap.Config_metaDataRate_get, _infomap.Config_metaDataRate_set)
    __swig_setmethods__["unweightedMetaData"] = _infomap.Config_unweightedMetaData_set
    __swig_getmethods__["unweightedMetaData"] = _infomap.Config_unweightedMetaData_get
    if _newclass:
        unweightedMetaData = _swig_property(_infomap.Config_unweightedMetaData_get, _infomap.Config_unweightedMetaData_set)
    __swig_setmethods__["numMetaDataDimensions"] = _infomap.Config_numMetaDataDimensions_set
    __swig_getmethods__["numMetaDataDimensions"] = _infomap.Config_numMetaDataDimensions_get
    if _newclass:
        numMetaDataDimensions = _swig_property(_infomap.Config_numMetaDataDimensions_get, _infomap.Config_numMetaDataDimensions_set)
    ...
    __swig_setmethods__["setUnidentifiedNodesToClosestModule"] = _infomap.Config_setUnidentifiedNodesToClosestModule_set
    __swig_getmethods__["setUnidentifiedNodesToClosestModule"] = _infomap.Config_setUnidentifiedNodesToClosestModule_get
    if _newclass:
        setUnidentifiedNodesToClosestModule = _swig_property(_infomap.Config_setUnidentifiedNodesToClosestModule_get, _infomap.Config_setUnidentifiedNodesToClosestModule_set)
...
class InfoNode(_object):
    ...
    __swig_setmethods__["metaData"] = _infomap.InfoNode_metaData_set
    __swig_getmethods__["metaData"] = _infomap.InfoNode_metaData_get
    if _newclass:
        metaData = _swig_property(_infomap.InfoNode_metaData_get, _infomap.InfoNode_metaData_set)
    ...
    __swig_setmethods__["metaCollection"] = _infomap.InfoNode_metaCollection_set
    __swig_getmethods__["metaCollection"] = _infomap.InfoNode_metaCollection_get
    if _newclass:
        metaCollection = _swig_property(_infomap.InfoNode_metaCollection_get, _infomap.InfoNode_metaCollection_set)
...
class InfomapIterator(_object):
    ...
    __swig_setmethods__["metaData"] = _infomap.InfomapIterator_metaData_set
    __swig_getmethods__["metaData"] = _infomap.InfomapIterator_metaData_get
    if _newclass:
        metaData = _swig_property(_infomap.InfomapIterator_metaData_get, _infomap.InfomapIterator_metaData_set)
    ...
    __swig_setmethods__["metaCollection"] = _infomap.InfomapIterator_metaCollection_set
    __swig_getmethods__["metaCollection"] = _infomap.InfomapIterator_metaCollection_get
    if _newclass:
        metaCollection = _swig_property(_infomap.InfomapIterator_metaCollection_get, _infomap.InfomapIterator_metaCollection_set)
...
class InfomapParentIterator(_object):
    ...
    __swig_setmethods__["metaData"] = _infomap.InfomapParentIterator_metaData_set
    __swig_getmethods__["metaData"] = _infomap.InfomapParentIterator_metaData_get
    if _newclass:
        metaData = _swig_property(_infomap.InfomapParentIterator_metaData_get, _infomap.InfomapParentIterator_metaData_set)
    ...
    __swig_setmethods__["metaCollection"] = _infomap.InfomapParentIterator_metaCollection_set
    __swig_getmethods__["metaCollection"] = _infomap.InfomapParentIterator_metaCollection_get
    if _newclass:
        metaCollection = _swig_property(_infomap.InfomapParentIterator_metaCollection_get, _infomap.InfomapParentIterator_metaCollection_set)
...
class map_uint_uint(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, map_uint_uint, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, map_uint_uint, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _infomap.new_map_uint_uint(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
map_uint_uint_swigregister = _infomap.map_uint_uint_swigregister
map_uint_uint_swigregister(map_uint_uint)
...
class InfomapBase(InfomapConfigInfomapBase):
    ...
    def getMetaCodelength(self):
        return _infomap.InfomapBase_getMetaCodelength(self)
...
class MetaMapEquation(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, MetaMapEquation, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, MetaMapEquation, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _infomap.new_MetaMapEquation(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
    if _newclass:
        haveMemory = staticmethod(_infomap.MetaMapEquation_haveMemory)
    else:
        haveMemory = _infomap.MetaMapEquation_haveMemory
    ...
    def getMetaCodelength(self):
        return _infomap.MetaMapEquation_getMetaCodelength(self)
    ...
    __swig_setmethods__["codelength"] = _infomap.MetaMapEquation_codelength_set
    __swig_getmethods__["codelength"] = _infomap.MetaMapEquation_codelength_get
    if _newclass:
        codelength = _swig_property(_infomap.MetaMapEquation_codelength_get, _infomap.MetaMapEquation_codelength_set)
    __swig_setmethods__["indexCodelength"] = _infomap.MetaMapEquation_indexCodelength_set
    __swig_getmethods__["indexCodelength"] = _infomap.MetaMapEquation_indexCodelength_get
    if _newclass:
        indexCodelength = _swig_property(_infomap.MetaMapEquation_indexCodelength_get, _infomap.MetaMapEquation_indexCodelength_set)
    __swig_setmethods__["moduleCodelength"] = _infomap.MetaMapEquation_moduleCodelength_set
    __swig_getmethods__["moduleCodelength"] = _infomap.MetaMapEquation_moduleCodelength_get
    if _newclass:
        moduleCodelength = _swig_property(_infomap.MetaMapEquation_moduleCodelength_get, _infomap.MetaMapEquation_moduleCodelength_set)
MetaMapEquation_swigregister = _infomap.MetaMapEquation_swigregister
MetaMapEquation_swigregister(MetaMapEquation)

def MetaMapEquation_haveMemory():
    return _infomap.MetaMapEquation_haveMemory()
MetaMapEquation_haveMemory = _infomap.MetaMapEquation_haveMemory

class InfomapCore(InfomapBase):
    __swig_setmethods__ = {}
    for _s in [InfomapBase]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, InfomapCore, name, value)
    __swig_getmethods__ = {}
    for _s in [InfomapBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, InfomapCore, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _infomap.new_InfomapCore(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def getMetaCodelength(self):
        return _infomap.InfomapCore_getMetaCodelength(self)
InfomapCore_swigregister = _infomap.InfomapCore_swigregister
InfomapCore_swigregister(InfomapCore)

class map_uint_vector_uint(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, map_uint_vector_uint, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, map_uint_vector_uint, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _infomap.new_map_uint_vector_uint(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
map_uint_vector_uint_swigregister = _infomap.map_uint_vector_uint_swigregister
map_uint_vector_uint_swigregister(map_uint_vector_uint)

class Infomap(InfomapCore):
    __swig_setmethods__ = {}
    for _s in [InfomapCore]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))

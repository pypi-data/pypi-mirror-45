...
public:
	...
	virtual double getMetaCodelength() const;
...
template<>
inline
double InfomapOptimizer<MetaMapEquation>::getMetaCodelength() const
{
	return m_objective.getMetaCodelength();
}

template<typename Objective>
inline
double InfomapOptimizer<Objective>::getMetaCodelength() const
{
	return 0.0;
}

...
class ModelLoader:
    ...
    def get_model(self):
        ...
        self.logger.info('Size of model data: {} KB'.format(int(len(str(new_trained_model_data).encode('utf-8')) / 1024)))

        model_data_encoded = new_trained_model_data.model
        self.model = self.__decode_model(model_data_encoded)
        new_trained_model_data.model = self.model

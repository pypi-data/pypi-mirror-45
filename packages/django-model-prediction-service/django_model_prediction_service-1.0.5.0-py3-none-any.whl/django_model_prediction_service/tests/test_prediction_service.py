...
class TestPredictionService(TestCase):
    ...
    @patch('django_model_prediction_service.config.config_manager.ConfigManager.get_config_dict', new=mock_get_config_dict, create=True)
    def setUp(self):
        ...
        # Target
        self.prediction_service = PredictionModelHandler(prediction_model_wrapper=wrapper, config_manager=config_manager, model_loader=model_loader)

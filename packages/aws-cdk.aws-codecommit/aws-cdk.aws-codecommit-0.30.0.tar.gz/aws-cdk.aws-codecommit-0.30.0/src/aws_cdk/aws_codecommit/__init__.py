...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codecommit", "0.30.0", __name__, "aws-codecommit@0.30.0.jsii.tgz")
...
class Repository(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codecommit.Repository"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, repository_name: str) -> "IRepository":
        ...
        Arguments:
            scope: the parent Construct for the Repository.
            id: the name of the Repository Construct.
            props: the properties used to identify the existing Repository.
            repositoryName: The name of an existing CodeCommit Repository that we are referencing. Must be in the same account and region as the root Stack.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codecommit.RepositoryImportProps", jsii_struct_bases=[])
...
__all__ = ["CfnRepository", "CfnRepositoryProps", "IRepository", "Repository", "RepositoryEventTrigger", "RepositoryImportProps", "RepositoryProps", "RepositoryTriggerOptions", "__jsii_assembly__"]

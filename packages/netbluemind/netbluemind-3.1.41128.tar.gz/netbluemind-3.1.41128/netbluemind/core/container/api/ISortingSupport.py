...
ISortingSupport_VERSION = "4.1.42252"
...
class ISortingSupport(BaseEndpoint):
    ...
    def sortedIds (self, sorted ):
        ...
        response = requests.get( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : ISortingSupport_VERSION}, data = __encoded__);

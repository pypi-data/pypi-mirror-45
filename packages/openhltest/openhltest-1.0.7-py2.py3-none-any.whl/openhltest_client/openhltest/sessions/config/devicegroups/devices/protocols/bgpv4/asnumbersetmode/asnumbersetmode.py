...
class AsNumberSetMode(Base):
	...
	def update(self, PatternFormat=None, PatternType=None, Single=None, ValueList=None):
		"""Update the current instance of the `as-number-set-mode` resource

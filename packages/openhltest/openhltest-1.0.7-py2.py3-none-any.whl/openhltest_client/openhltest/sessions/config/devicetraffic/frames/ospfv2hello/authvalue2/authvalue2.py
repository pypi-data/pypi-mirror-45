...
class AuthValue2(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.authvalue2.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.authvalue2.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.authvalue2.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.authvalue2.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.authvalue2.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.authvalue2.random.random import Random

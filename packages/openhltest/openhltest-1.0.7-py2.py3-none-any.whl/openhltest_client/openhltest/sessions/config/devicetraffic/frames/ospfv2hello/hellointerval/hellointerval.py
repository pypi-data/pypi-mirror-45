...
class HelloInterval(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.hellointerval.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.hellointerval.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.hellointerval.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.hellointerval.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.hellointerval.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.ospfv2hello.hellointerval.random.random import Random

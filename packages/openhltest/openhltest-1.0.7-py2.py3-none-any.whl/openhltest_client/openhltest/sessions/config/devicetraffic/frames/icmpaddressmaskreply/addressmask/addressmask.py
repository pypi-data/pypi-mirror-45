...
class AddressMask(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpaddressmaskreply.addressmask.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpaddressmaskreply.addressmask.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpaddressmaskreply.addressmask.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpaddressmaskreply.addressmask.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpaddressmaskreply.addressmask.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpaddressmaskreply.addressmask.random.random import Random

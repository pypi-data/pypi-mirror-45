...
class Ipv4ReservedBit(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpparameterproblem.ipv4reservedbit.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpparameterproblem.ipv4reservedbit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpparameterproblem.ipv4reservedbit.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpparameterproblem.ipv4reservedbit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpparameterproblem.ipv4reservedbit.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpparameterproblem.ipv4reservedbit.random.random import Random

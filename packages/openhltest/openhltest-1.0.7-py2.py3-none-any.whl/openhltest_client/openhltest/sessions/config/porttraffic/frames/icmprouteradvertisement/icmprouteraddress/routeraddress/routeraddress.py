...
class RouterAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.routeraddress.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.routeraddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.routeraddress.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.routeraddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.routeraddress.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.routeraddress.random.random import Random

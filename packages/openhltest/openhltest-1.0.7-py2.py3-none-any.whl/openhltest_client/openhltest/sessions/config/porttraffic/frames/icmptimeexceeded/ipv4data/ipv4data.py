...
class Ipv4Data(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.icmptimeexceeded.ipv4data.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.icmptimeexceeded.ipv4data.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.icmptimeexceeded.ipv4data.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.icmptimeexceeded.ipv4data.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.icmptimeexceeded.ipv4data.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.icmptimeexceeded.ipv4data.random.random import Random

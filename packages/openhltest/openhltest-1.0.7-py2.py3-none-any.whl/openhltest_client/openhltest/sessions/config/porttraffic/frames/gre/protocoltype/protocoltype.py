...
class ProtocolType(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.gre.protocoltype.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.gre.protocoltype.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.gre.protocoltype.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.gre.protocoltype.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.gre.protocoltype.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.gre.protocoltype.random.random import Random

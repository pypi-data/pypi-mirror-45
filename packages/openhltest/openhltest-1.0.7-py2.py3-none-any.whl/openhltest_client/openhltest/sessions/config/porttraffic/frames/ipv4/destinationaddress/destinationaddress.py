...
class DestinationAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.ipv4.destinationaddress.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.ipv4.destinationaddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.ipv4.destinationaddress.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.ipv4.destinationaddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.ipv4.destinationaddress.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.ipv4.destinationaddress.random.random import Random

...
class GatewayAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpredirect.gatewayaddress.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpredirect.gatewayaddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpredirect.gatewayaddress.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpredirect.gatewayaddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpredirect.gatewayaddress.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.devicetraffic.frames.icmpredirect.gatewayaddress.random.random import Random

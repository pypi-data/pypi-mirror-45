...
class BackupDesignatedRouterAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.ospfv2hello.backupdesignatedrouteraddress.increment.increment.Increment)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.ospfv2hello.backupdesignatedrouteraddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.ospfv2hello.backupdesignatedrouteraddress.decrement.decrement.Decrement)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.ospfv2hello.backupdesignatedrouteraddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.ospfv2hello.backupdesignatedrouteraddress.random.random.Random)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.ospfv2hello.backupdesignatedrouteraddress.random.random import Random

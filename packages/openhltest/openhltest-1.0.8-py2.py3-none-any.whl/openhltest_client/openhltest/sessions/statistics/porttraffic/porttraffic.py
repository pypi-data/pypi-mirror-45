...
class PortTraffic(Base):
	...
	YANG_KEYWORD = 'list'
	YANG_KEY = 'name tracking'
	YANG_PROPERTY_MAP = {"RxFrames": "rx-frames", "RxFrameRate": "rx-frame-rate", "TxFrameRate": "tx-frame-rate", "Tracking": "tracking", "Name": "name", "TxByteRate": "tx-byte-rate", "TxBitRate": "tx-bit-rate", "TxByteCount": "tx-byte-count", "RxByteCount": "rx-byte-count", "TxFrames": "tx-frames", "RxBitRate": "rx-bit-rate", "RxBitCount": "rx-bit-count", "DroppedFrames": "dropped-frames", "TxBitCount": "tx-bit-count", "RxByteRate": "rx-byte-rate"}
	...
	def create(self, Name=None, Tracking=None, TxFrames=None, RxFrames=None, TxFrameRate=None, RxFrameRate=None, DroppedFrames=None, TxBitCount=None, RxBitCount=None, TxBitRate=None, RxBitRate=None, TxByteCount=None, RxByteCount=None, TxByteRate=None, RxByteRate=None):
		"""Create an instance of the `port-traffic` resource

		Args:
			Name (string): Port Traffic name
			Tracking (string): Traffic Statistic-tracking leaf containers - mac.destination, mac.source
	...
	def read(self, Name tracking=None):
		"""Get `port-traffic` resource(s). Returns all resources from the server if `Name tracking` is not specified

		"""
		return self._read(Name tracking)
	...
	def update(self, Name=None, Tracking=None, TxFrames=None, RxFrames=None, TxFrameRate=None, RxFrameRate=None, DroppedFrames=None, TxBitCount=None, RxBitCount=None, TxBitRate=None, RxBitRate=None, TxByteCount=None, RxByteCount=None, TxByteRate=None, RxByteRate=None):

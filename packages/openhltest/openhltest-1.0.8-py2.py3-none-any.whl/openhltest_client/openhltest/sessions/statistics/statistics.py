...
class Statistics(Base):
	...
	@FirstActivityTimestamp.setter
	def FirstActivityTimestamp(self, value):
		return self._set_value('first-activity-timestamp', value)
	...
	@LastActivityTimestamp.setter
	def LastActivityTimestamp(self, value):
		return self._set_value('last-activity-timestamp', value)
	...
	def update(self, FirstActivityTimestamp=None, LastActivityTimestamp=None):
		"""Update the current instance of the `statistics` resource

		Args:
			FirstActivityTimestamp (string): Timestamp of the first request to this session.
			LastActivityTimestamp (string): Timestamp of the last request to this session
		"""

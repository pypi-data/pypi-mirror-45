...
class Plugin:
    ...
    def __init__(self, name='plugin', instanceCls=Instance):
        ...
        print(f'plugin {self.name} running')
    ...
    def startListener(self):
        ...
        print(f'listen on {self.name} queue')
    ...
    @onError(400, 'failed to create User')
    ...
    def stop(self, username):
        if username in self.__instances:
            self.__instances[username].onStop(self)

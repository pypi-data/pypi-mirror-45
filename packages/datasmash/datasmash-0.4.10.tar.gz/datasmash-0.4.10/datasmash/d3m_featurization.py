...
class d3m_SmashFeaturization(FeaturizationLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    metadata = base.PrimitiveMetadata({
        ...
        "source": {
            ...
            'uris': [ 
                    'https://gitlab.datadrivendiscovery.org/uchicago/datasmash/datasmash/d3m_featurization.py',

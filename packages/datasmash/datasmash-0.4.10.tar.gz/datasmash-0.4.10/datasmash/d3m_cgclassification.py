...
class d3m_CGSmashClassification(SupervisedLearnerPrimitiveBase[Inputs, Outputs,
                                                           Params, Hyperparams]):
    """
    ...
    metadata = base.PrimitiveMetadata({
        ...
        "name": "datasmash.d3m_CGSmashClassification",
        "primitive_family": "TIME_SERIES_CLASSIFICATION",
        "python_path": "d3m.primitives.datasmash.d3m_CGSmashClassification",
        "source": {
        	'name': 'UChicago',
			'contact': 'mailto:virotaru@uchicago.edu',
            'uris': [ 
                    'https://gitlab.datadrivendiscovery.org/uchicago/datasmash/datasmash/d3m_cgclassification.py',

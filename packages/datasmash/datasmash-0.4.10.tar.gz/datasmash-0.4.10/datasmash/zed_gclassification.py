...
class GSmashClassification(SupervisedLearnerPrimitiveBase[Inputs, Outputs,
                                                         Params, Hyperparams]):
    """
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        "name": "datasmash.classification.GSmashClassification",
        "primitive_family": "TIMESERIES_CLASSIFICATION",
        "python_path": "d3m.primitives.datasmash.GSmashClassification",

...
setup(
    ...
    version=read(os.path.join(here, 'src', 'msbackup', 'VERSION')),

    description='Generic backup utility.',
    long_description=read(os.path.join(here, 'README.rst')),

    # The project's main home page.
    url='https://dev.mousesoft.ml/redmine/projects/msbackup',

    # Author details
    author='Aleksei Badiaev',
    author_email='aleksei.badiaev@mousesoft.ml',
    ...
    data_files=[
        ('/etc/msbackup', ['conf/msbackup.conf']),
    ],

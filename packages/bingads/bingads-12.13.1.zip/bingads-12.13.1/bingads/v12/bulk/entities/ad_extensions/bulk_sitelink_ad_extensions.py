...
_SitelinkAdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V12.create('SitelinkAdExtension'))
...
class BulkSitelinkAdExtension(_BulkAdExtensionBase):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.sitelink_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V12.create('SitelinkAdExtension')

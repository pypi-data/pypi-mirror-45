...
:Version: 0.1.0
:Source: https://gitlab.routh.io/open-source/django-tidyfields
...
.. code-block:: python
   ...
   from django_tidyfields.fields import BleachedTextField, BleachedCharField
...
.. code-block:: python
   ...
   class UserSubmission(Model):
       title = BleachedCharField()
       description = BleachedTextField()
       body = BleachedTextField(field_args=settings.PERMISSIVE_TIDYFIELDS)

...
class RegularizationTerm(functions.func, ABC):
    def __init__(self, regularization_parameter):
        ...
        Args:
            regularization_parameter: The scaling factor of the regularization
                term. Must be a float greater or equal to zero.
...
def _pyunlocbox_to_scipy_result(pub_result, **kwargs):
...
def solve(linear_operator, data, reg_term=None, cost_reltol=1e-6,
          x_abstol=1e-6, max_nit=1000, x0=None, verbose='LOW'):
    """Fit the solution.

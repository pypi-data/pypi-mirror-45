...
from trytond.modules.employee_timetracking.period import WF_PERIOD_LOCK, WF_PERIOD_EXAMINE
from trytond.modules.employee_timetracking.const import WF_ACCOUNT_EXAMINE, WF_ACCOUNT_CREATED
...
class AccountRule(ModelSQL, ModelView):
    ...
    def get_periods_to_check_by_rule(cls, accountrule, startpos, endpos):
        ...
        if cls.is_in_weekdays(accountrule, p_start):
        ...
        for i in range((p_end - p_start).days):
            ...
            if cls.is_in_weekdays(accountrule, p1):

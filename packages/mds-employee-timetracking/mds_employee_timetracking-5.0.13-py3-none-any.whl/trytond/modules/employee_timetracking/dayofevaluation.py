...
class DaysOfEvaluation(ModelSQL, ModelView):
        ...
        tab_qu1 = tab_workdays.join(tab_sumact,
                ...
                Case (                          # timedelta - sum of working time per day,
                    ((tab_vacday.date_start != None) &  (tab_workdays.accountitem == None) &    # full vacation day
                     (tab_vacday.halfday != True), tab_workdays.targettime),
                    ((tab_vacday.date_start != None) & (tab_vacday.halfday == True),            # half vacation day
    ...
    def get_day_data(cls, days, names):
        ...
        l1 = cursor.fetchall()
        for i in l1:
            (id1, p1, wd1, dt1, w1, sp1, ep1, du1, su1, he1, hn1, tt1, sb1, vd1) = i
            r1['period'][id1] = p1
            r1['weekday'][id1] = wd1
            r1['daytype'][id1] = dt1
            r1['week'][id1] = w1
    ...
    @fields.depends('daytype', 'holidayname', 'accountitems_nonmain', 'breaktime', 'vacationday')
    def on_change_with_info(self, name=None):
        ...
        if self.daytype == EVAL_HOLIDAY:
            ...
            # vacation day
            if self.vacationday == VACDAY_FULL:
                if len(t1) > 0:
                    t1 += ', '

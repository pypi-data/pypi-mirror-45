...
def log_traceback(exception: BaseException, logger: Optional[logging.Logger]) -> None:
    """
...
class LogConfig:
    ...
    def set_custom_dimensions(self, custom_dimensions: Dict[str, Any]) -> None:
        ...
        :param logger: If the logger has custom_dimensions, then it will set the custom dimensions in log config.
        """

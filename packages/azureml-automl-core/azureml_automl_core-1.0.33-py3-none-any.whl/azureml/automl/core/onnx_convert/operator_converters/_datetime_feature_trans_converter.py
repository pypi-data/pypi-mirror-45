...
from ...featurization import DateTimeFeaturesTransformer
...
class DatetimeTransformerConverter(_AbstractOperatorConverter):
    ...
    def _setup_day_of_week_nodes(scope, container, year_var, month_var, day_var, dow_var):
        ...
        container.add_node(op_type, [virtual_y_name, one_hundred_var_name], y_div_one_hundred, op_version=7, **attrs)
        ...
        container.add_node(op_type, [virtual_y_name, four_hundred_var_name], y_div_four_hundred, op_version=7, **attrs)
    ...
    def _setup_is_leap_year_nodes(scope, container, year_var, result):
        ...
        container.add_node(op_type, [temp_res_1, y_mod_four_hundred_equal_zero], temp_res_bool, op_version=7, **attrs)

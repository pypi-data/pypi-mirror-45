...
class AbstractTimeSeriesTransformer(AutoMLTransformer):
    ...
    def __init__(self, logger: Optional[logging.Logger] = None, **kwargs: Any) -> None:
        ...
        :param kwargs: dictionary contains metadata for TimeSeries.
                   ...
                   country: the data origin coutry used to generate holiday feature
        :type kwargs: dict
        """
        super().__init__()
        ...
        self._engineered_feature_name_json_objects = {}     # type: Dict[str, Dict[str, Optional[Any]]]
        ...
        self.country = kwargs.get(constants.TimeSeries.COUNTRY, None)
    ...
    def delete_group_column_maybe(self, tsdf: TimeSeriesDataFrame) -> TimeSeriesDataFrame:
        """

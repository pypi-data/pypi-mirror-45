...
class Downloader:
    ...
    @classmethod
    def download(cls, download_prefix: str, file_name: str, target_dir: str, md5hash: Optional[str],
        ...
        if Downloader._is_download_needed(download_path, md5hash):
            try:
                ...
                cls.logger.error("Download failed with error: {error}".format(error=e))
                return None

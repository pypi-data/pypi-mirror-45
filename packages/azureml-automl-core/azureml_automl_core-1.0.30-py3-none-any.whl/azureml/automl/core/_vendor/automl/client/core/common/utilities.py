...
def _check_dimensions(
    ...
    if isinstance(X_valid, pd.DataFrame):
        ...
        x_valid_dim = X_valid.values.ndim
    elif isinstance(X_valid, np.ndarray) or scipy.sparse.issparse(X_valid):
        x_valid_shape = X_valid.shape
...
def _get_ts_params_dict(automl_settings: Any) -> Optional[Dict[str, str]]:
    ...
    if automl_settings.is_timeseries:
        dict_time_series = {
            ...
            constants.TimeSeries.COUNTRY: automl_settings.country
        }

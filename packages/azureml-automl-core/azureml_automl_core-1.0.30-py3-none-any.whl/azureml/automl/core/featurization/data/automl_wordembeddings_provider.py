...
class AutoMLEmbeddingsProvider(AbstractWordEmbeddingsProvider):
    ...
    def __init__(self, embeddings_name: str = "wiki-news-300d-1M-subword"):
        ...
        self._lock = None                                                           # type: Optional[threading.Lock]
    ...
    def _initialize(self) -> None:
        ...
        :return: None
        """
        # Lock so that we don't download or store the same file multiple times
        if not self._lock:

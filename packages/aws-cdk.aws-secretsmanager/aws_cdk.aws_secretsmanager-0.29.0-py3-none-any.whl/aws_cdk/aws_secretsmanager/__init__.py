...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-secretsmanager", "0.29.0", __name__, "aws-secretsmanager@0.29.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-secretsmanager.AttachedSecretProps", jsii_struct_bases=[AttachedSecretOptions])
...
class ISecret(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def export(self) -> "SecretImportProps":
        ...
        Returns:
            import props that can be passed back to ``Secret.import``.
        """
        ...
...
class SecretBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-secretsmanager.SecretBase"):
    """The common behavior of Secrets.

    Users should not use this class directly, and instead use ``Secret``.
    """
    @staticmethod
    def __jsii_proxy_class__():
...
class _SecretBaseProxy(SecretBase, jsii.proxy_for(aws_cdk.cdk.Resource)):
    @jsii.member(jsii_name="export")
    def export(self) -> "SecretImportProps":
        """Exports this secret."""
        return jsii.invoke(self, "export", [])
...
class Secret(SecretBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-secretsmanager.Secret"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, secret_arn: str, encryption_key: typing.Optional[aws_cdk.aws_kms.IEncryptionKey]=None) -> "ISecret":
        ...
        Arguments:
            ...
            props: the attributes of the imported secret.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-secretsmanager.SecretImportProps", jsii_struct_bases=[_SecretImportProps])

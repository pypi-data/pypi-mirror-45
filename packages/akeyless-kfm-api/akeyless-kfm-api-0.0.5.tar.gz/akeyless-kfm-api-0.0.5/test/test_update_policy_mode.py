...
from akeyless_kfm_api.models.update_policy_mode import UpdatePolicyMode  # noqa: E501
...
class TestUpdatePolicyMode(unittest.TestCase):
    ...
    def testUpdatePolicyMode(self):
        ...
        # model = akeyless_kfm_api.models.update_policy_mode.UpdatePolicyMode()  # noqa: E501
        pass

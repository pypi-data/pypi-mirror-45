...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        "jsii~=0.10.3",
        "publication>=0.0.3",
        "aws-cdk.assets-docker~=0.30.0",
        "aws-cdk.aws-applicationautoscaling~=0.30.0",
        "aws-cdk.aws-autoscaling~=0.30.0",
        "aws-cdk.aws-certificatemanager~=0.30.0",

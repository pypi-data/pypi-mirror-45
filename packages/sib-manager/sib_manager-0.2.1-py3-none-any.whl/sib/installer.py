...
class Installer(object):
    ...
    def create_project(self, site_url, allowed_hosts, production=False, db_host=None, db_name=None, db_user=None, db_pass=None, smtp_host=None, smtp_user=None, smtp_pass=None, smtp_port=587, smtp_tls=True):

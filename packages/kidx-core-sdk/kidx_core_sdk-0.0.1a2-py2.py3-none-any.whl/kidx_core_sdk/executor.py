...
from kidx_core_sdk import utils, Action, Tracker
    ...
    def utter_template(
        ...
        **kwargs  # type: Any
        ...
        """"Send a message to the client based on a template.
            Add update tracker status if the slot have been update
        """
...
class ActionExecutor(object):
    ...
    def register_action(self, action):
        if inspect.isclass(action):
            if action.__module__.startswith("kidx_core."):
    ...
    def register_package(self, package):
        ...
        for action in actions:
            ...
            if (
                not action.__module__.startswith("kidx_core.") and not
                action.__module__.startswith("kidx_core_sdk.") and not
                abstract
            ):

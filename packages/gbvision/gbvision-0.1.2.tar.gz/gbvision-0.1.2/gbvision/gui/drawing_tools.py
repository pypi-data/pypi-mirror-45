...
def draw_contours(threshold_func, color: (int, int, int), thickness=2, contours_process=EMPTY_PIPELINE):
    ...
    return PipeLine(_draw)


def draw_circles(threshold_func, color: (int, int, int), thickness=2, contours_process=EMPTY_PIPELINE,
...
def draw_rects(threshold_func, color: (int, int, int), thickness=2, contours_process=EMPTY_PIPELINE,
...
def draw_rotated_rects(threshold_func, color: (int, int, int), thickness=2, contours_process=EMPTY_PIPELINE,
...
def draw_ellipses(threshold_func, color: (int, int, int), thickness=2, contours_process=EMPTY_PIPELINE,

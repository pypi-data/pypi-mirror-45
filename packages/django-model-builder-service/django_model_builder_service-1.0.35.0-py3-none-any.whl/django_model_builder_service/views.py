...
def get_model(request):
    metrics_dict[COUNTERS][GET_MODEL][METRIC_OBJECT].inc()
    ...
    try:
        ...
        latest_model = builder_service.get_model_data().as_dict()
...
def show_model(request, identifier):
    metrics_dict[COUNTERS][SHOW_MODEL][METRIC_OBJECT].inc()

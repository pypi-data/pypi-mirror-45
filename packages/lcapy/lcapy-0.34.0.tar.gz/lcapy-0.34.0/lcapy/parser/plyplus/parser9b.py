...
rlc: ('R' | 'L' | 'C') cpt_id sep nnode sep nnode sep value;
vi: ('V' | 'I') cpt_id nnode sep nnode sep vi_type sep value;
vi_type: 'ac' | 'dc' | 'step' | 'acstep' | 'impulse' | 's'
q: 'Q' cpt_id sep nnode sep nnode sep nnode sep q_type;
q_type: 'pnp' | 'npn';
switch: 'SW' cpt_id sep nnode sep nnode sep switch_type;

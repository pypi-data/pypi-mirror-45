...
# [[file:~/Research/CFEDemands/Demands/demands.org::*Core%20routines][demand_core]]

# Tangled on Wed Apr 24 11:29:30 2019
...
def relative_risk_aversion0(p,alpha,beta,phi,NegativeDemands=True,ub=10,method='root_with_precision'):
    ...
    DEPRECATED: This replaced by more analytical solution, _core.relative_risk_aversion.
    """
    n,alpha,beta,phi = check_args(p,alpha,beta,phi)

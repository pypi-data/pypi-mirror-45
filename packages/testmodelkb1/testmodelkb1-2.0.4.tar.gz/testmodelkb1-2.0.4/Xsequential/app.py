...
metadata = dict()
dirs = dict()
IMAGE_FOLDER = os.getcwd() + "\\FashionMnist"
UPLOAD_FOLDER = os.getcwd() + "\\testdata"
...
def xFit():
    ...
    dirs = make_tree(dir_path + "\\FashionMnist\\")
    # pass data to FLask
...
def upload_file1():
    if request.method == 'POST':
        ...
        model_path = os.getcwd() + "\\FashionMnist\\" + filename1
        filenameclassespath = os.getcwd() + "\\FashionMnist\\" + filenameclasses
...
def viewexperiment():
    ...
    model_path = os.getcwd() + "\\FashionMnist\\" + filename1
    filenameclassespath = os.getcwd() + "\\FashionMnist\\" + filenameclasses
    dir_path = os.getcwd() + "\\testdata\\" + project + ''

...
class Xsequential(Sequential):
    ...
    def xfit_generator(self, generator,
          ...
          folder_name = Xsequential.get_project_name(self)
    ...
    def xfit(self,
            ...
            **kwargs):
            ...
            folder_name = os.path.dirname(os.path.abspath(__file__)) + '/' + Xsequential.get_project_name(self)

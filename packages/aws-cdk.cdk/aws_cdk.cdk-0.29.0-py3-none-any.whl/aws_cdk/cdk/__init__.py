...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/cdk", "0.29.0", __name__, "cdk@0.29.0.jsii.tgz")
...
class CloudFormationJSON(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.CloudFormationJSON"):
    ...
    def stringify(cls, obj: typing.Any, context: "IConstruct") -> str:
        ...
        Arguments:
            ...
            context: The Construct from which to resolve any Tokens found in the object.
        """
...
class ConstructNode(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.ConstructNode"):
    ...
    def ancestors(self, up_to: typing.Optional["Construct"]=None) -> typing.List["IConstruct"]:
        ...
        Arguments:
            upTo: The construct to return the path components relative to, or the entire list of ancestors (including root) if omitted.
        """
...
@jsii.data_type(jsii_type="@aws-cdk/cdk.FileSystemStoreOptions", jsii_struct_bases=[])
...
class App(Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.App"):
    ...
    def synthesize_stack(self, stack_name: str) -> aws_cdk.cx_api.SynthesizedStack:
        ...
        Arguments:
            stackName: The name of the stack to synthesize.

        Deprecated:
            This method is going to be deprecated in a future version of the CDK
        """
...
class CfnOutput(CfnElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.CfnOutput"):
    def __init__(self, scope: "Construct", id: str, *, value: typing.Any, condition: typing.Optional["CfnCondition"]=None, description: typing.Optional[str]=None, disable_export: typing.Optional[bool]=None, export: typing.Optional[str]=None) -> None:
        ...
        Arguments:
            ...
            condition: A condition from the "Conditions" section to associate with this output value. If the condition evaluates to ``false``, this output value will not be included in the stack.
...
class CfnParameter(CfnRefElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.CfnParameter"):
    ...
    def __init__(self, scope: "Construct", id: str, *, type: str, allowed_pattern: typing.Optional[str]=None, allowed_values: typing.Optional[typing.List[str]]=None, constraint_description: typing.Optional[str]=None, default: typing.Any=None, description: typing.Optional[str]=None, max_length: typing.Optional[jsii.Number]=None, max_value: typing.Optional[jsii.Number]=None, min_length: typing.Optional[jsii.Number]=None, min_value: typing.Optional[jsii.Number]=None, no_echo: typing.Optional[bool]=None) -> None:
        ...
        Arguments:
            ...
            noEcho: Whether to mask the parameter value when anyone makes a call that describes the stack. If you set the value to ``true``, the parameter value is masked with asterisks (``*****``).
        """
...
class CfnRule(CfnRefElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.CfnRule"):
    ...
    def __init__(self, scope: "Construct", id: str, *, assertions: typing.Optional[typing.List["RuleAssertion"]]=None, rule_condition: typing.Optional["ICfnConditionExpression"]=None) -> None:
        ...
        Arguments:
            ...
            ruleCondition: If the rule condition evaluates to false, the rule doesn't take effect. If the function in the rule condition evaluates to true, expressions in each assert are evaluated and applied.
        """
        props: CfnRuleProps = {}
...
class ISessionStore(jsii.compat.Protocol):
    ...
    def exists(self, name: str) -> bool:
        ...
        Returns:
            true if the file ``fileName`` exists in the store.
        """
        ...
    ...
    def mkdir(self, directory_name: str) -> str:
        ...
        throws:
            if a directory by that name already exists in the session or if the session has already been finalized.
        """
        ...
    ...
    def readdir(self, directory_name: str) -> typing.List[str]:
        ...
        Arguments:
            directoryName: The name of the artifact.

        throws:
            if there is no directory artifact under this name
        """
        ...
    ...
    def write_file(self, artifact_name: str, data: typing.Any) -> None:
        ...
        Arguments:
            artifactName: The name of the file.
...
class FileSystemStore(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.FileSystemStore"):
    ...
    def __init__(self, *, outdir: str) -> None:
        ...
        Arguments:
            options: -
            outdir: The output directory for synthesis artifacts.
        """
...
@jsii.data_type(jsii_type="@aws-cdk/cdk.ManifestOptions", jsii_struct_bases=[])
...
@jsii.data_type(jsii_type="@aws-cdk/cdk.MetadataEntry", jsii_struct_bases=[_MetadataEntry])
...
@jsii.data_type(jsii_type="@aws-cdk/cdk.ResolveContext", jsii_struct_bases=[])
...
@jsii.data_type(jsii_type="@aws-cdk/cdk.SynthesisOptions", jsii_struct_bases=[ManifestOptions])
...
class SynthesisSession(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.SynthesisSession"):
    def __init__(self, *, skip_validation: typing.Optional[bool]=None, store: typing.Optional["ISessionStore"]=None, legacy_manifest: typing.Optional[bool]=None, runtime_information: typing.Optional[bool]=None) -> None:
        ...
        Arguments:
            ...
            store: The file store used for this session. Default: InMemoryStore
            legacyManifest: Emit the legacy manifest (``cdk.out``) when the session is closed (alongside ``manifest.json``). Default: false
            runtimeInformation: Include runtime information (module versions) in manifest. Default: true
        """
    ...
    def is_synthesizable(cls, obj: typing.Any) -> bool:
        ...
        Returns:
            true if ``obj`` implements ``ISynthesizable``.
        """
...
class Token(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cdk.Token"):
    ...
    def unresolved(cls, obj: typing.Any) -> bool:
        """Returns true if obj is a token (i.e. has the resolve() method or is a string that includes token markers), or it's a listifictaion of a Token string.

...
from asched_src.asched import datetime_to_utc_timestamp, utc_timestamp_to_datetime
...
class RedisJobStore(BaseJobStore):
    ...
    def __init__(self, db=0, jobs_key='asched.jobs', run_times_key='asched.run_times',

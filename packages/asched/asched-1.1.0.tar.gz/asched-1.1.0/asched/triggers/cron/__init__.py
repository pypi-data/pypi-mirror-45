...
from asched_src.asched.triggers.cron.fields import (
    BaseField, MonthField, WeekField, DayOfMonthField, DayOfWeekField, DEFAULT_VALUES)
from asched_src.asched import datetime_ceil, convert_to_datetime, datetime_repr, astimezone
...
class CronTrigger(BaseTrigger):
    ...
    def __setstate__(self, state):
        # This is for compatibility with asched 3.0.x

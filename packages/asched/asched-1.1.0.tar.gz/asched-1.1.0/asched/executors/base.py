...
class BaseExecutor(six.with_metaclass(ABCMeta, object)):
    ...
    _scheduler = None
    _lock = None
    _logger = logging.getLogger('asched.executors')
    ...
    def start(self, scheduler, alias):
        ...
        :param asched.schedulers.base.BaseScheduler scheduler: the scheduler that is starting
            this executor
        ...
        self._logger = logging.getLogger('asched.executors.%s' % alias)

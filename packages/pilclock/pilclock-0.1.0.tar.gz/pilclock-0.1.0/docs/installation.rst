...
The sources for PilClock can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/nradulovic/pilclock
.. _tarball: https://github.com/nradulovic/pilclock/tarball/master

    ...
    if previous_run_df_local.empty:
        ...
        if type(datetime_col) is list:
            for col in datetime_col:
                right_on_col = right_on_col.append(col + '_previous')
        else:
            right_on_col = right_on_col.append(datetime_col + '_previous')
...
def blob_check_and_update(datasource, current_snapshot):
    """

...
def clean_superpositions(sinks, epsilon=0.01):
    """
    Remove superposed sinks ; in-place.
    ...
    sinks = sinks_.set_index("index", inplace=False)
...
def connect_terminals(
    ...
    text = "Initilization of the vertices and leaves dataframes in {} seconds."

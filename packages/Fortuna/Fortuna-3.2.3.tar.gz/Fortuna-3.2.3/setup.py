...
setup(
    ...
    keywords=[
        ...
        "Random Value Generator", "Gaussian Distribution", "Linear Geometric Distribution",
        "TruffleShuffle", "FlexCat", "Percent True", "Zero Cool", "Quantum Monty",
        "Custom Distribution", "Rarity Table",
    ],
    python_requires='>=3.7',
)

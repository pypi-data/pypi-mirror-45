...
from kidx_core.channels.channel import RestInput
from kidx_core.constants import DEFAULT_REQUEST_TIMEOUT

logger = logging.getLogger(__name__)


class KidxChatInput(RestInput):
    """Chat input channel for Kidx Platform"""
    ...
    def _extract_sender(self, req):
        """Fetch user from the Kidx Platform Admin API"""

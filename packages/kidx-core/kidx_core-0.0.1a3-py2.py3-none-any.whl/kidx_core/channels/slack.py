...
from kidx_core.channels.channel import UserMessage, OutputChannel
...
class SlackInput(InputChannel):
    ...
    def _sanitize_user_message(text, uids_to_remove):
        ...
        Probably a good starting point for pre-formatting of
        user-provided text, to make NLU's life easier in case
        they go funky to the power of extreme.

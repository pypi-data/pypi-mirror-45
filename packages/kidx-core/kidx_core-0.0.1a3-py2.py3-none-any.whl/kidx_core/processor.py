...
from kidx_core.actions import Action
from kidx_core.actions.action import (
    ACTION_LISTEN_NAME,
    ACTION_RESTART_NAME,
    ActionExecutionRejection)
from kidx_core.channels import CollectingOutputChannel
from kidx_core.channels import UserMessage
from kidx_core.dispatcher import Dispatcher
from kidx_core.domain import Domain
from kidx_core.events import ReminderScheduled, Event
from kidx_core.events import SlotSet
...
from kidx_core.interpreter import (
    ...
    KidxNLUHttpInterpreter,
    INTENT_MESSAGE_PREFIX)
from kidx_core.interpreter import RegexInterpreter
from kidx_core.nlg import NaturalLanguageGenerator
from kidx_core.policies.ensemble import PolicyEnsemble
...
class MessageProcessor(object):
    ...
    def _parse_message(self, message):
        ...
        elif isinstance(self.interpreter, KidxNLUHttpInterpreter):
    ...
    def _predict_and_execute_next_action(self, message, tracker):
        ...
        dispatcher = Dispatcher(message.sender_id,
                                ...
                                self.nlg)
        # keep taking actions decided by the policy until

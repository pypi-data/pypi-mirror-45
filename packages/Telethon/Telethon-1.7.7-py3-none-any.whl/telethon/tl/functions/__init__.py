...
from . import account, auth, bots, channels, contacts, contest, help, langpack, messages, payments, phone, photos, stickers, updates, upload, users
import os
import struct
from datetime import datetime
if TYPE_CHECKING:
    from ...tl.types import TypeInputClientProxy, TypeMessageRange, TypeType, TypeX
...
class InitConnectionRequest(TLRequest):
    ...
    def __init__(self, api_id: int, device_model: str, system_version: str, app_version: str, system_lang_code: str, lang_pack: str, lang_code: str, query: 'TypeX', proxy: Optional['TypeInputClientProxy']=None):
        """

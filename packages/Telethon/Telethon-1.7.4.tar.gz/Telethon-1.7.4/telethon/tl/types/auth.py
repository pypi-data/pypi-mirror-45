...
class CheckedPhone(TLObject):
    ...
    def __init__(self, phone_registered: 'TypeBool'):
        """
...
class SentCode(TLObject):
    ...
    def __init__(self, type: 'TypeSentCodeType', phone_code_hash: str, phone_registered: Optional[bool]=None, next_type: Optional['TypeCodeType']=None, timeout: Optional[int]=None, terms_of_service: Optional['TypeTermsOfService']=None):
        """

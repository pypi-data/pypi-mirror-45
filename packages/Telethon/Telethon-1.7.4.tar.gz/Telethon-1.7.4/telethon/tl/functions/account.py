...
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeAutoDownloadSettings, TypeBool, TypeCodeSettings, TypeInputCheckPasswordSRP, TypeInputFile, TypeInputNotifyPeer, TypeInputPeer, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeInputSecureValue, TypeInputWallPaper, TypeReportReason, TypeSecureCredentialsEncrypted, TypeSecureValueHash, TypeSecureValueType, TypeWallPaperSettings
...
class RegisterDeviceRequest(TLRequest):
    ...
    def __init__(self, token_type: int, token: str, app_sandbox: 'TypeBool', secret: bytes, other_uids: List[int]):
        """
        :returns Bool: This type has no constructors.
        """
...
class ReportPeerRequest(TLRequest):
    ...
    def __init__(self, peer: 'TypeInputPeer', reason: 'TypeReportReason'):
        """
        :returns Bool: This type has no constructors.
        """
        self.peer = peer
...
class SaveWallPaperRequest(TLRequest):
    ...
    def __init__(self, wallpaper: 'TypeInputWallPaper', unsave: 'TypeBool', settings: 'TypeWallPaperSettings'):
        """
        :returns Bool: This type has no constructors.
        """
        self.wallpaper = wallpaper
...
class SetContactSignUpNotificationRequest(TLRequest):
    ...
    def __init__(self, silent: 'TypeBool'):
        """
        :returns Bool: This type has no constructors.
        """
        self.silent = silent
...
class UpdateStatusRequest(TLRequest):
    ...
    def __init__(self, offline: 'TypeBool'):
        """
        :returns Bool: This type has no constructors.
        """

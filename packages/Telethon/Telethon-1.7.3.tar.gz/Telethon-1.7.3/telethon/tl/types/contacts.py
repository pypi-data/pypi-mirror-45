...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeContact, TypeContactBlocked, TypeContactLink, TypeImportedContact, TypePeer, TypePopularContact, TypeTopPeerCategoryPeers, TypeUser

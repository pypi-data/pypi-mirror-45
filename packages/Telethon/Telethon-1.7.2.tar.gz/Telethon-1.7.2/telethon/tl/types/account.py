...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAuthorization, TypeAutoDownloadSettings, TypePasswordKdfAlgo, TypePrivacyRule, TypeSecurePasswordKdfAlgo, TypeSecureRequiredType, TypeSecureSecretSettings, TypeSecureValue, TypeSecureValueError, TypeUser, TypeWallPaper, TypeWebAuthorization
...
class AutoDownloadSettings(TLObject):
    ...
    def __init__(self, low, medium, high):
        """
        :param TypeAutoDownloadSettings low:
        :param TypeAutoDownloadSettings medium:
        :param TypeAutoDownloadSettings high:

        Constructor for account.AutoDownloadSettings: Instance of AutoDownloadSettings.
        """
        self.low = low  # type: TypeAutoDownloadSettings
        self.medium = medium  # type: TypeAutoDownloadSettings
        self.high = high  # type: TypeAutoDownloadSettings

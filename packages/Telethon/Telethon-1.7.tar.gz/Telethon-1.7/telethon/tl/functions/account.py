...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputCheckPasswordSRP, TypeBool, TypeInputWallPaper, TypeCodeSettings, TypeInputPrivacyRule, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeWallPaperSettings, TypeAccountDaysTTL, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeInputPeer, TypeAutoDownloadSettings, TypeInputSecureValue, TypeInputFile, TypeReportReason, TypeSecureValueType, TypeSecureValueHash
...
class SaveAutoDownloadSettingsRequest(TLRequest):
    ...
    def __init__(self, settings, low=None, high=None):
        """
        :param TypeAutoDownloadSettings settings:
        :param Optional[bool] low:
        :param Optional[bool] high:

        :returns Bool: This type has no constructors.
        """
        self.settings = settings  # type: TypeAutoDownloadSettings
        self.low = low  # type: Optional[bool]
        self.high = high  # type: Optional[bool]

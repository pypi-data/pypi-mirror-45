...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePhoneCallProtocol, TypeInputUser, TypePhoneCallDiscardReason, TypeDataJSON, TypeInputPhoneCall
...
class DiscardCallRequest(TLRequest):
    ...
    def __init__(self, peer, duration, reason, connection_id, video=None):
        """
        :param TypeInputPhoneCall peer:
        :param int duration:
...
class RequestCallRequest(TLRequest):
    ...
    def __init__(self, user_id, g_a_hash, protocol, video=None, random_id=None):
        """
...
class SetCallRatingRequest(TLRequest):
    ...
    def __init__(self, peer, rating, comment, user_initiative=None):
        """
        :param TypeInputPhoneCall peer:
        :param int rating:
        :param str comment:
        :param Optional[bool] user_initiative:
        ...
        self.user_initiative = user_initiative  # type: Optional[bool]

...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeChannelAdminLogEventsFilter, TypeBool, TypeChatAdminRights, TypeInputMessage, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeInputChatPhoto, TypeInputChannel, TypeChatBannedRights

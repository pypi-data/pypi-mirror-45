...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessageEntity, TypeInputStickeredMedia, TypeInputBotInlineResult, TypeShippingOption, TypeInputDialogPeer, TypeSendMessageAction, TypeInputChatPhoto, TypeInputMedia, TypeInputUser, TypeInputBotInlineMessageID, TypeInlineBotSwitchPM, TypeInputDocument, TypeBool, TypeMessagesFilter, TypeInputSingleMedia, TypeInputEncryptedFile, TypeReportReason, TypeInputGeoPoint, TypeInputEncryptedChat, TypeInputStickerSet, TypeReplyMarkup, TypeInputMessage, TypeInputPeer, TypeChatBannedRights
...
class DeleteHistoryRequest(TLRequest):
    ...
    def __init__(self, peer, max_id, just_clear=None, revoke=None):
        """
...
class GetEmojiKeywordsLanguagesRequest(TLRequest):
    ...
    def __init__(self, lang_codes):
        """
        :param List[str] lang_codes:

        :returns Vector<EmojiLanguage>: This type has no constructors.
        """
        self.lang_codes = lang_codes  # type: List[str]
...
class GetStatsURLRequest(TLRequest):
    ...
    def __init__(self, peer, params, dark=None):
        """
        :param TypeInputPeer peer:
        :param str params:

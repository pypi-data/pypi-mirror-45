...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContact, TypePeer, TypeUser, TypeChat, TypeContactBlocked, TypePopularContact

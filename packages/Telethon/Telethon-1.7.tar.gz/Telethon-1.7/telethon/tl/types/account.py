...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureRequiredType, TypeSecureValueError, TypeAuthorization, TypePrivacyRule, TypeSecureSecretSettings, TypePasswordKdfAlgo, TypeSecureValue, TypeWallPaper, TypeWebAuthorization, TypeUser, TypeAutoDownloadSettings, TypeSecurePasswordKdfAlgo

...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSetCovered, TypeMessage, TypeFoundGif, TypeHighScore, TypeBotInlineResult, TypeInlineBotSwitchPM, TypeStickerSet, TypeStickerPack, TypeChatFull, TypeUser, TypeChat, TypeDialog, TypeDocument, TypeEncryptedFile

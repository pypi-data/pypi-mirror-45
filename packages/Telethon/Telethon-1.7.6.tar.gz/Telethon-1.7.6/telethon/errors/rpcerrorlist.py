...
class MessageIdInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('The specified message ID is invalid' + self._fmt_request(kwargs['request']))
...
class RightForbiddenError(ForbiddenError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('Your admin rights do not allow you to do this' + self._fmt_request(kwargs['request']))
...
class UserAdminInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__("You're not an admin" + self._fmt_request(kwargs['request']))

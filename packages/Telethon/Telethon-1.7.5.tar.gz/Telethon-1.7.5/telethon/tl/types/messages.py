...
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeChat, TypeChatFull, TypeDialog, TypeDocument, TypeEncryptedFile, TypeFoundGif, TypeHighScore, TypeInlineBotSwitchPM, TypeMessage, TypeStickerPack, TypeStickerSet, TypeStickerSetCovered, TypeUser
...
class ChannelMessages(TLObject):
    ...
    def __init__(self, pts: int, count: int, messages: List['TypeMessage'], chats: List['TypeChat'], users: List['TypeUser'], inexact: Optional[bool]=None):
        """
...
class FeaturedStickers(TLObject):
    ...
    # noinspection PyShadowingBuiltins
    def __init__(self, hash: int, sets: List['TypeStickerSetCovered'], unread: List[int]):
        """
...
class FoundGifs(TLObject):
    ...
    def __init__(self, next_offset: int, results: List['TypeFoundGif']):
        """
...
class MessagesSlice(TLObject):
    ...
    def __init__(self, count: int, messages: List['TypeMessage'], chats: List['TypeChat'], users: List['TypeUser'], inexact: Optional[bool]=None):
        """
        Constructor for messages.Messages: Instance of either Messages, MessagesSlice, ChannelMessages, MessagesNotModified.
        """
        self.count = count

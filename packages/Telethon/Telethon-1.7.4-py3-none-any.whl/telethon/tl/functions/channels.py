...
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeChatAdminRights, TypeChatBannedRights, TypeInputChannel, TypeInputChatPhoto, TypeInputMessage, TypeInputStickerSet, TypeInputUser
...
class ExportMessageLinkRequest(TLRequest):
    ...
    def __init__(self, channel: 'TypeInputChannel', id: int, grouped: 'TypeBool'):
        """
...
class TogglePreHistoryHiddenRequest(TLRequest):
    ...
    def __init__(self, channel: 'TypeInputChannel', enabled: 'TypeBool'):
        """
        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
        self.channel = channel

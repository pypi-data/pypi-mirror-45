...
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputContact, TypeInputPeer, TypeInputUser, TypeTopPeerCategory
...
class GetTopPeersRequest(TLRequest):
    ...
    def __init__(self, offset: int, limit: int, hash: int, correspondents: Optional[bool]=None, bots_pm: Optional[bool]=None, bots_inline: Optional[bool]=None, phone_calls: Optional[bool]=None, groups: Optional[bool]=None, channels: Optional[bool]=None):
        """
...
class ToggleTopPeersRequest(TLRequest):
    ...
    def __init__(self, enabled: 'TypeBool'):
        """
        :returns Bool: This type has no constructors.
        """

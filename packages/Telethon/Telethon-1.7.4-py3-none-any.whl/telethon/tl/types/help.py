...
class AppUpdate(TLObject):
    ...
    def __init__(self, id: int, version: str, text: str, entities: List['TypeMessageEntity'], popup: Optional[bool]=None, document: Optional['TypeDocument']=None, url: Optional[str]=None):
        """

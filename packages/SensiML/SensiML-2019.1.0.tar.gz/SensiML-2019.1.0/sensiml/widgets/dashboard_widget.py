...
from sensiml.widgets import QueryWidget, AutoSenseWidget, DownloadWidget, FlashWidget
...
class DashBoard(BaseWidget):
    ...
    def __init__(self, dsk=None, server='https://sensiml.cloud/', knowledgepack_level='Project', **kwargs):
        self._server = server
        self._kwargs = kwargs
        self._dsk = dsk
    ...
    def _create_widget(self, knowledgepack_level='Project'):
        ...
        self._button_clear = Button(
            description="Clear Output", tooltip='Clear Output Text Below Dashboard')
        ...
        self._auto = AutoSenseWidget(None)
        ...
        accordions[2].set_title(0, 'Create Knowledge Pack')
        accordions[3].set_title(0, 'Deploy Knowledge Pack')

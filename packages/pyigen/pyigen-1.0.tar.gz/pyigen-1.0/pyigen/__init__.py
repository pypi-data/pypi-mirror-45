...
def about():
    print("About pyigen 1.0")
    print()
    print("Created by Armaan Aggarwal on April 19, 2019")

print("pyigen 1.0 successfully imported")
print("To see the manual of pyigen 1.0, use the command 'pyigen.manual()'")

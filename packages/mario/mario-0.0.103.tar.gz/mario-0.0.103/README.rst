...
- Run Python code on the command line.
- Compose functions together with multiple verbs (map, filter, apply, stack, ...).
- Automatically call functions to avoid dealing with parentheses and shell quoting.
- Execute async functions concurrently in streaming fashion.
- Define and configure custom commands in your user config file.

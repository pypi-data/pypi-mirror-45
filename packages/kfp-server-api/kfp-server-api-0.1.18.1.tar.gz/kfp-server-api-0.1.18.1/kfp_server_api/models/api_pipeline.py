...
from kfp_server_api.models.api_url import ApiUrl  # noqa: F401,E501
...
class ApiPipeline(object):
    ...
    def __init__(self, id=None, created_at=None, name=None, description=None, parameters=None, url=None, error=None):  # noqa: E501

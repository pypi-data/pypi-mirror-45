...
class HelpDeskBot:
    ...
    def setup(self):
        ...
        async def coaching(context):
            message = 'Auto response from NanoDano: I am busy at the moment, but if you want personal 1-on-1 help, check out my availability schedule at https://www.codementor.io/nanodano'

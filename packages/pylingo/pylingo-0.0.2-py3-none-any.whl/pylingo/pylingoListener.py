...
class pylingoListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by pylingoParser#object.
    def enterObject(self, ctx:pylingoParser.ObjectContext):
        pass

    # Exit a parse tree produced by pylingoParser#object.
    def exitObject(self, ctx:pylingoParser.ObjectContext):
        pass

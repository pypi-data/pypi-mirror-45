...
class TestClient(Client):
    ...
    def create_test_result_attachment(self, attachment_request_model, project, run_id, test_case_result_id):
        ...
        :param :class:`<TestAttachmentRequestModel> <azure.devops.v5_1.test.models.TestAttachmentRequestModel>` attachment_request_model: Attachment details TestAttachmentRequestModel
        :param str project: Project ID or project name
        :param int run_id: ID of the test run that contains the result.
        :param int test_case_result_id: ID of the test result against which attachment has to be uploaded.
        :rtype: :class:`<TestAttachmentReference> <azure.devops.v5_1.test.models.TestAttachmentReference>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_test_sub_result_attachment(self, attachment_request_model, project, run_id, test_case_result_id, test_sub_result_id):
        ...
        [Preview API] Attach a file to a test result
        :param :class:`<TestAttachmentRequestModel> <azure.devops.v5_1.test.models.TestAttachmentRequestModel>` attachment_request_model: Attachment Request Model.
        :param str project: Project ID or project name
        :param int run_id: ID of the test run that contains the result.
    ...
    def get_points_by_query(self, query, project, skip=None, top=None):
        ...
        :param :class:`<TestPointsQuery> <azure.devops.v5_1.test.models.TestPointsQuery>` query: TestPointsQuery to get test points.
        :param str project: Project ID or project name
        :param int skip: Number of test points to skip..
        :param int top: Number of test points to return.
        :rtype: :class:`<TestPointsQuery> <azure.devops.v5_1.test.models.TestPointsQuery>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_result_retention_settings(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<ResultRetentionSettings> <azure.devops.v5_1.test.models.ResultRetentionSettings>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_result_retention_settings(self, retention_settings, project):
        ...
        :param :class:`<ResultRetentionSettings> <azure.devops.v5_1.test.models.ResultRetentionSettings>` retention_settings: Test result retention settings details to be updated
        :param str project: Project ID or project name
        :rtype: :class:`<ResultRetentionSettings> <azure.devops.v5_1.test.models.ResultRetentionSettings>`
        """
        route_values = {}
    ...
    def create_test_session(self, test_session, team_context):
        ...
        :param :class:`<TestSession> <azure.devops.v5_1.test.models.TestSession>` test_session: Test session details for creation
        :param :class:`<TeamContext> <azure.devops.v5_1.test.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TestSession> <azure.devops.v5_1.test.models.TestSession>`
        """
        project = None
        team = None
    ...
    def update_test_session(self, test_session, team_context):
        ...
        :param :class:`<TestSession> <azure.devops.v5_1.test.models.TestSession>` test_session: Test session details for update
        :param :class:`<TeamContext> <azure.devops.v5_1.test.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TestSession> <azure.devops.v5_1.test.models.TestSession>`
        """
        project = None
    ...
    def query_test_history(self, filter, project):
        ...
        :param :class:`<TestHistoryQuery> <azure.devops.v5_1.test.models.TestHistoryQuery>` filter: TestHistoryQuery to get history
        :param str project: Project ID or project name
        :rtype: :class:`<TestHistoryQuery> <azure.devops.v5_1.test.models.TestHistoryQuery>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')

...
class GroupEntitlement(Model):
    ...
    :type group: :class:`GraphGroup <azure.devops.v5_1.member_entitlement_management.models.GraphGroup>`
    ...
    :type license_rule: :class:`AccessLevel <azure.devops.v5_1.member_entitlement_management.models.AccessLevel>`
    ...
    :type project_entitlements: list of :class:`ProjectEntitlement <azure.devops.v5_1.member_entitlement_management.models.ProjectEntitlement>`
...
class GroupOperationResult(BaseOperationResult):
    ...
    :type result: :class:`GroupEntitlement <azure.devops.v5_1.member_entitlement_management.models.GroupEntitlement>`
    """
...
class GroupOption(Model):
    ...
    :param group: Group
    :type group: :class:`Group <azure.devops.v5_1.member_entitlement_management.models.Group>`
    """
...
class MemberEntitlementsResponseBase(Model):
    ...
    :type member_entitlement: :class:`MemberEntitlement <azure.devops.v5_1.member_entitlement_management.models.MemberEntitlement>`
    """
...
class OperationResult(Model):
    ...
    :type result: :class:`MemberEntitlement <azure.devops.v5_1.member_entitlement_management.models.MemberEntitlement>`
    """
...
class ProjectEntitlement(Model):
    ...
    :type project_ref: :class:`ProjectRef <azure.devops.v5_1.member_entitlement_management.models.ProjectRef>`
    :param team_refs: Team Ref.
    :type team_refs: list of :class:`TeamRef <azure.devops.v5_1.member_entitlement_management.models.TeamRef>`
    """
...
class UserEntitlement(Model):
    ...
    :type extensions: list of :class:`Extension <azure.devops.v5_1.member_entitlement_management.models.Extension>`
    :param group_assignments: [Readonly] GroupEntitlements that this user belongs to.
    :type group_assignments: list of :class:`GroupEntitlement <azure.devops.v5_1.member_entitlement_management.models.GroupEntitlement>`
    ...
    :type user: :class:`GraphUser <azure.devops.v5_1.member_entitlement_management.models.GraphUser>`
    """
...
class UserEntitlementOperationReference(OperationReference):
    ...
    :type results: list of :class:`UserEntitlementOperationResult <azure.devops.v5_1.member_entitlement_management.models.UserEntitlementOperationResult>`
    """
...
class UserEntitlementOperationResult(Model):
    ...
    :type is_success: bool
    :param result: Result of the MemberEntitlement after the operation.
    :type result: :class:`UserEntitlement <azure.devops.v5_1.member_entitlement_management.models.UserEntitlement>`
...
class UserEntitlementsResponseBase(Model):
    ...
    :type user_entitlement: :class:`UserEntitlement <azure.devops.v5_1.member_entitlement_management.models.UserEntitlement>`
    """
...
class UsersSummary(Model):
    ...
    :type extensions: list of :class:`ExtensionSummaryData <azure.devops.v5_1.member_entitlement_management.models.ExtensionSummaryData>`
    :param group_options: Group Options
    :type group_options: list of :class:`GroupOption <azure.devops.v5_1.member_entitlement_management.models.GroupOption>`
    :param licenses: Summary of Licenses in the organization
    :type licenses: list of :class:`LicenseSummaryData <azure.devops.v5_1.member_entitlement_management.models.LicenseSummaryData>`
    :param project_refs: Summary of Projects in the organization
    :type project_refs: list of :class:`ProjectRef <azure.devops.v5_1.member_entitlement_management.models.ProjectRef>`
    """
...
class GroupEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation.
    :type results: list of :class:`GroupOperationResult <azure.devops.v5_1.member_entitlement_management.models.GroupOperationResult>`
    """
...
class MemberEntitlement(UserEntitlement):
    ...
    :type member: :class:`GraphMember <azure.devops.v5_1.member_entitlement_management.models.GraphMember>`
    """
...
class MemberEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation
    :type results: list of :class:`OperationResult <azure.devops.v5_1.member_entitlement_management.models.OperationResult>`
    """
...
class MemberEntitlementsPatchResponse(MemberEntitlementsResponseBase):
    ...
    :type operation_results: list of :class:`OperationResult <azure.devops.v5_1.member_entitlement_management.models.OperationResult>`
    """
...
class MemberEntitlementsPostResponse(MemberEntitlementsResponseBase):
    ...
    :type operation_result: :class:`OperationResult <azure.devops.v5_1.member_entitlement_management.models.OperationResult>`
    """
...
class UserEntitlementsPatchResponse(UserEntitlementsResponseBase):
    ...
    :type user_entitlement: :class:`UserEntitlement <azure.devops.v5_1.member_entitlement_management.models.UserEntitlement>`
    :param operation_results: List of results for each operation.
    :type operation_results: list of :class:`UserEntitlementOperationResult <azure.devops.v5_1.member_entitlement_management.models.UserEntitlementOperationResult>`
    """
...
class UserEntitlementsPostResponse(UserEntitlementsResponseBase):
    ...
    :type user_entitlement: :class:`UserEntitlement <azure.devops.v5_1.member_entitlement_management.models.UserEntitlement>`
    :param operation_result: Operation result.
    :type operation_result: :class:`UserEntitlementOperationResult <azure.devops.v5_1.member_entitlement_management.models.UserEntitlementOperationResult>`
    """

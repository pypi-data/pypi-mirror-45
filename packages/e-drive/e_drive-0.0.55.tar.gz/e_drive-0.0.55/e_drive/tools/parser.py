...
class Parser():
    ...
    def run(self):
        ...
        if (self.count > 0) and (self.arguments != None):
            ...
            # >python -m e_drive light front hold 100 50 50 10
            # >python -m e_drive light body hold 100 50 50 10
            # >python -m e_drive light head hold 100 50 50 10
            # >python -m e_drive light tail hold 100 50 50 10
            # >python -m e_drive light left hold 100 50 50 10
            # >python -m e_drive light right hold 100 50 50 10
            ...
            # >python -m e_drive light body rainbow2 8 50 50 10
                ...
                self.light(self.arguments[1], self.arguments[2], int(self.arguments[3]), int(self.arguments[4]), int(self.arguments[5]), int(self.arguments[6]))
                return
    ...
    def light(self, strLightPart, strLightMode, interval, r, g, b):
    ...
    def help(self):
        ...
        print("")
        print(Fore.CYAN + "  - Light part" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light front hold 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light body hold 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light head hold 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light tail hold 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light left hold 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light right hold 100 50 50 10" + Style.RESET_ALL)

        print("")
        print(Fore.CYAN + "  - Light mode" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light body hold 100 50 50 10" + Style.RESET_ALL)

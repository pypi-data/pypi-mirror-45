...
@request.request
def set_file_attr(conninfo, credentials, mode=None, owner=None, group=None,
        size=None, creation_time=None, modification_time=None, change_time=None,
        id_=None, extended_attrs=None, if_match=None, path=None):
    """
...
@request.request
def punch_hole(
        conninfo, credentials, offset, size, path=None, id_=None,
        if_match=None):
    ...
    return request.rest_request(
        conninfo, credentials, 'POST', unicode(uri), body=body,
        if_match=if_match)

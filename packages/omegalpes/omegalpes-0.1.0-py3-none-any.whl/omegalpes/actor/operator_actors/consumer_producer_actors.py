...
from omegalpes.general.optimisation.elements import DynamicConstraint, \
    Objective, Quantity
from omegalpes.general.utils import def_abs_value
...
class Prosumer(Consumer, Producer):
    ...
    **Description**
    ...
    def maximize_conso_prod_match(self,
        ...
        print(production_p_string)
        print(consumption_p_string)
        ...
        self.calc_conso_prod_match = DynamicConstraint(
            name='calc_conso_prod_match',
            exp_t='{0}_conso_prod_match[t] == ({1} - ( {2} ))'.format(
    ...
    def maximize_selfconsumption_rate(self, time,
        ...
        self.calc_selfconsumption_rate = DynamicConstraint(
            name='calc_selfconsumption_rate',
            exp_t='{0}_selfconsumption_rate[t] == ({1} + {2} - ( {3} '
                  '))'.format(self.name, sc_production_export_p_string,
    ...
    def maximize_selfproduction_rate(self, time,
        ...
        self.calc_selfproduction_rate = DynamicConstraint(

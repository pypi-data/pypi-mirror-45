...
def bot(filters=None, not_on=None, chat_id=None, chat_type=None,
        from_id=None, regex=None, on_error=None):
    """
    ...
    :param regex: (:obj:`re-pattern`, optional)
...
"""
    ...
    :param foursquare_type: (:obj:`str`, optional) Foursquare type of the venue, 
     if known. (For example, “arts_entertainment/default”,
...
"""
    ...
    :param thumb: (:obj:`str`, :obj:`InputFile`) Optional. Thumbnail of the file 
     ...
     in size. A thumbnail‘s width and height should not exceed 90. Ignored if

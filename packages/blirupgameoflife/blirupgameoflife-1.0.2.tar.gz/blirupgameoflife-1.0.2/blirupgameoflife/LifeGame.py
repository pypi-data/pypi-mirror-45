...
class LifeGame:
    ...
    def __init__(self, screen_width=800, screen_height=600, cell_size=10, alive_color=(0, 255, 255),
        ...
        self.desired_milliseconds_between_updates = (1.0 / max_fps) * 10000
    ...
    def check_cell_neighbors(self, row_index, col_index):
        ...
        for the next generation, Determine whetjer it lives, dies, survives, or is born.
    ...
    def cap_frame_rate(self):
        """
        If game is running too fast and updating game too frequently.

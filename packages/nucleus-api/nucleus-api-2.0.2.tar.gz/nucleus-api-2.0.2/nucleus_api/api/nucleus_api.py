...
#
def upload_jsons(api_instance, dataset, json_iter, processes=4):
    ...
    pool_output = pool.imap_unordered(_upload_json, json_iter)
    pool.close()
    pool.join()

    json_props = []
    for jp in pool_output:
...
class NucleusApi(object):
    ...
    def post_save_filter(self, payload, **kwargs):  # noqa: E501
        ...
        Save a filter representing a subsect of a dataset (time range, query, metadata..).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def post_upload_file_with_http_info(self, file, dataset, **kwargs):  # noqa: E501
        ...
        all_params = ['file', 'dataset', 'metadata', 'filename']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

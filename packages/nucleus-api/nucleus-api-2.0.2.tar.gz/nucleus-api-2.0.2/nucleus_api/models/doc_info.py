...
class DocInfo(object):
    ...
    def metadata_selection(self):
        ...
        JSON object specifying metadata-based queries on the dataset. If titles or docids are also provided, then this selection is ignored. Format: {\"metadata_field\": \"selected_values\"}  # noqa: E501

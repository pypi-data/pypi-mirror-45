...
class UploadURLModel(object):
    ...
    def dataset(self):
        ...
        Name of the dataset where the file will be inserted.  # noqa: E501
    ...
    def filename(self):
        ...
        Specify the filename if different from the URL (Nucleus guesses the file type from the extension at the end of the URL or file name)  # noqa: E501

...
class TopicDeltaModel(object):
    ...
    def __init__(self, dataset=None, query=None, custom_stop_words=None, num_topics=None, num_keywords=None, metadata_selection=None, period_0_start=None, period_0_end=None, period_1_start=None, period_1_end=None, excluded_docs=None):  # noqa: E501

...
class CK_RSA_PKCS_OAEP_PARAMS(_object):
    ...
    if _newclass:hashAlg = _swig_property(_LowLevel.CK_RSA_PKCS_OAEP_PARAMS_hashAlg_get, _LowLevel.CK_RSA_PKCS_OAEP_PARAMS_hashAlg_set)
    ...
    if _newclass:mgf = _swig_property(_LowLevel.CK_RSA_PKCS_OAEP_PARAMS_mgf_get, _LowLevel.CK_RSA_PKCS_OAEP_PARAMS_mgf_set)
    ...
    if _newclass:src = _swig_property(_LowLevel.CK_RSA_PKCS_OAEP_PARAMS_src_get, _LowLevel.CK_RSA_PKCS_OAEP_PARAMS_src_set)
    ...
    if _newclass:pSourceData = _swig_property(_LowLevel.CK_RSA_PKCS_OAEP_PARAMS_pSourceData_get, _LowLevel.CK_RSA_PKCS_OAEP_PARAMS_pSourceData_set)
    ...
    if _newclass:ulSourceDataLen = _swig_property(_LowLevel.CK_RSA_PKCS_OAEP_PARAMS_ulSourceDataLen_get, _LowLevel.CK_RSA_PKCS_OAEP_PARAMS_ulSourceDataLen_set)
    def __init__(self): 
...
class CK_RSA_PKCS_PSS_PARAMS(_object):
    ...
    if _newclass:hashAlg = _swig_property(_LowLevel.CK_RSA_PKCS_PSS_PARAMS_hashAlg_get, _LowLevel.CK_RSA_PKCS_PSS_PARAMS_hashAlg_set)
    ...
    if _newclass:mgf = _swig_property(_LowLevel.CK_RSA_PKCS_PSS_PARAMS_mgf_get, _LowLevel.CK_RSA_PKCS_PSS_PARAMS_mgf_set)
    ...
    if _newclass:sLen = _swig_property(_LowLevel.CK_RSA_PKCS_PSS_PARAMS_sLen_get, _LowLevel.CK_RSA_PKCS_PSS_PARAMS_sLen_set)
    def __init__(self): 
...
class CK_ATTRIBUTE_SMART(_object):
    ...
    def IsAttributeList(self): return _LowLevel.CK_ATTRIBUTE_SMART_IsAttributeList(self)
    ...
    def SetList(self, *args): return _LowLevel.CK_ATTRIBUTE_SMART_SetList(self, *args)

...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-sqs", "0.29.0", __name__, "aws-sqs@0.29.0.jsii.tgz")
...
class IQueue(aws_cdk.cdk.IResource, aws_cdk.aws_s3_notifications.IBucketNotificationDestination, aws_cdk.aws_autoscaling_api.ILifecycleHookTarget, jsii.compat.Protocol):
    @staticmethod
...
class _IQueueProxy(jsii.proxy_for(aws_cdk.cdk.IResource), jsii.proxy_for(aws_cdk.aws_s3_notifications.IBucketNotificationDestination), jsii.proxy_for(aws_cdk.aws_autoscaling_api.ILifecycleHookTarget)):
...
class QueueBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-sqs.QueueBase"):
    ...
    def as_bucket_notification_destination(self, bucket_arn: str, bucket_id: str) -> aws_cdk.aws_s3_notifications.BucketNotificationDestinationProps:
        ...
        Arguments:
            bucketArn: The ARN of the notifying bucket.
            bucketId: A unique ID for the notifying bucket.
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sqs.QueueImportProps", jsii_struct_bases=[_QueueImportProps])

...
from aom_framework.protocols_pb2 import AgentStartRequest, AgentStartReply, AgentDecideRequest, AgentDecideReply, AgentRewardRequest, AgentRewardReply

SERVICE_NAME = _service_pbs.DESCRIPTOR.services_by_name['Agent'].full_name
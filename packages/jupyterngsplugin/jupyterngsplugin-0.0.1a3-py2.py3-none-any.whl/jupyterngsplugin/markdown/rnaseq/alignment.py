...
from jupyterngsplugin.markdown.utils import find_file_print_link_size, get_link_size
from jupyterngsplugin.utils.load_content_dict import load_content_dict


def star_alignment_table(samples_data, sample_list, alignment_path):
    """
...
Print alignment report table parsing data from STAR
    ...
    if alignment_tool == 'STAR':
        return star_alignment_table(samples_data, sample_list, alignment_path)


def star_reads_distribution_plot(samples_data, sample_list, fig_size):
    """
...
def reads_distribution_plot(samples_data, sample_list, fig_size, alignment_tool):
    ...
    """
    if alignment_tool == 'STAR':
        return star_reads_distribution_plot(samples_data, sample_list, fig_size)

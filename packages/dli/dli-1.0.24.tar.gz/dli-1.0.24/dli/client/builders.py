...
class DatasetBuilder:
    ...
    :param str name: Mandatory. A descriptive name of the dataset. It should be unique within the package the dataset belongs to.
    :param str description: Mandatory. A short description of the dataset.
    ...
    :param list[str] taxonomy: Mandatory. A list of segments to be used for a taxonomy,
                               the Data-<< Organization >>-<< topic >> prefix will be applied by the catalogue
                               For a taxonomy of Data-IHS Markit-Financial Markets-Credit-CDS, you would provide `taxonomy=["Credit", "CDS"]`
    ...
    :param str loadType: Optional. Whether each datafile in this dataset should be considered as a full version of a dataset
                         or a delta or increment. Accepted types are `Full Load` and `Incremental Load`
    """
    def __init__(
        self,
        package_id,

...
@skip('No test bucket on AWS for test')
class ChannelsTestCase(ChannelLiveServerTestCase):
    ...
    def setUp(self):
        ...
        file.write(
            urllib.request.urlopen('https://s3-eu-west-1.amazonaws.com/yogasoftbucket0/content_images/1.png').read())
        file.close()
...
class MemcahedTestCase(LiveServerTestCase):
    ...
    def setUp(self):
        ...
        file.write(
            urllib.request.urlopen('https://s3-eu-west-1.amazonaws.com/yogasoftbucket0/content_images/0.png').read())
        file.close()

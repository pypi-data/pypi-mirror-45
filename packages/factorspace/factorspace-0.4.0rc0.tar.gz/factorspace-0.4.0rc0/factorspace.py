...
#自适应规则算法
def adapt_rules(rules_set,delete_set,adapt_data,adapt_label,none_value=-1):
...
#自适应规则算法
def adapt_factor_analy(train_data,train_label,test_data,test_label,rules_set=[],delete_set=[],train_batch=100,test_batch=100,replace=False,repeat=10000,slim=False,exit_train_acc=1,exit_test_acc=1.,delete_rules_set=False,accuracy_info=False,none_value=-1):
    ...
    for i in range(repeat):
        ...
        rules_set,delete_set=adapt_rules(rules_set,delete_set,ddata,dlabel,none_value=none_value)

...
#最大规则算法
def max_rules(train_data,train_label,none_value=-1,train_times=10000,used_factors=False,full_rules=False,strict=False,expand=False,similar_first=True):
    ...
    if full_rules==False:
        ...
        for i in range(train_times):
            ...
            #判断规则库排序
            if similar_first==True:
                rules_set_part=np.array(rules_set_part)
                rules_set_part=np.unique(rules_set_part,axis=0)

...
x=np.array([[1,1,3,2],[2,1,1,2],[3,2,2,3],[2,1,3,2],[1,3,2,3],[1,3,2,1],[3,2,4,3],[2,2,4,3],[2,1,1,1]])
t=np.array([2,1,1,1,2,1,2,2,1])
...
#读取UCI数据集
def load(filename,start_index=2,nan_value='0'):
...
def factor_analy(train_data,train_label,none_value=-1,train_times=10000,used_factors=False,zero_decide_random=False):

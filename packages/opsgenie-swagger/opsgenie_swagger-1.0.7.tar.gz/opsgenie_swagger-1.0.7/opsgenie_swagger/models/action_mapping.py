...
class ActionMapping(object):
    ...
    def action(self, action):
        ...
        allowed_values = ["create", "acknowledge", "unacknowledge", "snooze", "escalate-to-next", "add-note", "add-recipient", "add-team", "add-tags", "remove-tags", "close", "delete", "escalate", "custom-action", "assign-ownership", "take-ownership", "update-priority", "update-description", "update-message"]  # noqa: E501
    ...
    def mapped_action(self, mapped_action):
        ...
        :type: str
        """
        allowed_values = ["publish", "create-incident", "create-problem", "update-description", "update-priority", "resolve-issue", "resolve-ticket", "add-work-info", "close-incident", "create", "close", "resolve", "add-journal", "in-progress-incident", "resolve-incident", "create-service-ticket", "add-discussion-note-to-ticket", "add-resolution-note-to-ticket", "add-internal-note-to-ticket", "close-service-ticket", "in-progress-ticket", "confirm-incident", "add-note", "set-status-to-closed", "set-status-to-pending", "set-status-to-resolved", "create-ticket", "add-public-note", "add-private-note", "set-status-to-open", "create-issue", "add-comment-to-issue", "in-progress-issue", "close-issue", "issue-done", "add-tag", "create-conversation", "set-status-to-completed", "ack-alert", "unmute-alert", "send-to-channel", "create-case", "set-case-status-to-active", "set-case-status-to-close", "set-case-status-to-close-as-duplicate", "acknowledge", "create-alert", "close-alert", "acknowledge-alert", "unacknowledge-alert", "acknowledgeSensor", "setStatusToClosed", "set-case-status-to-working", "add-note-to-incident", "assign-to-group", "assign-to-user", "assign-to-owner", "send-to-custom-endpoint", "acknowledge-notification", "createTag", "createComment", "updateSeverity", "updateStatusToClosed", "updateStatusToInProgress", "create-incident-and-update-component-statuses", "resolve-incident-and-update-component-statuses-back-to-operational", "update-component-statuses", "sendData", "postToUrl", "add-internal-note", "public-reply", "set-status-to-solved"]  # noqa: E501

...
DRIVER_NAME, DRIVER_VERSION = 'DataStax Enterprise Python Driver', sys.modules['dse'].__version__
    ...
    def _handle_startup_response(self, startup_response, did_authenticate=False):
        ...
        if isinstance(startup_response, ReadyMessage):
            ...
            if self.authenticator is None:
                log.error("Failed to authenticate to %s. Consider using TransitionalModePlainTextAuthProvider "

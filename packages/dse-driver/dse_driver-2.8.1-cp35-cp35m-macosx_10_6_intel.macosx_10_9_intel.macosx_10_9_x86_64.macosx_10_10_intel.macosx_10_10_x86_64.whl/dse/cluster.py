...
class Session(object):
    ...
    def default_consistency_level(self):
        raise AttributeError(
            "Session.default_consistency_level is no longer used. This "
    ...
    def default_serial_consistency_level(self, cl):
        raise AttributeError(
            "Session.default_serial_consistency_level is no longer used. This "
            "should be done by setting the desired serial consistency level on the "
            "ExecutionProfile at key EXEC_PROFILE_DEFAULT."
        )
    ...
    def execute(self, query, parameters=None, timeout=_NOT_SET, trace=False,
                ...
                paging_state=None, execute_as=None, host=None):
        """
        ...
        return self.execute_async(query, parameters, trace, custom_payload, timeout, execution_profile, paging_state, execute_as, host).result()

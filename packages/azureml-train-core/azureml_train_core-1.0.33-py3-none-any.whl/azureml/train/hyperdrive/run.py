...
class HyperDriveRun(ScriptRun):
    ...
    def __init__(self, experiment, run_id, hyperdrive_run_config=None, run_config=None):
        ...
        if hyperdrive_run_config is not None and hyperdrive_run_config.estimator is not None:
            source_directory = hyperdrive_run_config.estimator.source_directory
        super().__init__(experiment=experiment, run_id=run_id,
                         directory=source_directory, _run_config=run_config,

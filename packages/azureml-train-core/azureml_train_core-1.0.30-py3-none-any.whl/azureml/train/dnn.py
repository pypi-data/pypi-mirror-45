...
from azureml.core.runconfig import TensorflowConfiguration, MpiConfiguration
...
class TensorFlow(FrameworkBaseEstimator):
    ...
    def __init__(self,
        ...
        super().__init__(source_directory, compute_target=compute_target, vm_size=vm_size,
                         ...
                         _use_framework_image=_use_framework_image)
...
class PyTorch(FrameworkBaseEstimator):
    ...
    :param max_run_duration_seconds: Maximum allowed time for the run. The system will attempt to automatically
        cancel the run, if it took longer than this value.
    :type max_run_duration_seconds: int
    :param framework_version: PyTorch version to be used for executing training code.
    ...
    def __init__(self,
        ...
        if distributed_training and not isinstance(distributed_training, MpiConfiguration):
            raise TrainingException("Unsupported distributed backend value: "
                                    "{}. Supported backend: mpi.".format(distributed_backend))
...
class Chainer(FrameworkBaseEstimator):
    ...
    :param max_run_duration_seconds: Maximum allowed time for the run. The system will attempt to automatically
        cancel the run, if it took longer than this value.
    :type max_run_duration_seconds: int
    :param framework_version: Chainer version to be used for executing training code.
    ...
    def __init__(self,
        ...
        if distributed_training and not isinstance(distributed_training, MpiConfiguration):
            raise TrainingException("Unsupported distributed backend value. Supported backend: mpi.")

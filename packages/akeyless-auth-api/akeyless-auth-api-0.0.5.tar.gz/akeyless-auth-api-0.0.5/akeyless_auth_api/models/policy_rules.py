...
from akeyless_auth_api.models.access_role import AccessRole  # noqa: F401,E501
...
class PolicyRules(object):
    ...
    swagger_types = {
        'alg': 'Algorithm',
        'azure_ad_access_role': 'AccessRole',
        'cidr_whitelist': 'str',
        'key': 'str'
    }
    ...
    def __init__(self, alg=None, azure_ad_access_role=None, cidr_whitelist=None, key=None):  # noqa: E501

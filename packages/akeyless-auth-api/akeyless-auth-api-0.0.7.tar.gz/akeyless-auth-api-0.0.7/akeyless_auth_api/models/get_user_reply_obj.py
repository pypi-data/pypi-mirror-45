...
from akeyless_auth_api.models.user_access_policy_info import UserAccessPolicyInfo  # noqa: F401,E501
...
class GetUserReplyObj(object):
    ...
    """
    swagger_types = {
        'access_info': 'UserAccessPolicyInfo',
        'account_id': 'str',
        'user_name': 'str',
        'user_policy_id': 'str',
        'user_roles': 'list[str]'
    ...
    def __init__(self, access_info=None, account_id=None, user_name=None, user_policy_id=None, user_roles=None):  # noqa: E501

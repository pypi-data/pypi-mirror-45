...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ses", "0.29.0", __name__, "aws-ses@0.29.0.jsii.tgz")
...
class ReceiptRuleSetBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-ses.ReceiptRuleSetBase"):
...
class _ReceiptRuleSetBaseProxy(ReceiptRuleSetBase, jsii.proxy_for(aws_cdk.cdk.Resource)):
    @jsii.member(jsii_name="export")
    def export(self) -> "ReceiptRuleSetImportProps":
        """Exports this receipt rule set from the stack."""
        return jsii.invoke(self, "export", [])

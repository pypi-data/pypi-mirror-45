...
Enhancements
************
- Information on the effective feature derivation window is now available for :ref:`Time Series <time_series>` projects to specify the full span of historical data
...
- Previously available for only Eureqa models, Advanced Tuning methods and objects, including
  ...
  now support all models other than blender, OSS, and user-created.

...
SectionDict.provide(
    t.Or(
        ...
        t.Dict({
            'type': t.Atom('user'),
            'title': t.String,
            'regular_text': t.String,
            'highlighted_text': t.String,
            OptKey('sections'): t.List(SectionDict) | t.Null,
        }),
        t.Dict({
            'type': t.Atom('table_of_contents'),
            'title': t.String,
        }),
    )
)
...
class ComplianceDocTemplate(APIObject):
    ...
    * ``sections`` :  list of sub-section dicts nested under the parent section.
    ...
    def get_default(cls, template_type=None):
        ...
        """
        query_params = {'type': type} if template_type else None
        response = cls._client.get(
            'complianceDocTemplates/default/',
            params=query_params
        )
        return cls(
            id=None,
    ...
    def get(cls, template_id):
        ...
        return cls.from_location(
            make_url(cls._root_path, template_id)
        )
    ...
    def list(cls, name_part=None, limit=None, offset=None):
        ...
        r_data = cls._client.get(
            cls._root_path,
            params={'limit': limit, 'offset': offset, 'namePart': name_part}
        ).json()
    ...
    def update(self, name=None, sections=None):
        ...
        self._client.patch(
            make_url(self._root_path, self.id),
            data=payload
        )

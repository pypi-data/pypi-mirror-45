...
import sys
import os
# Somehow importing setuptools first gives you access to
#   the new and improved setup ...
# However, now event without add_packages, etc its going
# to copy *everything* in the /hashwrap package into the tar.gz!
import setuptools

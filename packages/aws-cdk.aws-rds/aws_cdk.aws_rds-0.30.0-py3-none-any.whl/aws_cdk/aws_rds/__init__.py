...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-rds", "0.30.0", __name__, "aws-rds@0.30.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-rds.DatabaseClusterImportProps", jsii_struct_bases=[])
...
class DatabaseCluster(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-rds.DatabaseCluster"):
    """Create a clustered database with a given number of instances."""
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, engine: "DatabaseClusterEngine", instance_props: "InstanceProps", master_user: "Login", backup: typing.Optional["BackupProps"]=None, cluster_identifier: typing.Optional[str]=None, default_database_name: typing.Optional[str]=None, delete_replace_policy: typing.Optional[aws_cdk.cdk.DeletionPolicy]=None, instance_identifier_base: typing.Optional[str]=None, instances: typing.Optional[jsii.Number]=None, kms_key: typing.Optional[aws_cdk.aws_kms.IEncryptionKey]=None, parameter_group: typing.Optional["IClusterParameterGroup"]=None, port: typing.Optional[jsii.Number]=None, preferred_maintenance_window: typing.Optional[str]=None, storage_encrypted: typing.Optional[bool]=None) -> None:
        ...
        Arguments:
            ...
            clusterIdentifier: An optional identifier for the cluster. If not supplied, a name is automatically generated.
            defaultDatabaseName: Name of a database which is automatically created inside the cluster.
            deleteReplacePolicy: The CloudFormation policy to apply when the cluster and its instances are removed from the stack or replaced during an update. Default: Retain
            instanceIdentifierBase: Base identifier for instances. Every replica is named by appending the replica number to this string, 1-based. If not given, the clusterIdentifier is used with the word "Instance" appended. If clusterIdentifier is also not given, the identifier is automatically generated.
            ...
            port: What port to listen on. If not supplied, the default for the engine is used.
            preferredMaintenanceWindow: A daily time range in 24-hours UTC format in which backups preferably execute. Must be at least 30 minutes long. Example: '01:00-02:00'

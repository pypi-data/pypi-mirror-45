...
@app.if_updated is related with skitai.reserve_states (), was.setlu() and was.getlu() and these are already explained was cache contorl part. And Atila app can use more conviniently.
...
.. code:: python
  ...
  skitai.reserve_states ("weather-news", ...)

...
from ._api import plugins_dir_path, local_plugin_info, install, uninstall, is_installed, load, is_loaded, \
    local_plugins_info, remote_plugins_info, dependencies, is_dev_mode, get_dependant_plugins, on_install, \
    on_pre_install, on_install_error, on_uninstall, plugin_path, is_loading, is_installing, get, is_management_mode, \

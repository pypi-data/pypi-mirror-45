...
setup(
    ...
    entry_points={'console_scripts': [
        ...
        'validattion_service = upload_chain.main:validation_chain',                       # 单进程方式验证数据是否已经上链
        'validattion_multiproc_service = upload_chain.main:validation_chain_multi_proc',  # 多进程方式验证数据是否已经上链
    ]},

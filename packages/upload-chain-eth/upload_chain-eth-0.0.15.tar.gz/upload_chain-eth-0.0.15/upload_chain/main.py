...
from upload_chain.business import BaseEvent, ArmyEvent, import_event, OrganizationEvent
...
# from upload_chain.plugins.solider import Solider
import importlib
import os
import re
...
if __name__ == "__main__":
    # impevent()
    army()
    # army('/Users/yuyongpeng/git/hard-chain/cport/upload_chain/oracle_army.conf')
    # organization('/Users/yuyongpeng/git/hard-chain/cport/upload_chain/upload_chain.conf')
    # upload_chain()

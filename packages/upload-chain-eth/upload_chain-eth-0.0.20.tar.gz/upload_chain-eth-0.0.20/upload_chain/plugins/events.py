...
from upload_chain.database.modles import Army, Organization
from pycontractsdk import keys
from upload_chain import wechat
...
class DIDAttributeChangeEvent(object):
    """
    处理 event = DIDAttributeChange 的数据
    """
    def __init__(self):
        pass
...
class DIDAttributeConfirmedEvent(object):
    """
    处理 event = DIDAttributeConfirmed 的数据
    """
    def __init__(self):
        pass

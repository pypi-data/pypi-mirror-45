...
class CosmosMagics(Magics):
    ...
    def autoconvert_to_dataframe(self, line, cell="", local_ns=None):
        """ sets auto conversion of the result to dataframe
        Usage:
        * ``%autoconvert_to_dataframe True``        - Enable automatically convert the result to dataframe.
        * ``%autoconvert_to_dataframe False``       - Disable automatically convert the result to dataframe.
        """
        global result_auto_convert_to_df
        result_auto_convert_to_df = bool(line)
        print("line is " + line)
        print("bool is " + result_auto_convert_to_df)
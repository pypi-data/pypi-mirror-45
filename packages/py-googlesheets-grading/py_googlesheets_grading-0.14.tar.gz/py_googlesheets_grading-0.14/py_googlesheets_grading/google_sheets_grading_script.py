...
class Grader:
    ...
    def grade_students(self, spreadsheet_url=None, DO_GRADE = [], DONT_GRADE = []):
        """
        Grades students based on the spreadsheet url.
        :param spreadsheet_url: Will prompt if input is none.
        :param DO_GRADE: If this has any input, the code will only grade these.
        :param DONT_GRADE: The program will skip anybody that's in here.
        :return: None
        """

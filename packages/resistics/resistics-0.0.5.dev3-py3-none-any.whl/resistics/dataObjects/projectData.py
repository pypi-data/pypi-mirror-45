...
from resistics.utilities.utilsPrint import arrayToString, listToString
from resistics.utilities.utilsReader import getDataReader
...
class ProjectData(DataObject):
    ...
    def view(self, **kwargs) -> plt.figure:
        ...
        import numpy as np
        from resistics.utilities.utilsPlotter import getPlotFonts

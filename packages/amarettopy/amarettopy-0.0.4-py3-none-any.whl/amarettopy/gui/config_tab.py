...
class ConfigTab(Tk.Frame):
    ...
    def __init__(self, amaretto, configfile = 'params.yml', master=None):
    ...
    def show_params(self):
        ...
        self.loadFileButton= Tk.Button(self.bottomFrame, text='LoadFile', command=self.load_params)
        
        self.loadFileButton.grid(row=0, column=0, columnspan=1, padx=5, pady=5)

        self.loadDefaultButton= Tk.Button(self.bottomFrame, text='LoadDefault', command=self.load_defaut_params)
        
        self.loadDefaultButton.grid(row=0, column=1, columnspan=1, padx=5, pady=5)

        self.button= Tk.Button(self.bottomFrame, text='Refresh', command=self.refresh)
        
        self.button.grid(row=0, column=2, columnspan=1, padx=5, pady=5)

...
MSG_TYPE_RESET_ROTATION_CMD     = 0x30
MSG_TYPE_SET_PARAM_CMD          = 0x40
MSG_TYPE_GET_PARAM_CMD          = 0x41
MSG_TYPE_CALIBRATION_CMD        = 0x60
MSG_TYPE_RESET_CMD              = 0x61
MSG_TYPE_FAULT_CMD              = 0x62
MSG_TYPE_GET_LOG_INFO_CMD       = 0x70
MSG_TYPE_GET_LOG_CMD            = 0x71
MSG_TYPE_CLEAR_LOG_CMD          = 0x72
MSG_TYPE_GET_LIFE_LOG_CMD       = 0x73
MSG_TYPE_CLEAR_LIFE_LOG_CMD     = 0x74
...
PARAM_ID_RECORDED_CALIB       = 0xa1
PARAM_ID_POSITION_SYS_OFFSET  = 0xa2
PARAM_ID_RAW_POSITION         = 0xa3
...
SERVO_FAULT_START_UP     = 0x0010
SERVO_FAULT_STOP_TIMEOUT = 0x0020
SERVO_FAULT_BREAK_IN     = 0x0040
SERVO_FAULT_SW_ERROR     = 0x0080
...
def cmd2str(c):
    if   c == MSG_TYPE_QUERY_SERVO_STATUS_CMD :
        ...
        return "get_param"
    elif c == MSG_TYPE_CALIBRATION_CMD        :
        return "calibration"
...
def log_group2str(g,sg,c):
    ...
    if g == LOG_GROUP_SYSTEM                           :
        ...
        if   sg == LOG_SUB_GROUP_SYSTEM_POWER_ON            :
            return (s, "power_on", s2)
        elif sg == LOG_SUB_GROUP_SYSTEM_START_UP            :
            return (s, "start_up", s2)

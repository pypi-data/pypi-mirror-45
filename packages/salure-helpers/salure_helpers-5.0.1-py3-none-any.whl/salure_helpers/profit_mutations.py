...
class ProfitMutations:
    ...
    def get_changed_data(self, filename :str, check_columns: list, unique_key: str):
        """
    ...
    def move_and_cleanup_files(self):
        ...
        for file in os.listdir(self.input_dir + 'archive'):
            if os.stat(file).st_mtime < time.time() - 90 * 86400:
        ...
        for file in os.listdir(self.input_dir + 'comparison_data'):
            os.rename(self.input_dir + 'comparison_data/' + file, self.input_dir + 'archive/' + file)

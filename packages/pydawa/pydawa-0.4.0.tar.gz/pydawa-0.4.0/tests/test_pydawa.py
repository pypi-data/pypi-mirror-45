...
def test_adresseopslag():
    adresse = Adresseopslag(id='0a3f507a-b2e6-32b8-e044-0003ba298018')
    adresse_info = adresse.info()
    assert isinstance(adresse_info, dict)
    assert adresse_info['vejnavn'] == 'Landgreven'
    assert adresse_info['husnr'] == '10'
    assert adresse_info['postnr'] == '1301'

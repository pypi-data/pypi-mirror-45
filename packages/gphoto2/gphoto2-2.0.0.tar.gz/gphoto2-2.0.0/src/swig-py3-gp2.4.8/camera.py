...
class Camera(object):
    ...
    def folder_put_file(self, *args) -> "void":
        """
        folder_put_file(Camera self, char const * folder, CameraFile file, Context context)
...
def gp_camera_folder_put_file(*args) -> "int":
    """
    gp_camera_folder_put_file(Camera camera, char const * folder, CameraFile file, Context context) -> int

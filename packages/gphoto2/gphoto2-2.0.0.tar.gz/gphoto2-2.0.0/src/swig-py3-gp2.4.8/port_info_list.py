...
class PortInfoList(object):
    ...
    def append(self, info: 'GPPortInfo') -> "void":
        """
        append(PortInfoList self, GPPortInfo info)
...
class GPPortInfo(object):
    ...
    This is not to be confused with the driver configurable port settings in
    GPPortSettings.  

    C++ includes: gphoto2-port-info-list.h
    """
...
def gp_port_info_list_append(list: 'PortInfoList', info: 'GPPortInfo') -> "int":
    """

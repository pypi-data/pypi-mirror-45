...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_Context", (PyCFunction)_wrap_delete_Context, METH_O, (char *)"delete_Context(Context self)"},
	 { (char *)"Context_swigregister", Context_swigregister, METH_VARARGS, NULL},
	 { (char *)"Context_swiginit", Context_swiginit, METH_VARARGS, NULL},
	 { (char *)"gp_context_new", (PyCFunction)_wrap_gp_context_new, METH_NOARGS, (char *)"\n"

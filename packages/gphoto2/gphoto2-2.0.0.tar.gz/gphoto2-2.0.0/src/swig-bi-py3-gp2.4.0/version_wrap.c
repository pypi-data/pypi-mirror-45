...
SWIGINTERN PyObject *_wrap_gp_port_library_version(PyObject *self, PyObject *args) {
  ...
  if(!PyArg_UnpackTuple(args,(char *)"gp_port_library_version",1,1,&obj0)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_gp_library_version(PyObject *self, PyObject *args) {
  ...
  if(!PyArg_UnpackTuple(args,(char *)"gp_library_version",1,1,&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gp_port_library_version", _wrap_gp_port_library_version, METH_VARARGS, (char *)"gp_port_library_version(GPVersionVerbosity verbose) -> char const **"},
	 { (char *)"gp_library_version", _wrap_gp_library_version, METH_VARARGS, (char *)"gp_library_version(GPVersionVerbosity verbose) -> char const **"},
	 { NULL, NULL, 0, NULL }
};

...
#define SWIGTYPE_p_GPPort swig_types[20]
#define SWIGTYPE_p_GPPortType swig_types[21]
#define SWIGTYPE_p_GPVersionVerbosity swig_types[22]
#define SWIGTYPE_p_GphotoDeviceType swig_types[23]
...
#define SWIGTYPE_p__GPPortInfo swig_types[41]
#define SWIGTYPE_p__GPPortInfoList swig_types[42]
...
#define SWIGTYPE_p_p__CameraAbilitiesList swig_types[47]
...
SWIGINTERN struct _CameraAbilitiesList *new__CameraAbilitiesList(void){
    ...
    if (error < 0)
      /*@SWIG:src/gphoto2/common/macros.i,18,GPHOTO2_ERROR@*/
...
SWIGINTERN void delete__CameraAbilitiesList(struct _CameraAbilitiesList *self){
    ...
    if (error < 0) /*@SWIG:src/gphoto2/common/macros.i,18,GPHOTO2_ERROR@*/
PyErr_SetObject(PyExc_GPhoto2Error, PyInt_FromLong(error));
/*@SWIG@*/
  }
...
SWIGINTERN PyObject *_wrap_CameraAbilitiesList_load(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"CameraAbilitiesList_load",1,2,swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p__CameraAbilitiesList, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_CameraAbilitiesList_detect(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"CameraAbilitiesList_detect",2,3,swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p__CameraAbilitiesList, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_gp_abilities_list_load(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"gp_abilities_list_load",1,2,swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p__CameraAbilitiesList, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_gp_abilities_list_detect(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"gp_abilities_list_detect",2,3,swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p__CameraAbilitiesList, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_CameraAbilitiesList", (PyCFunction)_wrap_delete_CameraAbilitiesList, METH_O, (char *)"delete_CameraAbilitiesList(CameraAbilitiesList self)"},
	 { (char *)"CameraAbilitiesList___len__", (PyCFunction)_wrap_CameraAbilitiesList___len__, METH_O, (char *)"CameraAbilitiesList___len__(CameraAbilitiesList self) -> int"},
	 { (char *)"CameraAbilitiesList___getitem__", _wrap_CameraAbilitiesList___getitem__, METH_VARARGS, (char *)"CameraAbilitiesList___getitem__(CameraAbilitiesList self, int idx)"},
	 { (char *)"CameraAbilitiesList_load", _wrap_CameraAbilitiesList_load, METH_VARARGS, (char *)"\n"
		"CameraAbilitiesList_load(CameraAbilitiesList self, Context context)\n"
		"\n"
	 ...
	 { (char *)"CameraAbilitiesList_reset", (PyCFunction)_wrap_CameraAbilitiesList_reset, METH_O, (char *)"\n"
		"CameraAbilitiesList_reset(CameraAbilitiesList self)\n"
		"\n"
		"Reset the list.  \n"
		"\n"
		"Parameters\n"
	 ...
	 { (char *)"CameraAbilitiesList_detect", _wrap_CameraAbilitiesList_detect, METH_VARARGS, (char *)"\n"
		"CameraAbilitiesList_detect(CameraAbilitiesList self, PortInfoList info_list, Context context)\n"
		"\n"
		"Parameters\n"
		"----------\n"
		"* `list` :  \n"
	 ...
	 { (char *)"CameraAbilitiesList_append", _wrap_CameraAbilitiesList_append, METH_VARARGS, (char *)"\n"
		"CameraAbilitiesList_append(CameraAbilitiesList self, CameraAbilities abilities)\n"
		"\n"
	 ...
	 { (char *)"CameraAbilitiesList_count", (PyCFunction)_wrap_CameraAbilitiesList_count, METH_O, (char *)"\n"
		"CameraAbilitiesList_count(CameraAbilitiesList self) -> int\n"
		"\n"
	 ...
	 { (char *)"CameraAbilitiesList_lookup_model", _wrap_CameraAbilitiesList_lookup_model, METH_VARARGS, (char *)"\n"
		"CameraAbilitiesList_lookup_model(CameraAbilitiesList self, char const * model) -> int\n"
		"\n"
	 ...
	 { (char *)"CameraAbilitiesList_get_abilities", _wrap_CameraAbilitiesList_get_abilities, METH_VARARGS, (char *)"\n"
		"CameraAbilitiesList_get_abilities(CameraAbilitiesList self, int index)\n"
		"\n"
	 ...
	 { (char *)"CameraAbilities_model_get", (PyCFunction)_wrap_CameraAbilities_model_get, METH_O, (char *)"CameraAbilities_model_get(CameraAbilities self) -> char [128]"},
	 { (char *)"CameraAbilities_status_get", (PyCFunction)_wrap_CameraAbilities_status_get, METH_O, (char *)"CameraAbilities_status_get(CameraAbilities self) -> CameraDriverStatus"},
	 { (char *)"CameraAbilities_port_get", (PyCFunction)_wrap_CameraAbilities_port_get, METH_O, (char *)"CameraAbilities_port_get(CameraAbilities self) -> GPPortType"},
	 { (char *)"CameraAbilities_speed_get", (PyCFunction)_wrap_CameraAbilities_speed_get, METH_O, (char *)"CameraAbilities_speed_get(CameraAbilities self) -> int [64]"},
	 { (char *)"CameraAbilities_operations_get", (PyCFunction)_wrap_CameraAbilities_operations_get, METH_O, (char *)"CameraAbilities_operations_get(CameraAbilities self) -> CameraOperation"},
	 { (char *)"CameraAbilities_file_operations_get", (PyCFunction)_wrap_CameraAbilities_file_operations_get, METH_O, (char *)"CameraAbilities_file_operations_get(CameraAbilities self) -> CameraFileOperation"},
	 { (char *)"CameraAbilities_folder_operations_get", (PyCFunction)_wrap_CameraAbilities_folder_operations_get, METH_O, (char *)"CameraAbilities_folder_operations_get(CameraAbilities self) -> CameraFolderOperation"},
	 { (char *)"CameraAbilities_usb_vendor_get", (PyCFunction)_wrap_CameraAbilities_usb_vendor_get, METH_O, (char *)"CameraAbilities_usb_vendor_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_usb_product_get", (PyCFunction)_wrap_CameraAbilities_usb_product_get, METH_O, (char *)"CameraAbilities_usb_product_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_usb_class_get", (PyCFunction)_wrap_CameraAbilities_usb_class_get, METH_O, (char *)"CameraAbilities_usb_class_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_usb_subclass_get", (PyCFunction)_wrap_CameraAbilities_usb_subclass_get, METH_O, (char *)"CameraAbilities_usb_subclass_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_usb_protocol_get", (PyCFunction)_wrap_CameraAbilities_usb_protocol_get, METH_O, (char *)"CameraAbilities_usb_protocol_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_library_get", (PyCFunction)_wrap_CameraAbilities_library_get, METH_O, (char *)"CameraAbilities_library_get(CameraAbilities self) -> char [1024]"},
	 { (char *)"CameraAbilities_id_get", (PyCFunction)_wrap_CameraAbilities_id_get, METH_O, (char *)"CameraAbilities_id_get(CameraAbilities self) -> char [1024]"},
	 { (char *)"CameraAbilities_device_type_get", (PyCFunction)_wrap_CameraAbilities_device_type_get, METH_O, (char *)"CameraAbilities_device_type_get(CameraAbilities self) -> GphotoDeviceType"},
	 { (char *)"CameraAbilities_reserved2_get", (PyCFunction)_wrap_CameraAbilities_reserved2_get, METH_O, (char *)"CameraAbilities_reserved2_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_reserved3_get", (PyCFunction)_wrap_CameraAbilities_reserved3_get, METH_O, (char *)"CameraAbilities_reserved3_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_reserved4_get", (PyCFunction)_wrap_CameraAbilities_reserved4_get, METH_O, (char *)"CameraAbilities_reserved4_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_reserved5_get", (PyCFunction)_wrap_CameraAbilities_reserved5_get, METH_O, (char *)"CameraAbilities_reserved5_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_reserved6_get", (PyCFunction)_wrap_CameraAbilities_reserved6_get, METH_O, (char *)"CameraAbilities_reserved6_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_reserved7_get", (PyCFunction)_wrap_CameraAbilities_reserved7_get, METH_O, (char *)"CameraAbilities_reserved7_get(CameraAbilities self) -> int"},
	 { (char *)"CameraAbilities_reserved8_get", (PyCFunction)_wrap_CameraAbilities_reserved8_get, METH_O, (char *)"CameraAbilities_reserved8_get(CameraAbilities self) -> int"},
	 { (char *)"delete_CameraAbilities", (PyCFunction)_wrap_delete_CameraAbilities, METH_O, (char *)"delete_CameraAbilities(CameraAbilities self)"},
...
static swig_type_info _swigt__p_GPPort = {"_p_GPPort", "GPPort *|CameraPort *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p__GPPortInfo = {"_p__GPPortInfo", "struct _GPPortInfo *|CameraPortInfo *|GPPortInfo *|gp_port_info *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_GPPort[] = {  {&_swigt__p_GPPort, 0, 0, 0},{0, 0, 0, 0}};

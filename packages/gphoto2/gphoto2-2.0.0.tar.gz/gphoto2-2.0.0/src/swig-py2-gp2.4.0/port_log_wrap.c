...
#define SWIGTYPE_p_f_enum_GPLogLevel_p_q_const__char_p_q_const__char_va_list_p_void__void swig_types[45]
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_delete_LogFuncItem(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_LogFuncItem, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *LogFuncItem_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args,(char *)"swigregister", 1, 1,&obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_LogFuncItem, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *_wrap_gp_log_add_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (GPLogLevel)(val1);
  {
    ...
    _global_callback->func = swig_obj[1];
    Py_INCREF(_global_callback->func);
    arg2 = gp_log_call_python;
  }
  if (swig_obj[2]) {
    {
      _global_callback->data = swig_obj[2];
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_LogFuncItem", (PyCFunction)_wrap_delete_LogFuncItem, METH_O, (char *)"delete_LogFuncItem(LogFuncItem self)"},
	 { (char *)"LogFuncItem_swigregister", LogFuncItem_swigregister, METH_VARARGS, NULL},
...
static swig_type_info _swigt__p_LogFuncItem = {"_p_LogFuncItem", "struct LogFuncItem *|LogFuncItem *", 0, 0, (void*)0, 0};

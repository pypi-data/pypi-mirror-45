...
class _CameraFilesystem(object):
    ...
    def __init__(self):
        """
        __init__(_CameraFilesystem self) -> _CameraFilesystem
...
def gp_filesystem_append(*args):
    ...
    * `context` :  
    ...
    Tells the fs that there is a file called filename in folder called
    folder. Usually camera drivers will call this function after capturing
    an image in order to tell the fs about the new file. A front-end should
...
def gp_filesystem_set_info_noop(*args):
    """
    gp_filesystem_set_info_noop(_CameraFilesystem fs, char const * folder, CameraFileInfo info, Context context) -> int
...
def gp_filesystem_set_file_noop(*args):
    """
    gp_filesystem_set_file_noop(_CameraFilesystem fs, char const * folder, CameraFile file, Context context) -> int
...
def gp_filesystem_delete_file_noop(*args):
    """
...
def gp_filesystem_get_folder(*args):
    """
...
def gp_filesystem_set_list_funcs(fs, file_list_func, folder_list_func, data):
    """
    gp_filesystem_set_list_funcs(_CameraFilesystem fs, CameraFilesystemListFunc file_list_func, CameraFilesystemListFunc folder_list_func, void * data) -> int
    ...
    * `data` :  
    ...
    and/or files. Typically, a camera driver would call this function on
    initialization. Each function can be NULL indicating that this
...
def gp_filesystem_list_files(*args):
    """
...
def gp_filesystem_list_folders(*args):
    """
...
def gp_filesystem_set_info_funcs(fs, get_info_func, set_info_func, data):
    """
    gp_filesystem_set_info_funcs(_CameraFilesystem fs, CameraFilesystemGetInfoFunc get_info_func, CameraFilesystemSetInfoFunc set_info_func, void * data) -> int
    ...
    * `data` :  
    ...
    Tells the filesystem which functions to call when file information about
    a file should be retrieved or set. Typically, this function will get
    called by the camera driver on initialization.  
...
def gp_filesystem_get_info(*args):
    """
...
def gp_filesystem_set_info(*args):
    """
...
def gp_filesystem_set_file_funcs(fs, get_file_func, del_file_func, data):
    """
    gp_filesystem_set_file_funcs(_CameraFilesystem fs, CameraFilesystemGetFileFunc get_file_func, CameraFilesystemDeleteFileFunc del_file_func, void * data) -> int
    ...
    * `data` :  
    ...
    Typically, a camera driver would call this function on initialization. A
    function can be NULL indicating that this functionality is not
    supported. For example, if a camera does not support file deletion, you
    would supply NULL for del_file_func.  
...
def gp_filesystem_get_file(*args):
    """
...
def gp_filesystem_delete_file(*args):
    """
...
def gp_filesystem_set_folder_funcs(fs, put_file_func, delete_all_func, make_dir_func, remove_dir_func, data):
    """
    gp_filesystem_set_folder_funcs(_CameraFilesystem fs, CameraFilesystemPutFileFunc put_file_func, CameraFilesystemDeleteAllFunc delete_all_func, CameraFilesystemDirFunc make_dir_func, CameraFilesystemDirFunc remove_dir_func, void * data) -> int
    ...
    * `data` :  
    ...
    If one functionality is not supported, NULL can be supplied. If you
    don't call this function, the fs will assume that neither of these
    features is supported.  

    The fs will try to compensate missing delete_all_func functionality with
    the delete_file_func if such a function has been supplied.  
...
def gp_filesystem_put_file(*args):
    """
    gp_filesystem_put_file(_CameraFilesystem fs, char const * folder, CameraFile file, Context context) -> int
...
def gp_filesystem_delete_all(*args):
    """
...
def gp_filesystem_make_dir(*args):
    """
...
def gp_filesystem_remove_dir(*args):
    """

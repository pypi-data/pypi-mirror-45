...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gp_port_library_version", (PyCFunction)_wrap_gp_port_library_version, METH_O, (char *)"gp_port_library_version(GPVersionVerbosity verbose) -> char const **"},
	 { (char *)"gp_library_version", (PyCFunction)_wrap_gp_library_version, METH_O, (char *)"gp_library_version(GPVersionVerbosity verbose) -> char const **"},
	 { NULL, NULL, 0, NULL }
};

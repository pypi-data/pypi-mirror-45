...
class CameraAbilitiesList(object):
    ...
    def __init__(self):
        """__init__(_CameraAbilitiesList self) -> CameraAbilitiesList"""
    ...
    def load_dir(self, *args) -> "void":
        """
        load_dir(CameraAbilitiesList self, char const * dir, Context context)
    ...
    def reset(self) -> "void":
        """
        reset(CameraAbilitiesList self)
    ...
    def detect(self, *args) -> "void":
        """
        detect(CameraAbilitiesList self, PortInfoList info_list, Context context)
    ...
    def append(self, abilities: 'CameraAbilities') -> "void":
        """
        append(CameraAbilitiesList self, CameraAbilities abilities)
    ...
    def count(self) -> "int":
        """
        count(CameraAbilitiesList self) -> int
    ...
    def lookup_model(self, model: 'char const *') -> "int":
        """
        lookup_model(CameraAbilitiesList self, char const * model) -> int
    ...
    def get_abilities(self, index: 'int') -> "void":
        """
        get_abilities(CameraAbilitiesList self, int index)
...
def gp_abilities_list_load(*args) -> "int":
    """
...
def gp_abilities_list_load_dir(*args) -> "int":
    """
...
def gp_abilities_list_detect(*args) -> "CameraList *":
    """

...
class Camera(object):
    ...
    def wait_for_event(self, *args) -> "void":
        ...
        *eventtype==GP_EVENT_TIMEOUT and eventdata is left unchanged. If an
        event is received then eventtype is set to the type of event, and
        eventdata is set to event specific data. See the CameraEventType enum to
        see which eventtype's match to which types of eventdata.
    ...
    def file_read(self, *args) -> "void":
        ...
        * `size` :  
            the size to be read and that was read  
        * `context` :  
            a GPContext  

...
def gp_widget_set_value(*args) -> "int const *":
    """
...
def gp_widget_get_value(*args) -> "int *":
    """
...
class CameraWidgetChildIter(object):
    ...
    def __next__(self) -> "CameraWidget *":
        """__next__(CameraWidgetChildIter self) -> CameraWidget"""
...
def gp_widget_get_children(widget: 'CameraWidget') -> "CameraWidgetChildIter *":
    """
...
class CameraWidgetChoiceIter(object):
    ...
    def __next__(self) -> "char const *":
        """__next__(CameraWidgetChoiceIter self) -> char const *"""
...
def gp_widget_get_choices(widget: 'CameraWidget') -> "CameraWidgetChoiceIter *":
    """
...
class CameraWidget(object):
    ...
    def count_children(self) -> "int":
        """
        count_children(CameraWidget self) -> int
    ...
    def get_child(self, child_number: 'int') -> "void":
        """
        get_child(CameraWidget self, int child_number)
    ...
    def get_children(self) -> "void":
        """
        get_children(CameraWidget self)
    ...
    def get_child_by_label(self, label: 'char const *') -> "void":
        """
        get_child_by_label(CameraWidget self, char const * label)
    ...
    def get_child_by_id(self, id: 'int') -> "void":
        """
        get_child_by_id(CameraWidget self, int id)
    ...
    def get_child_by_name(self, name: 'char const *') -> "void":
        """
        get_child_by_name(CameraWidget self, char const * name)
    ...
    def set_value(self, *args) -> "void":
        """
        set_value(CameraWidget self, char const * value)
        set_value(CameraWidget self, float const * value)
        set_value(CameraWidget self, int const * value)
    ...
    def set_name(self, name: 'char const *') -> "void":
        """
        set_name(CameraWidget self, char const * name)
    ...
    def set_info(self, info: 'char const *') -> "void":
        """
        set_info(CameraWidget self, char const * info)
    ...
    def set_range(self, min: 'float', max: 'float', increment: 'float') -> "void":
        """
        set_range(CameraWidget self, float min, float max, float increment)
    ...
    def add_choice(self, choice: 'char const *') -> "void":
        """
        add_choice(CameraWidget self, char const * choice)
    ...
    def count_choices(self) -> "int":
        """
        count_choices(CameraWidget self) -> int
    ...
    def get_choices(self) -> "void":
        """
        get_choices(CameraWidget self)

        Gets all the choice values of a CameraWidget. The return value is a a
    ...
    def get_choice(self, choice_number: 'int') -> "void":
        """
        get_choice(CameraWidget self, int choice_number)
    ...
    def set_changed(self, changed: 'int') -> "void":
        """
        set_changed(CameraWidget self, int changed)

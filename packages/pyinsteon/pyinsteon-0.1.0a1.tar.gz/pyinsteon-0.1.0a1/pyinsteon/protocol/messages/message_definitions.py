...
from ...constants import (MessageId, ImButtonEvents, AllLinkMode,
                          DeviceCategory, ManageAllLinkRecordAction,
                          AckNak)
...
FLD_STD_REC = [MessageField("address", 3, Address),
...
FLD_X10_SEND_REC = [MessageField("raw_x10", 1, int),
                    MessageField("x10_flag", 1, int)]
...
FLD_GET_IM_INFO_REC = [MessageField('address', 3, Address),
                       MessageField('cat', 1, DeviceCategory),
                       MessageField('subcat', 1, int),
                       MessageField('firmware', 1, int),
...
FLD_SEND_ALL_LINK_CMD = [MessageField('group', 1, int),
...
FLD_STD_SEND = [MessageField("address", 3, Address),
                MessageField("flags", 1, MessageFlags),
                MessageField("cmd1", 1, int),
                MessageField("cmd2", 1, int)]
...
FLD_START_ALL_LINKING = [MessageField('mode', 1, AllLinkMode),
                         MessageField('group', 1, int)]
...
FLD_SET_HOST_DEV_CAT = [MessageField('cat', 1, DeviceCategory),
                        MessageField('subcat', 1, int),
                        MessageField('firmware', 1, int)]
...
FLD_SET_ACK_TWO_BYTES = [MessageField('cmd1', 1, int),
                         MessageField('cmd2', 1, int)]
...
FLD_GET_IM_CONFIG = []
FLD_GET_IM_CONFIG_ACK = [MessageField('flags', 1, IMConfigurationFlags),
...
INBOUND_MSG_DEF[MessageId.SET_ACK_MESSAGE_BYTE] = MessageDefinition(
    MessageId.SET_ACK_MESSAGE_BYTE,
...
INBOUND_MSG_DEF[MessageId.GET_IM_CONFIGURATION] = MessageDefinition(
    MessageId.GET_IM_CONFIGURATION,
...
OUTBOUND_MSG_DEF[MessageId.GET_ALL_LINK_RECORD_FOR_SENDER] = MessageDefinition(
    MessageId.GET_ALL_LINK_RECORD_FOR_SENDER,
    FLD_GET_ALL_LINK_REC_FOR_SENDER)
OUTBOUND_MSG_DEF[MessageId.LED_ON] = MessageDefinition(
    MessageId.LED_ON,
    FLD_LED_ON_OFF)

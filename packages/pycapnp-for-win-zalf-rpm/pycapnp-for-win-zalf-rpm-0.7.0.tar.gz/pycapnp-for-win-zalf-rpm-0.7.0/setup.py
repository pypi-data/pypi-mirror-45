...
class build_libcapnp_ext(build_ext_c):
    def build_extension(self, ext):
        ext.include_dirs.append("../capnproto_zalf-rpm_fork/c++/src/")
        ext.library_dirs.append("../capnproto_zalf-rpm_fork/_cmake_win64_shared/c++/src/capnp/Release") 
        ext.library_dirs.append("../capnproto_zalf-rpm_fork/_cmake_win64_shared/c++/src/kj/Release")
...
setup(
    name="pycapnp-for-win-zalf-rpm",
    packages=["capnp"],
    version=VERSION,
    package_data={'capnp': ['*.pxd', '*.h', '*.capnp', 'helpers/*.pxd', 'helpers/*.h', 'includes/*.pxd', 'lib/*.pxd', 'lib/*.py', 'lib/*.pyx', 'lib/*.dll', 'templates/*']},

...
class ResolverAnalysisNode(AnalysisMixin):
    ...
    def __init__(self, id=None, inputs=None, files=None, job=None, gear_info=None, notes=None, tags=None, info=None, description=None, label=None, parent=None, parents=None, created=None, modified=None):  # noqa: E501

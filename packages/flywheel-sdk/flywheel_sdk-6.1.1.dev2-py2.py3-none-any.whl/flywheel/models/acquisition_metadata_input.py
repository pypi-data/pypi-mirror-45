...
class AcquisitionMetadataInput(object):
    ...
    def __init__(self, public=None, label=None, info=None, metadata=None, measurement=None, instrument=None, uid=None, tags=None, timestamp=None, timezone=None, files=None):  # noqa: E501

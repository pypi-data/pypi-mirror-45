...
class DataView(object):
    ...
    def __init__(self, parent=None, label=None, public=None, columns=None, file_spec=None, include_ids=None, include_labels=None, missing_data_strategy=None, id=None):  # noqa: E501

...
class SessionMetadataInput(object):
    ...
    def __init__(self, public=None, label=None, info=None, operator=None, uid=None, timestamp=None, timezone=None, subject=None, tags=None, age=None, weight=None, files=None):  # noqa: E501

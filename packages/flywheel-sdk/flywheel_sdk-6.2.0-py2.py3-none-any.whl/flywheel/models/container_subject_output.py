...
class ContainerSubjectOutput(SubjectMixin):
    ...
    def __init__(self, id=None, project=None, public=None, firstname=None, lastname=None, age=None, sex=None, cohort=None, type=None, race=None, ethnicity=None, species=None, strain=None, label=None, code=None, tags=None, info=None, files=None, parents=None, created=None, modified=None, permissions=None, notes=None, info_exists=None, analyses=None):  # noqa: E501

...
from xio.core.utils import cache
...
class Docker:
    ...
    def image(self, name=None, id=None):
         # fast search
        try:
            c = self.docker.images.get(name or id)
            if c:
                return Image(self, c)
        except:
            pass
    ...
    def container(self, name=None, id=None):
        # fast search
        try:
            c = self.docker.containers.get(name or id)
            if c:
                return Container(self, c)
        except:
            pass
        # full search
...
class Image:
    ...
    def __init__(self, docker, image):
        ...
        self.id = image.attrs.get('Id').split(':').pop()
...
class Container:
    ...
    def __init__(self, docker, container=None, id=None):
        ...
        self.id = id or container.attrs.get('Id').split(':').pop()
        self._load()

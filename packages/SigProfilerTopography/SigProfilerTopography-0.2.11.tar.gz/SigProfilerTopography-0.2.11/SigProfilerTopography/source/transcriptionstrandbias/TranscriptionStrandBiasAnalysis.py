...
def transcriptionStrandBiasAnalysis(mutationTypes,computationType,useTranscriptionStrandColumn,genome,chromSizesDict,chromNamesList,outputDir,jobname):
    ...
    print('Debug starts, April 24, 2019')
    debugSample = 'PD10014a'
    print(debugSample)
    print(accumulatedAllChromosomesSample2Type2TranscriptionStrand2CountDict[debugSample])
    print('Debug ends, April 24, 2019')

...
class TxLog:
    ...
    def get_latest_uncommitted_tx(self):
        ...
        if self._get_current_tx_index() < next_offset:
            return
    ...
    def _increment_tx_index(self):
        self._increment_int_attribute('index')

    def _get_current_tx_index(self):

...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-glue", "0.29.0", __name__, "aws-glue@0.29.0.jsii.tgz")
...
class Database(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.Database"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, catalog_arn: str, catalog_id: str, database_arn: str, database_name: str, location_uri: str) -> "IDatabase":
        ...
        Arguments:
            ...
            props: A ``DatabaseImportProps`` object. Can be obtained from a call to ``database.export()`` or manually created.
            catalogArn: -
            catalogId: -
            databaseArn: -
            databaseName: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-glue.DatabaseImportProps", jsii_struct_bases=[])
...
class Table(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.Table"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, table_arn: str, table_name: str) -> "ITable":
        ...
        Arguments:
            scope: The scope creating construct (usually ``this``).
            id: The construct's id.
            props: A ``TableImportProps`` object. Can be obtained from a call to ``table.export()`` or manually created.
            tableArn: -
            tableName: -
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-glue.TableImportProps", jsii_struct_bases=[])

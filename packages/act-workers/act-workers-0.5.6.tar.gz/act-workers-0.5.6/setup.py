...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'act-fireeye-carbanak = act_workers.fireeye_carbanak:main_log_error',
        ]
    },
    ...
    install_requires=['act-api>=0.5.4', 'requests', 'RashlyOutlaid', 'virustotal-api', 'stix2', 'pyexcel_xlsx'],

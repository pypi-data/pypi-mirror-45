...
class CloudAccounts(object):
    ...
    def __init__(
        self,
        google,
        host='cloudaccounts-api.broadinstitute.org',
    ):
        ...
        # get id token
        self.google.auth_service_account(self.google.scopes)
    ...
    # Splits
    def update_google_splits(self):
        """Update Splits."""
        return self.get('/google/splits/update').text

...
azureml_configuration_directory_name = ".azureml"
configuration_directory_name = "aml_config"
legacy_configuration_directory_name = ".azureml"
home_configuration_directory_name = ".azureml"
...
def get_home_settings_directory():
    ...
    settings_dir = os.path.join(home, home_configuration_directory_name)

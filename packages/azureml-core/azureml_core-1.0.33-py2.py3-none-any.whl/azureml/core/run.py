...
from azureml.exceptions import RunEnvironmentException, UserErrorException
...
class Run(_RunBase):
    ...
    def __init__(self, experiment, run_id, outputs=None, **kwargs):
        ...
        self._container = self._run_dto.get("data_container_id", None)
    ...
    def _start_logging(experiment, name=None, run_id=None,
        ...
        run._client.start()
        run._client.add_properties(global_tracking_info_registry.gather_all())
        if snapshot_directory:
            run._client.take_snapshot(snapshot_directory, _raise_on_validation_failure=False)
        return run

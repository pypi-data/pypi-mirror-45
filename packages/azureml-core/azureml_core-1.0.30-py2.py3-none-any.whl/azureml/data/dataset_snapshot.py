...
class DatasetSnapshot(object):
    ...
    def get_profile(self):
        """Get the profile of Dataset snapshot.
    ...
    def to_pandas_dataframe(self):
        """Pull all of the data and returns it as a Pandas DataFrame, which is fully materialized in memory.
    ...
    def get_all(workspace, dataset_name):
        ...
        :rtype: azureml.core.Dataset.list[azureml.data.DatasetSnapshot]
        """
    ...
    def compare_profiles(
        ...
        :param rhs_dataset_snapshot: DatasetSnapshot
        ...
        :param histogram_distance_method: Enum describing the method, ex: Wasserstein or Energy
        :type histogram_distance_method: HistogramDistance
    ...
    def is_data_snapshot_available(self):
        """Check if the materialized copy of the snapshot available.

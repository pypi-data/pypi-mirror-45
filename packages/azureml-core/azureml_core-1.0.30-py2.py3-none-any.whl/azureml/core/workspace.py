...
class Workspace(object):
    ...
    def create(name, auth=None, subscription_id=None, resource_group=None,
               ...
               key_vault=None, app_insights=None, container_registry=None, exist_ok=False, show_output=True):
    ...
    def environments(self):
        ...
        return {environment.name: environment for environment in Environment.list(self)}

...
class Model(object):
    ...
    _expected_payload_keys = ['createdTime', 'description', 'id', 'mimeType', 'name', 'kvTags',
                              'properties', 'unpack', 'url', 'version', 'experimentName', 'runId']

    def __init__(self, workspace, name=None, id=None, tags=None, properties=None, version=None, run_id=None):
        """Model constructor.
        ...
        if workspace:
            get_response_payload = self._get(workspace, name, id, tags, properties, version, run_id)
    ...
    @staticmethod
    def _get(workspace, name=None, id=None, tags=None, properties=None, version=None, run_id=None):
        ...
        resp = ClientBase._execute_func(requests.get, mms_url, headers=headers, params=params)
    ...
    def _register_with_asset(workspace, model_name, asset_id, tags=None, properties=None,
                             description=None, experiment_name=None, run_id=None, unpack=False):
        ...
        try:
            resp = ClientBase._execute_func(
                requests.post, model_url, params=params, headers=headers, json=json_payload)
    ...
    @staticmethod
    def list(workspace, name=None, tags=None, properties=None, run_id=None):
    ...
    def serialize(self):
        ...
        return {'createdTime': created_time, 'description': self.description, 'id': self.id,
                ...
                'experimentName': self.experiment_name, 'runId': self.run_id, 'runDetails': self.run.__str__()}
    ...
    def update(self, tags):
        ...
        resp = ClientBase._execute_func(
            requests.patch, self._mms_endpoint, headers=headers, params=params, json=patch_list,
    ...
    def delete(self):
        ...
        resp = ClientBase._execute_func(requests.delete, self._mms_endpoint, headers=headers, params=params)
    ...
    def deploy(workspace, name, models, inference_config, deployment_config=None, deployment_target=None):
        ...
        if deployment_config and (type(deployment_config) is LocalWebserviceDeploymentConfiguration):
                service = deployment_config._webservice_type._deploy(workspace, name, models,
                                                                     inference_config._convert_to_image_config(),
                                                                     deployment_config)
                return service
        else:
            try:
                ...
                if inference_config.source_directory:
                    os.chdir(inference_config.source_directory)
    ...
    def profile(workspace, profile_name, models, inference_config, input_data):
        ...
        resp = requests.post(profile_url, params=params, headers=headers, json=json_payload)
        try:
            resp.raise_for_status()
        except requests.exceptions.HTTPError:
            raise WebserviceException('Received bad response from Model Management Service:\n'
...
class InferenceConfig():
    ...
    :type description: str
    :param base_image: A custom image to be used as base image.
    :type base_image: str
    ...
    def __init__(self, entry_script, runtime, conda_file=None, extra_docker_file_steps=None,
                 source_directory=None, enable_gpu=None, tags=None, properties=None, description=None,
        ...
        self.entry_script_path = os.path.abspath(os.path.dirname(self.entry_script))
        self.validate_configuration()

    def _convert_to_image_config(self):
        ...
        return ContainerImageConfig(joinPath(self.source_directory, self.entry_script),
                                    ...
                                    None, dependencies, self.enable_gpu, self.tags, self.properties,
    ...
    def validate_configuration(self):
        ...
        script_name, script_extension = os.path.splitext(self.entry_script)

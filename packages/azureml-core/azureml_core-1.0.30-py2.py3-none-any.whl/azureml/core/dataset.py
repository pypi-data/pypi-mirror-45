...
This module provides methods for creating, managing datasets and performing actions on them.
"""
...
class Dataset(object):
    ...
    def definition_version(self):
        ...
        ..remarks::
            ...
            :func: ~azureml.core.Dataset.update_definition. Each definition has an unique identifier. The
        ...
        if self._definition is None:
            return None
        return self._definition._version_id
    ...
    def list(workspace):
        ...
        :rtype: azureml.core.Dataset.list[azureml.core.dataset.Dataset]
        """
    ...
    def get_definitions(self):
        ...
        :rtype: Dict[str, azureml.data.datset_definition.DatasetDefinition]
        """
    ...
    def get_definition(self, version_id=None):
        ...
        :type version_id: str
        :return: Dataset definition
        :rtype: azureml.data.datset_definition.DatasetDefinition
        """
    ...
    def from_delimited_files(
            path,
            separator=',',
            header=PromoteHeadersBehavior.AllFilesHaveSameHeaders,
            encoding=FileEncoding.UTF8,
            quoting=False,
            infer_column_types=True,
            skip_rows=0,
            skip_mode=SkipLinesBehavior.NoRows,
            comment=None,
            include_path=False,
        ...
        :type path: azureml.data.DataReference or str
        ...
        :type header: :class: azureml.contrib.dataset.PromoteHeadersBehavior
        :param encoding: The encoding of the files being read.
        :type encoding: :class: azureml.dataprep.FileEncoding
        ...
        :type skip_mode: :class: azureml.core.dataset.SkipLinesBehavior
    ...
    def from_binary_files(path):
        ...
        ..remarks::
            ...
            Use this method to read files as streams of binary data. Returns one file stream object per file read.
            Use this method when you're reading images, videos, audio or other binary data.

            :func: ~azureml.core.Dataset.get_profile and :func: ~azureml.core.Dataset.create_snapshot will not work
            as expected for a dataset created by this method.
    ...
    def from_sql_query(data_source, query):
        ...
        :param data_source: The details of the Azure SQL datastore or Azure PostgreSQL datastore.
    ...
    def from_json_files(path, encoding=FileEncoding.UTF8, flatten_nested_arrays=False, include_path=False):
        ...
        :type path: azureml.data.DataReference or str
        :param encoding: The encoding of the files being read.
        :type encoding: azureml.dataprep.api.engineapi.typedefinitions.FileEncoding
    ...
    def create_snapshot(self, snapshot_name, compute_target=None, create_data_snapshot=False, target_datastore=None):
        ...
        ..remarks::
            ...
            and an optional copy of the data itself.
        ...
        :param target_datastore: Target datastore (AzureStorageDatastore) to save snapshot.
            If omitted, the snapshot will be created in the default storage of the workspace.
        :type target_datastore: azureml.core.Datastore
        :return: Dataset snapshot object.
        :rtype: azureml.data.datset_snapshot.DatasetSnapshot
        """
    ...
    def get_all_snapshots(self):
        ...
        :rtype: azureml.core.Dataset.list[azureml.data.datset_snapshot.DatasetSnapshot]
        """
    ...
    def generate_profile(self, compute_target=None, workspace=None, arguments=None):
        ...
        :param arguments: Profile arguments. Valid arguments are
            "include_stype_counts", bool, Whether to include checking if values look like some well known
            semantic types of information. For Example, "email address". Turning this on will impact performance.
            "number_of_histogram_bins", int, which controls the number of histogram bins to use for numeric
            data (defaults to 10)
        :type arguments: Dict[str,object]
        :return: Dataset action run object.
        :rtype: azureml.data.DatasetActionRun
        """
    ...
    def get_profile(self, arguments=None, generate_if_not_exist=True, workspace=None, compute_target=None):
        ...
        ..remarks::
            ...
            Retrieves an existing profile that was created earlier by calling :func: get_profile
            if it is still valid. Profiles are invalidated when changed data is detected in the dataset.
    ...
    def deprecate(self, deprecate_by_dataset_id):
        ...
        ..remarks::
            ...
            Deprecated Datasets can still be consumed. To completely stop a dataset from being consumed, archive it.
    ...
    def sample(self, sample_strategy, arguments):
        ...
        :param arguments: Sample arguments.
            ...
            +-----------------------+---------------------------+--------------+-------------------------------------+
            |         top_n         |         top_n             |   integer    | Select top N rows as your sample    |
            +-----------------------+---------------------------+--------------+-------------------------------------+

...
PARAM_BINNING = _dmcam.PARAM_BINNING
...
class param_val_u(object):
    ...
    binning_info = _swig_property(_dmcam.param_val_u_binning_info_get)
...
class param_val_u_binning_info(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    col_reduction = _swig_property(_dmcam.param_val_u_binning_info_col_reduction_get, _dmcam.param_val_u_binning_info_col_reduction_set)
    row_reduction = _swig_property(_dmcam.param_val_u_binning_info_row_reduction_get, _dmcam.param_val_u_binning_info_row_reduction_set)

    def __init__(self):
        _dmcam.param_val_u_binning_info_swiginit(self, _dmcam.new_param_val_u_binning_info())
    __swig_destroy__ = _dmcam.delete_param_val_u_binning_info
param_val_u_binning_info_swigregister = _dmcam.param_val_u_binning_info_swigregister
param_val_u_binning_info_swigregister(param_val_u_binning_info)
...
DMCAM_FILTER_ID_BINNING = _dmcam.DMCAM_FILTER_ID_BINNING

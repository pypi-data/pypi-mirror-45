...
_dmcam.DM_NAME_swigconstant(_dmcam)
DM_NAME = _dmcam.DM_NAME

_dmcam.DM_VERSION_MAJOR_swigconstant(_dmcam)
DM_VERSION_MAJOR = _dmcam.DM_VERSION_MAJOR

_dmcam.DM_VERSION_MINOR_swigconstant(_dmcam)
DM_VERSION_MINOR = _dmcam.DM_VERSION_MINOR

_dmcam.DM_VERSION_REV_swigconstant(_dmcam)
DM_VERSION_REV = _dmcam.DM_VERSION_REV

_dmcam.DM_VERSION_STR_swigconstant(_dmcam)
DM_VERSION_STR = _dmcam.DM_VERSION_STR

_dmcam.DMCAM_ERR_CAP_FRAME_DISCARD_swigconstant(_dmcam)
DMCAM_ERR_CAP_FRAME_DISCARD = _dmcam.DMCAM_ERR_CAP_FRAME_DISCARD

_dmcam.DMCAM_ERR_CAP_WRONG_STATE_swigconstant(_dmcam)
DMCAM_ERR_CAP_WRONG_STATE = _dmcam.DMCAM_ERR_CAP_WRONG_STATE

_dmcam.DMCAM_ERR_CAP_CANCEL_swigconstant(_dmcam)
DMCAM_ERR_CAP_CANCEL = _dmcam.DMCAM_ERR_CAP_CANCEL

_dmcam.DMCAM_ERR_CAP_TIMEOUT_swigconstant(_dmcam)
DMCAM_ERR_CAP_TIMEOUT = _dmcam.DMCAM_ERR_CAP_TIMEOUT

_dmcam.DMCAM_ERR_CAP_STALL_swigconstant(_dmcam)
DMCAM_ERR_CAP_STALL = _dmcam.DMCAM_ERR_CAP_STALL

_dmcam.DMCAM_ERR_CAP_ERROR_swigconstant(_dmcam)
DMCAM_ERR_CAP_ERROR = _dmcam.DMCAM_ERR_CAP_ERROR

_dmcam.DMCAM_ERR_CAP_EOF_swigconstant(_dmcam)
DMCAM_ERR_CAP_EOF = _dmcam.DMCAM_ERR_CAP_EOF

_dmcam.DMCAM_ERR_CAP_UNKNOWN_swigconstant(_dmcam)
DMCAM_ERR_CAP_UNKNOWN = _dmcam.DMCAM_ERR_CAP_UNKNOWN

_dmcam.DM_SEEK_SET_swigconstant(_dmcam)
DM_SEEK_SET = _dmcam.DM_SEEK_SET

_dmcam.DM_SEEK_CUR_swigconstant(_dmcam)
DM_SEEK_CUR = _dmcam.DM_SEEK_CUR

_dmcam.DM_SEEK_END_swigconstant(_dmcam)
DM_SEEK_END = _dmcam.DM_SEEK_END

_dmcam.DEV_IF_USB_swigconstant(_dmcam)
DEV_IF_USB = _dmcam.DEV_IF_USB

_dmcam.DEV_IF_ETH_swigconstant(_dmcam)
DEV_IF_ETH = _dmcam.DEV_IF_ETH

_dmcam.DEV_IF_FILE_swigconstant(_dmcam)
DEV_IF_FILE = _dmcam.DEV_IF_FILE

_dmcam.DEV_IF_NONE_swigconstant(_dmcam)
...
_dmcam.LOG_LEVEL_TRACE_swigconstant(_dmcam)
LOG_LEVEL_TRACE = _dmcam.LOG_LEVEL_TRACE

_dmcam.LOG_LEVEL_DEBUG_swigconstant(_dmcam)
LOG_LEVEL_DEBUG = _dmcam.LOG_LEVEL_DEBUG

_dmcam.LOG_LEVEL_INFO_swigconstant(_dmcam)
LOG_LEVEL_INFO = _dmcam.LOG_LEVEL_INFO

_dmcam.LOG_LEVEL_WARN_swigconstant(_dmcam)
LOG_LEVEL_WARN = _dmcam.LOG_LEVEL_WARN

_dmcam.LOG_LEVEL_ERROR_swigconstant(_dmcam)
LOG_LEVEL_ERROR = _dmcam.LOG_LEVEL_ERROR

_dmcam.LOG_LEVEL_NONE_swigconstant(_dmcam)
LOG_LEVEL_NONE = _dmcam.LOG_LEVEL_NONE

_dmcam.DEV_RST_DEV_swigconstant(_dmcam)
DEV_RST_DEV = _dmcam.DEV_RST_DEV

_dmcam.DEV_RST_CAM0_swigconstant(_dmcam)
DEV_RST_CAM0 = _dmcam.DEV_RST_CAM0

_dmcam.DEV_RST_CAM1_swigconstant(_dmcam)
DEV_RST_CAM1 = _dmcam.DEV_RST_CAM1

_dmcam.DEV_RST_USB_swigconstant(_dmcam)
DEV_RST_USB = _dmcam.DEV_RST_USB

_dmcam.DEV_RST_IR1_swigconstant(_dmcam)
DEV_RST_IR1 = _dmcam.DEV_RST_IR1

_dmcam.DEV_RST_IR2_swigconstant(_dmcam)
DEV_RST_IR2 = _dmcam.DEV_RST_IR2

_dmcam.DEV_RST_MCU_swigconstant(_dmcam)
DEV_RST_MCU = _dmcam.DEV_RST_MCU

_dmcam.DEV_RST_CNT_swigconstant(_dmcam)
DEV_RST_CNT = _dmcam.DEV_RST_CNT

_dmcam.DEV_MODE_NORMAL_swigconstant(_dmcam)
DEV_MODE_NORMAL = _dmcam.DEV_MODE_NORMAL

_dmcam.DEV_MODE_DFU_swigconstant(_dmcam)
DEV_MODE_DFU = _dmcam.DEV_MODE_DFU

_dmcam.DEV_MODE_TEST_swigconstant(_dmcam)
DEV_MODE_TEST = _dmcam.DEV_MODE_TEST

_dmcam.DEV_MODE_DATA_UP_swigconstant(_dmcam)
DEV_MODE_DATA_UP = _dmcam.DEV_MODE_DATA_UP

_dmcam.DEV_REG_RESERVED_swigconstant(_dmcam)
DEV_REG_RESERVED = _dmcam.DEV_REG_RESERVED

_dmcam.DEV_REG_CAM0_swigconstant(_dmcam)
DEV_REG_CAM0 = _dmcam.DEV_REG_CAM0

_dmcam.DEV_REG_CAM1_swigconstant(_dmcam)
DEV_REG_CAM1 = _dmcam.DEV_REG_CAM1

_dmcam.DEV_REG_IR_0_swigconstant(_dmcam)
DEV_REG_IR_0 = _dmcam.DEV_REG_IR_0

_dmcam.DEV_REG_IR_1_swigconstant(_dmcam)
DEV_REG_IR_1 = _dmcam.DEV_REG_IR_1

_dmcam.PARAM_DEV_MODE_swigconstant(_dmcam)
PARAM_DEV_MODE = _dmcam.PARAM_DEV_MODE

_dmcam.PARAM_MOD_FREQ_swigconstant(_dmcam)
PARAM_MOD_FREQ = _dmcam.PARAM_MOD_FREQ

_dmcam.PARAM_INFO_VENDOR_swigconstant(_dmcam)
PARAM_INFO_VENDOR = _dmcam.PARAM_INFO_VENDOR

_dmcam.PARAM_INFO_PRODUCT_swigconstant(_dmcam)
PARAM_INFO_PRODUCT = _dmcam.PARAM_INFO_PRODUCT

_dmcam.PARAM_INFO_CAPABILITY_swigconstant(_dmcam)
PARAM_INFO_CAPABILITY = _dmcam.PARAM_INFO_CAPABILITY

_dmcam.PARAM_INFO_SERIAL_swigconstant(_dmcam)
PARAM_INFO_SERIAL = _dmcam.PARAM_INFO_SERIAL

_dmcam.PARAM_INFO_VERSION_swigconstant(_dmcam)
PARAM_INFO_VERSION = _dmcam.PARAM_INFO_VERSION

_dmcam.PARAM_INFO_SENSOR_swigconstant(_dmcam)
PARAM_INFO_SENSOR = _dmcam.PARAM_INFO_SENSOR

_dmcam.PARAM_INFO_CALIB_swigconstant(_dmcam)
PARAM_INFO_CALIB = _dmcam.PARAM_INFO_CALIB

_dmcam.PARAM_ROI_swigconstant(_dmcam)
PARAM_ROI = _dmcam.PARAM_ROI

_dmcam.PARAM_FRAME_FORMAT_swigconstant(_dmcam)
PARAM_FRAME_FORMAT = _dmcam.PARAM_FRAME_FORMAT

_dmcam.PARAM_ILLUM_POWER_swigconstant(_dmcam)
PARAM_ILLUM_POWER = _dmcam.PARAM_ILLUM_POWER

_dmcam.PARAM_FRAME_RATE_swigconstant(_dmcam)
PARAM_FRAME_RATE = _dmcam.PARAM_FRAME_RATE

_dmcam.PARAM_INTG_TIME_swigconstant(_dmcam)
PARAM_INTG_TIME = _dmcam.PARAM_INTG_TIME

_dmcam.PARAM_PHASE_CORR_swigconstant(_dmcam)
PARAM_PHASE_CORR = _dmcam.PARAM_PHASE_CORR

_dmcam.PARAM_TEMP_swigconstant(_dmcam)
PARAM_TEMP = _dmcam.PARAM_TEMP

_dmcam.PARAM_HDR_INTG_TIME_swigconstant(_dmcam)
PARAM_HDR_INTG_TIME = _dmcam.PARAM_HDR_INTG_TIME

_dmcam.PARAM_SYNC_DELAY_swigconstant(_dmcam)
PARAM_SYNC_DELAY = _dmcam.PARAM_SYNC_DELAY

_dmcam.PARAM_SYS_CALIB_COEFF_swigconstant(_dmcam)
PARAM_SYS_CALIB_COEFF = _dmcam.PARAM_SYS_CALIB_COEFF

_dmcam.PARAM_SYNC_SYS_TIME_swigconstant(_dmcam)
PARAM_SYNC_SYS_TIME = _dmcam.PARAM_SYNC_SYS_TIME

_dmcam.PARAM_AMBIENT_LIGHT_COEFF_swigconstant(_dmcam)
PARAM_AMBIENT_LIGHT_COEFF = _dmcam.PARAM_AMBIENT_LIGHT_COEFF

_dmcam.PARAM_DUAL_MOD_FREQ_swigconstant(_dmcam)
PARAM_DUAL_MOD_FREQ = _dmcam.PARAM_DUAL_MOD_FREQ

_dmcam.PARAM_INFO_LENS_swigconstant(_dmcam)
PARAM_INFO_LENS = _dmcam.PARAM_INFO_LENS

_dmcam.PARAM_ENUM_COUNT_swigconstant(_dmcam)
PARAM_ENUM_COUNT = _dmcam.PARAM_ENUM_COUNT

_dmcam.BIN_DATA_TYPE_MCU_swigconstant(_dmcam)
BIN_DATA_TYPE_MCU = _dmcam.BIN_DATA_TYPE_MCU

_dmcam.BIN_DATA_TYPE_TFC_swigconstant(_dmcam)
BIN_DATA_TYPE_TFC = _dmcam.BIN_DATA_TYPE_TFC

_dmcam.BIN_DATA_TYPE_CALIB_swigconstant(_dmcam)
...
class param_roi_t(object):
    ...
    cur_fsize = _swig_property(_dmcam.param_roi_t_cur_fsize_get, _dmcam.param_roi_t_cur_fsize_set)
...
class param_val_u(object):
    ...
    info_capability = _swig_property(_dmcam.param_val_u_info_capability_get)
...
class param_val_u_info_capability(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    max_frame_width = _swig_property(_dmcam.param_val_u_info_capability_max_frame_width_get, _dmcam.param_val_u_info_capability_max_frame_width_set)
    max_frame_height = _swig_property(_dmcam.param_val_u_info_capability_max_frame_height_get, _dmcam.param_val_u_info_capability_max_frame_height_set)
    max_frame_depth = _swig_property(_dmcam.param_val_u_info_capability_max_frame_depth_get, _dmcam.param_val_u_info_capability_max_frame_depth_set)
    max_fps = _swig_property(_dmcam.param_val_u_info_capability_max_fps_get, _dmcam.param_val_u_info_capability_max_fps_set)
    max_intg_us = _swig_property(_dmcam.param_val_u_info_capability_max_intg_us_get, _dmcam.param_val_u_info_capability_max_intg_us_set)

    def __init__(self):
        _dmcam.param_val_u_info_capability_swiginit(self, _dmcam.new_param_val_u_info_capability())
    __swig_destroy__ = _dmcam.delete_param_val_u_info_capability
param_val_u_info_capability_swigregister = _dmcam.param_val_u_info_capability_swigregister
param_val_u_info_capability_swigregister(param_val_u_info_capability)
...
_dmcam.DM_FRAME_FMT_RAW_DIST_swigconstant(_dmcam)
DM_FRAME_FMT_RAW_DIST = _dmcam.DM_FRAME_FMT_RAW_DIST

_dmcam.DM_FRAME_FMT_DISTANCE_swigconstant(_dmcam)
DM_FRAME_FMT_DISTANCE = _dmcam.DM_FRAME_FMT_DISTANCE

_dmcam.DM_FRAME_FMT_GRAY_swigconstant(_dmcam)
DM_FRAME_FMT_GRAY = _dmcam.DM_FRAME_FMT_GRAY

_dmcam.DM_FRAME_FMT_PCLOUD_swigconstant(_dmcam)
DM_FRAME_FMT_PCLOUD = _dmcam.DM_FRAME_FMT_PCLOUD

_dmcam.DM_FRAME_FMT_RGB_swigconstant(_dmcam)
...
_dmcam.DMCAM_CMAP_OUTFMT_RGB_swigconstant(_dmcam)
DMCAM_CMAP_OUTFMT_RGB = _dmcam.DMCAM_CMAP_OUTFMT_RGB

_dmcam.DMCAM_CMAP_OUTFMT_RGBA_swigconstant(_dmcam)
DMCAM_CMAP_OUTFMT_RGBA = _dmcam.DMCAM_CMAP_OUTFMT_RGBA

_dmcam.DMCAM_CMAP_OUTFMT_BGR_swigconstant(_dmcam)
DMCAM_CMAP_OUTFMT_BGR = _dmcam.DMCAM_CMAP_OUTFMT_BGR

def cmap_dist_f32_to_RGB(dst, src, outfmt, range_min_m, range_max_m):
    return _dmcam.cmap_dist_f32_to_RGB(dst, src, outfmt, range_min_m, range_max_m)
cmap_dist_f32_to_RGB = _dmcam.cmap_dist_f32_to_RGB

def cmap_float(dst, src, outfmt, range_min_m, range_max_m):
    return _dmcam.cmap_float(dst, src, outfmt, range_min_m, range_max_m)
cmap_float = _dmcam.cmap_float

def cmap_dist_u16_to_RGB(dst, src, outfmt, range_min_mm, range_max_mm):
    return _dmcam.cmap_dist_u16_to_RGB(dst, src, outfmt, range_min_mm, range_max_mm)
...
def cmap_gray_u16_to_RGB32(dst, src, balance):
    return _dmcam.cmap_gray_u16_to_RGB32(dst, src, balance)
cmap_gray_u16_to_RGB32 = _dmcam.cmap_gray_u16_to_RGB32

def cmap_gray_f32_to_RGB32(dst, src, balance):
    return _dmcam.cmap_gray_f32_to_RGB32(dst, src, balance)
cmap_gray_f32_to_RGB32 = _dmcam.cmap_gray_f32_to_RGB32
...
_dmcam.DMCAM_FRAME_SAVE_FLOAT32_swigconstant(_dmcam)
DMCAM_FRAME_SAVE_FLOAT32 = _dmcam.DMCAM_FRAME_SAVE_FLOAT32

_dmcam.DMCAM_FRAME_SAVE_UINT32_swigconstant(_dmcam)
DMCAM_FRAME_SAVE_UINT32 = _dmcam.DMCAM_FRAME_SAVE_UINT32

_dmcam.DMCAM_FRAME_SAVE_UINT16_swigconstant(_dmcam)
DMCAM_FRAME_SAVE_UINT16 = _dmcam.DMCAM_FRAME_SAVE_UINT16

_dmcam.DMCAM_FRAME_SAVE_UINT8_swigconstant(_dmcam)

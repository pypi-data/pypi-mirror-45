...
def query_mine(*auth_args):
    ...
    for item in cursor:
        ...
        item['contract'] = ctrl_contract.read(json_id(item.pop('contract_id')))
        array.append(item)
...
def create(contract_id, data, *auth_args):
    ...
    if t == 'main':
        ...
        if existed is not None:
            ...
            existed['contract'] = ctrl_contract.read(json_id(existed.pop('contract_id')))
            return existed
    ...
    ret['contract'] = ctrl_contract.read(json_id(ret.pop('contract_id')))
...
def tx_estimate(contract_id, sender_address, data):
    ...
    return tx['gas'] * tx['gasPrice'], contract['decimals']

...
setup(
    ...
    name='scipion-em-motioncorr',  # Required
    ...
    description='Plugin to use motioncorr programs within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-motioncorr',  # Optional

...
class PlotWidget(FigureCanvas):
    ...
    def __init__(self,parent=None,parameters=[],lines=1,width=5,height=5,dpi=100):
        '''  Constructor  '''
        self.lines = []
        self.axes = []
...
class Plot2DWidget(PlotWidget):
    ...
    def set_data(self,x=0,y=0,line=0,autoscale=True):
        ''' set the data '''
...
class Vector3DWidget(QFrame):
    ...
    def __init__(self,parent=None,parameters=[],font=None):
        ...
        l = QGridLayout()
        l.setSpacing(0)
        l.addWidget(self.plot,0,0,1,6)
        l.addWidget(_x,1,0,1,1)
        l.addWidget(self.x,1,1,1,1)
        l.addWidget(_y,1,2,1,1)
        l.addWidget(self.y,1,3,1,1)
        l.addWidget(_z,1,4,1,1)
        l.addWidget(self.z,1,5,1,1)
        for i in range(3): 
    ...
    def set_data(self,x,y,z,ts=0,dp=2,units=''):
        ...
        self.plot.set_data([0,x],[0,0],[0,0],line=0,autoscale=True)
        self.plot.set_data([0,0],[0,y],[0,0],line=1,autoscale=True)
        self.plot.set_data([0,0],[0,0],[0,z],line=2,autoscale=True)
...
class MainWindow(QWidget):
    ...
    def onClick(self):
        ...
        # test 3D
        self.plot3.set_data([1,2],[1,2],[1,2],line=0,autoscale=True)

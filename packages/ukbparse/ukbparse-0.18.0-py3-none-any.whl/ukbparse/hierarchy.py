...
def getHierarchyFilePath(dtable=None,
    ...
    Hierarchy files can be looked up with one of two methods:

     1. By passing a :class:`.DataTable` (``dtable``) and variable ID (``vid``)

     2. By specifying a data type name (``name``)

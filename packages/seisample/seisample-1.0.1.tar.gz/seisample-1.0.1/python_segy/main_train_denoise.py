...
if __name__ == '__main__':
    ...
    xs = datagenerator(data_dir = args.train_data,patch_size = (128,128),stride = (32,32),train_data_num = 10000,download=False,datasets = "Hess_VTI",aug_times=0,scales = [1],verbose=True,jump=2,agc=True)

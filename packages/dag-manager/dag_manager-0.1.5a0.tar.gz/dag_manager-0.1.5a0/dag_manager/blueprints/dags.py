...
from dag_manager.auth import need_auth
from dag_manager.config import (
    ALL_DAGS_ZIP_NAME,
    DAG_FOLDER,
    ALL_DAGS_ZIP_PATH,
    ACCEPTED_EXT,
...
from dag_manager.util.lock import unlock, lock
...
def is_valid_dag_file(dag_id, path, ext, dag_path=None):
    ...
    if ext == '.zip':
        ...
        zip_tract_path = extract_zip(path)

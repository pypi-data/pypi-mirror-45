...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ssm", "0.29.0", __name__, "aws-ssm@0.29.0.jsii.tgz")
...
class ParameterBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-ssm.ParameterBase"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str) -> None:
        ...
        """
        jsii.create(ParameterBase, self, [scope, id])
...
class _ParameterBaseProxy(ParameterBase, jsii.proxy_for(aws_cdk.cdk.Resource)):
    @property
    @jsii.member(jsii_name="parameterName")
    def parameter_name(self) -> str:
        """The name of the SSM Parameter resource."""
...
class Parameter(ParameterBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.Parameter"):
    """SSM parameter.

    Use ``StringParameter`` and ``StringListParameter`` for a strong-typed version.
    """
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, type: "ParameterType", value: str, allowed_pattern: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None) -> None:
        """
        Arguments:
            scope: -
            id: -
        ...
        """
        props: ParameterProps = {"type": type, "value": value}
        ...
        jsii.create(Parameter, self, [scope, id, props])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ssm.ParameterProps", jsii_struct_bases=[ParameterOptions])
class ParameterProps(ParameterOptions, jsii.compat.TypedDict):
    type: "ParameterType"

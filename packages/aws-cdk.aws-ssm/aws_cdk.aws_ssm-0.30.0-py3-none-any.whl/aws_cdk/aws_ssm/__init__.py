...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ssm", "0.30.0", __name__, "aws-ssm@0.30.0.jsii.tgz")
...
class Parameter(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.Parameter"):
    """SSM parameter.

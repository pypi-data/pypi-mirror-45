...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-s3", "0.29.0", __name__, "aws-s3@0.29.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-s3.BucketImportProps", jsii_struct_bases=[])
...
class IBucket(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def on_put_object(self, name: str, target: typing.Optional[aws_cdk.aws_events.IEventRuleTarget]=None, path: typing.Optional[str]=None) -> aws_cdk.aws_events.EventRule:
        ...
        Arguments:
            name: the logical ID of the newly created Event Rule.
            target: the optional target of the Event Rule.
            path: the optional path inside the Bucket that will be watched for changes.

        Returns:
            a new {@link events.EventRule} instance
        """
        ...
...
class BucketBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-s3.BucketBase"):
...
class _BucketBaseProxy(BucketBase, jsii.proxy_for(aws_cdk.cdk.Resource)):
    @jsii.member(jsii_name="export")
    def export(self) -> "BucketImportProps":
        """Exports this bucket from the stack."""
        return jsii.invoke(self, "export", [])
...
class Bucket(BucketBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-s3.Bucket"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, block_public_access: typing.Optional["BlockPublicAccess"]=None, bucket_name: typing.Optional[str]=None, encryption: typing.Optional["BucketEncryption"]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IEncryptionKey]=None, lifecycle_rules: typing.Optional[typing.List["LifecycleRule"]]=None, public_read_access: typing.Optional[bool]=None, removal_policy: typing.Optional[aws_cdk.cdk.RemovalPolicy]=None, versioned: typing.Optional[bool]=None, website_error_document: typing.Optional[str]=None, website_index_document: typing.Optional[str]=None) -> None:
        ...
        Arguments:
            ...
            encryption: The kind of server-side encryption to apply to this bucket. If you choose KMS, you can specify a KMS key via ``encryptionKey``. If encryption key is not specified, a key will automatically be created. Default: Unencrypted
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, bucket_arn: typing.Optional[str]=None, bucket_domain_name: typing.Optional[str]=None, bucket_name: typing.Optional[str]=None, bucket_website_new_url_format: typing.Optional[bool]=None, bucket_website_url: typing.Optional[str]=None) -> "IBucket":
        ...
        Arguments:
            ...
            props: A ``BucketAttributes`` object. Can be obtained from a call to ``bucket.export()`` or manually created.
...
__all__ = ["BlockPublicAccess", "BlockPublicAccessOptions", "Bucket", "BucketBase", "BucketEncryption", "BucketImportProps", "BucketPolicy", "BucketPolicyProps", "BucketProps", "CfnBucket", "CfnBucketPolicy", "CfnBucketPolicyProps", "CfnBucketProps", "Coordinates", "EventType", "IBucket", "LifecycleRule", "NoncurrentVersionTransition", "NotificationKeyFilter", "StorageClass", "Transition", "__jsii_assembly__"]

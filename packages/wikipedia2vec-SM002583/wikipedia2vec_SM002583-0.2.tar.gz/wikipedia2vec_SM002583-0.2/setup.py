...
def list_cpp_files(package_dir='wikipedia2vec_SM002583'):
...
setup(
    ...
    url='https://github.com/samikshm/wikipedia2vec_SM002583',
    download_url = 'https://github.com/samikshm/wikipedia2vec_SM002583/archive/0.2.tar.gz',
    ...
    entry_points={
        'console_scripts': [
            'wikipedia2vec_SM002583=wikipedia2vec_SM002583.cli:cli',
        ]
    },

...
setup(
    ...
    name='scipion-em-gautomatch',  # Required
    ...
    version='1.0.5b',  # Required

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description='Plugin to use Gautomatch program within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-gautomatch',  # Optional

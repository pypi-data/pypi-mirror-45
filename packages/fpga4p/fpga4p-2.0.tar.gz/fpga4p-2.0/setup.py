...
setup(
    ...
    version='2.0',
    packages=['fpga4p',
              'fpga4p.classification_algorithms',
              'fpga4p.training_algorithms',
	      'fpga4p.supporting_tools',
	      'fpga4p.testing'],
    ...
    description='Python package / GNU Linux terminal utility for porting machine learning algorithms to FPGA.',
    long_description=
    """
    MANUAL:

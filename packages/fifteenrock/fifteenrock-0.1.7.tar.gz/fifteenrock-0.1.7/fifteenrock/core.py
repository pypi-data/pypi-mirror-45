...
def deploy(credentials: Dict[str, str], main_file: str, project: str, function: str,
           url: str = 'https://www.15rock.com',
    ...
    try:
        return util.post(new_url, raw_data=raw_data, files={'archive': archive_file})

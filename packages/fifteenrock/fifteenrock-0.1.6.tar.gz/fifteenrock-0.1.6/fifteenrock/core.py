...
def deploy(main_file: str, credentials: Dict[str, str], url: str = 'https://www.15rock.com', project: str = None,
           dependencies: List = None, name: str = None, requirements_file: str = None, runtime: str = None,
           runtime_version: str = None, project_folder: str = None):
    '''
    ...
    requirements_file = requirements_file or util.make_requirements_file()
    ...
    try:
        return util.post(new_url, raw_data=raw_data, files={'archive': archive_file}).text
...
if __name__ == '__main__':
    ...
    print(deploy(main_path, {'user_name': 'rajiv'}, url=url))
    pass

...
import src.EMDAT.Recording
import src.EMDAT.params as params
from src.EMDAT.Participant import *
from src.EMDAT.AOI import AOI
from src.EMDAT.Scene import Scene
...
class BasicParticipant(Participant):
    ...
    def __init__(self, pid, eventfile, datafile, fixfile, segfile, log_time_offset = None, aoifile = None, prune_length= None, 
        ...
        self.features={}
        rec = Recording.Recording(datafile, datafile, params.MEDIA_OFFSET)
        print("Done!")

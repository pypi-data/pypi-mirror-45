...
from twc.widgets import AgendaView, Tabline, CommandLine
...
class LayoutController:
    ...
    def _make_layout(self):
        ...
        self.agendaview.reset_agenda(next(iter(self.cfg.agendas)))

        split = HSplit([self.tabline, self.agendaview, self.commandline])
        compl_menu = Float(
            xcursor=True,
            ycursor=True,

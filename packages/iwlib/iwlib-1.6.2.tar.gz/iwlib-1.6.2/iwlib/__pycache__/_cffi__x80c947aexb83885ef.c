...
PyMODINIT_FUNC
PyInit__cffi__x80c947aexb83885ef(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x80c947aexb83885ef(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x80c947aexb83885ef", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;

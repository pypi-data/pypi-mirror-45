...
_cffi_layout_struct_wireless_config(PyObject *self, PyObject *noarg)
{
  ...
  static Py_ssize_t nums[] = {
    ...
    0,  /* char[] */
    offsetof(struct wireless_config, key_size),
    sizeof(((struct wireless_config *)0)->key_size),
    offsetof(struct wireless_config, key_flags),
    sizeof(((struct wireless_config *)0)->key_flags),
    offsetof(struct wireless_config, has_key),
    sizeof(((struct wireless_config *)0)->has_key),
    offsetof(struct wireless_config, has_essid),
    sizeof(((struct wireless_config *)0)->has_essid),
    offsetof(struct wireless_config, cool_field),
    sizeof(((struct wireless_config *)0)->cool_field),
    -1
  };
  (void)self; /* unused */
  (void)noarg; /* unused */
...
PyMODINIT_FUNC
PyInit__cffi__x5d62b64dx76469d20(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x5d62b64dx76469d20(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x5d62b64dx76469d20", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;

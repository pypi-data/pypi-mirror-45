...
class Ui_LogicSettingsWindow(object):
    def setupUi(self, LogicSettingsWindow):
        ...
        self.trick_level_layout = QtWidgets.QVBoxLayout(self.trick_level_tab)
        self.trick_level_layout.setObjectName("trick_level_layout")
        self.logic_description_label = QtWidgets.QLabel(self.trick_level_tab)
        ...
        self.logic_combo_box = QtWidgets.QComboBox(self.trick_level_tab)
        ...
        self.logic_level_label = QtWidgets.QLabel(self.trick_level_tab)
        ...
        self.translators_scroll_contents.setGeometry(QtCore.QRect(0, 0, 479, 318))

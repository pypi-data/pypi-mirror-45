...
class TestNLStatements(unittest.TestCase):
    ...
    def test_r1_picks_cube_one(self):
        statements = [
            ...
            ("cs", "pokud robot R1 zvedne kostičku 1"),
            ("cs", "pokud robot R1 zvedne kostičku jedna"),
            ("cs", "pokud robot R1 zvedne kostičku číslo 1"),
        ]
...
if __name__ == '__main__':
    unittest.TestCase.host = "host.docker.internal"

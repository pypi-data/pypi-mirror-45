...
class Parser:
    ...
    def parseScenario(self, nlBatch: SignalBatch, lineNumber: int, textlines: list):
        ...
        if scenarioName:
            ...
            logging.warning(
                "Missing name for a scenario on line {}, using random name".format(
                    lineNumber), extra={"type": logging_types.W_GENERAL_ERROR, "phrase" : line})
    ...
    def parseScenarioSection(self, lineNumber: int, textlines: list, section: str):
        ...
        if section == g.GIVEN:
            ...
            logging.warning(
                "Unknown section '{}' encountered on line {}".format(section, lineNumber),

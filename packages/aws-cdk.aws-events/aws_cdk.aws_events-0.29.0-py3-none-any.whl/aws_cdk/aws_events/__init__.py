...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-events", "0.29.0", __name__, "aws-events@0.29.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-events.EventRuleImportProps", jsii_struct_bases=[])
...
class EventRule(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-events.EventRule"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, event_rule_arn: str) -> "IEventRule":
        ...
        Arguments:
            ...
            id: -
            props: -
            eventRuleArn: The value of the event rule Amazon Resource Name (ARN), such as arn:aws:events:us-east-2:123456789012:rule/example.
        """

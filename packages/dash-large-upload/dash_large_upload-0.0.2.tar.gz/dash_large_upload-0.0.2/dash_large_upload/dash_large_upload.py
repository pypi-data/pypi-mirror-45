...
class dash_large_upload(Component):
    """A dash_large_upload component.
...
- value (string; optional): The value displayed in the input"""
    ...
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, **kwargs):
        ...
        self._type = 'dash_large_upload'
        self._namespace = 'dash_large_upload'
        ...
        super(dash_large_upload, self).__init__(**args)

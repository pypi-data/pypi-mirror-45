...
id = "bf380d037a4487c2dfdc7244e8c06ffaea735873"
date = "2019-04-29 18:12:32 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "bf380d037a4487c2dfdc7244e8c06ffaea735873":
        return
    msg = "Program id (bf380d037a4487c2dfdc7244e8c06ffaea735873) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":

...
id = "9288744c80a5fab6708a2fda9c05e7aca15ec5a4"
date = "2019-04-15 22:02:15 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "9288744c80a5fab6708a2fda9c05e7aca15ec5a4":
        return
    msg = "Program id (9288744c80a5fab6708a2fda9c05e7aca15ec5a4) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":

...
ktdk.suite.require_that(ExistFiles('main.c', source='submission'))
ktdk.suite.require_that(ExistFiles('CMakeLists.txt', source='submission'))
ktdk.suite.add_task(CopyFiles('*.c', source='submission'))
ktdk.suite.add_task(CopyFiles('CMakeLists.txt', source='submission'))
ktdk.suite.require_that(ExistFiles('CMakeLists.txt', source='workspace'))
ktdk.suite.require_that(ExistFiles('main.c', source='workspace'))

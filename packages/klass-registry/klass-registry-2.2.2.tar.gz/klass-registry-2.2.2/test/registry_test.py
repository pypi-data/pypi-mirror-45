...
from klass_registry.registry import (ClassRegistry, RegistryKeyError, SortedClassRegistry)
...
class SortedClassRegistryTestCase(TestCase):
    def test_sort_key(self):
        ...
        """
        registry = SortedClassRegistry(attr_name='element', sort_key='weight')
    ...
    def test_sort_key_reverse(self):
        ...
        """
        registry = SortedClassRegistry(attr_name='element', sort_key='weight', reverse=True)
    ...
    def test_cmp_to_key(self):
        ...
        registry = SortedClassRegistry(attr_name='element', sort_key=cmp_to_key(compare_pokemon))

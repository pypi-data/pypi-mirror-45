...
# Set to False If you would like to leave debug printing on
SWITCH_OFF_DEBUG_PRINT = True
...
def switch_off_debug_print():
    ...
    debug_print_var_name = "DEBUG_PRINT"
    ...
    if debug_print_file_exists:
        try:
            true_string = "{debug_print_var} = True".format(debug_print_var=debug_print_var_name)
            false_string = "{debug_print_var} = False".format(debug_print_var=debug_print_var_name)
            inplace_change(file_path=debug_print_file_path,

...
from azureml.explain.model._internal.constants import ExplainParams, ExplainType, ModelTask, \
    ShapValuesOutput, LoggingNamespace, MimicSerializationConstants
import logging
import json
...
class MimicExplainer(BlackBoxExplainer):
    ...
    def __init__(self, model, initialization_examples, explainable_model, explainable_model_args={},
        ...
        # TODO: Add a property to explainable models to indicate whether this is a tree-based model
        if issubclass(explainable_model, LGBMExplainableModel):

...
class AudioOutputStream(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        create_pull_stream = staticmethod(_speech_py_impl.AudioOutputStream_create_pull_stream)
    else:
        create_pull_stream = _speech_py_impl.AudioOutputStream_create_pull_stream
    if _newclass:
        create_push_stream = staticmethod(_speech_py_impl.AudioOutputStream_create_push_stream)
    else:
        create_push_stream = _speech_py_impl.AudioOutputStream_create_push_stream
...
def AudioOutputStream_create_pull_stream(*args)                                                                                           :
    return _speech_py_impl.AudioOutputStream_create_pull_stream(*args)
AudioOutputStream_create_pull_stream = _speech_py_impl.AudioOutputStream_create_pull_stream

def AudioOutputStream_create_push_stream(*args)                                                                                           :
    return _speech_py_impl.AudioOutputStream_create_push_stream(*args)
AudioOutputStream_create_push_stream = _speech_py_impl.AudioOutputStream_create_push_stream
...
class PullAudioOutputStream(AudioOutputStream):
    ...
    def read(self, buffer             , bufferSize            )              :
        return _speech_py_impl.PullAudioOutputStream_read(self, buffer, bufferSize)
...
def PullAudioOutputStream_create(*args)                                                                                           :
    return _speech_py_impl.PullAudioOutputStream_create(*args)
...
def PushAudioOutputStream_create(*args)                                                                                           :
    return _speech_py_impl.PushAudioOutputStream_create(*args)
...
class AudioConfig(_object):
    ...
    if _newclass:
        from_default_speaker_output = staticmethod(_speech_py_impl.AudioConfig_from_default_speaker_output)
    else:
        from_default_speaker_output = _speech_py_impl.AudioConfig_from_default_speaker_output
    if _newclass:
        from_wav_file_output = staticmethod(_speech_py_impl.AudioConfig_from_wav_file_output)
    else:
        from_wav_file_output = _speech_py_impl.AudioConfig_from_wav_file_output
    if _newclass:
        from_stream_output = staticmethod(_speech_py_impl.AudioConfig_from_stream_output)
    else:
        from_stream_output = _speech_py_impl.AudioConfig_from_stream_output
...
def AudioConfig_from_default_speaker_output()                                                                                 :
    return _speech_py_impl.AudioConfig_from_default_speaker_output()
AudioConfig_from_default_speaker_output = _speech_py_impl.AudioConfig_from_default_speaker_output

def AudioConfig_from_wav_file_output(fileName                       )                                                                                 :
    return _speech_py_impl.AudioConfig_from_wav_file_output(fileName)
AudioConfig_from_wav_file_output = _speech_py_impl.AudioConfig_from_wav_file_output

def AudioConfig_from_stream_output(stream                                                                                     )                                                                                 :
    return _speech_py_impl.AudioConfig_from_stream_output(stream)
AudioConfig_from_stream_output = _speech_py_impl.AudioConfig_from_stream_output
...
class SpeechSynthesisResult(_object):
    ...
    def __init__(self, hresult                   ):
        this = _speech_py_impl.new_SpeechSynthesisResult(hresult)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def get_audio_data(self)                                                                         :
        return _speech_py_impl.SpeechSynthesisResult_get_audio_data(self)
...
class AudioDataStream(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        from_result = staticmethod(_speech_py_impl.AudioDataStream_from_result)
    else:
        from_result = _speech_py_impl.AudioDataStream_from_result

    def get_status(self)                                                        :
        return _speech_py_impl.AudioDataStream_get_status(self)

    def can_read_data(self, *args)          :
        return _speech_py_impl.AudioDataStream_can_read_data(self, *args)

    def read_data(self, *args)              :
        return _speech_py_impl.AudioDataStream_read_data(self, *args)
...
def AudioDataStream_from_result(result                                                                                  )                                                                              :
    return _speech_py_impl.AudioDataStream_from_result(result)
AudioDataStream_from_result = _speech_py_impl.AudioDataStream_from_result
...
class SpeechSynthesisCancellationDetails(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        from_result = staticmethod(_speech_py_impl.SpeechSynthesisCancellationDetails_from_result)
    else:
        from_result = _speech_py_impl.SpeechSynthesisCancellationDetails_from_result
    if _newclass:
        from_stream = staticmethod(_speech_py_impl.SpeechSynthesisCancellationDetails_from_stream)
    else:
        from_stream = _speech_py_impl.SpeechSynthesisCancellationDetails_from_stream
...
def SpeechSynthesisCancellationDetails_from_result(result                                                                                  )                                                                                                 :
    return _speech_py_impl.SpeechSynthesisCancellationDetails_from_result(result)
SpeechSynthesisCancellationDetails_from_result = _speech_py_impl.SpeechSynthesisCancellationDetails_from_result

def SpeechSynthesisCancellationDetails_from_stream(stream                                                                            )                                                                                                 :
    return _speech_py_impl.SpeechSynthesisCancellationDetails_from_stream(stream)
SpeechSynthesisCancellationDetails_from_stream = _speech_py_impl.SpeechSynthesisCancellationDetails_from_stream
...
class SpeechSynthesisEventArgs(EventArgs):
    ...
    def __init__(self, hevent                  ):
        this = _speech_py_impl.new_SpeechSynthesisEventArgs(hevent)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class SpeechSynthesizer(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        from_config = staticmethod(_speech_py_impl.SpeechSynthesizer_from_config)
    else:
        from_config = _speech_py_impl.SpeechSynthesizer_from_config
...
def SpeechSynthesizer_from_config(*args)                                                                                :
    return _speech_py_impl.SpeechSynthesizer_from_config(*args)
SpeechSynthesizer_from_config = _speech_py_impl.SpeechSynthesizer_from_config

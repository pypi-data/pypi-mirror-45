...
setup(
    ...
    url='https://github.com/soodoku/incline',
    ...
    keywords='time-series derivative slope',
    ...
    # In this case, 'packagename' will be installed into '<sys.prefix>/packagename'

    #data_files=[('packagename', ['packagename/data/test.txt'])],

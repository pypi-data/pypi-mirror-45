...
def make_pipeline(phase_folders=None, tag_phases=True, rows=None, mask_function=msk.Mask.empty_for_shape,
    ...
    phase2 = SerialPhase(phase_name='phase_2_serial_x3_species_initialize', phase_folders=phase_folders,
                         tag_phases=tag_phases,
                         serial_species=[prior_model.PriorModel(arctic_params.Species),
    ...
    class SerialHyperModelFixedPhase(ph.SerialHyperPhase):
        ...
        def pass_priors(self, results):
            ...
            self.serial_species = results.from_phase('phase_2_serial_x3_species_initialize').constant.serial_species
            self.serial_ccd = results.from_phase('phase_2_serial_x3_species_initialize').constant.serial_ccd
    ...
    class SerialHyperFixedPhase(ph.SerialHyperPhase):
        ...
        def pass_priors(self, results):
            ...
            self.serial_species = results.from_phase('phase_2_serial_x3_species_initialize').variable.serial_species
            self.serial_ccd = results.from_phase('phase_2_serial_x3_species_initialize').variable.serial_ccd
            self.serial_ccd.well_fill_alpha = 1.0
            self.serial_ccd.well_fill_gamma = 0.0

    phase4 = SerialHyperFixedPhase(phase_name='phase_4_serial_x3_species', phase_folders=phase_folders,
                                   tag_phases=tag_phases,
                                   serial_species=[prior_model.PriorModel(arctic_params.Species),
                                                   prior_model.PriorModel(arctic_params.Species),
                                                   prior_model.PriorModel(arctic_params.Species)],

...
ci_data_model = 'parallel_x3_species_poisson'
...
from workspace_jam.pipelines import parallel_x3_species

pipeline = parallel_x3_species.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],

...
cosma_path = '/cosma5/data/autocti/'
...
ci_data_model = 'serial_x2_species'
...
from workspace_jam.pipelines import serial_x2_species

pipeline = serial_x2_species.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],

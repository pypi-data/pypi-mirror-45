...
from workspace_jam.pipelines.initialize import serial_x2

pipeline_initialize = serial_x2.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
...
from workspace_jam.pipelines.normal.from_initialize import serial_x2

pipeline_normal = serial_x2.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
                                           mask_function=mask_function_for_bug, cosmic_ray_parallel_buffer=10,
                                           cosmic_ray_serial_buffer=10, cosmic_ray_diagonal_buffer=3)

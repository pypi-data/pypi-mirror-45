...
ci_data_model = 'parallel_x2_species' # Shows the data was creating using a parallel CTI model with one species.
...
if ci_data_resolution in 'high_res':
    shape = (2316, 2119)
...
def mask_function_for_bug(shape, frame_geometry):
    return msk.Mask.from_masked_regions(shape=shape, frame_geometry=frame_geometry,
                                        masked_regions=[(0, 330, 0, shape[1])])

...
def make_pipeline(phase_folders=None, tag_phases=True, columns=None, mask_function=msk.Mask.empty_for_shape,
    ...
    phase2 = ParallelPhase(phase_name='phase_2_parallel_x3_species_initialize', phase_folders=phase_folders,
                           tag_phases=tag_phases,
                           parallel_species=[prior_model.PriorModel(arctic_params.Species),
    ...
    class ParallelHyperModelFixedPhase(ph.ParallelHyperPhase):
        ...
        def pass_priors(self, results):
            ...
            self.parallel_species = results.from_phase('phase_2_parallel_x3_species_initialize').constant.parallel_species
            self.parallel_ccd = results.from_phase('phase_2_parallel_x3_species_initialize').constant.parallel_ccd
    ...
    class ParallelHyperFixedPhase(ph.ParallelHyperPhase):
        ...
        def pass_priors(self, results):
            ...
            self.parallel_species = results.from_phase('phase_2_parallel_x3_species_initialize').variable.parallel_species
            self.parallel_ccd = results.from_phase('phase_2_parallel_x3_species_initialize').variable.parallel_ccd
            self.parallel_ccd.well_fill_alpha = 1.0
            self.parallel_ccd.well_fill_gamma = 0.0

    phase4 = ParallelHyperFixedPhase(phase_name='phase_4_parallel_x3_species', phase_folders=phase_folders,
                                     tag_phases=tag_phases,
                                     parallel_species=[prior_model.PriorModel(arctic_params.Species),
                                                       prior_model.PriorModel(arctic_params.Species),
                                                       prior_model.PriorModel(arctic_params.Species)],

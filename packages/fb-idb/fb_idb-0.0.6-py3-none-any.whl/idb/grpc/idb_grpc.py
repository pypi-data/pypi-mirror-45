...
class CompanionServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def accessibility_info(self, stream):
        pass

    @abc.abstractmethod
    async def add_media(self, stream):
        pass

    @abc.abstractmethod
    async def approve(self, stream):
        pass

    @abc.abstractmethod
    async def boot(self, stream):
        pass

    @abc.abstractmethod
    async def clear_keychain(self, stream):
        pass
    ...
    @abc.abstractmethod
    async def contacts_update(self, stream):
        pass

    @abc.abstractmethod
    async def crash_delete(self, stream):
        pass

    @abc.abstractmethod
    async def crash_list(self, stream):
        pass

    @abc.abstractmethod
    async def crash_show(self, stream):
        pass

    @abc.abstractmethod
    async def debugserver(self, stream):
        pass

    @abc.abstractmethod
    async def describe(self, stream):
        pass
    ...
    @abc.abstractmethod
    async def focus(self, stream):
        pass

    @abc.abstractmethod
    async def hid(self, stream):
        pass

    @abc.abstractmethod
    async def install(self, stream):
        pass

    @abc.abstractmethod
    async def instruments_run(self, stream):
        pass

    @abc.abstractmethod
    async def launch(self, stream):
        pass

    @abc.abstractmethod
    async def list_apps(self, stream):
        pass

    @abc.abstractmethod
    async def list_targets(self, stream):
        pass

    @abc.abstractmethod
    async def log(self, stream):
        pass

    @abc.abstractmethod
    async def ls(self, stream):
        pass

    @abc.abstractmethod
    async def mkdir(self, stream):
        pass

    @abc.abstractmethod
    async def mv(self, stream):
        pass

    @abc.abstractmethod
    async def open_url(self, stream):
        pass
    ...
    @abc.abstractmethod
    async def rm(self, stream):
        pass

    @abc.abstractmethod
    async def screenshot(self, stream):
        pass

    @abc.abstractmethod
    async def set_location(self, stream):
        pass

    @abc.abstractmethod
    async def terminate(self, stream):
        pass

    @abc.abstractmethod
    async def uninstall(self, stream):
        pass

    @abc.abstractmethod
    async def xctest_list_bundles(self, stream):
        pass

    @abc.abstractmethod
    async def xctest_list_tests(self, stream):
        pass

    @abc.abstractmethod
    async def xctest_run(self, stream):
        pass
...
class CompanionServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.install = grpclib.client.StreamUnaryMethod(
            channel,

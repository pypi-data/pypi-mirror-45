...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-iam", "0.29.0", __name__, "aws-iam@0.29.0.jsii.tgz")
...
class IIdentity(IPrincipal, aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def attach_inline_policy(self, policy: "Policy") -> None:
        ...
        Arguments:
            policy: The policy resource to attach to this principal.
        """
        ...
...
class Group(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Group"):
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, group_name: typing.Optional[str]=None, managed_policy_arns: typing.Optional[typing.List[typing.Any]]=None, path: typing.Optional[str]=None) -> None:
        ...
        Arguments:
            ...
            path: The path to the group. For more information about paths, see `IAM Identifiers <http://docs.aws.amazon.com/IAM/latest/UserGuide/index.html?Using_Identifiers.html>`_ in the IAM User Guide.
        """
        props: GroupProps = {}
...
class PolicyDocument(aws_cdk.cdk.Token, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PolicyDocument"):
    ...
    def post_process(self, input: typing.Any, *, prefix: typing.List[str], scope: aws_cdk.cdk.IConstruct) -> typing.Any:
...
class PolicyProps(jsii.compat.TypedDict, total=False):
    ...
    Default:
        Uses the logical ID of the policy resource, which is ensured to
...
class Role(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Role"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, role_arn: str, role_id: typing.Optional[str]=None) -> "IRole":
        ...
        Arguments:
            ...
            id: -
            props: -
            roleArn: The role's ARN.
            roleId: The stable and unique string identifying the role. For example, AIDAJQABLZS4A3QDU576Q. Default: If "roleId" is not specified for an imported role, then ``role.roleId`` will throw an exception. In most cases, role ID is not really needed.
        """
...
class _RoleImportProps(jsii.compat.TypedDict, total=False):
    ...
    Default:
        If "roleId" is not specified for an imported role, then
        ``role.roleId`` will throw an exception. In most cases, role ID is not really needed.
    """

@jsii.data_type(jsii_type="@aws-cdk/aws-iam.RoleImportProps", jsii_struct_bases=[_RoleImportProps])

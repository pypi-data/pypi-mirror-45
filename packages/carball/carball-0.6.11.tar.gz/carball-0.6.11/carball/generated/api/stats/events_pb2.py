...
_BOOSTPICKUP = _descriptor.Descriptor(
  name='BoostPickup',
  full_name='api.stats.BoostPickup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='frame_number', full_name='api.stats.BoostPickup.frame_number', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='player_id', full_name='api.stats.BoostPickup.player_id', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='boost_type', full_name='api.stats.BoostPickup.boost_type', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='x', full_name='api.stats.BoostPickup.x', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='y', full_name='api.stats.BoostPickup.y', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BOOSTPICKUP.fields_by_name['player_id'].message_type = player_id_pb2._PLAYERID
...
BoostPickup = _reflection.GeneratedProtocolMessageType('BoostPickup', (_message.Message,), dict(
  DESCRIPTOR = _BOOSTPICKUP,
  __module__ = 'api.stats.events_pb2'
  # @@protoc_insertion_point(class_scope:api.stats.BoostPickup)
  ))

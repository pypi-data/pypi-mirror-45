...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancing", "0.29.0", __name__, "aws-elasticloadbalancing@0.29.0.jsii.tgz")
...
class LoadBalancer(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancing.LoadBalancer"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, vpc: aws_cdk.aws_ec2.IVpcNetwork, health_check: typing.Optional["HealthCheck"]=None, internet_facing: typing.Optional[bool]=None, listeners: typing.Optional[typing.List["LoadBalancerListener"]]=None, targets: typing.Optional[typing.List["ILoadBalancerTarget"]]=None) -> None:
        ...
        Arguments:
            ...
            healthCheck: Health check settings for the load balancing targets. Not required but recommended.
            ...
            listeners: What listeners to set up for the load balancer. Can also be added by .addListener()
            targets: What targets to load balance to. Can also be added by .addTarget()
        """

...
class HTMLReport(object):
    ...
    def patch_click(self):
        ...
        self._patch_class_func(muiautomator.Session, 'click', _mock_click)
        self._patch_class_func(muiautomator.Session, 'long_click',
                               _mock_long_click)
    ...
    def unpatch_click(self):
        ...
        """
        self._unpatch_func(muiautomator.Session, 'click')
        self._unpatch_func(muiautomator.Session, 'long_click')
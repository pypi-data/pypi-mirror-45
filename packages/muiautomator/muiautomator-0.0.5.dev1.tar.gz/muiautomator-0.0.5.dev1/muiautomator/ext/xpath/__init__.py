...
import muiautomator
from muiautomator.utils import U
...
def init():
    muiautomator.plugin_register("xpath", XPath)
...
if __name__ == "__main__":
    init()
    import muiautomator.ext.htmlreport as htmlreport

    d = muiautomator.connect()

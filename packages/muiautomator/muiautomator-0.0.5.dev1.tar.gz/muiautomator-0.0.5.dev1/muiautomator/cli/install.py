...
#     d = muiautomator.connect(self._device_url)
#     print(d.info, dst)
...
#         u = muiautomator.connect_wifi(self._device_url)
...
def pkgserv_addr(device_url):
    ...
    d = muiautomator.connect(device_url)
...
def main():
    ...
    # command line
    # python -m muiautomator.cli install 10.240.174.43 http://arch.s3.netease.com/hzdev-appci/h35_trunk_RelWithDebInfo_373397.apk -s http://wifiphone.nie.netease.com

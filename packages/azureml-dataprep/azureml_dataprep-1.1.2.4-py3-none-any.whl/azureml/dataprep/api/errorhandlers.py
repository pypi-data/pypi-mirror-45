...
class PandasImportError(Exception):
    ...
    """
    def __init__(self):
        super().__init__('Could not import pandas. Ensure a compatible version is installed by running: pip install azureml-dataprep[pandas]')
...
class NumpyImportError(Exception):
    ...
    """
    def __init__(self):
        super().__init__('Could not import numpy. Ensure a compatible version is installed by running: pip install azureml-dataprep[pandas]')

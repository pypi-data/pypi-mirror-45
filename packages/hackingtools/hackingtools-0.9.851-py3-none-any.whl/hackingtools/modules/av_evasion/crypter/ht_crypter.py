...
class StartModule():
	...
	def getRandomKeypair(self):
		...
		while prime_a == prime_b:
			while prime_a == '':
				num = random.randint(random.randint(0,40),random.randint(40,80))*random.randint(1,10) ** 12
				if self.__is_prime__(num):
					prime_a = num
			while prime_b == '':
				num = random.randint(random.randint(40,80),random.randint(80,120))*random.randint(1,10) ** 12
				if self.__is_prime__(num):
					prime_b = num

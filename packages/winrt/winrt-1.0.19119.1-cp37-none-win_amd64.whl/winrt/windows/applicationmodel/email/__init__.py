# WARNING: Please don't edit this file. It was generated by Python/WinRT v0.9.190429.1

import typing, winrt
import enum

_ns_module = winrt._import_ns_module("Windows.ApplicationModel.Email")
...
EmailAttachment = _ns_module.EmailAttachment
EmailConversation = _ns_module.EmailConversation
EmailConversationBatch = _ns_module.EmailConversationBatch
EmailConversationReader = _ns_module.EmailConversationReader
EmailFolder = _ns_module.EmailFolder
EmailIrmInfo = _ns_module.EmailIrmInfo
EmailIrmTemplate = _ns_module.EmailIrmTemplate
EmailItemCounts = _ns_module.EmailItemCounts
EmailMailbox = _ns_module.EmailMailbox
EmailMailboxAction = _ns_module.EmailMailboxAction
EmailMailboxAutoReply = _ns_module.EmailMailboxAutoReply
EmailMailboxAutoReplySettings = _ns_module.EmailMailboxAutoReplySettings
EmailMailboxCapabilities = _ns_module.EmailMailboxCapabilities
EmailMailboxChange = _ns_module.EmailMailboxChange
EmailMailboxChangeReader = _ns_module.EmailMailboxChangeReader
EmailMailboxChangeTracker = _ns_module.EmailMailboxChangeTracker
EmailMailboxChangedDeferral = _ns_module.EmailMailboxChangedDeferral
EmailMailboxChangedEventArgs = _ns_module.EmailMailboxChangedEventArgs
EmailMailboxCreateFolderResult = _ns_module.EmailMailboxCreateFolderResult
EmailMailboxPolicies = _ns_module.EmailMailboxPolicies
EmailMailboxSyncManager = _ns_module.EmailMailboxSyncManager
EmailManager = _ns_module.EmailManager
EmailManagerForUser = _ns_module.EmailManagerForUser
EmailMeetingInfo = _ns_module.EmailMeetingInfo
EmailMessage = _ns_module.EmailMessage
EmailMessageBatch = _ns_module.EmailMessageBatch
EmailMessageReader = _ns_module.EmailMessageReader
EmailQueryOptions = _ns_module.EmailQueryOptions
EmailQueryTextSearch = _ns_module.EmailQueryTextSearch
EmailRecipient = _ns_module.EmailRecipient
EmailRecipientResolutionResult = _ns_module.EmailRecipientResolutionResult
EmailStore = _ns_module.EmailStore
EmailStoreNotificationTriggerDetails = _ns_module.EmailStoreNotificationTriggerDetails

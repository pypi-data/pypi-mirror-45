...
class yc_ipAddress_vlan_schema__VLAN_IP_ipAddress(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vlan_schema - based on the path /VLAN_IP/ipAddress. Each member element of
...
class yc_VLAN_IP_vlan_schema__VLAN_IP(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vlan_schema - based on the path /VLAN_IP. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__vlan_name','__ipAddress',)
  ...
  def _get_vlan_name(self):
    """
    Getter method for vlan_name, mapped from YANG variable /VLAN_IP/vlan_name (leafref)
    """
    return self.__vlan_name
      
  def _set_vlan_name(self, v, load=False):
    """
    Setter method for vlan_name, mapped from YANG variable /VLAN_IP/vlan_name (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _set_ipAddress(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_ipAddress_vlan_schema__VLAN_IP_ipAddress, is_container='container', yang_name="ipAddress", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipAddress must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_ipAddress_vlan_schema__VLAN_IP_ipAddress, is_container='container', yang_name="ipAddress", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = OrderedDict([('vlan_name', vlan_name), ('ipAddress', ipAddress), ])


class yc_VLAN_vlan_schema__VLAN(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vlan_schema - based on the path /VLAN. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__description = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="description", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    self.__ipv6Address = YANGDynClass(unique=True, base=TypedListType(allowed_type=RestrictedClassType(base_type=six.text_type, restriction_dict={u'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(/(([0-9])|([0-9]{2})|(1[0-1][0-9])|(12[0-8])))'})), is_leaf=False, yang_name="ipv6Address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='inet:ipv6-prefix', is_config=True)
    self.__aclIn = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="aclIn", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    self.__name__ = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="name__", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    self.__aclOut = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="aclOut", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    self.__mtu = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={u'range': [u'64 .. 9216']}), is_leaf=True, yang_name="mtu", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='mtu', is_config=True)
    self.__dhcpSever = YANGDynClass(unique=True, base=TypedListType(allowed_type=[RestrictedClassType(base_type=six.text_type, restriction_dict={u'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}),RestrictedClassType(base_type=six.text_type, restriction_dict={u'pattern': u'((:|[0-9a-f]{0,4}):)([0-9a-f]{0,4}:){0,5}((([0-9a-f]{0,4}:)?(:|[0-9a-f]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}),]), is_leaf=False, yang_name="dhcpSever", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='inet:ip-address', is_config=True)
    self.__vrf = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="vrf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    self.__arpProxy = YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={u'down': {}, u'up': {}},), is_leaf=True, yang_name="arpProxy", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='common:status', is_config=True)
  ...
  def _set_name__(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="name__", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name__ must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="name__", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)""",
        })
  ...
  def _get_ipv4Address(self):
    """
    Getter method for ipv4Address, mapped from YANG variable /VLAN/ipv4Address (inet:ipv4-prefix)
    """
    return self.__ipv4Address
      
  def _set_ipv4Address(self, v, load=False):
    """
    Setter method for ipv4Address, mapped from YANG variable /VLAN/ipv4Address (inet:ipv4-prefix)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv4Address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv4Address() directly.
  ...
  def _get_ipv6Address(self):
    """
    Getter method for ipv6Address, mapped from YANG variable /VLAN/ipv6Address (inet:ipv6-prefix)
    """
    return self.__ipv6Address
      
  def _set_ipv6Address(self, v, load=False):
    """
    Setter method for ipv6Address, mapped from YANG variable /VLAN/ipv6Address (inet:ipv6-prefix)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv6Address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv6Address() directly.
  ...
  def _get_ipv6Linklocal(self):
    """
    Getter method for ipv6Linklocal, mapped from YANG variable /VLAN/ipv6Linklocal (inet:ipv6-prefix)
    """
    return self.__ipv6Linklocal
      
  def _set_ipv6Linklocal(self, v, load=False):
    """
    Setter method for ipv6Linklocal, mapped from YANG variable /VLAN/ipv6Linklocal (inet:ipv6-prefix)
    If this variable is read-only (config: false) in the
  ...
  def _get_vrf(self):
    """
    Getter method for vrf, mapped from YANG variable /VLAN/vrf (string)
    """
    return self.__vrf
      
  def _set_vrf(self, v, load=False):
    """
    Setter method for vrf, mapped from YANG variable /VLAN/vrf (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="vrf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vrf must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="vrf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)""",
        })
  ...
  def _get_adminStatus(self):
    """
    Getter method for adminStatus, mapped from YANG variable /VLAN/adminStatus (common:status)
    """
    return self.__adminStatus
      
  def _set_adminStatus(self, v, load=False):
    """
    Setter method for adminStatus, mapped from YANG variable /VLAN/adminStatus (common:status)
    If this variable is read-only (config: false) in the
  ...
  def _get_aclIn(self):
    """
    Getter method for aclIn, mapped from YANG variable /VLAN/aclIn (string)
    """
    return self.__aclIn
      
  def _set_aclIn(self, v, load=False):
    """
    Setter method for aclIn, mapped from YANG variable /VLAN/aclIn (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="aclIn", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """aclIn must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="aclIn", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)""",
        })
  ...
  def _get_aclOut(self):
    """
    Getter method for aclOut, mapped from YANG variable /VLAN/aclOut (string)
    """
    return self.__aclOut
      
  def _set_aclOut(self, v, load=False):
    """
    Setter method for aclOut, mapped from YANG variable /VLAN/aclOut (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="aclOut", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """aclOut must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="aclOut", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)""",
        })
  ...
  def _get_mtu(self):
    """
    Getter method for mtu, mapped from YANG variable /VLAN/mtu (mtu)
    """
    return self.__mtu
      
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /VLAN/mtu (mtu)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={u'range': [u'64 .. 9216']}), is_leaf=True, yang_name="mtu", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='mtu', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mtu must be of a type compatible with mtu""",
          'defined-type': "vlan_schema:mtu",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={u'range': [u'64 .. 9216']}), is_leaf=True, yang_name="mtu", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='mtu', is_config=True)""",
        })
  ...
  def _get_arpProxy(self):
    """
    Getter method for arpProxy, mapped from YANG variable /VLAN/arpProxy (common:status)
    """
    return self.__arpProxy
      
  def _set_arpProxy(self, v, load=False):
    """
    Setter method for arpProxy, mapped from YANG variable /VLAN/arpProxy (common:status)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """arpProxy must be of a type compatible with common:status""",
          'defined-type': "common:status",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={u'down': {}, u'up': {}},), is_leaf=True, yang_name="arpProxy", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='common:status', is_config=True)""",
        })
  ...
  def _set_description(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="description", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """description must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="description", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/vlan', defining_module='vlan_schema', yang_type='string', is_config=True)""",
        })
  ...
  def _get_dhcpRelaySrcIP(self):
    """
    Getter method for dhcpRelaySrcIP, mapped from YANG variable /VLAN/dhcpRelaySrcIP (inet:ip-address)
    """
    return self.__dhcpRelaySrcIP
      
  def _set_dhcpRelaySrcIP(self, v, load=False):
    """
    Setter method for dhcpRelaySrcIP, mapped from YANG variable /VLAN/dhcpRelaySrcIP (inet:ip-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_dhcpSever(self):
    """
    Getter method for dhcpSever, mapped from YANG variable /VLAN/dhcpSever (inet:ip-address)
    """
    return self.__dhcpSever
      
  def _set_dhcpSever(self, v, load=False):
    """
    Setter method for dhcpSever, mapped from YANG variable /VLAN/dhcpSever (inet:ip-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_ndpProxy(self):
    """
    Getter method for ndpProxy, mapped from YANG variable /VLAN/ndpProxy (common:enable-status)
    """
    return self.__ndpProxy
      
  def _set_ndpProxy(self, v, load=False):
    """
    Setter method for ndpProxy, mapped from YANG variable /VLAN/ndpProxy (common:enable-status)
    If this variable is read-only (config: false) in the
...
class vlan_schema(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vlan_schema - based on the path /vlan_schema. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__VLAN_IP','__VLAN',)

  _yang_name = 'vlan_schema'
  ...
  _pyangbind_elements = OrderedDict([('VLAN_IP', VLAN_IP), ('VLAN', VLAN), ])

...
class yc_VLAN_vlan_update_schema__VLAN(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vlan_update_schema - based on the path /VLAN. Each member element of
  ...
  def _get_name__(self):
    """
    Getter method for name__, mapped from YANG variable /VLAN/name__ (leafref)
    """
    return self.__name__
      
  def _set_name__(self, v, load=False):
    """
    Setter method for name__, mapped from YANG variable /VLAN/name__ (leafref)

...
class yc_VLANS_portChannel_add_vlan_schema__PORTCHANNEL_VLAN_VLANS(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module portChannel_add_vlan_schema - based on the path /PORTCHANNEL_VLAN/VLANS. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__vlan_name__ = YANGDynClass(base=ReferenceType(referenced_path='/vlan-schema:VLAN/vlan-schema:name__', caller=self._path() + ['vlan_name__'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="vlan_name__", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://north-api.aliababa.com/schema/portChannel/vlan', defining_module='portChannel_add_vlan_schema', yang_type='leafref', is_config=True)
    self.__taggingMode = YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={u'untagged': {}, u'tagged': {}},), is_leaf=True, yang_name="taggingMode", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://north-api.aliababa.com/schema/portChannel/vlan', defining_module='portChannel_add_vlan_schema', yang_type='common:taggingMode', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'PORTCHANNEL_VLAN', u'VLANS']

  def _get_vlan_name__(self):
    """
    Getter method for vlan_name__, mapped from YANG variable /PORTCHANNEL_VLAN/VLANS/vlan_name__ (leafref)
    """
    return self.__vlan_name__
      
  def _set_vlan_name__(self, v, load=False):
    """
    Setter method for vlan_name__, mapped from YANG variable /PORTCHANNEL_VLAN/VLANS/vlan_name__ (leafref)
  ...
  def _get_taggingMode(self):
    """
    Getter method for taggingMode, mapped from YANG variable /PORTCHANNEL_VLAN/VLANS/taggingMode (common:taggingMode)
    """
    return self.__taggingMode
      
  def _set_taggingMode(self, v, load=False):
    """
    Setter method for taggingMode, mapped from YANG variable /PORTCHANNEL_VLAN/VLANS/taggingMode (common:taggingMode)
    If this variable is read-only (config: false) in the
...
class yc_PORTCHANNEL_VLAN_portChannel_add_vlan_schema__PORTCHANNEL_VLAN(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module portChannel_add_vlan_schema - based on the path /PORTCHANNEL_VLAN. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__name__','__VLANS',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__VLANS = YANGDynClass(base=YANGListType("vlan_name__",yc_VLANS_portChannel_add_vlan_schema__PORTCHANNEL_VLAN_VLANS, yang_name="VLANS", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vlan_name__', extensions=None), is_container='list', yang_name="VLANS", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://north-api.aliababa.com/schema/portChannel/vlan', defining_module='portChannel_add_vlan_schema', yang_type='list', is_config=True)
  ...
  def _get_VLANS(self):
    """
    Getter method for VLANS, mapped from YANG variable /PORTCHANNEL_VLAN/VLANS (list)
    """
    return self.__VLANS
      
  def _set_VLANS(self, v, load=False):
    """
    Setter method for VLANS, mapped from YANG variable /PORTCHANNEL_VLAN/VLANS (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """VLANS must be of a type compatible with list""",
          'defined-type': "list",
  ...
  _pyangbind_elements = OrderedDict([('name__', name__), ('VLANS', VLANS), ])


class portChannel_add_vlan_schema(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module portChannel_add_vlan_schema - based on the path /portChannel_add_vlan_schema. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__PORTCHANNEL_VLAN',)

  _yang_name = 'portChannel_add_vlan_schema'

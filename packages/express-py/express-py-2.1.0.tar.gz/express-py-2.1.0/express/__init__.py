...
if __name__ == "__main__":
    ...
    parser = "espresso"
    property_name = "charge_density_profile"
    work_dir = "/Users/exabyte/Desktop/esm"
    stdout_file = "{}/bands.out".format(work_dir)
    exp = ExPrESS(parser, **dict({"work_dir": work_dir, "stdout_file": stdout_file}))
    print(json.dumps(exp.property(property_name), indent=4))

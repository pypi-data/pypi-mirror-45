...
if __name__ == "__main__":
    ...
    work_dir = "/Users/exabyte/Desktop/elements-order-test"
    stdout_file = "{}/pw-relax.out".format(work_dir)
    exp = ExPrESS(parser, **dict({"work_dir": work_dir, "stdout_file": stdout_file}))
    print(json.dumps(exp.property(property_name, is_final_structure=True), indent=4))

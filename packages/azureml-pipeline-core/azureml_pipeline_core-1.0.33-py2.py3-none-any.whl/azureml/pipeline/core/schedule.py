...
class Schedule(object):
    ...
    Two types of schedules are supported. The first uses a time recurrence to submit a Pipeline on a given schedule.
    The second monitors an Azure Blob Datastore for added or modified blobs and will submit a Pipeline when
    changes are detected. Note: blob additions/modifications in sub-folders are not detected.
    ...
    :param path_on_datastore: Optional. The path on the datastore to monitor for modified/added blobs. If none, the
                              datastore container is monitored.
    ...
    def __init__(self, workspace, id, name, description, pipeline_id, status, recurrence,
        ...
        :type continue_on_step_failure: bool
        :param path_on_datastore: Optional. The path on the datastore to monitor for modified/added blobs. If none, the
                                  datastore container is monitored. Only supported for DataStore schedules.
        :type path_on_datastore: str
        :param _schedule_provider: The schedule provider.
        :type _schedule_provider: _AevaScheduleProvider object
        """

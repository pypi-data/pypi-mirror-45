...
from morm.core  import config_path,test_path,root_path,upcasefirst,Rule,lowcasefirst
from morm.core.dbhelper import DBHelper
from  morm.core.decorator import get_connect_config
import warnings
...
class Gen:
	...
	def _read_config(cls,path=None):
		...
		with open(config_file) as f:
			...
			Gen.log("----------------------")
			Gen.log("---通过配置文件[%s]连接库-----"%config_file)
			Gen.log("----------------------")

...
class PlotCanvas(FigureCanvas):
    ...
    def update_figure(self, init=False):
        ...
        try:
            ...
            df = pd.DataFrame(data_list, columns=("date", "wakeup", "bedtime"))

            # BTSHIFT

            BED_TIME_REFERENCE = '22 h 30 m'

            df["btshift"] = df.bedtime - df.date
            ...
            WAKE_UP_TIME_REFERENCE = '6 h 30 m'

            df["wushift"] = df.wakeup - df.date
            ...
            # set locator
            self.axes.xaxis.set_major_locator(mdates.DayLocator(interval=1))     # TODO: Day
            self.axes.xaxis.set_minor_locator(mdates.HourLocator(interval=1))    # TODO: Month

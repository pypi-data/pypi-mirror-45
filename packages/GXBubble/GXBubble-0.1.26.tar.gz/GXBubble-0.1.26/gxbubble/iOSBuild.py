...
class IOSBuild:
    ...
    def XcodeToIPA(self,p12file_dis,provision_dis,exportOptionPlistPath,iPASavePath,P12PassWord,IPAName,SHA1,ShowLog):
        ...
        # 解锁Keychain
        os.system ('security unlock-keychain -p ztgame@123 /Users/fuhua/Library/Keychains/login.keychain')
        os.system('security list-keychains -s /Users/fuhua/Library/Keychains/login.keychain')
        # 导入证书

        if(p12file_dis != "" ):
            os.system("security import '+ p12File_dis +' -k /Users/fuhua/Library/Keychains/login.keychain -P "+self.p12Password+" -T /usr/bin/codesign")
        ...
        provision_bds_dir = "/Users/fuhua/Library/MobileDevice/Provisioning Profiles/";

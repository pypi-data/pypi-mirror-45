import os
import math
from transcend.coding.codec import H264, Vpx, Vp9, MotionEstimation, BFrames,\
                                   Aac, Opus
from transcend.coding.output import Video, Audio
from transcend.coding import format
from transcend.coding.preset import video
...
class BaseHlsH264(video.h264.BaseH264):
...
class H264xAnyDevice(video.h264.AnyDevice, BaseHlsH264):
...
class H264xAnyDevice360p(video.h264.AnyDevice360p, BaseHlsH264):
...
class H264x360p(video.h264.Main360p, BaseHlsH264):
...
class H264x480p(video.h264.High480p, BaseHlsH264):
...
class H264x576p(video.h264.High576p, BaseHlsH264):
...
class H264x720p(video.h264.High720p, BaseHlsH264):
...
class H264x1080p(video.h264.High1080p, BaseHlsH264):

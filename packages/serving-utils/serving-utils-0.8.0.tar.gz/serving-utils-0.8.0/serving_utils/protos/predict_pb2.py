...
from serving_utils.protos import tensor_pb2 as serving__utils_dot_protos_dot_tensor__pb2
from serving_utils.protos import model_pb2 as serving__utils_dot_protos_dot_model__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='serving_utils/protos/predict.proto',
  ...
  ,
  dependencies=[serving__utils_dot_protos_dot_tensor__pb2.DESCRIPTOR,serving__utils_dot_protos_dot_model__pb2.DESCRIPTOR,])
...
_PREDICTREQUEST_INPUTSENTRY.fields_by_name['value'].message_type = serving__utils_dot_protos_dot_tensor__pb2._TENSORPROTO
_PREDICTREQUEST_INPUTSENTRY.containing_type = _PREDICTREQUEST
_PREDICTREQUEST.fields_by_name['model_spec'].message_type = serving__utils_dot_protos_dot_model__pb2._MODELSPEC
_PREDICTREQUEST.fields_by_name['inputs'].message_type = _PREDICTREQUEST_INPUTSENTRY
_PREDICTRESPONSE_OUTPUTSENTRY.fields_by_name['value'].message_type = serving__utils_dot_protos_dot_tensor__pb2._TENSORPROTO
_PREDICTRESPONSE_OUTPUTSENTRY.containing_type = _PREDICTRESPONSE
_PREDICTRESPONSE.fields_by_name['model_spec'].message_type = serving__utils_dot_protos_dot_model__pb2._MODELSPEC
...
PredictRequest = _reflection.GeneratedProtocolMessageType('PredictRequest', (_message.Message,), dict(
  ...
  InputsEntry = _reflection.GeneratedProtocolMessageType('InputsEntry', (_message.Message,), dict(
    ...
    __module__ = 'serving_utils.protos.predict_pb2'

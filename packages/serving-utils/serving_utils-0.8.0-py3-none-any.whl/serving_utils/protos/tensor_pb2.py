...
from serving_utils.protos import resource_handle_pb2 as serving__utils_dot_protos_dot_resource__handle__pb2
from serving_utils.protos import tensor_shape_pb2 as serving__utils_dot_protos_dot_tensor__shape__pb2
from serving_utils.protos import types_pb2 as serving__utils_dot_protos_dot_types__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='serving_utils/protos/tensor.proto',
  ...
  ,
  dependencies=[serving__utils_dot_protos_dot_resource__handle__pb2.DESCRIPTOR,serving__utils_dot_protos_dot_tensor__shape__pb2.DESCRIPTOR,serving__utils_dot_protos_dot_types__pb2.DESCRIPTOR,])
...
_TENSORPROTO.fields_by_name['dtype'].enum_type = serving__utils_dot_protos_dot_types__pb2._DATATYPE
_TENSORPROTO.fields_by_name['tensor_shape'].message_type = serving__utils_dot_protos_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_TENSORPROTO.fields_by_name['resource_handle_val'].message_type = serving__utils_dot_protos_dot_resource__handle__pb2._RESOURCEHANDLEPROTO
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  __module__ = 'serving_utils.protos.tensor_pb2'

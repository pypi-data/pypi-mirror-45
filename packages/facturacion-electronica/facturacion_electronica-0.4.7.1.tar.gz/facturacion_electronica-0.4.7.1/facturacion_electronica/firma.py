# -#- coding: utf-8 -#-
from facturacion_electronica.signature import SignatureCert
...
class Firma(object):
    ...
    def firma_electronica(self, val):
        if not val:
            return
        try:
            decripted_key = UserSignature(val)
    ...
    def firmar(self, string, uri=False, type="doc"):
        ...
        reference_uri = '#'+uri if uri else False
        ...
        key = crypto.load_privatekey(type_, self.privkey)

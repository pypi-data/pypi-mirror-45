...
from swiss_logger.log_utils import get_logger, log_enter_and_exit
...
class PredictionModelWrapper(object):
    ...
    def __init__(self, model_class_fully_qualified_name, config):
        ...
        try:
            ...
            self.trained_model_data.model = model_class(self.model_config)
        except Exception as e:
            self.logger.error(exception_error_msg(e))
            raise ModuleNotFoundError('Failed to find module: {}'.format(self.model_class_fully_qualified_name))

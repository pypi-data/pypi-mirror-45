...
class PredictionModelWrapper(object):
    ...
    def __init__(self, model_class_qual_name, config=None):
        self.trained_model_data = TrainedModelData()
        self.model_class_qual_name = model_class_qual_name
    ...
    def build(self):
        ...
        model_class = self.get_class(self.model_class_qual_name)

...
- group (boolean; optional): Set group to True if the DropdownMenu is inside a ButtonGroup."""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, label=Component.UNDEFINED, direction=Component.UNDEFINED, in_navbar=Component.UNDEFINED, addon_type=Component.UNDEFINED, disabled=Component.UNDEFINED, nav=Component.UNDEFINED, caret=Component.UNDEFINED, bs_size=Component.UNDEFINED, loading_state=Component.UNDEFINED, group=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'key', 'label', 'direction', 'in_navbar', 'addon_type', 'disabled', 'nav', 'caret', 'bs_size', 'loading_state', 'group']
        self._type = 'DropdownMenu'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'key', 'label', 'direction', 'in_navbar', 'addon_type', 'disabled', 'nav', 'caret', 'bs_size', 'loading_state', 'group']

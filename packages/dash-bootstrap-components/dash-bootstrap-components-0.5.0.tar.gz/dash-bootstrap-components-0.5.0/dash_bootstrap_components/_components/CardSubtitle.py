...
- tag (string; optional): HTML tag to use for the card subtitle, default: h6
...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, tag=Component.UNDEFINED, color=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'key', 'tag', 'color', 'loading_state']
        self._type = 'CardSubtitle'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'key', 'tag', 'color', 'loading_state']
        ...
        super(CardSubtitle, self).__init__(children=children, **args)

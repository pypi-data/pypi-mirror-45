...
def parse_args():
    ...
    parser.add_argument('--network', nargs='?', const=5, default=5, type=int,
    ...
    parser.add_argument('--qt', action='store_true',
                        help="All about Qt, all options below 'qt-bindings' and "
                             "'qt-abstractions' (PEAD)")
    parser.add_argument('--qt-bindings', action='store_true',
                        help="Available Qt bindings (PyQt/Pyside) and Qt "
                        "version (PEAD)")
    parser.add_argument('--qt-abstractions', action='store_true',
                        help="Available Qt abstractions and its configurations "
    ...
    parser.add_argument('--numbers', action='store_true',
                        help="All options below, 'float' and 'int' (PEI)")
...
def main():
    ...
    if args.network or args.all or no_args:

...
def exception_test(throws, message,  method_to_test, *args):
    print(message, end="...")
    try:
        method_to_test(*args)
        if throws:
...
def main():
    exception_test(True, "testing - should throw",  _test, True, "hello")
    exception_test(False, "testing - should NOT throw",  _test, False, "hello")

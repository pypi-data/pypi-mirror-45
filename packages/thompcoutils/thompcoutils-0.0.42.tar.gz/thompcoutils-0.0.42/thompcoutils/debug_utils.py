...
def exception_test(message,  method_to_test):
    print(message, end="...")
    try:
        method_to_test
...
def main():
    exception_test("testing - should throw", partial(_test, True, "hello"))
    exception_test("testing - should throw", partial(_test, throws=True, second="hello"))

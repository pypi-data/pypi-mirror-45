...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x1findoor_temperature_action.proto\x12\x19indoor_temperature_action\"U\n\x07Request\x12\x10\n\x08\x62uilding\x18\x01 \x01(\t\x12\x0c\n\x04zone\x18\x02 \x01(\t\x12\r\n\x05start\x18\x03 \x01(\x03\x12\x0b\n\x03\x65nd\x18\x04 \x01(\x03\x12\x0e\n\x06window\x18\x05 \x01(\t\"C\n\x10TemperaturePoint\x12\x0c\n\x04time\x18\x01 \x01(\x03\x12\x13\n\x0btemperature\x18\x02 \x01(\x01\x12\x0c\n\x04unit\x18\x03 \x01(\t\"+\n\x0b\x41\x63tionPoint\x12\x0c\n\x04time\x18\x01 \x01(\x03\x12\x0e\n\x06\x61\x63tion\x18\x02 \x01(\x01\"\xc6\x01\n\x16TemperatureActionPoint\x12\x0c\n\x04time\x18\x01 \x01(\x03\x12\x0e\n\x06window\x18\x02 \x01(\t\x12\x19\n\x11temperature_start\x18\x03 \x01(\x01\x12\x17\n\x0ftemperature_end\x18\x04 \x01(\x01\x12\x18\n\x10temperature_unit\x18\x05 \x01(\t\x12\x0e\n\x06\x61\x63tion\x18\x06 \x01(\x01\x12\x17\n\x0fprevious_action\x18\x07 \x01(\x01\x12\x17\n\x0f\x61\x63tion_duration\x18\x08 \x01(\t\"X\n\x13RawTemperatureReply\x12\x41\n\x0ctemperatures\x18\x01 \x03(\x0b\x32+.indoor_temperature_action.TemperaturePoint\"I\n\x0eRawActionReply\x12\x37\n\x07\x61\x63tions\x18\x01 \x03(\x0b\x32&.indoor_temperature_action.ActionPoint\"l\n\x19ProcessedTemperatureReply\x12O\n\x14temperatures_actions\x18\x01 \x03(\x0b\x32\x31.indoor_temperature_action.TemperatureActionPoint2\xe6\x02\n\x17IndoorTemperatureAction\x12j\n\x12GetRawTemperatures\x12\".indoor_temperature_action.Request\x1a..indoor_temperature_action.RawTemperatureReply\"\x00\x12`\n\rGetRawActions\x12\".indoor_temperature_action.Request\x1a).indoor_temperature_action.RawActionReply\"\x00\x12}\n\x1fGetProcessedTemperaturesActions\x12\".indoor_temperature_action.Request\x1a\x34.indoor_temperature_action.ProcessedTemperatureReply\"\x00\x42\x02P\x01\x62\x06proto3')
)
...
_TEMPERATUREACTIONPOINT = _descriptor.Descriptor(
  name='TemperatureActionPoint',
  full_name='indoor_temperature_action.TemperatureActionPoint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='indoor_temperature_action.TemperatureActionPoint.time', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='window', full_name='indoor_temperature_action.TemperatureActionPoint.window', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temperature_start', full_name='indoor_temperature_action.TemperatureActionPoint.temperature_start', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temperature_end', full_name='indoor_temperature_action.TemperatureActionPoint.temperature_end', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temperature_unit', full_name='indoor_temperature_action.TemperatureActionPoint.temperature_unit', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='action', full_name='indoor_temperature_action.TemperatureActionPoint.action', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='previous_action', full_name='indoor_temperature_action.TemperatureActionPoint.previous_action', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='action_duration', full_name='indoor_temperature_action.TemperatureActionPoint.action_duration', index=7,
...
_PROCESSEDTEMPERATUREREPLY = _descriptor.Descriptor(
  name='ProcessedTemperatureReply',
  full_name='indoor_temperature_action.ProcessedTemperatureReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='temperatures_actions', full_name='indoor_temperature_action.ProcessedTemperatureReply.temperatures_actions', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROCESSEDTEMPERATUREREPLY.fields_by_name['temperatures_actions'].message_type = _TEMPERATUREACTIONPOINT
...
DESCRIPTOR.message_types_by_name['TemperatureActionPoint'] = _TEMPERATUREACTIONPOINT
...
DESCRIPTOR.message_types_by_name['ProcessedTemperatureReply'] = _PROCESSEDTEMPERATUREREPLY
...
TemperatureActionPoint = _reflection.GeneratedProtocolMessageType('TemperatureActionPoint', (_message.Message,), dict(
  DESCRIPTOR = _TEMPERATUREACTIONPOINT,
  __module__ = 'indoor_temperature_action_pb2'
  # @@protoc_insertion_point(class_scope:indoor_temperature_action.TemperatureActionPoint)
  ))
_sym_db.RegisterMessage(TemperatureActionPoint)
...
ProcessedTemperatureReply = _reflection.GeneratedProtocolMessageType('ProcessedTemperatureReply', (_message.Message,), dict(
  DESCRIPTOR = _PROCESSEDTEMPERATUREREPLY,
  __module__ = 'indoor_temperature_action_pb2'
  # @@protoc_insertion_point(class_scope:indoor_temperature_action.ProcessedTemperatureReply)
  ))
_sym_db.RegisterMessage(ProcessedTemperatureReply)
...
_INDOORTEMPERATUREACTION = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetProcessedTemperaturesActions',
    full_name='indoor_temperature_action.IndoorTemperatureAction.GetProcessedTemperaturesActions',
    index=2,
    containing_service=None,
    input_type=_REQUEST,
    output_type=_PROCESSEDTEMPERATUREREPLY,
    options=None,
  ),
])

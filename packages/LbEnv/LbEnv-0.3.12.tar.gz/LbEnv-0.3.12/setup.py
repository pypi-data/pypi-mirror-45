...
setup(
    ...
    package_dir={'': 'python'},
    package_data={'LbEnv': ['data/platforms.txt', 'data/projects.txt',
                            'data/packages.txt',
                            'data/aliases.sh', 'data/aliases.csh']},
    ...
    install_requires=["LbPlatformUtils>=2.1.0", "xenv<1.0.0"],

    # see https://stackoverflow.com/a/30064248, needed for Python 2.6 (SLC6)
    dependency_links=[
        'https://lhcb-pypi.web.cern.ch/lhcb-pypi/simple/xenv',
        'https://lhcb-pypi.web.cern.ch/lhcb-pypi/simple/lbplatformutils',
    ],

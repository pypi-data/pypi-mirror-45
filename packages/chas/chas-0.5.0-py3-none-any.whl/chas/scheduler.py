...
class Scheduler:
    ...
    def job(self, time, manual=True, description=""):
        logger.debug("Registering job.")
        def register_job(job):
            self.register_job(job, time, manual=manual, description=description)
        return register_job
    ...
    def register_job(self, function, time, manual=True, description=""):
        job = Job(function, time, manual=manual, description=description)

...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\'hydro_serving_grpc/tf/api/predict.proto\x12\x1ehydrosphere.tensorflow.serving\x1a\"hydro_serving_grpc/tf/tensor.proto\x1a%hydro_serving_grpc/tf/api/model.proto\x1a,hydro_serving_grpc/monitoring/metadata.proto\"\xf5\x01\n\x0ePredictRequest\x12=\n\nmodel_spec\x18\x01 \x01(\x0b\x32).hydrosphere.tensorflow.serving.ModelSpec\x12J\n\x06inputs\x18\x02 \x03(\x0b\x32:.hydrosphere.tensorflow.serving.PredictRequest.InputsEntry\x1aR\n\x0bInputsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\x32\n\x05value\x18\x02 \x01(\x0b\x32#.hydrosphere.tensorflow.TensorProto:\x02\x38\x01J\x04\x08\x03\x10\x04\"\xa6\x03\n\x0fPredictResponse\x12M\n\x07outputs\x18\x01 \x03(\x0b\x32<.hydrosphere.tensorflow.serving.PredictResponse.OutputsEntry\x12X\n\rinternal_info\x18\x65 \x03(\x0b\x32\x41.hydrosphere.tensorflow.serving.PredictResponse.InternalInfoEntry\x12\x35\n\ntrace_data\x18\x66 \x01(\x0b\x32!.hydrosphere.monitoring.TraceData\x1aS\n\x0cOutputsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\x32\n\x05value\x18\x02 \x01(\x0b\x32#.hydrosphere.tensorflow.TensorProto:\x02\x38\x01\x1aX\n\x11InternalInfoEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\x32\n\x05value\x18\x02 \x01(\x0b\x32#.hydrosphere.tensorflow.TensorProto:\x02\x38\x01J\x04\x08\x02\x10\x03\x42*\n%io.hydrosphere.serving.tensorflow.api\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[hydro__serving__grpc_dot_tf_dot_tensor__pb2.DESCRIPTOR,hydro__serving__grpc_dot_tf_dot_api_dot_model__pb2.DESCRIPTOR,hydro__serving__grpc_dot_monitoring_dot_metadata__pb2.DESCRIPTOR,])
...
_PREDICTRESPONSE_INTERNALINFOENTRY = _descriptor.Descriptor(
  name='InternalInfoEntry',
  full_name='hydrosphere.tensorflow.serving.PredictResponse.InternalInfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='hydrosphere.tensorflow.serving.PredictResponse.InternalInfoEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='hydrosphere.tensorflow.serving.PredictResponse.InternalInfoEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREDICTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='internal_info', full_name='hydrosphere.tensorflow.serving.PredictResponse.internal_info', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trace_data', full_name='hydrosphere.tensorflow.serving.PredictResponse.trace_data', index=2,
  ...
  nested_types=[_PREDICTRESPONSE_OUTPUTSENTRY, _PREDICTRESPONSE_INTERNALINFOENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_PREDICTRESPONSE_INTERNALINFOENTRY.fields_by_name['value'].message_type = hydro__serving__grpc_dot_tf_dot_tensor__pb2._TENSORPROTO
_PREDICTRESPONSE_INTERNALINFOENTRY.containing_type = _PREDICTRESPONSE
_PREDICTRESPONSE.fields_by_name['outputs'].message_type = _PREDICTRESPONSE_OUTPUTSENTRY
_PREDICTRESPONSE.fields_by_name['internal_info'].message_type = _PREDICTRESPONSE_INTERNALINFOENTRY
_PREDICTRESPONSE.fields_by_name['trace_data'].message_type = hydro__serving__grpc_dot_monitoring_dot_metadata__pb2._TRACEDATA
...
PredictResponse = _reflection.GeneratedProtocolMessageType('PredictResponse', (_message.Message,), dict(
  ...
  InternalInfoEntry = _reflection.GeneratedProtocolMessageType('InternalInfoEntry', (_message.Message,), dict(
    DESCRIPTOR = _PREDICTRESPONSE_INTERNALINFOENTRY,
    __module__ = 'hydro_serving_grpc.tf.api.predict_pb2'
    # @@protoc_insertion_point(class_scope:hydrosphere.tensorflow.serving.PredictResponse.InternalInfoEntry)
    ))
  ,
...
_sym_db.RegisterMessage(PredictResponse.InternalInfoEntry)
...
_PREDICTRESPONSE_INTERNALINFOENTRY.has_options = True
_PREDICTRESPONSE_INTERNALINFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

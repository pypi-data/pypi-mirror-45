...
History : (16/11/2015) First version.
        ...
        : (30/03/2019) V. 1.7.1.
        : (05/04/2019) V. 1.7.2.
        : (28/04/2019) V. 1.7.3, 1.7.4, 1.7.5 and 1.7.6.
"""
...
__all__ =  ['ApyPhot', 'ApyPSFPhot', 'CheckMagDiff', 'Chi2', 'DaoPhot', 'DaoPSFPhot', 'FindPathes', 'FindSubPathes', 
                'Flux2Mag', 'GetApPhot', 'GetCommandStr', 'GetFITS', 'GetGAIAxMatch', 'GetGLADExMatch', 
                'GetHeadVal', 'GetIGAIA', 'GetIGAIAxMatch', 'GetLEDAxMatch', 'GetPanSTARSS',
                'GetPics', 'GetPixVal', 'GetPixXY', 'GetPSFPhot', 'GetSkyBot', 'GetSkyBotMatch', 'GetSimbad',
                'GetSimbadxMatch', 'GetTest', 'GetUSNOxMatch', 'GetWeights', 'IsCoordIn', 'MyPhot', 'Score',
                'SexPhot']

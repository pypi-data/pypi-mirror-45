...
class TopicApiBaseMixin(object):
            ...
            if query and aggregations:
                ...
                res['aggregations'] = {
                    key: {'values': [
                        ...
                        if v['key'] in data['input_features'][key]]}
                    for key, value in agg_res['aggregations'].iteritems()}
                return res
        return {}
    ...
    def modify_item(self, project_id, item_id, star=None, read=None,
        ...
        :param keywords: Updates to the `keywords` of the item.
        :param entities: Updates to the `entities` of the item.
        :param force_cache_clear: Force all relevant caches to be cleared
        ...
        if force_cache_clear is not None:
            data['force_cache_clear'] = force_cache_clear

...
from DevLGram.errors import UserNotParticipant
...
class GetChatMember(BaseClient):
    async def get_chat_member(
        ...
        Returns:
            On success, a :obj:`ChatMember <DevLGram.ChatMember>` object is returned.
        ...
        if isinstance(chat_id, types.InputPeerChat):
            ...
            for member in DevLGram.ChatMembers._parse(self, full_chat).chat_members:
            ...
            return DevLGram.ChatMember._parse(self, r.participant, users)
        else:

...
from DevLGram.errors import FileIdInvalid, FloodWait
from DevLGram.client.ext import BaseClient, utils
...
class SendMediaGroup(BaseClient):
    ...
    async def send_media_group(
        ...
        for i in media:
            ...
            if isinstance(i, DevLGram.InputMediaPhoto):
            ...
            elif isinstance(i, DevLGram.InputMediaVideo):
                if os.path.exists(i.media):
                    while True:
                        try:
                            media = await self.send(
        ...
        return await DevLGram.Messages._parse(
            self,

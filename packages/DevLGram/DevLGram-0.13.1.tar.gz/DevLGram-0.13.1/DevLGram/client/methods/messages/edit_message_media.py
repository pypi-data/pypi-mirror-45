...
from DevLGram.errors import FileIdInvalid
from DevLGram.client.ext import BaseClient, utils
from DevLGram.client.types import (
...
class EditMessageMedia(BaseClient):
    async def edit_message_media(
        ...
        message_id: int,
        media: InputMedia,
        reply_markup: "DevLGram.InlineKeyboardMarkup" = None
    ) -> "DevLGram.Message":
        ...
        for i in r.updates:
            if isinstance(i, (types.UpdateEditMessage, types.UpdateEditChannelMessage)):
                return await DevLGram.Message._parse(
                    self, i.message,

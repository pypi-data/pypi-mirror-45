...
from DevLGram.errors import UnknownError
...
class GetInlineBotResults(BaseClient):
    async def get_inline_bot_results(
        ...
        You can then send a result using :obj:`send_inline_bot_result <DevLGram.Client.send_inline_bot_result>`
        ...
        Returns:
            On Success, :obj:`BotResults <DevLGram.api.types.messages.BotResults>` is returned.

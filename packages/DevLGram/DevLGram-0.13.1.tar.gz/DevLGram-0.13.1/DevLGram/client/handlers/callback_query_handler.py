...
class CallbackQueryHandler(Handler):
    ...
    It is intended to be used with :meth:`add_handler() <DevLGram.Client.add_handler>`

    For a nicer way to register this handler, have a look at the
    :meth:`on_callback_query() <DevLGram.Client.on_callback_query>` decorator.
    ...
    Other parameters:
        ...
        callback_query (:obj:`CallbackQuery <DevLGram.CallbackQuery>`):

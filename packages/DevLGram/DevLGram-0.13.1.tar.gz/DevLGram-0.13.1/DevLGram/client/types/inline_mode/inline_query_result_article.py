...
class InlineQueryResultArticle(InlineQueryResult):
    ...
    Args:
        ...
        input_message_content (:obj:`InputMessageContent <DevLGram.InputMessageContent>`):
            Content of the message to be sent.

        reply_markup (:obj:`InlineKeyboardMarkup <DevLGram.InlineKeyboardMarkup>`, *optional*):

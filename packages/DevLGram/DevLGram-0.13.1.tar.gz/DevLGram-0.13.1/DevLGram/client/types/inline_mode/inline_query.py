...
class InlineQuery(DevLGramType, Update):
    ...
    Args:
        ...
        from_user (:obj:`User <DevLGram.User>`):
            Sender.
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`InlineQuery <DevLGram.InlineQuery>`.
        ...
        Args:
            results (List of :obj:`InlineQueryResult <DevLGram.InlineQueryResult>`):

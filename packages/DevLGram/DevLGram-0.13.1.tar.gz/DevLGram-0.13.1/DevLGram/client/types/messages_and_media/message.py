...
from DevLGram.errors import MessageIdsEmpty
from DevLGram.client.ext import ChatAction, ParseMode
from DevLGram.client.types.input_media import InputMedia
...
class Message(DevLGramType, Update):
    ...
    Args:
        ...
        chat (:obj:`Chat <DevLGram.Chat>`, *optional*):
            Conversation the message belongs to.

        from_user (:obj:`User <DevLGram.User>`, *optional*):
            Sender, empty for messages sent to channels.

        forward_from (:obj:`User <DevLGram.User>`, *optional*):
        ...
        forward_from_chat (:obj:`Chat <DevLGram.Chat>`, *optional*):
        ...
        reply_to_message (:obj:`Message <DevLGram.Message>`, *optional*):
        ...
        entities (List of :obj:`MessageEntity <DevLGram.MessageEntity>`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`MessageEntity <DevLGram.MessageEntity>`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`Audio <DevLGram.Audio>`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`Document <DevLGram.Document>`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`Photo <DevLGram.Photo>`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`Sticker <DevLGram.Sticker>`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`Animation <DevLGram.Animation>`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`Game <DevLGram.Game>`, *optional*):
            Message is a game, information about the game.

        video (:obj:`Video <DevLGram.Video>`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`Voice <DevLGram.Voice>`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`VideoNote <DevLGram.VideoNote>`, *optional*):
        ...
        contact (:obj:`Contact <DevLGram.Contact>`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`Location <DevLGram.Location>`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`Venue <DevLGram.Venue>`, *optional*):
        ...
        new_chat_members (List of :obj:`User <DevLGram.User>`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`User <DevLGram.User>`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`Photo <DevLGram.Photo>`, *optional*):
        ...
        pinned_message (:obj:`Message <DevLGram.Message>`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`GameHighScore <DevLGram.GameHighScore>`, *optional*):
        ...
        via_bot (:obj:`User <DevLGram.User>`):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <DevLGram.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`Filters.command <DevLGram.Filters.command>`.
    ...
    def __init__(
        ...
        *,
        ...
        text: Str = None,
        entities: List["DevLGram.MessageEntity"] = None,
        caption_entities: List["DevLGram.MessageEntity"] = None,
        audio: "DevLGram.Audio" = None,
        document: "DevLGram.Document" = None,
        photo: "DevLGram.Photo" = None,
        sticker: "DevLGram.Sticker" = None,
        animation: "DevLGram.Animation" = None,
        game: "DevLGram.Game" = None,
        video: "DevLGram.Video" = None,
        voice: "DevLGram.Voice" = None,
        video_note: "DevLGram.VideoNote" = None,
        caption: Str = None,
        contact: "DevLGram.Contact" = None,
        location: "DevLGram.Location" = None,
        venue: "DevLGram.Venue" = None,
        web_page: bool = None,
        poll: "DevLGram.Poll" = None,
        new_chat_members: List[User] = None,
        left_chat_member: User = None,
        new_chat_title: str = None,
        new_chat_photo: "DevLGram.Photo" = None,
    ...
    async def _parse(client, message: types.Message or types.MessageService or types.MessageEmpty, users: dict,
        ...
        if isinstance(message, types.MessageService):
            ...
            if isinstance(action, types.MessageActionGameScore):
                parsed_message.game_high_score = DevLGram.GameHighScore._parse_action(client, message, users)
        ...
        if isinstance(message, types.Message):
            ...
            if media:
                if isinstance(media, types.MessageMediaPhoto):
                    ...
                    venue = DevLGram.Venue._parse(client, media)
                elif isinstance(media, types.MessageMediaGame):
                    game = DevLGram.Game._parse(client, message)
                    ...
                    if isinstance(doc, types.Document):
                        ...
                        if types.DocumentAttributeAudio in attributes:
                            ...
                            if audio_attributes.voice:
                                voice = DevLGram.Voice._parse(client, doc, audio_attributes)
                            else:
                                audio = DevLGram.Audio._parse(client, doc, audio_attributes, file_name)
                        elif types.DocumentAttributeAnimated in attributes:
                            video_attributes = attributes.get(types.DocumentAttributeVideo, None)

                            animation = DevLGram.Animation._parse(client, doc, video_attributes, file_name)
                        elif types.DocumentAttributeVideo in attributes:
                            video_attributes = attributes[types.DocumentAttributeVideo]

                            if video_attributes.round_message:
                                video_note = DevLGram.VideoNote._parse(client, doc, video_attributes)
                            else:
                                video = DevLGram.Video._parse(client, doc, video_attributes, file_name)
                        elif types.DocumentAttributeSticker in attributes:
                            sticker = await DevLGram.Sticker._parse(
                                client, doc,
                            ...
                            document = DevLGram.Document._parse(client, doc, file_name)
                elif isinstance(media, types.MessageMediaWebPage):
                    web_page = True
                    media = None
                elif isinstance(media, types.MessageMediaPoll):
                    poll = DevLGram.Poll._parse(client, media)
                else:
                    media = None
            ...
            if reply_markup:
                if isinstance(reply_markup, types.ReplyKeyboardForceReply):
                    reply_markup = DevLGram.ForceReply.read(reply_markup)
                elif isinstance(reply_markup, types.ReplyKeyboardMarkup):
                    reply_markup = DevLGram.ReplyKeyboardMarkup.read(reply_markup)
                elif isinstance(reply_markup, types.ReplyInlineMarkup):
                    reply_markup = DevLGram.InlineKeyboardMarkup.read(reply_markup)
                elif isinstance(reply_markup, types.ReplyKeyboardHide):
                    reply_markup = DevLGram.ReplyKeyboardRemove.read(reply_markup)
                else:
                    reply_markup = None
    ...
    async def reply(
        ...
        """Bound method *reply* of :obj:`Message <DevLGram.Message>`.
        ...
        Args:
            ...
            parse_mode (``str``, *optional*):
                Use :obj:`MARKDOWN <DevLGram.ParseMode.MARKDOWN>` or :obj:`HTML <DevLGram.ParseMode.HTML>`
        ...
        Raises:
            :class:`RPCError <DevLGram.RPCError>`
        """
        if quote is None:
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_chat_action(
        ...
        """Bound method *reply_chat_action* of :obj:`Message <DevLGram.Message>`.
        ...
        Args:
            action (:obj:`ChatAction <DevLGram.ChatAction>` | ``str``):
                Type of action to broadcast.
                Choose one from the :class:`ChatAction <DevLGram.ChatAction>` enumeration,
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_media_group(
        self,
        media: List[Union["DevLGram.InputMediaPhoto", "DevLGram.InputMediaVideo"]],
        quote: bool = None,
        disable_notification: bool = None,
        reply_to_message_id: int = None
    ) -> "Message":
        """Bound method *reply_media_group* of :obj:`Message <DevLGram.Message>`.
        ...
        Args:
            media (``list``):
                A list containing either :obj:`InputMediaPhoto <DevLGram.InputMediaPhoto>` or
                :obj:`InputMediaVideo <DevLGram.InputMediaVideo>` objects
        ...
        Returns:
            On success, a :obj:`Messages <DevLGram.Messages>` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`Message <DevLGram.Message>`.
        ...
        Example:
            .. code-block:: python
                ...
                message.reply_poll("Is DevLGram the best?", ["Yes", "Yes"])
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`Message <DevLGram.Message>`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`Message <DevLGram.Message>`.
    ...
    async def edit(
        ...
        """Bound method *edit* of :obj:`Message <DevLGram.Message>`
        ...
        Returns:
            On success, the edited :obj:`Message <DevLGram.Message>` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`Message <DevLGram.Message>`
    ...
    async def edit_media(self, media: InputMedia, reply_markup: "DevLGram.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_media* of :obj:`Message <DevLGram.Message>`
    ...
    async def edit_reply_markup(self, reply_markup: "DevLGram.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`Message <DevLGram.Message>`
        ...
        Returns:
            ...
            :obj:`Message <DevLGram.Message>` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`Message <DevLGram.Message>`.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`Message <DevLGram.Message>`.
    ...
    async def click(self, x: int or str, y: int = None, quote: bool = None):
        """Bound method *click* of :obj:`Message <DevLGram.Message>`.
        ...
        """
        if isinstance(self.reply_markup, DevLGram.ReplyKeyboardMarkup):
            return await self.reply(x, quote=quote)
        elif isinstance(self.reply_markup, DevLGram.InlineKeyboardMarkup):
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`Message <DevLGram.Message>`.
    ...
    async def pin(self, disable_notification: bool = None) -> "Message":
        """Bound method *pin* of :obj:`Message <DevLGram.Message>`.

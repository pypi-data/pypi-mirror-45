...
class Messages(DevLGramType, Update):
    ...
    Args:
        ...
        messages (List of :obj:`Message <DevLGram.Message>`):
            Requested messages.
    """
    ...
    def forward(
        ...
        """Bound method *forward* of :obj:`Message <DevLGram.Messages>`.
        ...
        Returns:
            On success, a :class:`Messages <DevLGram.Messages>` containing forwarded messages is returned.

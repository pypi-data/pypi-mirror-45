...
from DevLGram.api.types import KeyboardButtonRow
from DevLGram.api.types import ReplyKeyboardMarkup as RawReplyKeyboardMarkup
from . import KeyboardButton
from ..DevLGram_type import DevLGramType


class ReplyKeyboardMarkup(DevLGramType):
    """This object represents a custom keyboard with reply options.

    Args:
        keyboard (List of List of :obj:`KeyboardButton <DevLGram.KeyboardButton>`):

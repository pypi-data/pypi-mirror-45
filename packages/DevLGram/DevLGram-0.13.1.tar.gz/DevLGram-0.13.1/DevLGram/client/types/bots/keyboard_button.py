...
from DevLGram.api.types import KeyboardButton as RawKeyboardButton
from DevLGram.api.types import KeyboardButtonRequestPhone, KeyboardButtonRequestGeoLocation
from ..DevLGram_type import DevLGramType


class KeyboardButton(DevLGramType):

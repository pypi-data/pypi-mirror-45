...
class CallbackQuery(DevLGramType, Update):
    ...
    Args:
        ...
        message (:obj:`Message <DevLGram.Message>`, *optional*):
    ...
    def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        """Bound method *answer* of :obj:`CallbackQuery <DevLGram.CallbackQuery>`.

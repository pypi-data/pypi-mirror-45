...
import DevLGram
from DevLGram import __copyright__, __license__, __version__
from DevLGram.api import functions, types
from DevLGram.api.all import layer
from DevLGram.api.core import Object, MsgContainer, Int, Long, FutureSalt, FutureSalts
from DevLGram.errors import RPCError, InternalServerError, AuthKeyDuplicated
from DevLGram.connection import Connection
from DevLGram.crypto import MTProto
...
class Session:
    ...
    def __init__(self,
        ...
        if not Session.notice_displayed:
            print("DevLGram v{}, {}".format(__version__, __copyright__))

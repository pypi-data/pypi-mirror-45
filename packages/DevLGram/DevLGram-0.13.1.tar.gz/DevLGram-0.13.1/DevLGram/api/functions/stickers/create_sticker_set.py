...
class CreateStickerSet(Object):
    ...
    Args:
        ...
        title: ``str``
        short_name: ``str``
        stickers: List of :obj:`InputStickerSetItem <DevLGram.api.types.InputStickerSetItem>`
        masks (optional): ``bool``
    ...
    __slots__ = ["user_id", "title", "short_name", "stickers", "masks"]

    ID = 0x9bd86e6a
    QUALNAME = "stickers.CreateStickerSet"

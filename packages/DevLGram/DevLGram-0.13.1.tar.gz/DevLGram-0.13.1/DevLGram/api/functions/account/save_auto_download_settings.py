...
class SaveAutoDownloadSettings(Object):
    """Attributes:
        ID: ``0x76f36233``

    Args:
        settings: :obj:`AutoDownloadSettings <DevLGram.api.types.AutoDownloadSettings>`
        low (optional): ``bool``
        high (optional): ``bool``
    ...
    ID = 0x76f36233
    QUALNAME = "account.SaveAutoDownloadSettings"

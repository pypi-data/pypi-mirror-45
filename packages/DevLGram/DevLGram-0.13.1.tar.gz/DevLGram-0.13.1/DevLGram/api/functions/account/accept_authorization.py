...
class AcceptAuthorization(Object):
    ...
    Args:
        ...
        scope: ``str``
        public_key: ``str``
        value_hashes: List of :obj:`SecureValueHash <DevLGram.api.types.SecureValueHash>`
        credentials: :obj:`SecureCredentialsEncrypted <DevLGram.api.types.SecureCredentialsEncrypted>`
    ...
    ID = 0xe7027c94
    QUALNAME = "account.AcceptAuthorization"

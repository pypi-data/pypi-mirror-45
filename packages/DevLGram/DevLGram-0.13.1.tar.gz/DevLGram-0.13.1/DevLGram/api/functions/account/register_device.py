...
class RegisterDevice(Object):
    ...
    __slots__ = ["token_type", "token", "app_sandbox", "secret", "other_uids"]

    ID = 0x5cbea590
    QUALNAME = "account.RegisterDevice"
    ...
    def read(b: BytesIO, *args) -> "RegisterDevice":
        ...
        return RegisterDevice(token_type=token_type, token=token, app_sandbox=app_sandbox, secret=secret, other_uids=other_uids)

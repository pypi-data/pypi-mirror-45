...
class SendMessage(Object):
    ...
    __slots__ = ["peer", "message", "random_id", "no_webpage", "silent", "background", "clear_draft", "reply_to_msg_id", "reply_markup", "entities"]

    ID = 0xfa88427a
    QUALNAME = "messages.SendMessage"
    ...
    def read(b: BytesIO, *args) -> "SendMessage":
        ...
        return SendMessage(peer=peer, message=message, random_id=random_id, no_webpage=no_webpage, silent=silent, background=background, clear_draft=clear_draft, reply_to_msg_id=reply_to_msg_id, reply_markup=reply_markup, entities=entities)

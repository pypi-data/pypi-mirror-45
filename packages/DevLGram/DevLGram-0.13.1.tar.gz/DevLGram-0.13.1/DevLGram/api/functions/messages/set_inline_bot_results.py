...
class SetInlineBotResults(Object):
    ...
    Args:
        query_id: ``int`` ``64-bit``
        results: List of either :obj:`InputBotInlineResult <DevLGram.api.types.InputBotInlineResult>`, :obj:`InputBotInlineResultPhoto <DevLGram.api.types.InputBotInlineResultPhoto>`, :obj:`InputBotInlineResultDocument <DevLGram.api.types.InputBotInlineResultDocument>` or :obj:`InputBotInlineResultGame <DevLGram.api.types.InputBotInlineResultGame>`
        cache_time: ``int`` ``32-bit``
        gallery (optional): ``bool``
        private (optional): ``bool``
        next_offset (optional): ``str``
        switch_pm (optional): :obj:`InlineBotSwitchPM <DevLGram.api.types.InlineBotSwitchPM>`
    ...
    ID = 0xeb5ea206
    QUALNAME = "messages.SetInlineBotResults"

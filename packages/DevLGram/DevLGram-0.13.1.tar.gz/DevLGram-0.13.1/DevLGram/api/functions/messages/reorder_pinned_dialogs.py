...
class ReorderPinnedDialogs(Object):
    ...
    Args:
        order: List of :obj:`InputDialogPeer <DevLGram.api.types.InputDialogPeer>`
        force (optional): ``bool``
    ...
    __slots__ = ["order", "force"]

    ID = 0x5b51d63f
    QUALNAME = "messages.ReorderPinnedDialogs"
    ...
    def read(b: BytesIO, *args) -> "ReorderPinnedDialogs":
        ...
        return ReorderPinnedDialogs(order=order, force=force)

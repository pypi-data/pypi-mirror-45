...
class SendInlineBotResult(Object):
    ...
    __slots__ = ["peer", "random_id", "query_id", "id", "silent", "background", "clear_draft", "hide_via", "reply_to_msg_id"]

    ID = 0xb16e06fe
    QUALNAME = "messages.SendInlineBotResult"

    def __init__(self, *, peer, random_id: int, query_id: int, id: str, silent: bool = None, background: bool = None, clear_draft: bool = None, hide_via: bool = None, reply_to_msg_id: int = None):
    ...
    def read(b: BytesIO, *args) -> "SendInlineBotResult":
        ...
        return SendInlineBotResult(peer=peer, random_id=random_id, query_id=query_id, id=id, silent=silent, background=background, clear_draft=clear_draft, hide_via=hide_via, reply_to_msg_id=reply_to_msg_id)

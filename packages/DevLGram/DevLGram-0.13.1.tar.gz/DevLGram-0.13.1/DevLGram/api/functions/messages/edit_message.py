...
class EditMessage(Object):
    ...
    __slots__ = ["peer", "id", "no_webpage", "message", "media", "reply_markup", "entities"]

    ID = 0xd116f31e
    QUALNAME = "messages.EditMessage"

    def __init__(self, *, peer, id: int, no_webpage: bool = None, message: str = None, media=None, reply_markup=None, entities: list = None):
    ...
    def read(b: BytesIO, *args) -> "EditMessage":
        ...
        return EditMessage(peer=peer, id=id, no_webpage=no_webpage, message=message, media=media, reply_markup=reply_markup, entities=entities)

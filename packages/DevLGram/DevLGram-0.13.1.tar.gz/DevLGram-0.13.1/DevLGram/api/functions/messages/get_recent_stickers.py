...
class GetRecentStickers(Object):
    ...
    Returns:
        Either :obj:`messages.RecentStickersNotModified <DevLGram.api.types.messages.RecentStickersNotModified>` or :obj:`messages.RecentStickers <DevLGram.api.types.messages.RecentStickers>`
    """

    __slots__ = ["hash", "attached"]

    ID = 0x5ea192c9
    QUALNAME = "messages.GetRecentStickers"

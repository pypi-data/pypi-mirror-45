...
class EditChatDefaultBannedRights(Object):
    """Attributes:
        ID: ``0xa5866b41``
    ...
    Args:
        ...
        banned_rights: :obj:`ChatBannedRights <DevLGram.api.types.ChatBannedRights>`
    ...
    ID = 0xa5866b41
    QUALNAME = "messages.EditChatDefaultBannedRights"

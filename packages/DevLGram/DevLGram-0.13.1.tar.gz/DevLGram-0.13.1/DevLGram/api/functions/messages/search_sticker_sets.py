...
class SearchStickerSets(Object):
    ...
    Returns:
        Either :obj:`messages.FoundStickerSetsNotModified <DevLGram.api.types.messages.FoundStickerSetsNotModified>` or :obj:`messages.FoundStickerSets <DevLGram.api.types.messages.FoundStickerSets>`
    """

    __slots__ = ["q", "hash", "exclude_featured"]

    ID = 0xc2b7d08b
    QUALNAME = "messages.SearchStickerSets"

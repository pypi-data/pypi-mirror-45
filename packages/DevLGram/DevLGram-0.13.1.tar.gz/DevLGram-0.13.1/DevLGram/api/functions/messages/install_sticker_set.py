...
class InstallStickerSet(Object):
    ...
    Returns:
        Either :obj:`messages.StickerSetInstallResultSuccess <DevLGram.api.types.messages.StickerSetInstallResultSuccess>` or :obj:`messages.StickerSetInstallResultArchive <DevLGram.api.types.messages.StickerSetInstallResultArchive>`
    """

    __slots__ = ["stickerset", "archived"]

    ID = 0xc78fe460
    QUALNAME = "messages.InstallStickerSet"

...
class ExportChatInvite(Object):
    ...
    Returns:
        Either :obj:`ChatInviteEmpty <DevLGram.api.types.ChatInviteEmpty>` or :obj:`ChatInviteExported <DevLGram.api.types.ChatInviteExported>`
    """

    __slots__ = ["peer"]

    ID = 0x0df7534c
    QUALNAME = "messages.ExportChatInvite"

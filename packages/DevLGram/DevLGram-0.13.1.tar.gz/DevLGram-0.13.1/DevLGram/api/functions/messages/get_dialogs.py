...
class GetDialogs(Object):
    ...
    Returns:
        Either :obj:`messages.Dialogs <DevLGram.api.types.messages.Dialogs>`, :obj:`messages.DialogsSlice <DevLGram.api.types.messages.DialogsSlice>` or :obj:`messages.DialogsNotModified <DevLGram.api.types.messages.DialogsNotModified>`
    """

    __slots__ = ["offset_date", "offset_id", "offset_peer", "limit", "hash", "exclude_pinned"]

    ID = 0xb098aee6
    QUALNAME = "messages.GetDialogs"

    def __init__(self, *, offset_date: int, offset_id: int, offset_peer, limit: int, hash: int, exclude_pinned: bool = None):
    ...
    def read(b: BytesIO, *args) -> "GetDialogs":
        ...
        return GetDialogs(offset_date=offset_date, offset_id=offset_id, offset_peer=offset_peer, limit=limit, hash=hash, exclude_pinned=exclude_pinned)

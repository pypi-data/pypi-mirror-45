...
class GetTopPeers(Object):
    ...
    Returns:
        Either :obj:`contacts.TopPeersNotModified <DevLGram.api.types.contacts.TopPeersNotModified>`, :obj:`contacts.TopPeers <DevLGram.api.types.contacts.TopPeers>` or :obj:`contacts.TopPeersDisabled <DevLGram.api.types.contacts.TopPeersDisabled>`
    """

    __slots__ = ["offset", "limit", "hash", "correspondents", "bots_pm", "bots_inline", "phone_calls", "groups", "channels"]

    ID = 0xd4982db5
    QUALNAME = "contacts.GetTopPeers"
    ...
    def read(b: BytesIO, *args) -> "GetTopPeers":
        ...
        return GetTopPeers(offset=offset, limit=limit, hash=hash, correspondents=correspondents, bots_pm=bots_pm, bots_inline=bots_inline, phone_calls=phone_calls, groups=groups, channels=channels)

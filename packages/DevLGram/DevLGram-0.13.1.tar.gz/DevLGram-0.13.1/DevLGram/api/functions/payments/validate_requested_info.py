...
class ValidateRequestedInfo(Object):
    ...
    Args:
        msg_id: ``int`` ``32-bit``
        info: :obj:`PaymentRequestedInfo <DevLGram.api.types.PaymentRequestedInfo>`
        save (optional): ``bool``
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <DevLGram.api.types.payments.ValidatedRequestedInfo>`
    """

    __slots__ = ["msg_id", "info", "save"]

    ID = 0x770a8e74
    QUALNAME = "payments.ValidateRequestedInfo"

...
class SendPaymentForm(Object):
    ...
    Args:
        msg_id: ``int`` ``32-bit``
        credentials: Either :obj:`InputPaymentCredentialsSaved <DevLGram.api.types.InputPaymentCredentialsSaved>`, :obj:`InputPaymentCredentials <DevLGram.api.types.InputPaymentCredentials>`, :obj:`InputPaymentCredentialsApplePay <DevLGram.api.types.InputPaymentCredentialsApplePay>` or :obj:`InputPaymentCredentialsAndroidPay <DevLGram.api.types.InputPaymentCredentialsAndroidPay>`
    ...
    Returns:
        Either :obj:`payments.PaymentResult <DevLGram.api.types.payments.PaymentResult>` or :obj:`payments.PaymentVerficationNeeded <DevLGram.api.types.payments.PaymentVerficationNeeded>`
    """

    __slots__ = ["msg_id", "credentials", "requested_info_id", "shipping_option_id"]

    ID = 0x2b8879b3
    QUALNAME = "payments.SendPaymentForm"

...
class InitConnection(Object):
    ...
    Args:
        ...
        proxy (optional): :obj:`InputClientProxy <DevLGram.api.types.InputClientProxy>`
    ...
    __slots__ = ["api_id", "device_model", "system_version", "app_version", "system_lang_code", "lang_pack", "lang_code", "query", "proxy"]

    ID = 0x785188b8
    QUALNAME = "InitConnection"
    ...
    def read(b: BytesIO, *args) -> "InitConnection":
        ...
        return InitConnection(api_id=api_id, device_model=device_model, system_version=system_version, app_version=app_version, system_lang_code=system_lang_code, lang_pack=lang_pack, lang_code=lang_code, query=query, proxy=proxy)

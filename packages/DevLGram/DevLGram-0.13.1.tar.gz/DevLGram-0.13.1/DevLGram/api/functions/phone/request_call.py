...
class RequestCall(Object):
    ...
    Returns:
        :obj:`phone.PhoneCall <DevLGram.api.types.phone.PhoneCall>`
    """

    __slots__ = ["user_id", "random_id", "g_a_hash", "protocol"]

    ID = 0x5b95b3d4
    QUALNAME = "phone.RequestCall"
    ...
    def read(b: BytesIO, *args) -> "RequestCall":
        ...
        return RequestCall(user_id=user_id, random_id=random_id, g_a_hash=g_a_hash, protocol=protocol)

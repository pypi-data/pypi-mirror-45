...
class GetDifference(Object):
    ...
    Returns:
        Either :obj:`updates.DifferenceEmpty <DevLGram.api.types.updates.DifferenceEmpty>`, :obj:`updates.Difference <DevLGram.api.types.updates.Difference>`, :obj:`updates.DifferenceSlice <DevLGram.api.types.updates.DifferenceSlice>` or :obj:`updates.DifferenceTooLong <DevLGram.api.types.updates.DifferenceTooLong>`
    """

    __slots__ = ["pts", "date", "qts", "pts_total_limit"]

    ID = 0x25939651
    QUALNAME = "updates.GetDifference"

...
class PassportConfig(Object):
    """Attributes:
        ID: ``0xa098d6af``

    Args:
        hash: ``int`` ``32-bit``
        countries_langs: :obj:`DataJSON <DevLGram.api.types.DataJSON>`

    See Also:
        This object can be returned by :obj:`help.GetPassportConfig <DevLGram.api.functions.help.GetPassportConfig>`.
    """

    __slots__ = ["hash", "countries_langs"]

    ID = 0xa098d6af
    QUALNAME = "help.PassportConfig"

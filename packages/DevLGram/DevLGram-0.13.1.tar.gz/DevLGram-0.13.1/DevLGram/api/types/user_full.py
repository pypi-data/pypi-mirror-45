...
class UserFull(Object):
    ...
    Args:
        ...
        link: :obj:`contacts.Link <DevLGram.api.types.contacts.Link>`
        ...
        about (optional): ``str``
        profile_photo (optional): Either :obj:`PhotoEmpty <DevLGram.api.types.PhotoEmpty>` or :obj:`Photo <DevLGram.api.types.Photo>`
        bot_info (optional): :obj:`BotInfo <DevLGram.api.types.BotInfo>`
        pinned_msg_id (optional): ``int`` ``32-bit``

    See Also:
        This object can be returned by :obj:`users.GetFullUser <DevLGram.api.functions.users.GetFullUser>`.
    """

    __slots__ = ["user", "link", "notify_settings", "common_chats_count", "blocked", "phone_calls_available", "phone_calls_private", "can_pin_message", "about", "profile_photo", "bot_info", "pinned_msg_id"]

    ID = 0x8ea4a881
    QUALNAME = "UserFull"

    def __init__(self, *, user, link, notify_settings, common_chats_count: int, blocked: bool = None, phone_calls_available: bool = None, phone_calls_private: bool = None, can_pin_message: bool = None, about: str = None, profile_photo=None, bot_info=None, pinned_msg_id: int = None):
    ...
    def read(b: BytesIO, *args) -> "UserFull":
        ...
        return UserFull(user=user, link=link, notify_settings=notify_settings, common_chats_count=common_chats_count, blocked=blocked, phone_calls_available=phone_calls_available, phone_calls_private=phone_calls_private, can_pin_message=can_pin_message, about=about, profile_photo=profile_photo, bot_info=bot_info, pinned_msg_id=pinned_msg_id)

...
class MessageMediaInvoice(Object):
    ...
    Args:
        ...
        test (optional): ``bool``
        photo (optional): Either :obj:`WebDocument <DevLGram.api.types.WebDocument>` or :obj:`WebDocumentNoProxy <DevLGram.api.types.WebDocumentNoProxy>`

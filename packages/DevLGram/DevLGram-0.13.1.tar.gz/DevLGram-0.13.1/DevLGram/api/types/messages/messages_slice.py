...
class MessagesSlice(Object):
    ...
    __slots__ = ["count", "messages", "chats", "users", "inexact"]

    ID = 0xa6c47aaa
    QUALNAME = "messages.MessagesSlice"

    def __init__(self, *, count: int, messages: list, chats: list, users: list, inexact: bool = None):

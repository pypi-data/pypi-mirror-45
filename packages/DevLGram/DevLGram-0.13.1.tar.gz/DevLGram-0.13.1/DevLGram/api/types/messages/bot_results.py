...
class BotResults(Object):
    ...
    Args:
        query_id: ``int`` ``64-bit``
        results: List of either :obj:`BotInlineResult <DevLGram.api.types.BotInlineResult>` or :obj:`BotInlineMediaResult <DevLGram.api.types.BotInlineMediaResult>`
    ...
    See Also:
        This object can be returned by :obj:`messages.GetInlineBotResults <DevLGram.api.functions.messages.GetInlineBotResults>`.
    """

    __slots__ = ["query_id", "results", "cache_time", "users", "gallery", "next_offset", "switch_pm"]

    ID = 0x947ca848
    QUALNAME = "messages.BotResults"

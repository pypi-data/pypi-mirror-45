...
class BotCallbackAnswer(Object):
    ...
    See Also:
        This object can be returned by :obj:`messages.GetBotCallbackAnswer <DevLGram.api.functions.messages.GetBotCallbackAnswer>`.
    """

    __slots__ = ["cache_time", "alert", "has_url", "native_ui", "message", "url"]

    ID = 0x36585ea4
    QUALNAME = "messages.BotCallbackAnswer"

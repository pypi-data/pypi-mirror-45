...
class FoundGifs(Object):
    ...
    Args:
        ...
        results: List of either :obj:`FoundGif <DevLGram.api.types.FoundGif>` or :obj:`FoundGifCached <DevLGram.api.types.FoundGifCached>`

    See Also:
        This object can be returned by :obj:`messages.SearchGifs <DevLGram.api.functions.messages.SearchGifs>`.
    """

    __slots__ = ["next_offset", "results"]

    ID = 0x450a1c0a
    QUALNAME = "messages.FoundGifs"

...
class PhoneCall(Object):
    ...
    Args:
        ...
        protocol: :obj:`PhoneCallProtocol <DevLGram.api.types.PhoneCallProtocol>`
        connection: :obj:`PhoneConnection <DevLGram.api.types.PhoneConnection>`
        alternative_connections: List of :obj:`PhoneConnection <DevLGram.api.types.PhoneConnection>`
        start_date: ``int`` ``32-bit``
        p2p_allowed (optional): ``bool``
    """

    __slots__ = ["id", "access_hash", "date", "admin_id", "participant_id", "g_a_or_b", "key_fingerprint", "protocol", "connection", "alternative_connections", "start_date", "p2p_allowed"]

    ID = 0xe6f9ddf3
    QUALNAME = "PhoneCall"

    def __init__(self, *, id: int, access_hash: int, date: int, admin_id: int, participant_id: int, g_a_or_b: bytes, key_fingerprint: int, protocol, connection, alternative_connections: list, start_date: int, p2p_allowed: bool = None):
    ...
    def read(b: BytesIO, *args) -> "PhoneCall":
        ...
        return PhoneCall(id=id, access_hash=access_hash, date=date, admin_id=admin_id, participant_id=participant_id, g_a_or_b=g_a_or_b, key_fingerprint=key_fingerprint, protocol=protocol, connection=connection, alternative_connections=alternative_connections, start_date=start_date, p2p_allowed=p2p_allowed)

...
class UpdateUserPhoto(Object):
    ...
    Args:
        user_id: ``int`` ``32-bit``
        date: ``int`` ``32-bit``
        photo: Either :obj:`UserProfilePhotoEmpty <DevLGram.api.types.UserProfilePhotoEmpty>` or :obj:`UserProfilePhoto <DevLGram.api.types.UserProfilePhoto>`
        previous: ``bool``
    """

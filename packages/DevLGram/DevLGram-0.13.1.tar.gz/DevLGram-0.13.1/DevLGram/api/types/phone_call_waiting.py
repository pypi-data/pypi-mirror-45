...
class PhoneCallWaiting(Object):
    ...
    __slots__ = ["id", "access_hash", "date", "admin_id", "participant_id", "protocol", "receive_date"]

    ID = 0x1b8f4ad1
    QUALNAME = "PhoneCallWaiting"
    ...
    def read(b: BytesIO, *args) -> "PhoneCallWaiting":
        ...
        return PhoneCallWaiting(id=id, access_hash=access_hash, date=date, admin_id=admin_id, participant_id=participant_id, protocol=protocol, receive_date=receive_date)

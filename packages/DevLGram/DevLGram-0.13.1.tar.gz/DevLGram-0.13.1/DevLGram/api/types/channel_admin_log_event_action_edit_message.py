...
class ChannelAdminLogEventActionEditMessage(Object):
    ...
    Args:
        prev_message: Either :obj:`MessageEmpty <DevLGram.api.types.MessageEmpty>`, :obj:`Message <DevLGram.api.types.Message>` or :obj:`MessageService <DevLGram.api.types.MessageService>`
        new_message: Either :obj:`MessageEmpty <DevLGram.api.types.MessageEmpty>`, :obj:`Message <DevLGram.api.types.Message>` or :obj:`MessageService <DevLGram.api.types.MessageService>`
    """

    __slots__ = ["prev_message", "new_message"]

    ID = 0x709b2405
    QUALNAME = "ChannelAdminLogEventActionEditMessage"

...
class UpdateNewEncryptedMessage(Object):
    ...
    Args:
        message: Either :obj:`EncryptedMessage <DevLGram.api.types.EncryptedMessage>` or :obj:`EncryptedMessageService <DevLGram.api.types.EncryptedMessageService>`
        qts: ``int`` ``32-bit``
    """
    ...
    ID = 0x12bcbd9a
    QUALNAME = "UpdateNewEncryptedMessage"

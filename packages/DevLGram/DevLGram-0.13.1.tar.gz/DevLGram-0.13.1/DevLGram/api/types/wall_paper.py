...
class WallPaper(Object):
    ...
    Args:
        ...
        slug: ``str``
        document: Either :obj:`DocumentEmpty <DevLGram.api.types.DocumentEmpty>` or :obj:`Document <DevLGram.api.types.Document>`
        creator (optional): ``bool``
        default (optional): ``bool``
        pattern (optional): ``bool``
        dark (optional): ``bool``
        settings (optional): :obj:`WallPaperSettings <DevLGram.api.types.WallPaperSettings>`

    See Also:
        This object can be returned by :obj:`account.GetWallPaper <DevLGram.api.functions.account.GetWallPaper>` and :obj:`account.UploadWallPaper <DevLGram.api.functions.account.UploadWallPaper>`.
    """

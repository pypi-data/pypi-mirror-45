...
class StickerSet(Object):
    ...
    Args:
        ...
        thumb (optional): Either :obj:`PhotoSizeEmpty <DevLGram.api.types.PhotoSizeEmpty>`, :obj:`PhotoSize <DevLGram.api.types.PhotoSize>`, :obj:`PhotoCachedSize <DevLGram.api.types.PhotoCachedSize>` or :obj:`PhotoStrippedSize <DevLGram.api.types.PhotoStrippedSize>`
    """

    __slots__ = ["id", "access_hash", "title", "short_name", "count", "hash", "archived", "official", "masks", "installed_date", "thumb"]

    ID = 0x6a90bcb7
    QUALNAME = "StickerSet"

    def __init__(self, *, id: int, access_hash: int, title: str, short_name: str, count: int, hash: int, archived: bool = None, official: bool = None, masks: bool = None, installed_date: int = None, thumb=None):
    ...
    def read(b: BytesIO, *args) -> "StickerSet":
        ...
        return StickerSet(id=id, access_hash=access_hash, title=title, short_name=short_name, count=count, hash=hash, archived=archived, official=official, masks=masks, installed_date=installed_date, thumb=thumb)

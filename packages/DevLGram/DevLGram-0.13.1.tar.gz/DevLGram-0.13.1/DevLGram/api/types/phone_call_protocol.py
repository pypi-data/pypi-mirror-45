...
class PhoneCallProtocol(Object):
    ...
    __slots__ = ["min_layer", "max_layer", "udp_p2p", "udp_reflector"]

    ID = 0xa2bb35cb
    QUALNAME = "PhoneCallProtocol"
    ...
    def read(b: BytesIO, *args) -> "PhoneCallProtocol":
        ...
        return PhoneCallProtocol(min_layer=min_layer, max_layer=max_layer, udp_p2p=udp_p2p, udp_reflector=udp_reflector)

...
class PhoneCallDiscarded(Object):
    ...
    def read(b: BytesIO, *args) -> "PhoneCallDiscarded":
        ...
        return PhoneCallDiscarded(id=id, need_rating=need_rating, need_debug=need_debug, reason=reason, duration=duration)

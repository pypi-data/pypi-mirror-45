...
class PhotoCachedSize(Object):
    ...
    Args:
        type: ``str``
        location: Either :obj:`FileLocationUnavailable <DevLGram.api.types.FileLocationUnavailable>` or :obj:`FileLocation <DevLGram.api.types.FileLocation>`
        w: ``int`` ``32-bit``
        h: ``int`` ``32-bit``
        bytes: ``bytes``
    """

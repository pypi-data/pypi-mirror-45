...
class InputStickerSetItem(Object):
    ...
    Args:
        document: Either :obj:`InputDocumentEmpty <DevLGram.api.types.InputDocumentEmpty>` or :obj:`InputDocument <DevLGram.api.types.InputDocument>`
        emoji: ``str``
        mask_coords (optional): :obj:`MaskCoords <DevLGram.api.types.MaskCoords>`
    """

    __slots__ = ["document", "emoji", "mask_coords"]

    ID = 0xffa0a496
    QUALNAME = "InputStickerSetItem"

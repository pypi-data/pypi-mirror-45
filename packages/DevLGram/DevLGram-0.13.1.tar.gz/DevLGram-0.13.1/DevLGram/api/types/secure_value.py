...
class SecureValue(Object):
    ...
    Args:
        ...
        hash: ``bytes``
        data (optional): :obj:`SecureData <DevLGram.api.types.SecureData>`
        front_side (optional): Either :obj:`SecureFileEmpty <DevLGram.api.types.SecureFileEmpty>` or :obj:`SecureFile <DevLGram.api.types.SecureFile>`
        reverse_side (optional): Either :obj:`SecureFileEmpty <DevLGram.api.types.SecureFileEmpty>` or :obj:`SecureFile <DevLGram.api.types.SecureFile>`
        selfie (optional): Either :obj:`SecureFileEmpty <DevLGram.api.types.SecureFileEmpty>` or :obj:`SecureFile <DevLGram.api.types.SecureFile>`
        translation (optional): List of either :obj:`SecureFileEmpty <DevLGram.api.types.SecureFileEmpty>` or :obj:`SecureFile <DevLGram.api.types.SecureFile>`
        files (optional): List of either :obj:`SecureFileEmpty <DevLGram.api.types.SecureFileEmpty>` or :obj:`SecureFile <DevLGram.api.types.SecureFile>`
        plain_data (optional): Either :obj:`SecurePlainPhone <DevLGram.api.types.SecurePlainPhone>` or :obj:`SecurePlainEmail <DevLGram.api.types.SecurePlainEmail>`

    See Also:
        This object can be returned by :obj:`account.GetAllSecureValues <DevLGram.api.functions.account.GetAllSecureValues>`, :obj:`account.GetSecureValue <DevLGram.api.functions.account.GetSecureValue>` and :obj:`account.SaveSecureValue <DevLGram.api.functions.account.SaveSecureValue>`.
    """

    __slots__ = ["type", "hash", "data", "front_side", "reverse_side", "selfie", "translation", "files", "plain_data"]

    ID = 0x187fa0ca
    QUALNAME = "SecureValue"

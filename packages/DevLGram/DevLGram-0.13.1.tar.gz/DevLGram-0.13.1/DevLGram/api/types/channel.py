...
class Channel(Object):
    ...
    Args:
        id: ``int`` ``32-bit``
        title: ``str``
        photo: Either :obj:`ChatPhotoEmpty <DevLGram.api.types.ChatPhotoEmpty>` or :obj:`ChatPhoto <DevLGram.api.types.ChatPhoto>`
        date: ``int`` ``32-bit``
        version: ``int`` ``32-bit``
        ...
        admin_rights (optional): :obj:`ChatAdminRights <DevLGram.api.types.ChatAdminRights>`
        banned_rights (optional): :obj:`ChatBannedRights <DevLGram.api.types.ChatBannedRights>`
        default_banned_rights (optional): :obj:`ChatBannedRights <DevLGram.api.types.ChatBannedRights>`
        participants_count (optional): ``int`` ``32-bit``
    """

    __slots__ = ["id", "title", "photo", "date", "version", "creator", "left", "broadcast", "verified", "megagroup", "restricted", "signatures", "min", "access_hash", "username", "restriction_reason", "admin_rights", "banned_rights", "default_banned_rights", "participants_count"]

    ID = 0x4df30834
    QUALNAME = "Channel"

    def __init__(self, *, id: int, title: str, photo, date: int, version: int, creator: bool = None, left: bool = None, broadcast: bool = None, verified: bool = None, megagroup: bool = None, restricted: bool = None, signatures: bool = None, min: bool = None, access_hash: int = None, username: str = None, restriction_reason: str = None, admin_rights=None, banned_rights=None, default_banned_rights=None, participants_count: int = None):

...
class LangPackLanguage(Object):
    ...
    See Also:
        This object can be returned by :obj:`langpack.GetLanguages <DevLGram.api.functions.langpack.GetLanguages>` and :obj:`langpack.GetLanguage <DevLGram.api.functions.langpack.GetLanguage>`.
    """

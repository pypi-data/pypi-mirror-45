...
class ChatParticipantsForbidden(Object):
    ...
    Args:
        chat_id: ``int`` ``32-bit``
        self_participant (optional): Either :obj:`ChatParticipant <DevLGram.api.types.ChatParticipant>`, :obj:`ChatParticipantCreator <DevLGram.api.types.ChatParticipantCreator>` or :obj:`ChatParticipantAdmin <DevLGram.api.types.ChatParticipantAdmin>`
    """

    __slots__ = ["chat_id", "self_participant"]

    ID = 0xfc900c2b
    QUALNAME = "ChatParticipantsForbidden"

...
class PhoneCallAccepted(Object):
    ...
    __slots__ = ["id", "access_hash", "date", "admin_id", "participant_id", "g_b", "protocol"]

    ID = 0x6d003d3f
    QUALNAME = "PhoneCallAccepted"
    ...
    def read(b: BytesIO, *args) -> "PhoneCallAccepted":
        ...
        return PhoneCallAccepted(id=id, access_hash=access_hash, date=date, admin_id=admin_id, participant_id=participant_id, g_b=g_b, protocol=protocol)

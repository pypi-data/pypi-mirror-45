...
class InputMediaUploadedDocument(Object):
    ...
    Args:
        ...
        mime_type: ``str``
        attributes: List of either :obj:`DocumentAttributeImageSize <DevLGram.api.types.DocumentAttributeImageSize>`, :obj:`DocumentAttributeAnimated <DevLGram.api.types.DocumentAttributeAnimated>`, :obj:`DocumentAttributeSticker <DevLGram.api.types.DocumentAttributeSticker>`, :obj:`DocumentAttributeVideo <DevLGram.api.types.DocumentAttributeVideo>`, :obj:`DocumentAttributeAudio <DevLGram.api.types.DocumentAttributeAudio>`, :obj:`DocumentAttributeFilename <DevLGram.api.types.DocumentAttributeFilename>` or :obj:`DocumentAttributeHasStickers <DevLGram.api.types.DocumentAttributeHasStickers>`
        nosound_video (optional): ``bool``
        thumb (optional): Either :obj:`InputFile <DevLGram.api.types.InputFile>` or :obj:`InputFileBig <DevLGram.api.types.InputFileBig>`
        stickers (optional): List of either :obj:`InputDocumentEmpty <DevLGram.api.types.InputDocumentEmpty>` or :obj:`InputDocument <DevLGram.api.types.InputDocument>`
        ttl_seconds (optional): ``int`` ``32-bit``
    """

    __slots__ = ["file", "mime_type", "attributes", "nosound_video", "thumb", "stickers", "ttl_seconds"]

    ID = 0x5b38c6c1
    QUALNAME = "InputMediaUploadedDocument"
    ...
    def read(b: BytesIO, *args) -> "InputMediaUploadedDocument":
        ...
        return InputMediaUploadedDocument(file=file, mime_type=mime_type, attributes=attributes, nosound_video=nosound_video, thumb=thumb, stickers=stickers, ttl_seconds=ttl_seconds)

...
class WebPage(Object):
    ...
    Args:
        ...
        photo (optional): Either :obj:`PhotoEmpty <DevLGram.api.types.PhotoEmpty>` or :obj:`Photo <DevLGram.api.types.Photo>`
        ...
        cached_page (optional): :obj:`Page <DevLGram.api.types.Page>`

    See Also:
        This object can be returned by :obj:`messages.GetWebPage <DevLGram.api.functions.messages.GetWebPage>`.
    """

    __slots__ = ["id", "url", "display_url", "hash", "type", "site_name", "title", "description", "photo", "embed_url", "embed_type", "embed_width", "embed_height", "duration", "author", "document", "cached_page"]
    ...
    def read(b: BytesIO, *args) -> "WebPage":
        ...
        return WebPage(id=id, url=url, display_url=display_url, hash=hash, type=type, site_name=site_name, title=title, description=description, photo=photo, embed_url=embed_url, embed_type=embed_type, embed_width=embed_width, embed_height=embed_height, duration=duration, author=author, document=document, cached_page=cached_page)

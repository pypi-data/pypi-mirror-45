...
class PasswordSettings(Object):
    ...
    Args:
        email (optional): ``str``
        secure_settings (optional): :obj:`SecureSecretSettings <DevLGram.api.types.SecureSecretSettings>`

    See Also:
        This object can be returned by :obj:`account.GetPasswordSettings <DevLGram.api.functions.account.GetPasswordSettings>`.
    """

    __slots__ = ["email", "secure_settings"]

    ID = 0x9a5c33e5
    QUALNAME = "account.PasswordSettings"

...
class PasswordInputSettings(Object):
    ...
    Args:
        new_algo (optional): Either :obj:`PasswordKdfAlgoUnknown <DevLGram.api.types.PasswordKdfAlgoUnknown>` or :obj:`PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow <DevLGram.api.types.PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow>`
        new_password_hash (optional): ``bytes``
        hint (optional): ``str``
        email (optional): ``str``
        new_secure_settings (optional): :obj:`SecureSecretSettings <DevLGram.api.types.SecureSecretSettings>`
    """

    __slots__ = ["new_algo", "new_password_hash", "hint", "email", "new_secure_settings"]

    ID = 0xc23727c9
    QUALNAME = "account.PasswordInputSettings"

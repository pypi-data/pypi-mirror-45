...
class Password(Object):
    ...
    Args:
        new_algo: Either :obj:`PasswordKdfAlgoUnknown <DevLGram.api.types.PasswordKdfAlgoUnknown>` or :obj:`PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow <DevLGram.api.types.PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow>`
        new_secure_algo: Either :obj:`SecurePasswordKdfAlgoUnknown <DevLGram.api.types.SecurePasswordKdfAlgoUnknown>`, :obj:`SecurePasswordKdfAlgoPBKDF2HMACSHA512iter100000 <DevLGram.api.types.SecurePasswordKdfAlgoPBKDF2HMACSHA512iter100000>` or :obj:`SecurePasswordKdfAlgoSHA512 <DevLGram.api.types.SecurePasswordKdfAlgoSHA512>`
        secure_random: ``bytes``
        has_recovery (optional): ``bool``
        has_secure_values (optional): ``bool``
        has_password (optional): ``bool``
        current_algo (optional): Either :obj:`PasswordKdfAlgoUnknown <DevLGram.api.types.PasswordKdfAlgoUnknown>` or :obj:`PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow <DevLGram.api.types.PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow>`
    ...
    See Also:
        This object can be returned by :obj:`account.GetPassword <DevLGram.api.functions.account.GetPassword>`.
    """

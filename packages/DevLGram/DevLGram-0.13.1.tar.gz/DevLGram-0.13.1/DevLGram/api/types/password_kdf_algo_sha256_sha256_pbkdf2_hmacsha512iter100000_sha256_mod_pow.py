...
class PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow(Object):
    """Attributes:
        ID: ``0x3a912d4a``
    ...
    ID = 0x3a912d4a
    QUALNAME = "PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow"

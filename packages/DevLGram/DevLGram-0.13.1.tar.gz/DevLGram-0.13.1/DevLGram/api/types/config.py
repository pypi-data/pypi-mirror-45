...
class Config(Object):
    ...
    Args:
        ...
        test_mode: ``bool``
        this_dc: ``int`` ``32-bit``
        dc_options: List of :obj:`DcOption <DevLGram.api.types.DcOption>`
    ...
    See Also:
        This object can be returned by :obj:`help.GetConfig <DevLGram.api.functions.help.GetConfig>`.
    """

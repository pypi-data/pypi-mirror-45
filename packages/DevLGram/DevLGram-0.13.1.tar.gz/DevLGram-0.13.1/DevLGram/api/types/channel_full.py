...
class ChannelFull(Object):
    ...
    Args:
        ...
        chat_photo: Either :obj:`PhotoEmpty <DevLGram.api.types.PhotoEmpty>` or :obj:`Photo <DevLGram.api.types.Photo>`
        notify_settings: :obj:`PeerNotifySettings <DevLGram.api.types.PeerNotifySettings>`
        exported_invite: Either :obj:`ChatInviteEmpty <DevLGram.api.types.ChatInviteEmpty>` or :obj:`ChatInviteExported <DevLGram.api.types.ChatInviteExported>`
        bot_info: List of :obj:`BotInfo <DevLGram.api.types.BotInfo>`
        ...
        stickerset (optional): :obj:`StickerSet <DevLGram.api.types.StickerSet>`
        available_min_id (optional): ``int`` ``32-bit``
    """

    __slots__ = ["id", "about", "read_inbox_max_id", "read_outbox_max_id", "unread_count", "chat_photo", "notify_settings", "exported_invite", "bot_info", "can_view_participants", "can_set_username", "can_set_stickers", "hidden_prehistory", "can_view_stats", "participants_count", "admins_count", "kicked_count", "banned_count", "online_count", "migrated_from_chat_id", "migrated_from_max_id", "pinned_msg_id", "stickerset", "available_min_id"]

    ID = 0x1c87a71a
    QUALNAME = "ChannelFull"

    def __init__(self, *, id: int, about: str, read_inbox_max_id: int, read_outbox_max_id: int, unread_count: int, chat_photo, notify_settings, exported_invite, bot_info: list, can_view_participants: bool = None, can_set_username: bool = None, can_set_stickers: bool = None, hidden_prehistory: bool = None, can_view_stats: bool = None, participants_count: int = None, admins_count: int = None, kicked_count: int = None, banned_count: int = None, online_count: int = None, migrated_from_chat_id: int = None, migrated_from_max_id: int = None, pinned_msg_id: int = None, stickerset=None, available_min_id: int = None):
    ...
    def read(b: BytesIO, *args) -> "ChannelFull":
        ...
        return ChannelFull(id=id, about=about, read_inbox_max_id=read_inbox_max_id, read_outbox_max_id=read_outbox_max_id, unread_count=unread_count, chat_photo=chat_photo, notify_settings=notify_settings, exported_invite=exported_invite, bot_info=bot_info, can_view_participants=can_view_participants, can_set_username=can_set_username, can_set_stickers=can_set_stickers, hidden_prehistory=hidden_prehistory, can_view_stats=can_view_stats, participants_count=participants_count, admins_count=admins_count, kicked_count=kicked_count, banned_count=banned_count, online_count=online_count, migrated_from_chat_id=migrated_from_chat_id, migrated_from_max_id=migrated_from_max_id, pinned_msg_id=pinned_msg_id, stickerset=stickerset, available_min_id=available_min_id)

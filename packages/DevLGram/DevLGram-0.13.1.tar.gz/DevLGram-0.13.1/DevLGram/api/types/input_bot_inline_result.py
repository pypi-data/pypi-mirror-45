...
class InputBotInlineResult(Object):
    ...
    Args:
        ...
        url (optional): ``str``
        thumb (optional): :obj:`InputWebDocument <DevLGram.api.types.InputWebDocument>`
        content (optional): :obj:`InputWebDocument <DevLGram.api.types.InputWebDocument>`
    """

    __slots__ = ["id", "type", "send_message", "title", "description", "url", "thumb", "content"]

    ID = 0x88bf9319
    QUALNAME = "InputBotInlineResult"

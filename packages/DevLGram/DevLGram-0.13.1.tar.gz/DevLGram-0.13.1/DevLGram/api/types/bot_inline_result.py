...
class BotInlineResult(Object):
    ...
    Args:
        id: ``str``
        type: ``str``
        send_message: Either :obj:`BotInlineMessageMediaAuto <DevLGram.api.types.BotInlineMessageMediaAuto>`, :obj:`BotInlineMessageText <DevLGram.api.types.BotInlineMessageText>`, :obj:`BotInlineMessageMediaGeo <DevLGram.api.types.BotInlineMessageMediaGeo>`, :obj:`BotInlineMessageMediaVenue <DevLGram.api.types.BotInlineMessageMediaVenue>` or :obj:`BotInlineMessageMediaContact <DevLGram.api.types.BotInlineMessageMediaContact>`
        title (optional): ``str``
        description (optional): ``str``
        url (optional): ``str``
        thumb (optional): Either :obj:`WebDocument <DevLGram.api.types.WebDocument>` or :obj:`WebDocumentNoProxy <DevLGram.api.types.WebDocumentNoProxy>`
        content (optional): Either :obj:`WebDocument <DevLGram.api.types.WebDocument>` or :obj:`WebDocumentNoProxy <DevLGram.api.types.WebDocumentNoProxy>`
    """

    __slots__ = ["id", "type", "send_message", "title", "description", "url", "thumb", "content"]

    ID = 0x11965f3a
    QUALNAME = "BotInlineResult"

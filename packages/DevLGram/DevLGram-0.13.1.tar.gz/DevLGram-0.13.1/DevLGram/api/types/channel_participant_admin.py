...
class ChannelParticipantAdmin(Object):
    ...
    Args:
        ...
        date: ``int`` ``32-bit``
        admin_rights: :obj:`ChatAdminRights <DevLGram.api.types.ChatAdminRights>`
        can_edit (optional): ``bool``
        is_self (optional): ``bool``
        inviter_id (optional): ``int`` ``32-bit``
    """

    __slots__ = ["user_id", "promoted_by", "date", "admin_rights", "can_edit", "is_self", "inviter_id"]

    ID = 0x5daa6e23
    QUALNAME = "ChannelParticipantAdmin"

    def __init__(self, *, user_id: int, promoted_by: int, date: int, admin_rights, can_edit: bool = None, is_self: bool = None, inviter_id: int = None):
    ...
    def read(b: BytesIO, *args) -> "ChannelParticipantAdmin":
        ...
        return ChannelParticipantAdmin(user_id=user_id, promoted_by=promoted_by, date=date, admin_rights=admin_rights, can_edit=can_edit, is_self=is_self, inviter_id=inviter_id)

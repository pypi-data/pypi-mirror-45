...
class PhoneCallRequested(Object):
    ...
    __slots__ = ["id", "access_hash", "date", "admin_id", "participant_id", "g_a_hash", "protocol"]

    ID = 0x83761ce4
    QUALNAME = "PhoneCallRequested"
    ...
    def read(b: BytesIO, *args) -> "PhoneCallRequested":
        ...
        return PhoneCallRequested(id=id, access_hash=access_hash, date=date, admin_id=admin_id, participant_id=participant_id, g_a_hash=g_a_hash, protocol=protocol)

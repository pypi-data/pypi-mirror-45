...
class PeerSettings(Object):
    ...
    See Also:
        This object can be returned by :obj:`messages.GetPeerSettings <DevLGram.api.functions.messages.GetPeerSettings>`.
    """

    __slots__ = ["report_spam"]

    ID = 0x818426cd
    QUALNAME = "PeerSettings"
    ...
    def read(b: BytesIO, *args) -> "PeerSettings":
        ...
        return PeerSettings(report_spam=report_spam)

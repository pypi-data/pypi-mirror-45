...
class CdnConfig(Object):
    ...
    Args:
        public_keys: List of :obj:`CdnPublicKey <DevLGram.api.types.CdnPublicKey>`

    See Also:
        This object can be returned by :obj:`help.GetCdnConfig <DevLGram.api.functions.help.GetCdnConfig>`.
    """

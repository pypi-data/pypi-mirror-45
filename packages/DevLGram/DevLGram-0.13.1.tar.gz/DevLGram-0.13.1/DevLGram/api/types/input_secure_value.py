...
class InputSecureValue(Object):
    ...
    Args:
        ...
        front_side (optional): Either :obj:`InputSecureFileUploaded <DevLGram.api.types.InputSecureFileUploaded>` or :obj:`InputSecureFile <DevLGram.api.types.InputSecureFile>`
        reverse_side (optional): Either :obj:`InputSecureFileUploaded <DevLGram.api.types.InputSecureFileUploaded>` or :obj:`InputSecureFile <DevLGram.api.types.InputSecureFile>`
        selfie (optional): Either :obj:`InputSecureFileUploaded <DevLGram.api.types.InputSecureFileUploaded>` or :obj:`InputSecureFile <DevLGram.api.types.InputSecureFile>`
        translation (optional): List of either :obj:`InputSecureFileUploaded <DevLGram.api.types.InputSecureFileUploaded>` or :obj:`InputSecureFile <DevLGram.api.types.InputSecureFile>`
        files (optional): List of either :obj:`InputSecureFileUploaded <DevLGram.api.types.InputSecureFileUploaded>` or :obj:`InputSecureFile <DevLGram.api.types.InputSecureFile>`

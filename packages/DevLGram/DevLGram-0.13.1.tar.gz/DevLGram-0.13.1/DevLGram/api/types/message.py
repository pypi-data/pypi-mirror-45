...
class Message(Object):
    ...
    __slots__ = ["id", "to_id", "date", "message", "out", "mentioned", "media_unread", "silent", "post", "from_scheduled", "from_id", "fwd_from", "via_bot_id", "reply_to_msg_id", "media", "reply_markup", "entities", "views", "edit_date", "post_author", "grouped_id"]

    ID = 0x44f9b43d
    QUALNAME = "Message"

    def __init__(self, *, id: int, to_id, date: int, message: str, out: bool = None, mentioned: bool = None, media_unread: bool = None, silent: bool = None, post: bool = None, from_scheduled: bool = None, from_id: int = None, fwd_from=None, via_bot_id: int = None, reply_to_msg_id: int = None, media=None, reply_markup=None, entities: list = None, views: int = None, edit_date: int = None, post_author: str = None, grouped_id: int = None):

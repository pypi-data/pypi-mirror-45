...
class Authorization(Object):
    ...
    See Also:
        This object can be returned by :obj:`auth.SignUp <DevLGram.api.functions.auth.SignUp>`, :obj:`auth.SignIn <DevLGram.api.functions.auth.SignIn>`, :obj:`auth.ImportAuthorization <DevLGram.api.functions.auth.ImportAuthorization>`, :obj:`auth.ImportBotAuthorization <DevLGram.api.functions.auth.ImportBotAuthorization>`, :obj:`auth.CheckPassword <DevLGram.api.functions.auth.CheckPassword>` and :obj:`auth.RecoverPassword <DevLGram.api.functions.auth.RecoverPassword>`.
    """

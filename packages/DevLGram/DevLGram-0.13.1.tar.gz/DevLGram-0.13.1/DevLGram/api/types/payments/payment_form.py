...
class PaymentForm(Object):
    ...
    Args:
        ...
        native_params (optional): :obj:`DataJSON <DevLGram.api.types.DataJSON>`
        saved_info (optional): :obj:`PaymentRequestedInfo <DevLGram.api.types.PaymentRequestedInfo>`
        saved_credentials (optional): :obj:`PaymentSavedCredentialsCard <DevLGram.api.types.PaymentSavedCredentialsCard>`

    See Also:
        This object can be returned by :obj:`payments.GetPaymentForm <DevLGram.api.functions.payments.GetPaymentForm>`.
    """

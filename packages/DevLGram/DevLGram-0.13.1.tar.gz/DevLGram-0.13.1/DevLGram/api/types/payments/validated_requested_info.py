...
class ValidatedRequestedInfo(Object):
    ...
    Args:
        id (optional): ``str``
        shipping_options (optional): List of :obj:`ShippingOption <DevLGram.api.types.ShippingOption>`

    See Also:
        This object can be returned by :obj:`payments.ValidateRequestedInfo <DevLGram.api.functions.payments.ValidateRequestedInfo>`.
    """

    __slots__ = ["id", "shipping_options"]

    ID = 0xd1451883
    QUALNAME = "payments.ValidatedRequestedInfo"

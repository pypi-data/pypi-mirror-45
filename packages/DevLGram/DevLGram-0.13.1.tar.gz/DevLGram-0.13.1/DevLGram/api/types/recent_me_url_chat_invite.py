...
class RecentMeUrlChatInvite(Object):
    ...
    Args:
        url: ``str``
        chat_invite: Either :obj:`ChatInviteAlready <DevLGram.api.types.ChatInviteAlready>` or :obj:`ChatInvite <DevLGram.api.types.ChatInvite>`
    """

    __slots__ = ["url", "chat_invite"]

    ID = 0xeb49081d
    QUALNAME = "RecentMeUrlChatInvite"

...
class InputMediaInvoice(Object):
    ...
    Args:
        ...
        payload: ``bytes``
        provider: ``str``
        provider_data: :obj:`DataJSON <DevLGram.api.types.DataJSON>`
        start_param: ``str``
        photo (optional): :obj:`InputWebDocument <DevLGram.api.types.InputWebDocument>`
    """

    __slots__ = ["title", "description", "invoice", "payload", "provider", "provider_data", "start_param", "photo"]

    ID = 0xf4e096c3
    QUALNAME = "InputMediaInvoice"

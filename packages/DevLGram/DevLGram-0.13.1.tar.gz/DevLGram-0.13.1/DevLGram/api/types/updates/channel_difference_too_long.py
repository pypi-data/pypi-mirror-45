...
class ChannelDifferenceTooLong(Object):
    ...
    __slots__ = ["pts", "top_message", "read_inbox_max_id", "read_outbox_max_id", "unread_count", "unread_mentions_count", "messages", "chats", "users", "final", "timeout"]

    ID = 0x6a9d7b35
    QUALNAME = "updates.ChannelDifferenceTooLong"
    ...
    def read(b: BytesIO, *args) -> "ChannelDifferenceTooLong":
        ...
        return ChannelDifferenceTooLong(pts=pts, top_message=top_message, read_inbox_max_id=read_inbox_max_id, read_outbox_max_id=read_outbox_max_id, unread_count=unread_count, unread_mentions_count=unread_mentions_count, messages=messages, chats=chats, users=users, final=final, timeout=timeout)

...
class UpdateBotInlineSend(Object):
    ...
    Args:
        ...
        query: ``str``
        id: ``str``
        geo (optional): Either :obj:`GeoPointEmpty <DevLGram.api.types.GeoPointEmpty>` or :obj:`GeoPoint <DevLGram.api.types.GeoPoint>`
        msg_id (optional): :obj:`InputBotInlineMessageID <DevLGram.api.types.InputBotInlineMessageID>`
    """

    __slots__ = ["user_id", "query", "id", "geo", "msg_id"]

    ID = 0x0e48f964
    QUALNAME = "UpdateBotInlineSend"

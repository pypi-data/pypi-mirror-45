...
class MessageFwdHeader(Object):
    ...
    Args:
        ...
        saved_from_peer (optional): Either :obj:`PeerUser <DevLGram.api.types.PeerUser>`, :obj:`PeerChat <DevLGram.api.types.PeerChat>` or :obj:`PeerChannel <DevLGram.api.types.PeerChannel>`
        saved_from_msg_id (optional): ``int`` ``32-bit``
    """

    __slots__ = ["date", "from_id", "from_name", "channel_id", "channel_post", "post_author", "saved_from_peer", "saved_from_msg_id"]

    ID = 0xec338270
    QUALNAME = "MessageFwdHeader"

    def __init__(self, *, date: int, from_id: int = None, from_name: str = None, channel_id: int = None, channel_post: int = None, post_author: str = None, saved_from_peer=None, saved_from_msg_id: int = None):
    ...
    def read(b: BytesIO, *args) -> "MessageFwdHeader":
        ...
        return MessageFwdHeader(date=date, from_id=from_id, from_name=from_name, channel_id=channel_id, channel_post=channel_post, post_author=post_author, saved_from_peer=saved_from_peer, saved_from_msg_id=saved_from_msg_id)

...
class SecureSecretSettings(Object):
    """Attributes:
        ID: ``0x1527bcac``

    Args:
        secure_algo: Either :obj:`SecurePasswordKdfAlgoUnknown <DevLGram.api.types.SecurePasswordKdfAlgoUnknown>`, :obj:`SecurePasswordKdfAlgoPBKDF2HMACSHA512iter100000 <DevLGram.api.types.SecurePasswordKdfAlgoPBKDF2HMACSHA512iter100000>` or :obj:`SecurePasswordKdfAlgoSHA512 <DevLGram.api.types.SecurePasswordKdfAlgoSHA512>`
        secure_secret: ``bytes``

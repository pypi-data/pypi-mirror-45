...
class Contacts(Object):
    ...
    Args:
        contacts: List of :obj:`Contact <DevLGram.api.types.Contact>`
    ...
    See Also:
        This object can be returned by :obj:`contacts.GetContacts <DevLGram.api.functions.contacts.GetContacts>`.
    """

    __slots__ = ["contacts", "saved_count", "users"]

    ID = 0xeae87e42
    QUALNAME = "contacts.Contacts"

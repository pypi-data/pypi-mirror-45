...
class ChannelAdminLogEventActionDefaultBannedRights(Object):
    """Attributes:
        ID: ``0x2df5fc0a``

    Args:
        prev_banned_rights: :obj:`ChatBannedRights <DevLGram.api.types.ChatBannedRights>`
        new_banned_rights: :obj:`ChatBannedRights <DevLGram.api.types.ChatBannedRights>`
    """

    __slots__ = ["prev_banned_rights", "new_banned_rights"]

    ID = 0x2df5fc0a
    QUALNAME = "ChannelAdminLogEventActionDefaultBannedRights"

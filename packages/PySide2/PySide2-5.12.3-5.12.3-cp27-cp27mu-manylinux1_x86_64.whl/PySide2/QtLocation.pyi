...
class QGeoCodingManagerEngine(PySide2.QtCore.QObject):
    ...
    def __init__(self, parameters: Dict[str, Any], parent: PySide2.QtCore.QObject=...): ...
    @typing.overload
    def geocode(self, address: PySide2.QtPositioning.QGeoAddress, bounds: PySide2.QtPositioning.QGeoShape) -> PySide2.QtLocation.QGeoCodeReply: ...
    @typing.overload
...
class QGeoManeuver(Shiboken.Object):
    ...
    def setExtendedAttributes(self, extendedAttributes: Dict[str, Any]): ...
...
class QGeoRouteRequest(Shiboken.Object):
    ...
    def extraParameters(self) -> Dict[str, Any]: ...
    ...
    def setExtraParameters(self, extraParameters: Dict[str, Any]): ...
...
class QGeoServiceProvider(PySide2.QtCore.QObject):
    ...
    def __init__(self, providerName: str, parameters: Dict[str, Any]=..., allowExperimental: bool=...): ...
    @staticmethod
...
class QGeoServiceProviderFactory(Shiboken.Object):
    ...
    def __init__(self): ...
    def createGeocodingManagerEngine(self, parameters: Dict[str, Any], error: PySide2.QtLocation.QGeoServiceProvider.Error, errorString: str) -> PySide2.QtLocation.QGeoCodingManagerEngine: ...
    def createPlaceManagerEngine(self, parameters: Dict[str, Any], error: PySide2.QtLocation.QGeoServiceProvider.Error, errorString: str) -> PySide2.QtLocation.QPlaceManagerEngine: ...
    def createRoutingManagerEngine(self, parameters: Dict[str, Any], error: PySide2.QtLocation.QGeoServiceProvider.Error, errorString: str) -> PySide2.QtLocation.QGeoRoutingManagerEngine: ...

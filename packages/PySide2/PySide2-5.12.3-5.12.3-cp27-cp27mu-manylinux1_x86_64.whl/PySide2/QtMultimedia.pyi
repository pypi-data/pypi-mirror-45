...
class QAudioEncoderSettings(Shiboken.Object):
    ...
    def encodingOptions(self) -> Dict[str, Any]: ...
    def isNull(self) -> bool: ...
    ...
    def setEncodingOptions(self, options: Dict[str, Any]): ...
...
class QRadioTuner(PySide2.QtMultimedia.QMediaObject):
    ...
    def frequencyRange(self, band: PySide2.QtMultimedia.QRadioTuner.Band) -> Pair: ...
...
class QRadioTunerControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def errorString(self) -> str: ...
    def frequency(self) -> int: ...
    def frequencyRange(self, b: PySide2.QtMultimedia.QRadioTuner.Band) -> Pair: ...
...
class QVideoFrame(Shiboken.Object):
    ...
    def __copy__(self): ...
    def availableMetaData(self) -> Dict[str, Any]: ...
    def bits(self) -> Char: ...
    @typing.overload

...
enum : int {
    ...
    SBK_QTCORE_QVECTOR_QCBORVALUE_IDX                        = 23, // QVector<QCborValue >
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 24, // const QList<QCommandLineOption > &
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 25, // QList<QFileInfo >
    SBK_QTCORE_QVECTOR_QPOINTF_IDX                           = 26, // QVector<QPointF >
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 27, // const QList<QItemSelectionRange > &
    SBK_QTCORE_QSET_QITEMSELECTIONRANGE_IDX                  = 28, // const QSet<QItemSelectionRange > &
    SBK_QTCORE_QVECTOR_QITEMSELECTIONRANGE_IDX               = 29, // const QVector<QItemSelectionRange > &
    SBK_QTCORE_QLIST_QLOCALE_COUNTRY_IDX                     = 30, // QList<QLocale::Country >
    SBK_QTCORE_QLIST_QLOCALE_IDX                             = 31, // QList<QLocale >
    SBK_QTCORE_QLIST_QT_DAYOFWEEK_IDX                        = 32, // QList<Qt::DayOfWeek >
    SBK_QTCORE_QLIST_QURL_IDX                                = 33, // const QList<QUrl > &
    SBK_QTCORE_QLIST_QMIMETYPE_IDX                           = 34, // QList<QMimeType >
    SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                      = 35, // QPair<qreal,QVariant >
    SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX              = 36, // QVector<QPair< qreal,QVariant > >
    SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX              = 37, // QList<QAbstractTransition* >
    SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                    = 38, // QSet<QAbstractState* >
    SBK_QTCORE_QLIST_QSTORAGEINFO_IDX                        = 39, // QList<QStorageInfo >
    SBK_QTCORE_QLIST_INT_IDX                                 = 40, // QList<int >
    SBK_QTCORE_QVECTOR_QTIMEZONE_OFFSETDATA_IDX              = 41, // QVector<QTimeZone::OffsetData >
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 42, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 43, // QList<QPair< QString,QString > >
    SBK_QTCORE_QVECTOR_QXMLSTREAMATTRIBUTE_IDX               = 44, // QVector<QXmlStreamAttribute > &
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 45, // const QList<QXmlStreamAttribute > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMNAMESPACEDECLARATION_IDX    = 46, // const QVector<QXmlStreamNamespaceDeclaration > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMENTITYDECLARATION_IDX       = 47, // QVector<QXmlStreamEntityDeclaration >
    SBK_QTCORE_QVECTOR_QXMLSTREAMNOTATIONDECLARATION_IDX     = 48, // QVector<QXmlStreamNotationDeclaration >
    SBK_QTCORE_QLIST_QSTRING_IDX                             = 49, // QList<QString >
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 50, // QMap<QString,QVariant >

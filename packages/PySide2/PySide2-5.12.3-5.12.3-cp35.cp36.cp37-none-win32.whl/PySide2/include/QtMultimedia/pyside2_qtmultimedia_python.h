...
enum : int {
    ...
    SBK_QTMULTIMEDIA_QLIST_QSTRING_IDX                       = 7, // QList<QString >
    SBK_QTMULTIMEDIA_QLIST_QAUDIO_ROLE_IDX                   = 8, // QList<QAudio::Role >
    SBK_QTMULTIMEDIA_QLIST_QCAMERA_FRAMERATERANGE_IDX        = 9, // QList<QCamera::FrameRateRange >
    SBK_QTMULTIMEDIA_QLIST_QSIZE_IDX                         = 10, // QList<QSize >
    SBK_QTMULTIMEDIA_QLIST_QCAMERAVIEWFINDERSETTINGS_IDX     = 11, // QList<QCameraViewfinderSettings >
    SBK_QTMULTIMEDIA_QLIST_QVARIANT_IDX                      = 12, // QList<QVariant >
    SBK_QTMULTIMEDIA_QLIST_QCAMERAINFO_IDX                   = 13, // QList<QCameraInfo >
    SBK_QTMULTIMEDIA_QLIST_QMEDIARESOURCE_IDX                = 14, // const QList<QMediaResource > &
    SBK_QTMULTIMEDIA_QLIST_QNETWORKCONFIGURATION_IDX         = 15, // const QList<QNetworkConfiguration > &
    SBK_QTMULTIMEDIA_QLIST_QMEDIACONTENT_IDX                 = 16, // const QList<QMediaContent > &
    SBK_QTMULTIMEDIA_QLIST_QREAL_IDX                         = 17, // QList<qreal >
    SBK_QTMULTIMEDIA_QLIST_QMEDIATIMEINTERVAL_IDX            = 18, // QList<QMediaTimeInterval >
    SBK_QTMULTIMEDIA_QPAIR_INT_INT_IDX                       = 19, // QPair<int,int >
    SBK_QTMULTIMEDIA_QMAP_QSTRING_QVARIANT_IDX               = 20, // QMap<QString,QVariant >

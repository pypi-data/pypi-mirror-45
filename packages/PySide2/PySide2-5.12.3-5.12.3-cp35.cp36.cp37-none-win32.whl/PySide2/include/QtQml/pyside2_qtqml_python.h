...
enum : int {
    ...
    SBK_QQMLABSTRACTURLINTERCEPTOR_IDX                       = 9,
    SBK_QQMLABSTRACTURLINTERCEPTOR_DATATYPE_IDX              = 10,
    SBK_QQMLAPPLICATIONENGINE_IDX                            = 11,
    SBK_QQMLCOMPONENT_IDX                                    = 12,
    SBK_QQMLCOMPONENT_COMPILATIONMODE_IDX                    = 13,
    SBK_QQMLCOMPONENT_STATUS_IDX                             = 14,
    SBK_QQMLCONTEXT_IDX                                      = 15,
    SBK_QQMLDEBUGGINGENABLER_IDX                             = 16,
    SBK_QQMLDEBUGGINGENABLER_STARTMODE_IDX                   = 17,
    SBK_QQMLENGINE_IDX                                       = 18,
    SBK_QQMLENGINE_OBJECTOWNERSHIP_IDX                       = 19,
    SBK_QQMLERROR_IDX                                        = 20,
    SBK_QQMLEXPRESSION_IDX                                   = 21,
    SBK_QQMLEXTENSIONINTERFACE_IDX                           = 22,
    SBK_QQMLEXTENSIONPLUGIN_IDX                              = 23,
    SBK_QQMLFILE_IDX                                         = 24,
    SBK_QQMLFILE_STATUS_IDX                                  = 25,
    SBK_QQMLFILESELECTOR_IDX                                 = 26,
    SBK_QQMLIMAGEPROVIDERBASE_IDX                            = 27,
    SBK_QQMLIMAGEPROVIDERBASE_IMAGETYPE_IDX                  = 29,
    SBK_QQMLIMAGEPROVIDERBASE_FLAG_IDX                       = 28,
    SBK_QFLAGS_QQMLIMAGEPROVIDERBASE_FLAG_IDX                = 1,
    SBK_QQMLINCUBATIONCONTROLLER_IDX                         = 30,
    SBK_QQMLINCUBATOR_IDX                                    = 31,
    SBK_QQMLINCUBATOR_INCUBATIONMODE_IDX                     = 32,
    SBK_QQMLINCUBATOR_STATUS_IDX                             = 33,
    SBK_QQMLLISTREFERENCE_IDX                                = 34,
    SBK_QQMLNETWORKACCESSMANAGERFACTORY_IDX                  = 35,
    SBK_QQMLPARSERSTATUS_IDX                                 = 36,
    SBK_QQMLPROPERTY_IDX                                     = 37,
    SBK_QQMLPROPERTY_PROPERTYTYPECATEGORY_IDX                = 38,
    SBK_QQMLPROPERTY_TYPE_IDX                                = 39,
    SBK_QQMLPROPERTYMAP_IDX                                  = 40,
    SBK_QQMLPROPERTYVALUESOURCE_IDX                          = 41,
    SBK_QQMLSCRIPTSTRING_IDX                                 = 42,
    SBK_QQMLTYPESEXTENSIONINTERFACE_IDX                      = 43,
    SBK_QTQML_IDX                                            = 44,
    SBK_QML_HAS_ATTACHED_PROPERTIES_IDX                      = 8,
    SBK_QtQml_IDX_COUNT                                      = 45
};
...
enum : int {
    ...
    SBK_QTQML_QHASH_QSTRING_QVARIANT_IDX                     = 4, // const QHash<QString,QVariant > &
    SBK_QTQML_QLIST_QVARIANT_IDX                             = 5, // QList<QVariant >
    SBK_QTQML_QLIST_QSTRING_IDX                              = 6, // QList<QString >
    SBK_QTQML_QMAP_QSTRING_QVARIANT_IDX                      = 7, // QMap<QString,QVariant >

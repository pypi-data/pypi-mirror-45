...
enum : int {
    ...
    SBK_QSCXMLEXECUTABLECONTENT_IDX                          = 10,
...
enum : int {
    ...
    SBK_QTSCXML_QVECTOR_INT_IDX                              = 3, // const QVector<int > &
    SBK_QTSCXML_QVECTOR_QSCXMLEXECUTABLECONTENT_PARAMETERINFO_IDX = 4, // const QVector<QScxmlExecutableContent::ParameterInfo > &
    SBK_QTSCXML_QVECTOR_QSCXMLINVOKABLESERVICEPTR_IDX        = 5, // QVector<QScxmlInvokableService* >
    SBK_QTSCXML_QLIST_QVARIANT_IDX                           = 6, // QList<QVariant >
    SBK_QTSCXML_QLIST_QSTRING_IDX                            = 7, // QList<QString >
    SBK_QTSCXML_QMAP_QSTRING_QVARIANT_IDX                    = 8, // QMap<QString,QVariant >

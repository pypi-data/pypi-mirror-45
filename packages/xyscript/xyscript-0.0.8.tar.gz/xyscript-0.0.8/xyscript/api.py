...
def _print_helpdoc():
    ...
    print("     \033[0;34m[-b]\033[0m or \033[0;34m[--branch]\033[0m    which branch to package")
    print("     \033[0;34m[-p]\033[0m or \033[0;34m[--platform]\033[0m  which platform to package to")

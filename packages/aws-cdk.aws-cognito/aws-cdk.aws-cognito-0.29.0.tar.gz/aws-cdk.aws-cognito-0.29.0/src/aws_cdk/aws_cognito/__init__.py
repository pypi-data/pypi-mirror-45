...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cognito", "0.29.0", __name__, "aws-cognito@0.29.0.jsii.tgz")
...
class IUserPool(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def export(self) -> "UserPoolImportProps":
        ...
        Returns:
            user pool props that can be imported into another stack
        """
        ...
...
class UserPool(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.UserPool"):
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, user_pool_arn: str, user_pool_id: str, user_pool_provider_name: str, user_pool_provider_url: str) -> "IUserPool":
        ...
        Arguments:
            ...
            id: Construct ID.
            props: Imported user pool properties.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.UserPoolImportProps", jsii_struct_bases=[])

...
SERVERS: Dict[str, List[Dict[str, Any]]] = {
    ...
    'bitcoin_main': [
      ...
      },
      {
       "nickname": null,
       "hostname": "bitnode.pw",
       "ip_addr": "81.183.169.117",
       "ports": [
        "s57081"
       ],
       "version": "1.4",
       "pruning_limit": 0,
       "seen_at": 1533670768.731807
      },
      {
       "nickname": null,
      ...
      {
       "nickname": null,
       "hostname": "electrum-server.ninja",
       "ip_addr": "220.233.178.199",
       "ports": [
        "s50002",
        "t50001"
       ],
      ...
      {
       "nickname": null,
       "hostname": "electrum.imaginary.cash",
       "ip_addr": "193.29.187.78",
       "ports": [
        "s50002",
        "t50001"
       ],
      ...
      {
       "nickname": "hachre",
       "hostname": "electrum3.hachre.de",
       "ip_addr": "173.249.52.246",
       "ports": [
        "s50002",
        "t50001"
       ],
       "version": "1.4",
       "pruning_limit": 0,
       "seen_at": 1533670768.8676941
      },
      {
       "nickname": null,
       "hostname": "electrumx-core.1209k.com",
       "ip_addr": "2601:602:8802:2091:dcc3:26ff:fe77:bd7f",
       "ports": [
        "s50002",
        "t50001"
       ],

...
from kfp_uploadpipeline.models.api_parameter import ApiParameter  # noqa: F401,E501
...
class ApiPipeline(object):
    ...
    def __init__(self, id=None, created_at=None, name=None, description=None, parameters=None, error=None):  # noqa: E501

...
from kidx_nlu.config import KidxNLUModelConfig, override_defaults
...
class Component(object, metaclass=ComponentMetaclass):
    ...
    def create(cls,
               ...
               config: KidxNLUModelConfig) -> 'Component':
...
class ComponentBuilder(object):
    ...
    def load_component(self,
        ...
        Args:
            ...
            model_metadata (Metadata):
                the model's :class:`kidx_nlu.models.Metadata`
    ...
    def create_component(self,
                         component_config: Dict[Text, Any],
                         cfg: KidxNLUModelConfig) -> Component:

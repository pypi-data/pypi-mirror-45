...
from kidx_nlu.model import Interpreter, Metadata
from kidx_nlu.utils import EndpointConfig, is_url
...
def _update_model_from_server(model_server: EndpointConfig,
    ...
    """Load a zipped Kidx NLU model from a URL and update the passed
...
class Project(object):
    ...
    def _latest_project_model(self):
        ...
        if models:
            time_list = [datetime.datetime.strptime(parse_time,
                                                    '%Y%m%d-%H%M%S')

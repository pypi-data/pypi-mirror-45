...
def load(filename: Optional[Text] = None,
    ...
    if filename is not None:
        ...
        return KidxNLUModelConfig(file_config)
    else:
        return KidxNLUModelConfig(kwargs)
...
class KidxNLUModelConfig(object):

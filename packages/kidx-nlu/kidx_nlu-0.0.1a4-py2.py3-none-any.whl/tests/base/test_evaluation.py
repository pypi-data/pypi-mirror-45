...
from kidx_nlu.test import does_token_cross_borders
from kidx_nlu.test import align_entity_predictions
from kidx_nlu.test import determine_intersection
from kidx_nlu.test import determine_token_labels
from kidx_nlu.config import KidxNLUModelConfig
from kidx_nlu.tokenizers import Token
from kidx_nlu import utils
import json
import os
from kidx_nlu import training_data, config
...
def test_drop_intents_below_freq():
    td = training_data.load_data('data/examples/kidx/demo-kidx.json')

...
def test_endpoint_config():
    ...
    assert r.headers.get("X-Powered-By") == "Kidx"
...
def test_read_emojis_from_json():
    import json
    from kidx_nlu.utils import read_yaml

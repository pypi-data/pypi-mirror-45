...
from kidx_nlu import training_data, utils
from kidx_nlu.convert import convert_training_data
...
from kidx_nlu.training_data.formats import MarkdownReader
from kidx_nlu.training_data.formats.kidx import validate_kidx_nlu_data


def test_example_training_data_is_valid():
    demo_json = 'data/examples/kidx/demo-kidx.json'
    data = utils.read_json_file(demo_json)
    validate_kidx_nlu_data(data)
...
def test_validation_is_throwing_exceptions(invalid_data):
    with pytest.raises(ValidationError):
        validate_kidx_nlu_data(invalid_data)
...
@pytest.mark.parametrize("filename", ["data/examples/kidx/demo-kidx.json",
                                      'data/examples/kidx/demo-kidx.md'])
...
@pytest.mark.parametrize("filename", ['data/examples/kidx/demo-kidx.md'])
...
@pytest.mark.parametrize("files", [('data/examples/kidx/demo-kidx.json',
...
@pytest.mark.parametrize("data_file,gold_standard_file,output_format,language",
                         [
                             ("data/examples/wit/demo-flights.json",
                              "data/test/wit_converted_to_kidx.json", "json",
                              None),
                             ("data/examples/luis/demo-restaurants.json",
                              "data/test/luis_converted_to_kidx.json", "json",
                              None),
                             ("data/examples/dialogflow/",
                              "data/test/dialogflow_en_converted_to_kidx.json",
                              "json", "en"),
                             ("data/examples/dialogflow/",
                              "data/test/dialogflow_es_converted_to_kidx.json",
                              "json", "es"),
                             ("data/examples/kidx/demo-kidx.md",
                              "data/test/md_converted_to_json.json", "json",
                              None),
                             ("data/examples/kidx/demo-kidx.json",
...
def test_training_data_conversion(tmpdir, data_file, gold_standard_file,
    ...
    out_path = tmpdir.join("kidx_nlu_data.json")

...
from kidx_nlu.training_data.formats import markdown
from kidx_nlu.training_data.formats.dialogflow import (
...
from kidx_nlu.utils import EndpointConfig

if typing.TYPE_CHECKING:
    from kidx_nlu.training_data import TrainingData
    from kidx_nlu.training_data.formats.readerwriter import TrainingDataReader
...
_json_format_heuristics = {
    ...
    KIDX: lambda js, fn: "kidx_nlu_data" in js,
...
def _reader_factory(fformat: Text) -> Optional['TrainingDataReader']:
    ...
    from kidx_nlu.training_data.formats import (
        MarkdownReader, WitReader, LuisReader,
        KidxReader, DialogflowReader)

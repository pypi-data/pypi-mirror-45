...
from kidx_nlu.model import Interpreter, Trainer
from kidx_nlu.training_data import load_data
from kidx_nlu.training_data.loading import load_data_from_endpoint
from kidx_nlu.utils import EndpointConfig, read_endpoints
...
def create_argument_parser():
    ...
    parser.add_argument('-c', '--config',
                        required=True,
                        help="Kidx NLU configuration file")
...
def do_train_in_worker(cfg: KidxNLUModelConfig,
                       data: Text,
                       path: Text,
...
def train(nlu_config: Union[Text, KidxNLUModelConfig],
          data: Text,

...
from kidx_nlu.classifiers import INTENT_RANKING_LENGTH
from kidx_nlu.components import Component
from multiprocessing import cpu_count
from kidx_nlu.models.lenet import conv_net
...
class EmbeddingBertIntentClassifier(Component):
    ...
    def get_config_proto(component_config):
        ...
        config = tf.ConfigProto(
            ...
            gpu_options={
                'allow_growth': component_config
                ['config_proto']['allow_growth']
            }
        )
        return config

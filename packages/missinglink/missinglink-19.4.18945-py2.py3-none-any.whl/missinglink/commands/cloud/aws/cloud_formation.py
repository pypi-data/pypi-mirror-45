...
class Cf(AwsBase):
    ...
    def create(self, stack_name, stack_data, parameters=None, tags=None):
        parameters = sorted(self.dict_to_tuple_array(parameters or {}, key='ParameterKey', value='ParameterValue', value_transformer=self.ensure_str))
        tags = self.dict_to_tuple_array(tags or {}, value_transformer=self.ensure_str)
    ...
    def get(self, stack_name):
        ...
        output_dict = self.tuple_array_do_dict(stack.get('Outputs', []), key='OutputKey', value='OutputValue')

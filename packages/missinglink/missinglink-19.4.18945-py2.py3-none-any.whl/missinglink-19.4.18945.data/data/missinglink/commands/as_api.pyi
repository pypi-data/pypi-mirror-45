...
class Alerts:
	@staticmethod
	def subscribe(project: int, alert_type: List[str]) -> object: ...
	@staticmethod
...
class Orgs:
	...
	@staticmethod
	def metadata(org: str, name: Optional[str] = None, value: Optional[str] = None, add: Optional[bool] = False, replace: Optional[bool] = False, delete: Optional[bool] = False) -> object: ...
...
class Data:
	...
	@staticmethod
	def create(org: str, display_name: Optional[str] = None, description: Optional[str] = None, data_path: Optional[str] = None, bucket: Optional[str] = None, linked: Optional[bool] = False) -> object: ...
	@staticmethod
	def config(volume_id: int, edit: Optional[bool] = False) -> object: ...
	@staticmethod
	def commit(volume_id: int, message: Optional[str] = None, isolation_token: Optional[str] = None) -> object: ...
	@staticmethod
	...
	@staticmethod
	def sync(volume_id: int, data_path: str, commit: Optional[str] = None, no_progressbar: Optional[bool] = False, isolated: Optional[bool] = False) -> object: ...
	@staticmethod
	def add(volume_id: int, files: Optional[List[str]] = None, commit: Optional[str] = None, no_progressbar: Optional[bool] = False) -> object: ...
	@staticmethod
	def clone(volume_id: int, dest_folder: str, dest_file: Optional[str] = "$@name", query: Optional[str] = None, delete: Optional[bool] = False, batch_size: Optional[int] = -1, no_progressbar: Optional[bool] = False, isolation_token: Optional[str] = None) -> object: ...
	@staticmethod
	def query(volume_id: int, query: Optional[str] = None, batch_size: Optional[int] = -1, as_dict: Optional[bool] = False, silent: Optional[bool] = False) -> object: ...
	@staticmethod
	def list() -> object: ...
	@staticmethod
	def validate(volume_id: int, data_path: str, no_progressbar: Optional[bool] = False) -> object: ...


class Run:
	@staticmethod
	def track(org: Optional[str] = None) -> object: ...
	@staticmethod
	def xp(org: Optional[str] = None, project: Optional[int] = None, image: Optional[str] = None, git_repo: Optional[str] = None, no_source: Optional[bool] = False, git_tag: Optional[str] = None, source_dir: Optional[str] = None, command: Optional[List[str]] = None, gpu: Optional[bool] = None, data_volume: Optional[str] = None, queue: Optional[str] = None, data_query: Optional[str] = None, data_dest: Optional[str] = None, data_iterator: Optional[bool] = None, recipe: Optional[str] = None, save_recipe: Optional[str] = None, env: Optional[List[Tuple[str, str]]] = None, output_paths: Optional[List[str]] = None, git_identity: Optional[str] = None, persistent_path: Optional[List[Tuple[str, str]]] = None, secure_env: Optional[List[Tuple[str, str]]] = None, docker_host: Optional[str] = None, docker_user: Optional[str] = None, docker_password: Optional[str] = None, requirements_txt: Optional[str] = None, disable_colors: Optional[bool] = None, attach: Optional[bool] = None, name: Optional[str] = None, name_prefix: Optional[str] = None) -> object: ...
	@staticmethod
	def logs(org: str, job: Optional[str] = None, disable_colors: Optional[bool] = False) -> object: ...
	@staticmethod
...
class Aws:
	@staticmethod
	def init(org: str, ssh_key_path: Optional[str] = None, region: Optional[str] = None) -> object: ...


class Azure:
	@staticmethod
	def init(org: str, location: Optional[str] = None, acr: Optional[List[str]] = None) -> object: ...

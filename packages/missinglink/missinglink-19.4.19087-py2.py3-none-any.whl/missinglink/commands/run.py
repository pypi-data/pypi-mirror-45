...
@click.option('--link-gcp/--no-gcp', required=False, default=True, help='Allow the job to access you current `gcloud` configuration folder.')
@click.option('--link-azure/--no-azure', required=False, default=True, help='Allow the job to access you current Azure configuration folder.')

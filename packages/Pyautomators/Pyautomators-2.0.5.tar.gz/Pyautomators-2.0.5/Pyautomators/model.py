...
"""
This module provides the model element class that represent a Pyautomators model:
...
from Pyautomators.model_core import \
        Status, BasicStatement, TagAndStatusStatement, TagStatement, Replayable
from Pyautomators.matchers import NoMatch
from Pyautomators.textutil import text as _text
if six.PY2:
...
class Feature(TagAndStatusStatement, Replayable):
    ...
    .. attribute:: background
       ...
       The :class:`~Pyautomators.model.Background` for this feature, if any.

    .. attribute:: scenarios

       A list of :class:`~Pyautomators.model.Scenario` making up this feature.

    .. attribute:: tags

       A list of @tags (as :class:`~Pyautomators.model.Tag` which are basically
    ...
    def skip(self, reason=None, require_not_executed=False):
        ...
        """
        if reason:
            logger = logging.getLogger("Pyautomators")
...
class Background(BasicStatement, Replayable):
    ...
    .. attribute:: steps
       ...
       A list of :class:`~Pyautomators.model.Step` making up this background.
...
class Scenario(TagAndStatusStatement, Replayable):
    ...
    .. attribute:: feature
       ...
       The :class:`~Pyautomators.model.Feature` this scenario belongs to.

    .. attribute:: steps

       A list of :class:`~Pyautomators.model.Step` making up this scenario.
    ...
    def run(self, runner):
        ...
        if not runner.config.dry_run and run_scenario:
            ...
            if self.hook_failed:
                # -- SKIP: Scenario steps and Pyautomators like dry_run_scenario
                failed = True
...
class ScenarioOutline(Scenario):
    ...
    A scenario outline extends the existing :class:`~Pyautomators.model.Scenario`
    class with the addition of the :class:`~Pyautomators.model.Examples` tables of
    ...
    .. attribute:: feature
       ...
       The :class:`~Pyautomators.model.Feature` this scenario outline belongs to.

    .. attribute:: steps

       A list of :class:`~Pyautomators.model.Step` making up this scenario outline.

    .. attribute:: examples

       A list of :class:`~Pyautomators.model.Examples` used by this scenario outline.
...
class Examples(TagStatement, Replayable):
    ...
    .. attribute:: table
       ...
       An instance  of :class:`~Pyautomators.model.Table` that came with the example
       in the *feature file*.
...
class Step(BasicStatement, Replayable):
    ...
    .. attribute:: text
       ...
       An instance of :class:`~Pyautomators.model.Text` that came with the step
       in the *feature file*.

    .. attribute:: table

       An instance of :class:`~Pyautomators.model.Table` that came with the step
       in the *feature file*.
...
class Table(Replayable):
    ...
    **iteration**
      Iterating over the Table will yield the :class:`~Pyautomators.model.Row`
    ...
    **indexed access**
    ...
    .. attribute:: rows
       ...
       An list of instances of :class:`~Pyautomators.model.Row` that make up the body
...
class Row(object):
    ...
    **indexed access**
    ...
    def as_dict(self):
        ...
        """
        from Pyautomators.compat.collections import OrderedDict

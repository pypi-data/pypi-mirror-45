...
"""Time data and its related operations."""
...
def extend_time_column(dataset, time_col_name, timeVal):
    """Extend time column for struct_time type."""
    (new_time_col_name, dataset) = add_datetime_col(dataset, time_col_name, mktime)
    return new_time_col_name, dataset[new_time_col_name].apply(datetime.fromtimestamp)
...
class TimePublicData(PublicData, TimeData):
    ...
    def extend_time_column(self):
        ...
        (self.time_column_name, self.data) = extend_time_column(dataset, self.time_column_name, timeVal)
...
class TimeCustomerData(CustomerData, TimeData):
    ...
    def extend_time_column(self, env):
        ...
        (self.time_column_name, dataset) = extend_time_column(dataset, self.time_column_name, timeVal)

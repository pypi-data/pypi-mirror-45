...
class Stream(BaseRequest):
    ...
    def create_livestream(self, stream_name='Unknown', player_id=0):
        body = {
            'name': stream_name,
            'player_id': player_id
        }
    ...
    def upload_thumbnail(self, livestream_id, thumbnail):
        return self.api_post('/live-streams/{id}/thumbnail'.format(id=livestream_id), body=thumbnail, need_auth=True)

...
class PulseShaping(object):
    ...
    def rrcfilter(self, signal_interface):
        ...
        signal_interface.data_sample = np.asarray(signal_interface.data_sample, dtype=np.complex)
...
class AWG(object):
    ...
    def __init__(self, sps=2, alpha=0.02, span=1024):
        ...
        self.pulse_shaping_filter = PulseShaping(kind='rrc', alpha=alpha, sps=sps, span=span)
        self.dac = DAC()

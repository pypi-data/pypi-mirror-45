...
Revision Info:
$Author: noboru $
$Date: 2019/04/17 07:57:10 $
$Header: /Users/noboru/src/python/VXI11/PyVXI11-Current/setup.py,v 660d3708c33d 2019/04/17 07:57:10 noboru $
$Id: setup.py,v 660d3708c33d 2019/04/17 07:57:10 noboru $
$RCSfile: setup.py,v $
$Revision: 660d3708c33d $
...
#
HGTag="$HGTag: 1.14.7-660d3708c33d $"
HGdate="$HGdate: Wed, 17 Apr 2019 16:57:10 +0900 $"
HGTagShort="$HGTagShort: 1.14.7 $"
HGlastlog="$lastlog: include VXI11-3.pyx in MANIFEST again $"
...
ext_modules=[]
cVXI11_source_PY2="cVXI11.pyx"
cVXI11_source_PY3="cVXI11-3.pyx"

if sys.version_info >= (3,):
    if not os.path.exists(cVXI11_source_PY3):
        os.link(cVXI11_source_PY2, cVXI11_source_PY3)

...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codepipeline-actions", "0.30.0", __name__, "aws-codepipeline-actions@0.30.0.jsii.tgz")

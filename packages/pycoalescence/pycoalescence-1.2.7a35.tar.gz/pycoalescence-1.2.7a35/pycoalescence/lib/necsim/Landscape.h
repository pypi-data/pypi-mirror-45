...
public:
     ...
     * @param generation the generation timer
     */
    void findNearestHabitatCells(const long &start_x, const long &start_y, const long &start_x_wrap,
            const long &start_y_wrap, long &end_x, long &end_y, const double &generation)
    {
        double theta = 0;
        double radius = 1.0;

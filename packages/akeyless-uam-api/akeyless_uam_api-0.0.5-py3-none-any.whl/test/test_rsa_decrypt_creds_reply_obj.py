...
from akeyless_uam_api.models.rsa_decrypt_creds_reply_obj import RSADecryptCredsReplyObj  # noqa: E501
...
class TestRSADecryptCredsReplyObj(unittest.TestCase):
    ...
    def testRSADecryptCredsReplyObj(self):
        ...
        # model = akeyless_uam_api.models.rsa_decrypt_creds_reply_obj.RSADecryptCredsReplyObj()  # noqa: E501
        pass

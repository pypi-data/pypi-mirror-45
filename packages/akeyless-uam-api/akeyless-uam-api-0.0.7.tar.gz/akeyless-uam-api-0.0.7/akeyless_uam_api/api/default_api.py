...
class DefaultApi(object):
    ...
    def create_item_with_http_info(self, akeyless_uam_user_creds, item_name, item_type, user_metadata, split_level, **kwargs):  # noqa: E501
        ...
        all_params = ['akeyless_uam_user_creds', 'item_name', 'item_type', 'user_metadata', 'split_level', 'akeyless_request_id', 'akeyless_client_id', 'size', 'customer_fragment_id', 'upload_rsa_key_creds', 'upload_secret_creds', 'secret_enc_val']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_upload_secret_creds_with_http_info(self, akeyless_uam_user_creds, secret_name, **kwargs):  # noqa: E501
        ...
        all_params = ['akeyless_uam_user_creds', 'secret_name', 'akeyless_request_id', 'akeyless_client_id', 'protected_key_name', 'creds_expiry']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

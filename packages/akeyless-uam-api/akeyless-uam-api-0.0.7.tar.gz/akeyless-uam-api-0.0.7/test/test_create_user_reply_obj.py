...
from akeyless_uam_api.models.create_user_reply_obj import CreateUserReplyObj  # noqa: E501
...
class TestCreateUserReplyObj(unittest.TestCase):
    ...
    def testCreateUserReplyObj(self):
        ...
        # model = akeyless_uam_api.models.create_user_reply_obj.CreateUserReplyObj()  # noqa: E501
        pass

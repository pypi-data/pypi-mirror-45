...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codebuild", "0.29.0", __name__, "aws-codebuild@0.29.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.BitBucketSourceProps", jsii_struct_bases=[GitBuildSourceProps])
...
class GitHubEnterpriseSource(GitBuildSource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubEnterpriseSource"):
    ...
    def __init__(self, *, https_clone_url: str, ignore_ssl_errors: typing.Optional[bool]=None, clone_depth: typing.Optional[jsii.Number]=None, identifier: typing.Optional[str]=None) -> None:
        """
        Arguments:
            props: -
...
@jsii.data_type_optionals(jsii_struct_bases=[GitBuildSourceProps])
...
class GitHubSource(GitBuildSource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubSource"):
    ...
    def __init__(self, *, owner: str, repo: str, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, clone_depth: typing.Optional[jsii.Number]=None, identifier: typing.Optional[str]=None) -> None:
        """
        Arguments:
            props: -
            owner: The GitHub account/user that owns the repo.
            repo: The name of the repo (without the username).
            reportBuildStatus: Whether to send GitHub notifications on your build's start and end. Default: true
            webhook: Whether to create a webhook that will trigger a build every time a commit is pushed to the GitHub repository. Default: false
            cloneDepth: The depth of history to download. Minimum value is 0. If this value is 0, greater than 25, or not provided, then the full history is downloaded with each build of the project.
            identifier: The source identifier. This property is required on secondary sources.
        """
...
class IBuildImage(jsii.compat.Protocol):
    ...
    def validate(self, *, build_image: typing.Optional["IBuildImage"]=None, compute_type: typing.Optional["ComputeType"]=None, environment_variables: typing.Optional[typing.Mapping[str,"BuildEnvironmentVariable"]]=None, privileged: typing.Optional[bool]=None) -> typing.List[str]:
        ...
        Arguments:
            ...
            buildImage: The image used for the builds. Default: LinuxBuildImage.UBUNTU_18_04_STANDARD_1_0
...
class IProject(aws_cdk.cdk.IResource, aws_cdk.aws_iam.IGrantable, jsii.compat.Protocol):
    ...
    def export(self) -> "ProjectImportProps":
        ...
        Allows referencing this Project in a different CDK Stack.
        """
        ...
...
class LinuxBuildImage(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.LinuxBuildImage"):
    ...
    @classproperty
    @jsii.member(jsii_name="UBUNTU_18_04_STANDARD_1_0")
    def UBUNTU_18_04_STANDARD_1_0(cls) -> "LinuxBuildImage":
        return jsii.sget(cls, "UBUNTU_18_04_STANDARD_1_0")
...
class ProjectBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-codebuild.ProjectBase"):
...
class _ProjectBaseProxy(ProjectBase, jsii.proxy_for(aws_cdk.cdk.Resource)):
    @jsii.member(jsii_name="export")
    def export(self) -> "ProjectImportProps":
        """Export this Project.
...
class Project(ProjectBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.Project"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, artifacts: typing.Optional["BuildArtifacts"]=None, secondary_artifacts: typing.Optional[typing.List["BuildArtifacts"]]=None, secondary_sources: typing.Optional[typing.List["BuildSource"]]=None, source: typing.Optional["BuildSource"]=None, allow_all_outbound: typing.Optional[bool]=None, badge: typing.Optional[bool]=None, build_script_asset: typing.Optional[aws_cdk.assets.Asset]=None, build_script_asset_entrypoint: typing.Optional[str]=None, build_spec: typing.Any=None, cache_bucket: typing.Optional[aws_cdk.aws_s3.IBucket]=None, cache_dir: typing.Optional[str]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IEncryptionKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str,"BuildEnvironmentVariable"]]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, timeout: typing.Optional[jsii.Number]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpcNetwork]=None) -> None:
        ...
        Arguments:
            ...
            secondaryArtifacts: The secondary artifacts for the Project. Can also be added after the Project has been created by using the {@link Project#addSecondaryArtifact} method. Default: []
            secondarySources: The secondary sources for the Project. Can be also added after the Project has been created by using the {@link Project#addSecondarySource} method. Default: []
            ...
            cacheBucket: Bucket to store cached source artifacts If not specified, source artifacts will not be cached.
            cacheDir: Subdirectory to store cached artifacts.
            description: A description of the project. Use the description to identify the purpose of the project.
            encryptionKey: Encryption key to use to read and write artifacts If not specified, a role will be created.
            ...
            role: Service Role to assume while running the build. If not specified, a role will be created.
            securityGroups: What security group to associate with the codebuild project's network interfaces. If no security group is identified, one will be created automatically. Only used if 'vpc' is supplied.
    ...
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, project_name: str) -> "IProject":
        ...
        Arguments:
            ...
            props: the properties of the referenced Project.
            projectName: The human-readable name of the CodeBuild Project we're referencing. The Project must be in the same account and region as the root Stack.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.ProjectImportProps", jsii_struct_bases=[])

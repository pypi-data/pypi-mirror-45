...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ko', 'hu', 'sh', 'cs', 'ro', 'eu', 'tr', 'ms', 'eo', 'bg', 'da', 'hy',
        'he', 'sk', 'zh-min-nan', 'kk', 'min', 'ce', 'hr', 'lt', 'et', 'be',
        'sl', 'el', 'gl', 'az', 'ur', 'simple', 'nn', 'azb', 'uz', 'th', 'hi',
        'la', 'ka', 'vo', 'ta', 'cy', 'mk', 'ast', 'tg', 'lv', 'mg', 'oc',
        'tt', 'bs', 'ky', 'af', 'sq', 'tl', 'zh-yue', 'new', 'te', 'be-tarask',
        'br', 'bn', 'pms', 'ml', 'lb', 'jv', 'ht', 'sco', 'mr', 'ga', 'sw',
        'ba', 'pnb', 'nds', 'is', 'my', 'fy', 'cv', 'su', 'lmo', 'an', 'ne',
        'yo', 'pa', 'gu', 'io', 'bar', 'scn', 'ku', 'als', 'bpy', 'kn', 'ckb',
        'ia', 'qu', 'arz', 'wuu', 'mn', 'bat-smg', 'si', 'wa', 'or', 'gd',
        'yi', 'am', 'nap', 'cdo', 'bug', 'hsb', 'map-bms', 'mai', 'xmf', 'fo',
        'mzn', 'li', 'ilo', 'sah', 'eml', 'vec', 'os', 'sa', 'sd', 'mrj',
        'mhr', 'diq', 'ps', 'hif', 'roa-tara', 'zh-classical', 'bcl', 'ace',
        'hak', 'frr', 'pam', 'szl', 'nso', 'se', 'km', 'nv', 'mi', 'rue',
        'nah', 'nds-nl', 'vls', 'bh', 'hyw', 'gan', 'crh', 'sc', 'vep', 'bo',
        'glk', 'co', 'myv', 'tk', 'fiu-vro', 'as', 'so', 'kv', 'lrc', 'csb',
        'gv', 'shn', 'zea', 'udm', 'ie', 'pcd', 'ay', 'sn', 'ug', 'nrm', 'stq',
        'lez', 'lad', 'kw', 'mwl', 'gom', 'gn', 'haw', 'rm', 'lij', 'ha',
        'koi', 'mt', 'lfn', 'fur', 'frp', 'lo', 'dsb', 'kab', 'ab', 'ln',
        'ang', 'ext', 'olo', 'dty', 'cbk-zam', 'dv', 'ksh', 'gag', 'pi', 'pfl',
        'pag', 'av', 'bjn', 'bxr', 'xal', 'gor', 'krc', 'pap', 'za', 'kaa',
        'pdc', 'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbp', 'kbd',
        'tpi', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'bi',
        'kg', 'mdf', 'wo', 'lg', 'zu', 'srn', 'tcy', 'atj', 'inh', 'chr',
        'ltg', 'sm', 'xh', 'om', 'pih', 'sat', 'cu', 'rmy', 'tw', 'bm', 'tn',
        'chy', 'rn', 'got', 'ts', 'tum', 'ak', 'st', 'ny', 'ch', 'ss', 'pnt',

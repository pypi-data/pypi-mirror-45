...
void log_Z3_solver_set_activity(Z3_context a0, Z3_solver a1, Z3_ast a2, double a3);
#define LOG_Z3_solver_set_activity(_ARG0, _ARG1, _ARG2, _ARG3) z3_log_ctx _LOG_CTX; if (_LOG_CTX.enabled()) { log_Z3_solver_set_activity(_ARG0, _ARG1, _ARG2, _ARG3); }

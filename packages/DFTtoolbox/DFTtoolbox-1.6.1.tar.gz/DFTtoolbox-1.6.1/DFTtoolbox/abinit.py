...
class init(dftstr):
    ...
    def ground(self,prefix,soc,mag,dftu,kdense=20):
        ...
        if dftu=='on':
            ...
            file.write('# exchange within the PAW sphere. So do not use with DFT+U.\n')
            file.write('# -----\n\n')
            file.write('dmatpuopt  2              # definition of density matrix (use 4 for s,p)\n\n')
            file.write('# DFT+U\n')
            file.write('usepawu 1                 # DFT+U,0:off,1:FLL,2:AMF\n')

...
def whois(*args, **kwargs):
    raise Exception(
        "The whois() method has been replaced by a different method (with a different API), since whopy 2.0. "
        "Either install the older whopy 1.2.3, or change your code to use the new API.")

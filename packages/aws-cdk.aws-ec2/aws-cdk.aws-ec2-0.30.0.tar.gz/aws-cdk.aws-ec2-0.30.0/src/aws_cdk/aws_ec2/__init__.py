...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ec2", "0.30.0", __name__, "aws-ec2@0.30.0.jsii.tgz")
...
class CfnTrunkInterfaceAssociation(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.CfnTrunkInterfaceAssociation"):
    """A CloudFormation ``AWS::EC2::TrunkInterfaceAssociation``.
    ...
    """
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, branch_interface_id: str, trunk_interface_id: str, gre_key: typing.Optional[typing.Union[typing.Optional[jsii.Number], typing.Optional[aws_cdk.cdk.Token]]]=None, vlan_id: typing.Optional[typing.Union[typing.Optional[jsii.Number], typing.Optional[aws_cdk.cdk.Token]]]=None) -> None:
        ...
        Arguments:
            ...
            id: - scoped id of the resource.
            props: - resource properties.
            branchInterfaceId: ``AWS::EC2::TrunkInterfaceAssociation.BranchInterfaceId``.
            trunkInterfaceId: ``AWS::EC2::TrunkInterfaceAssociation.TrunkInterfaceId``.
            greKey: ``AWS::EC2::TrunkInterfaceAssociation.GREKey``.
            vlanId: ``AWS::EC2::TrunkInterfaceAssociation.VLANId``.
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.CfnTrunkInterfaceAssociationProps", jsii_struct_bases=[_CfnTrunkInterfaceAssociationProps])
class CfnTrunkInterfaceAssociationProps(_CfnTrunkInterfaceAssociationProps):
    """Properties for defining a ``AWS::EC2::TrunkInterfaceAssociation``.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.GatewayVpcEndpointImportProps", jsii_struct_bases=[])
class GatewayVpcEndpointImportProps(jsii.compat.TypedDict):
...
class IVpcEndpoint(aws_cdk.cdk.IConstruct, jsii.compat.Protocol):
    """A VPC endpoint."""
    @staticmethod
    def __jsii_proxy_class__():
...
class _IVpcEndpointProxy(jsii.proxy_for(aws_cdk.cdk.IConstruct)):
    """A VPC endpoint."""
...
class IGatewayVpcEndpoint(IVpcEndpoint, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "GatewayVpcEndpointImportProps":
...
class IInterfaceVpcEndpoint(IVpcEndpoint, IConnectable, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "InterfaceVpcEndpointImportProps":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.InterfaceVpcEndpointImportProps", jsii_struct_bases=[])
class InterfaceVpcEndpointImportProps(jsii.compat.TypedDict):
...
class SecurityGroup(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.SecurityGroup"):
    ...
    @classmethod
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, security_group_id: str, security_group_vpc_id: typing.Optional[str]=None) -> "ISecurityGroup":
        ...
        Arguments:
            ...
            securityGroupVpcId: The VPC ID this security group is part of. If not provided, the ``securityGroupVpcId`` property will throw an exception.
        """
        props: SecurityGroupImportProps = {"securityGroupId": security_group_id}

        if security_group_vpc_id is not None:
            props["securityGroupVpcId"] = security_group_vpc_id
...
@jsii.data_type_optionals(jsii_struct_bases=[])
class _SecurityGroupImportProps(jsii.compat.TypedDict, total=False):
    securityGroupVpcId: str
    """The VPC ID this security group is part of.

    If not provided, the ``securityGroupVpcId`` property
    will throw an exception.
    """

@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.SecurityGroupImportProps", jsii_struct_bases=[_SecurityGroupImportProps])
class SecurityGroupImportProps(_SecurityGroupImportProps):
    securityGroupId: str
...
class VpcEndpoint(aws_cdk.cdk.Construct, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-ec2.VpcEndpoint"):
    @staticmethod
    def __jsii_proxy_class__():
...
class _VpcEndpointProxy(VpcEndpoint):
    @property
    @jsii.member(jsii_name="vpcEndpointId")
    def vpc_endpoint_id(self) -> str:
        """The VPC endpoint identifier."""
...
class GatewayVpcEndpoint(VpcEndpoint, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.GatewayVpcEndpoint"):
    """A gateway VPC endpoint."""
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, vpc: "IVpcNetwork", service: "IGatewayVpcEndpointService", subnets: typing.Optional[typing.List["SubnetSelection"]]=None) -> None:
        """
        Arguments:
            scope: -
            id: -
    ...
    @jsii.member(jsii_name="import")
    @classmethod
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, vpc_endpoint_id: str) -> "IGatewayVpcEndpoint":
        ...
        Arguments:
            ...
            id: -
            props: -
            vpcEndpointId: The gateway VPC endpoint identifier.
        """
        props: GatewayVpcEndpointImportProps = {"vpcEndpointId": vpc_endpoint_id}
...
class InterfaceVpcEndpoint(VpcEndpoint, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.InterfaceVpcEndpoint"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, vpc: "IVpcNetwork", service: "IInterfaceVpcEndpointService", private_dns_enabled: typing.Optional[bool]=None, subnets: typing.Optional["SubnetSelection"]=None) -> None:
        """
        Arguments:
            scope: -
            id: -
    ...
    @jsii.member(jsii_name="import")
    @classmethod
    def import_(cls, scope: aws_cdk.cdk.Construct, id: str, *, port: str, security_group_id: str, vpc_endpoint_id: str) -> "IInterfaceVpcEndpoint":
        ...
        """
        props: InterfaceVpcEndpointImportProps = {"port": port, "securityGroupId": security_group_id, "vpcEndpointId": vpc_endpoint_id}
    ...
    @property
    @jsii.member(jsii_name="dnsEntries")
    def dns_entries(self) -> typing.List[str]:
        """The DNS entries for the interface VPC endpoint."""
        return jsii.get(self, "dnsEntries")

    @property
    @jsii.member(jsii_name="networkInterfaceIds")
    def network_interface_ids(self) -> typing.List[str]:
        """One or more network interfaces for the interface VPC endpoint."""
        return jsii.get(self, "networkInterfaceIds")
...
class VpcNetwork(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.VpcNetwork"):
    ...
    def _select_subnet_objects(self, *, one_per_az: typing.Optional[bool]=None, subnet_name: typing.Optional[str]=None, subnet_type: typing.Optional["SubnetType"]=None) -> typing.List["IVpcSubnet"]:
    ...
    def cidr(self) -> str:
        """
        Returns:
            The IPv4 CidrBlock as returned by the VPC
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.VpcNetworkImportProps", jsii_struct_bases=[_VpcNetworkImportProps])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.VpcNetworkProps", jsii_struct_bases=[])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.VpcNetworkProviderProps", jsii_struct_bases=[])
...
class VpcPrivateSubnet(VpcSubnet, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.VpcPrivateSubnet"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, availability_zone: str, cidr_block: str, vpc_id: str, map_public_ip_on_launch: typing.Optional[bool]=None) -> None:
        ...
        Arguments:
            ...
            mapPublicIpOnLaunch: Controls if a public IP is associated to an instance at launch. Defaults to true in Subnet.Public, false in Subnet.Private or Subnet.Isolated.
        """
        props: VpcPrivateSubnetProps = {"availabilityZone": availability_zone, "cidrBlock": cidr_block, "vpcId": vpc_id}
...
class VpcPublicSubnet(VpcSubnet, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.VpcPublicSubnet"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, availability_zone: str, cidr_block: str, vpc_id: str, map_public_ip_on_launch: typing.Optional[bool]=None) -> None:
        ...
        Arguments:
            ...
            mapPublicIpOnLaunch: Controls if a public IP is associated to an instance at launch. Defaults to true in Subnet.Public, false in Subnet.Private or Subnet.Isolated.
        """
        props: VpcPublicSubnetProps = {"availabilityZone": availability_zone, "cidrBlock": cidr_block, "vpcId": vpc_id}
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.VpcSubnetImportProps", jsii_struct_bases=[])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.VpcSubnetProps", jsii_struct_bases=[_VpcSubnetProps])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.VpcPrivateSubnetProps", jsii_struct_bases=[VpcSubnetProps])
class VpcPrivateSubnetProps(VpcSubnetProps, jsii.compat.TypedDict):
    pass

@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.VpcPublicSubnetProps", jsii_struct_bases=[VpcSubnetProps])
class VpcPublicSubnetProps(VpcSubnetProps, jsii.compat.TypedDict):
    pass

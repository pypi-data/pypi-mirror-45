...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ec2", "0.29.0", __name__, "aws-ec2@0.29.0.jsii.tgz")
...
class SecurityGroupBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-ec2.SecurityGroupBase"):
...
class _SecurityGroupBaseProxy(SecurityGroupBase, jsii.proxy_for(aws_cdk.cdk.Resource)):
    @jsii.member(jsii_name="export")
    def export(self) -> "SecurityGroupImportProps":
        """Export this SecurityGroup for use in a different Stack."""
        return jsii.invoke(self, "export", [])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.SecurityGroupImportProps", jsii_struct_bases=[])

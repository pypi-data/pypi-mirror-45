...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-apigateway", "0.29.0", __name__, "aws-apigateway@0.29.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.RestApiImportProps", jsii_struct_bases=[])

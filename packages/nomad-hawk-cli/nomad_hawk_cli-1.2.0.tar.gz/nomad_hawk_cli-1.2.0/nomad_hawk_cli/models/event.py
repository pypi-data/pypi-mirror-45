...
class Event(object):
    ...
    def __init__(self, type=None, category=None, label=None, message=None, location_city=None, location_country=None, value=None, value_type=None, source=None, sales_channel=None, user=None, id=None, items=None):  # noqa: E501

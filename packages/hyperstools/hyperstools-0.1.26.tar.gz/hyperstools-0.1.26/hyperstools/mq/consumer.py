...
class BaseConsumer(object):
    ...
    def __init__(self, identify, callback, logger=None, ack="last", **kwargs):
    ...
    def setup_exchange(self, exchange_name):
        ...
        self._channel.exchange_declare(
            exchange=exchange_name, exchange_type=self.EXCHANGE_TYPE, callback=cb, durable=self._durable
        )

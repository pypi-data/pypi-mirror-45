...
class Publisher(object):
    ...
    def __init__(self, identify: dict, messages, logger=None):
    ...
    def setup_exchange(self, exchange_name):
        ...
        self._channel.exchange_declare(
            exchange=exchange_name, exchange_type=self.EXCHANGE_TYPE, callback=cb, durable=True
        )
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(queue=queue_name, callback=self.on_queue_declareok, durable=True)
    ...
    def publish_message(self):
        ...
        self.LOGGER.info("Published message # %i", message)

...
class Gtf_helper():
    ...
    def extract_window_from_gene_id(self, gene_id):
        ...
        try:
            ...
            if self.find == 1:
                ...
                print('The specified gene id is not found in the genome annotation.')
                sys.exit(0)
        except:
            print('Unable to parse gtf file. Please check -gtf and -g parameters.')
            sys.exit(0)
    ...
    def extract_transcripts_from_widnow(self, chr, start, end, selected_transcripts=0):
        ...
        try:
            ...
            print('Unable to parse gtf file and find any annotation for the requested genomic coordinates. Please check -gtf and -w parameters.')
            sys.exit(0)
    ...
    def extract_data_about_transcripts(self, elements_id, users_scaffold=0, users_start=0, users_end=0):
        try:
            ...
            if self.exist == 1:
                ...
                print('One or several specified transcript ids are not found in the genome annotation.')
                sys.exit(0)

        except:
            print(
                'Unable to parse gtf file. Please check the -gtf and -t parameters.')
            sys.exit(0)
...
class CoverageExtraction():
    ...
    def extract(self):
        ...
        try:
            ...
            print('Unable to parse the bedGraph files.')
            sys.exit(0)

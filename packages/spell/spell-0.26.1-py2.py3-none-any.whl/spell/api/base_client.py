...
SPELL_ENCODERS = [models.RunRequest, models.ValueSpec, models.RangeSpec]
...
class BaseClient(object):
    ...
    def request(self, method, resource_url, headers=None, payload=None, params=None, stream=False, timeout=None):
        kwargs = {}

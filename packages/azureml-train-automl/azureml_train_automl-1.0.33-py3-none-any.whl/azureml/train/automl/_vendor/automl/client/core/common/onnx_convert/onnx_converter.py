...
# -----------------------------------
from automl.client.core.common.onnx_convert import OnnxConvertConstants       # noqa: E402
...
if sys.version_info < OnnxConvertConstants.OnnxInompatiblePythonVersion:
...
# Transformers.
from automl.client.core.common.featurization import CatImputer       # noqa: E402
from automl.client.core.common.featurization import HashOneHotVectorizerTransformer       # noqa: E402
from automl.client.core.common.featurization import LaggingTransformer       # noqa: E402
from automl.client.core.common.featurization import ImputationMarker       # noqa: E402
from automl.client.core.common.featurization import StringCastTransformer       # noqa: E402
from automl.client.core.common.featurization import DateTimeFeaturesTransformer       # noqa: E402
from automl.client.core.common.featurization import DataTransformer       # noqa: E402

from automl.client.core.common.exceptions import AutoMLException, OnnxConvertException       # noqa: E402

from automl.client.core.common.onnx_convert.operator_converters import (       # noqa: E402
...
from automl.client.core.common.onnx_convert import OperatorConverterManager       # noqa: E402
...
class OnnxConverter:
    ...
    def __init__(self, logger=None, version='', is_onnx_compatible=False, *args, **kwargs):
        ...
        # The column name to index map, in the user input X.
        self.df_column_to_df_col_idx_in_input = {}      # type: Dict[Union[str, int], Any]

        # The column name to index map, in the generated initial types.
    ...
    def initialize_input(self, X, x_raw_column_names=None, model_name='', model_desc=None):
        ...
        try:
            ...
            header_exists = False
            for c in X.columns:
                if isinstance(c, str) and not header_exists:
                    header_exists = True
            ...
            col_idx_to_infra_type_string = {}
            for i_init_tp, column in enumerate(X.columns):
                arr = X[column].values
                tp_str = pd.api.types.infer_dtype(arr[~pd.isnull(arr)])
                col_idx_to_infra_type_string[i_init_tp] = tp_str
            ...
            last_type = None
            for i_init_tp, column in enumerate(X.columns):
                tp_str = col_idx_to_infra_type_string[i_init_tp]
                cur_type = tp_str
    ...
    def _convert_np_to_onnx_type(self, tp_str):
        if tp_str == NumericalDtype.Floating or tp_str == NumericalDtype.MixedIntegerFloat:
            ...
            return Int64TensorType
                ...
                tp_str == NumericalDtype.MixedInteger:

...
from automl.client.core.common.featurization.timeseries.category_binarizer import CategoryBinarizer
...
from automl.client.core.common._engineered_feature_names import \
    ...
    FeatureTypeRecognizer, _Transformer, _FeatureTransformers
from automl.client.core.common.time_series_data_frame import TimeSeriesDataFrame
from automl.client.core.common._engineered_feature_names import _RawFeatureFeaturizationInfo
from automl.client.core.common.types import FeaturizationSummaryType
from automl.client.core.common.memory_utilities import get_all_ram
...
class TimeSeriesTransformer(AbstractTimeSeriesTransformer):
    ...
    def _construct_pre_processing_pipeline(self,
        ...
        # pipeline:
        # TODO: unify the imputers to support all datatypes
        ...
        # Lag and rollinw window transformer
    ...
    def _remove_lag_lead_and_rw_maybe(self, df: pd.DataFrame, y: np.ndarray) -> None:
        ...
        remove_ll_rw = True
        try:
            total_memory = get_all_ram(self.logger)

...
from .constants import ModelNameMappings, SupportedModelNames
from .exceptions import ConfigException
from .logging_utilities import _get_null_logger
from .metrics import minimize_or_maximize
from .utilities import get_primary_metrics
from .types import DataInputType, DataSingleColumnInputType
...
class AutoMLBaseSettings:
    ...
    def __init__(self,
        ...
        if is_timeseries:
            ...
            self.country = kwargs.pop(constants.TimeSeries.COUNTRY, None)
        ...
        if self.iterations > AutoMLBaseSettings.MINIMUM_REQUIRED_ITERATIONS_ENSEMBLE:

...
def _automl_static_submit(automl_config_object,
    ...
    run = automl_estimator.fit(**automl_config_object.fit_params,
...
class AutoMLConfig(object):
    ...
    :param country: The country used to generate holiday features.
        These should be ISO 3166 two-letter country codes (i.e. 'US', 'GB').
    :type country: str

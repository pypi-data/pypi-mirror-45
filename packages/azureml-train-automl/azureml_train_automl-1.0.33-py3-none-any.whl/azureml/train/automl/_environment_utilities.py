...
def modify_run_configuration(settings: AutoMLBaseSettings, run_config: RunConfiguration, logger: logging.Logger):
    ...
    try:
        ...
        logger.warning("Could not find the version info for azureml-core or azureml-train-automl")
        core_version = None
        automl_version = None

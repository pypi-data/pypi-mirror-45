...
from automl.client.core.common.data_context import RawDataContext, TransformedDataContext
...
class _AdbAutomlExperiment():
    ...
    def fit_iteration(self, pipeline_dto, run_id):
        ...
        train_frac = 1
        # TODO remove after jos adb subsampling changes are deployed
            ...
            try:
                ...
                if (run_id.endswith("setup")):
                    self.input_data = get_input_datamodel_from_dataprep_json(
                        self.dataprep_json, self.log_message, automl_settings=self.automl_settings)
                    ...
                    if self.automl_settings.enable_cache is True and \
                       (self.automl_settings.preprocess or self.automl_settings.is_timeseries):
                        ...
                        set_problem_info(X=data_context.X,
                                         y=data_context.y,

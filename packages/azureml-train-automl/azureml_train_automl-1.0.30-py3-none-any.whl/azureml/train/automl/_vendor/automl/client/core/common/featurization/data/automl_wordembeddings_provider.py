...
from automl.client.core.common.featurization.data.abstract_wordembeddings_provider import \
    AbstractWordEmbeddingsProvider
from automl.client.core.common.featurization.data.word_embeddings_info import WordEmbeddingsInfo, EmbeddingInfo


class AutoMLEmbeddingsProvider(AbstractWordEmbeddingsProvider):
    """AutoML word embeddings provider."""

    def __init__(self, logger: Optional[logging.Logger] = None, embeddings_name: str = "wiki_news_300d_1M_subword"):

...
from automl.client.core.common._engineered_feature_names import _TransformationFunctionNames, _OperatorNames
...
class WordEmbeddingTransformer(AutoMLTransformer):
    ...
    def __init__(self,
        ...
        self._transformer_name = _TransformationFunctionNames.WordEmbedding
    ...
    def _get_memory_footprint(self, X: DataSingleColumnInputType, y: DataSingleColumnInputType) -> int:
        """
        ...
        try:
            ...
            self._logger_wrapper("debug", "Exception while trying to estimate memory footprint: {e}".format(e=e))
            return sys.maxsize

...
class rootType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('markup', 'markupType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'markup', b'type': b'markupType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rootType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='rootType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class markupType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('embedded', 'xs:string', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'embedded', b'type': b'xs:string'}, None),
        MemberSpec_('nested', 'nestedType', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'nested', b'type': b'nestedType'}, None),
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='markupType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='markupType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class nestedType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('nested1', 'nested1Type', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'nested1', b'type': b'nested1Type'}, None),
        MemberSpec_('nested2', 'xs:string', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'nested2', b'type': b'xs:string'}, None),
        MemberSpec_('nested3', 'xs:integer', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'nested3', b'type': b'xs:integer'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nestedType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='nestedType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class nested1Type(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('nestedA1', 'nested1AType', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'nestedA1', b'type': b'nested1AType'}, None),
        MemberSpec_('nestedA2', 'nested1AType', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'nestedA2', b'type': b'nested1AType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nested1Type', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='nested1Type', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class nested1AType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('nestedB1', 'xs:string', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'nestedB1', b'type': b'xs:string'}, None),
        MemberSpec_('nestedB2', 'xs:string', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'nestedB2', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nested1AType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='nested1AType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

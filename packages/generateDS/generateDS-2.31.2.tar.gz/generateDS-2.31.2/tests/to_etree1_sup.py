...
class peopleType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('comments', 'commentsType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'comments', b'type': b'commentsType'}, None),
        MemberSpec_('person', 'personType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'person', b'type': b'personType'}, None),
        MemberSpec_('specialperson', 'specialperson', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'specialperson', b'type': b'specialperson'}, None),
        MemberSpec_('programmer', 'programmerType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'programmer', b'type': b'programmerType'}, None),
        MemberSpec_('python_programmer', 'python-programmerType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'python-programmer', b'type': b'python-programmerType'}, None),
        MemberSpec_('java_programmer', 'java-programmerType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'java-programmer', b'type': b'java-programmerType'}, None),
    ]
    subclass = None
    superclass = None
...
class personType(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('hot_agent', 'hot.agent', 0, 0, {b'name': b'hot.agent', b'type': b'hot.agent'}, None),
        MemberSpec_('agent', 'agentType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'agent', b'type': b'agentType'}, None),
        MemberSpec_('promoter', 'boosterType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'promoter', b'type': b'boosterType'}, None),
        MemberSpec_('description', 'xs:string', 0, 0, {b'name': b'description', b'type': b'xs:string'}, None),
        MemberSpec_('range_', ['RangeType', 'xs:integer'], 0, 0, {b'name': b'range', b'type': b'xs:integer'}, None),
    ]
    subclass = None
    superclass = None
...
class programmerType(personType):
    member_data_items_ = [
        ...
        MemberSpec_('eldatetime', 'xs:dateTime', 0, 0, {b'name': b'eldatetime', b'type': b'xs:dateTime'}, None),
        MemberSpec_('eldatetime1', 'xs:dateTime', 0, 0, {b'name': b'eldatetime1', b'type': b'xs:dateTime'}, None),
        ...
        MemberSpec_('elparam', 'paramType', 0, 0, {b'name': b'elparam', b'type': b'paramType'}, None),
...
class python_programmerType(programmerType):
    member_data_items_ = [
        ...
        MemberSpec_('flowvalue', ['FlowType', 'xs:integer'], 0, 0, {b'name': b'flowvalue', b'type': b'xs:integer'}, None),
        MemberSpec_('drcs', 'xs:string', 0, 0, {b'name': b'drcs', b'type': b'xs:string'}, None),
    ]
    subclass = None
...
class java_programmerType(programmerType):
    member_data_items_ = [
        ...
        MemberSpec_('favorite_editor', 'xs:string', 0, 0, {b'name': b'favorite-editor', b'type': b'xs:string'}, None),
        MemberSpec_('datetime1', 'xs:gYear', 0, 0, {b'name': b'datetime1', b'type': b'xs:gYear'}, None),
        MemberSpec_('datetime2', 'xs:gYearMonth', 0, 0, {b'name': b'datetime2', b'type': b'xs:gYearMonth'}, None),
        MemberSpec_('datetime3', 'xs:gMonth', 0, 0, {b'name': b'datetime3', b'type': b'xs:gMonth'}, None),
        MemberSpec_('datetime4', 'xs:gMonthDay', 0, 0, {b'name': b'datetime4', b'type': b'xs:gMonthDay'}, None),
        MemberSpec_('datetime5', 'xs:gDay', 0, 0, {b'name': b'datetime5', b'type': b'xs:gDay'}, None),
    ]
    subclass = None
    superclass = programmerType
...
class agentType(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('info', 'infoType', 0, 0, {b'name': b'info', b'type': b'infoType'}, None),
        MemberSpec_('vehicle', 'vehicleType', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'vehicle', b'ref': b'vehicle', b'type': b'vehicle'}, None),
    ]
    subclass = None
    superclass = None
...
class hot_agent(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('firstname', 'xs:string', 0, 0, {b'default': b'empty\\name', b'name': b'firstname', b'type': b'xs:string'}, None),
        MemberSpec_('lastname', 'xs:string', 0, 0, {b'default': b"no 'last' name", b'name': b'lastname', b'type': b'xs:string'}, None),
        MemberSpec_('priority', 'xs:float', 0, 0, {b'name': b'priority', b'type': b'xs:float'}, None),
        MemberSpec_('startDate', 'xs:date', 0, 0, {b'name': b'startDate', b'type': b'xs:date'}, None),
    ]
    subclass = None
    superclass = None

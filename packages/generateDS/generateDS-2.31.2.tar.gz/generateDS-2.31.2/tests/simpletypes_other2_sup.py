...
class simpleTypeTestsType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('simpleTypeTest', 'simpleTypeTestDefs', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'simpleTypeTest', b'type': b'simpleTypeTestDefs'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='simpleTypeTestsType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='simpleTypeTestsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class simpleTypeTestDefs(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('integerVal1', 'xs:integer', 0, 0, {b'name': b'integerVal1', b'type': b'xs:integer'}, None),
        MemberSpec_('integerVal2', 'xs:integer', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'integerVal2', b'type': b'xs:integer'}, None),
        MemberSpec_('stringVal1', 'xs:string', 0, 0, {b'name': b'stringVal1', b'type': b'xs:string'}, None),
        MemberSpec_('stringVal2', 'xs:string', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'stringVal2', b'type': b'xs:string'}, None),
        MemberSpec_('booleanVal1', 'xs:boolean', 0, 0, {b'name': b'booleanVal1', b'type': b'xs:boolean'}, None),
        MemberSpec_('booleanVal2', 'xs:boolean', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'booleanVal2', b'type': b'xs:boolean'}, None),
        MemberSpec_('decimalVal1', 'xs:decimal', 0, 0, {b'name': b'decimalVal1', b'type': b'xs:decimal'}, None),
        MemberSpec_('decimalVal2', 'xs:decimal', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'decimalVal2', b'type': b'xs:decimal'}, None),
        MemberSpec_('doubleVal1', 'xs:double', 0, 0, {b'name': b'doubleVal1', b'type': b'xs:double'}, None),
        MemberSpec_('doubleVal2', 'xs:double', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'doubleVal2', b'type': b'xs:double'}, None),
        MemberSpec_('floatVal1', 'xs:float', 0, 0, {b'name': b'floatVal1', b'type': b'xs:float'}, None),
        MemberSpec_('floatVal2', 'xs:float', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'floatVal2', b'type': b'xs:float'}, None),
        MemberSpec_('dateVal1', 'xs:date', 0, 0, {b'name': b'dateVal1', b'type': b'xs:date'}, None),
        MemberSpec_('dateVal2', 'xs:date', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'dateVal2', b'type': b'xs:date'}, None),
        MemberSpec_('dateTimeVal1', 'xs:dateTime', 0, 0, {b'name': b'dateTimeVal1', b'type': b'xs:dateTime'}, None),
        MemberSpec_('dateTimeVal2', 'xs:dateTime', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'dateTimeVal2', b'type': b'xs:dateTime'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='simpleTypeTestDefs', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='simpleTypeTestDefs', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

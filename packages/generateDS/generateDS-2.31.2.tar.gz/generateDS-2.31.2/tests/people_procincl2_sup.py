...
class people(GeneratedsSuper):
    """A list of people."""
    member_data_items_ = [
        MemberSpec_('comments', 'comments', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'comments', b'type': b'comments'}, None),
        MemberSpec_('person', 'person', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'person', b'type': b'person'}, None),
        MemberSpec_('specialperson', 'specialperson', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'specialperson', b'type': b'specialperson'}, None),
        MemberSpec_('programmer', 'programmer', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'programmer', b'type': b'programmer'}, None),
        MemberSpec_('python_programmer', 'python-programmer', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'python-programmer', b'type': b'python-programmer'}, None),
        MemberSpec_('java_programmer', 'java-programmer', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'java-programmer', b'type': b'java-programmer'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='people', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='people', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class comments(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('emp', 'xs:string', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'emp', b'type': b'xs:string'}, None),
        MemberSpec_('bold', 'xs:string', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'bold', b'type': b'xs:string'}, None),
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='comments', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='comments', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class person(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('name', 'xs:string', 0, 0, {b'name': b'name', b'type': b'xs:string'}, None),
        MemberSpec_('interest', 'xs:string', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'interest', b'type': b'xs:string'}, None),
        MemberSpec_('category', 'xs:integer', 0, 0, {b'name': b'category', b'type': b'xs:integer'}, None),
        MemberSpec_('agent', 'agent', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'agent', b'type': b'agent'}, None),
        MemberSpec_('promoter', 'booster', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'promoter', b'type': b'booster'}, None),
        MemberSpec_('description', 'xs:string', 0, 0, {b'name': b'description', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='person', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='person', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class specialperson(person):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='specialperson', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='specialperson', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class param(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='param', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='param', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class agent(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('firstname', 'xs:string', 0, 0, {b'name': b'firstname', b'type': b'xs:string'}, None),
        MemberSpec_('lastname', 'xs:string', 0, 0, {b'name': b'lastname', b'type': b'xs:string'}, None),
        MemberSpec_('priority', 'xs:float', 0, 0, {b'name': b'priority', b'type': b'xs:float'}, None),
        MemberSpec_('info', 'info', 0, 0, {b'name': b'info', b'type': b'info'}, None),
        MemberSpec_('vehicle', 'vehicle', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'vehicle', b'ref': b'vehicle', b'type': b'vehicle'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='agent', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='agent', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class special_agent(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='special-agent', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='special-agent', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class booster(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('firstname', 'xs:string', 0, 0, {b'name': b'firstname', b'type': b'xs:string'}, None),
        MemberSpec_('lastname', 'xs:string', 0, 0, {b'name': b'lastname', b'type': b'xs:string'}, None),
        MemberSpec_('other_name', 'xs:float', 0, 0, {b'name': b'other-name', b'type': b'xs:float'}, None),
        MemberSpec_('class_', 'xs:float', 0, 0, {b'name': b'class', b'type': b'xs:float'}, None),
        MemberSpec_('other_value', 'xs:float', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'other-value', b'type': b'xs:float'}, None),
        MemberSpec_('type_', 'xs:float', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'type', b'type': b'xs:float'}, None),
        MemberSpec_('client_handler', 'client-handlerType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'client-handler', b'type': b'client-handlerType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='booster', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='booster', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class info(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='info', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='info', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class vehicle(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('wheelcount', 'xs:integer', 0, 0, {b'name': b'wheelcount', b'type': b'xs:integer'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='vehicle', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='vehicle', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class automobile(vehicle):
    member_data_items_ = [
        MemberSpec_('drivername', 'xs:string', 0, 0, {b'name': b'drivername', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = vehicle
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='automobile', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='automobile', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class airplane(vehicle):
    member_data_items_ = [
        MemberSpec_('pilotname', 'xs:string', 0, 0, {b'name': b'pilotname', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = vehicle
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='airplane', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='airplane', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class programmer(person):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('email', 'xs:string', 0, 0, {b'name': b'email', b'type': b'xs:string'}, None),
        MemberSpec_('elposint', 'xs:positiveInteger', 0, 0, {b'name': b'elposint', b'type': b'xs:positiveInteger'}, None),
        MemberSpec_('elnonposint', 'xs:nonPositiveInteger', 0, 0, {b'name': b'elnonposint', b'type': b'xs:nonPositiveInteger'}, None),
        MemberSpec_('elnegint', 'xs:negativeInteger', 0, 0, {b'name': b'elnegint', b'type': b'xs:negativeInteger'}, None),
        MemberSpec_('elnonnegint', 'xs:nonNegativeInteger', 0, 0, {b'name': b'elnonnegint', b'type': b'xs:nonNegativeInteger'}, None),
        MemberSpec_('eldate', 'xs:date', 0, 0, {b'name': b'eldate', b'type': b'xs:date'}, None),
        MemberSpec_('eltoken', 'xs:token', 0, 0, {b'name': b'eltoken', b'type': b'xs:token'}, None),
        MemberSpec_('elshort', 'xs:short', 0, 0, {b'name': b'elshort', b'type': b'xs:short'}, None),
        MemberSpec_('ellong', 'xs:long', 0, 0, {b'name': b'ellong', b'type': b'xs:long'}, None),
        MemberSpec_('elparam', 'param', 0, 0, {b'name': b'elparam', b'type': b'param'}, None),
        MemberSpec_('elarraytypes', ['ArrayTypes', 'xs:NMTOKEN'], 0, 0, {b'name': b'elarraytypes', b'type': b'xs:NMTOKEN'}, None),
    ]
    subclass = None
    superclass = person
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='programmer', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='programmer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class client_handlerType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('fullname', 'xs:string', 0, 0, {b'name': b'fullname', b'type': b'xs:string'}, None),
        MemberSpec_('refid', 'xs:integer', 0, 0, {b'name': b'refid', b'type': b'xs:integer'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='client-handlerType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='client-handlerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class java_programmer(programmer):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('favorite_editor', 'xs:string', 0, 0, {b'name': b'favorite-editor', b'type': b'xs:string'}, None),
    ]
    subclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='java-programmer', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='java-programmer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class python_programmer(programmer):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='python-programmer', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='python-programmer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

...
class containerType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('sample1', 'simpleOneType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'sample1', b'type': b'simpleOneType'}, None),
        MemberSpec_('sample2_bad', 'simpleOneType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'sample2_bad', b'type': b'simpleOneType'}, None),
        MemberSpec_('sample3_bad', 'simpleOneType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'sample3_bad', b'type': b'simpleOneType'}, None),
        MemberSpec_('sample4_bad', 'simpleOneType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'sample4_bad', b'type': b'simpleOneType'}, None),
        MemberSpec_('sample2', 'simpleTwoType', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'sample2', b'type': b'simpleTwoType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='containerType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='containerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class simpleOneType(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('integer_range_1_value', ['integer_range_1_st', 'integer_range_2_st', 'xs:integer'], 0, 0, {b'default': b'5', b'name': b'integer_range_1_value', b'type': b'xs:integer'}, None),
        MemberSpec_('pattern_value', ['pattern_st', 'pattern_1_st', 'min_length_st', 'xs:string'], 0, 0, {b'name': b'pattern_value', b'type': b'xs:string'}, None),
        MemberSpec_('token_enum_value', ['token_enum_st', 'xs:NMTOKEN'], 0, 0, {b'name': b'token_enum_value', b'type': b'xs:NMTOKEN'}, None),
        MemberSpec_('integer_range_incl_value', ['integer_range_incl_st', 'xs:integer'], 0, 0, {b'name': b'integer_range_incl_value', b'type': b'xs:integer'}, None),
        MemberSpec_('integer_range_excl_value', ['integer_range_excl_st', 'xs:integer'], 0, 0, {b'name': b'integer_range_excl_value', b'type': b'xs:integer'}, None),
        MemberSpec_('min_max_length_value', ['min_max_length_st', 'xs:string'], 0, 0, {b'name': b'min_max_length_value', b'type': b'xs:string'}, None),
        MemberSpec_('length_value', ['length_st', 'xs:string'], 0, 0, {b'name': b'length_value', b'type': b'xs:string'}, None),
        MemberSpec_('totalDigits_value', ['totalDigits_st', 'xs:decimal'], 0, 0, {b'name': b'totalDigits_value', b'type': b'xs:decimal'}, None),
        MemberSpec_('date_minincl_value', ['date_minincl_st', 'xs:date'], 0, 0, {b'name': b'date_minincl_value', b'type': b'xs:date'}, None),
        MemberSpec_('date_maxincl_value', ['date_maxincl_st', 'xs:date'], 0, 0, {b'name': b'date_maxincl_value', b'type': b'xs:date'}, None),
        MemberSpec_('date_minexcl_value', ['date_minexcl_st', 'xs:date'], 0, 0, {b'name': b'date_minexcl_value', b'type': b'xs:date'}, None),
        MemberSpec_('date_maxexcl_value', ['date_maxexcl_st', 'xs:date'], 0, 0, {b'name': b'date_maxexcl_value', b'type': b'xs:date'}, None),
        MemberSpec_('time_minincl_value', ['time_minincl_st', 'xs:time'], 0, 0, {b'name': b'time_minincl_value', b'type': b'xs:time'}, None),
        MemberSpec_('time_maxincl_value', ['time_maxincl_st', 'xs:time'], 0, 0, {b'name': b'time_maxincl_value', b'type': b'xs:time'}, None),
        MemberSpec_('time_minexcl_value', ['time_minexcl_st', 'xs:time'], 0, 0, {b'name': b'time_minexcl_value', b'type': b'xs:time'}, None),
        MemberSpec_('time_maxexcl_value', ['time_maxexcl_st', 'xs:time'], 0, 0, {b'name': b'time_maxexcl_value', b'type': b'xs:time'}, None),
        MemberSpec_('datetime_minincl_value', ['datetime_minincl_st', 'xs:dateTime'], 0, 0, {b'name': b'datetime_minincl_value', b'type': b'xs:dateTime'}, None),
        MemberSpec_('datetime_maxincl_value', ['datetime_maxincl_st', 'xs:dateTime'], 0, 0, {b'name': b'datetime_maxincl_value', b'type': b'xs:dateTime'}, None),
        MemberSpec_('datetime_minexcl_value', ['datetime_minexcl_st', 'xs:dateTime'], 0, 0, {b'name': b'datetime_minexcl_value', b'type': b'xs:dateTime'}, None),
        MemberSpec_('datetime_maxexcl_value', ['datetime_maxexcl_st', 'xs:dateTime'], 0, 0, {b'name': b'datetime_maxexcl_value', b'type': b'xs:dateTime'}, None),
        MemberSpec_('vbar_pattern_value', ['vbar_pattern_st', 'xs:string'], 0, 0, {b'name': b'vbar_pattern_value', b'type': b'xs:string'}, None),
        MemberSpec_('unicode_pattern_value', ['unicode_pattern_st', 'xs:string'], 0, 0, {b'name': b'unicode_pattern_value', b'type': b'xs:string'}, None),
        MemberSpec_('anonymous_float_value', ['anonymous_float_valueType', 'xs:float'], 0, 0, {b'name': b'anonymous_float_value', b'type': b'xs:float'}, None),
        MemberSpec_('primative_integer', 'xs:integer', 0, 0, {b'name': b'primative_integer', b'type': b'xs:integer'}, None),
        MemberSpec_('primative_float', 'xs:float', 0, 0, {b'name': b'primative_float', b'type': b'xs:float'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='simpleOneType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='simpleOneType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class simpleTwoType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('simpleTwoElementOne', 'simpleTwoElementOneType', 0, 0, {b'name': b'simpleTwoElementOne', b'type': b'simpleTwoElementOneType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='simpleTwoType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='simpleTwoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class simpleTwoElementOneType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('simpleTwoElementTwo', ['simpleTwoElementTwoType', 'xs:string'], 0, 0, {b'name': b'simpleTwoElementTwo', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='simpleTwoElementOneType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='simpleTwoElementOneType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

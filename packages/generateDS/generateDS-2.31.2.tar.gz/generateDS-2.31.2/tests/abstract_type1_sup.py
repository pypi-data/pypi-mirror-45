...
class carrierType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('fleet', 'Vehicle', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'fleet', b'type': b'Vehicle'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:target="http://cars.example.com/schema" xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='carrierType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='carrierType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class Car(Vehicle):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:target="http://cars.example.com/schema"', name_='Car', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='Car', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class Plane(Vehicle):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:target="http://cars.example.com/schema"', name_='Plane', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='Plane', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

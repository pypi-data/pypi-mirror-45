...
class authorsType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('author', 'author', 1, 1, {b'name': b'author', b'ref': b'author', b'type': b'author'}, 1),
        MemberSpec_('cooperation', 'xsd:string', 1, 1, {b'name': b'cooperation', b'type': b'xsd:string'}, 1),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='authorsType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='authorsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class author(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('description', 'xsd:string', 0, 0, {b'name': b'description', b'type': b'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='author', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='author', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

...
class FooList(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('Foo', 'FooType', 0, 0, {b'name': b'Foo', b'type': b'FooType'}, None),
        MemberSpec_('Bar', 'BarType', 0, 0, {b'name': b'Bar', b'type': b'BarType'}, None),
        MemberSpec_('Baz', 'BazType', 0, 0, {b'name': b'Baz', b'type': b'BazType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='FooList', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='FooList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class FooType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('FooType', ['FooTypeType', 'xs:string'], 0, 0, {b'name': b'FooType', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='FooType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='FooType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class BarType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('BarType', ['BarTypeType', 'xs:string'], 0, 0, {b'name': b'BarType', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BarType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='BarType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class BazType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('BazType', ['BazTypeType', 'xs:string'], 0, 0, {b'name': b'BazType', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BazType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='BazType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

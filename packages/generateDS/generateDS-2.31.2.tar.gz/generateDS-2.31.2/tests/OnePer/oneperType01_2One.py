...
class oneperType01_1(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('username', 'xs:string', 0, 0, {b'name': b'username', b'type': b'xs:string'}, None),
        MemberSpec_('inner01', 'oneperType01_2', 0, 0, {b'name': b'inner01', b'type': b'oneperType01_2'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType01_1', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='oneperType01_1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class oneperType01_2(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('userdescription', 'xs:string', 0, 0, {b'name': b'userdescription', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType01_2', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='oneperType01_2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

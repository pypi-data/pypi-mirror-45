...
class oneperType03_1(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('helpername', 'xs:string', 0, 0, {b'name': b'helpername', b'type': b'xs:string'}, None),
        MemberSpec_('inner01', 'oneperType02_2', 0, 0, {b'name': b'inner01', b'type': b'oneperType02_2'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, helpername=None, inner01=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType03_1', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='oneperType03_1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class oneperType03_2(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('helperdescription', 'xs:string', 0, 0, {b'name': b'helperdescription', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, helperdescription=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType03_2', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='oneperType03_2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

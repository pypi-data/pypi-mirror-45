...
class DefaultTypes(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('default1', 'DefaultType1', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'default1', b'type': b'DefaultType1'}, None),
        MemberSpec_('default2', 'DefaultType2', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'default2', b'type': b'DefaultType2'}, None),
        MemberSpec_('fixed1', 'FixedType1', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'fixed1', b'type': b'FixedType1'}, None),
        MemberSpec_('fixed2', 'FixedType2', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'fixed2', b'type': b'FixedType2'}, None),
    ]
    subclass = None
    superclass = None
...
class DefaultType1(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('normal03', 'xs:float', 0, 0, {b'minOccurs': b'1', b'name': b'normal03', b'type': b'xs:float'}, None),
        MemberSpec_('normal04', 'xs:double', 0, 0, {b'minOccurs': b'1', b'name': b'normal04', b'type': b'xs:double'}, None),
        MemberSpec_('default03', 'xs:float', 0, 0, {b'default': b'23.45', b'minOccurs': b'1', b'name': b'default03', b'type': b'xs:float'}, None),
        MemberSpec_('default04', 'xs:double', 0, 0, {b'default': b'54.32', b'minOccurs': b'1', b'name': b'default04', b'type': b'xs:double'}, None),
    ]
    subclass = None
    superclass = None
...
class FixedType1(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('normal01', 'xs:integer', 0, 1, {b'minOccurs': b'0', b'name': b'normal01', b'type': b'xs:integer'}, None),
        MemberSpec_('normal02', 'xs:string', 0, 1, {b'minOccurs': b'0', b'name': b'normal02', b'type': b'xs:string'}, None),
        MemberSpec_('fixed01', 'xs:integer', 0, 1, {b'fixed': b'23', b'minOccurs': b'0', b'name': b'fixed01', b'type': b'xs:integer'}, None),
        MemberSpec_('fixed02', 'xs:string', 0, 1, {b'fixed': b'Peach', b'minOccurs': b'0', b'name': b'fixed02', b'type': b'xs:string'}, None),
        MemberSpec_('normal03', 'xs:float', 0, 0, {b'minOccurs': b'1', b'name': b'normal03', b'type': b'xs:float'}, None),
        MemberSpec_('normal04', 'xs:double', 0, 0, {b'minOccurs': b'1', b'name': b'normal04', b'type': b'xs:double'}, None),
        MemberSpec_('fixed03', 'xs:float', 0, 0, {b'fixed': b'23.45', b'minOccurs': b'1', b'name': b'fixed03', b'type': b'xs:float'}, None),
        MemberSpec_('fixed04', 'xs:double', 0, 0, {b'fixed': b'54.32', b'minOccurs': b'1', b'name': b'fixed04', b'type': b'xs:double'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='FixedType1', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='FixedType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class FixedType2(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='FixedType2', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='FixedType2', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

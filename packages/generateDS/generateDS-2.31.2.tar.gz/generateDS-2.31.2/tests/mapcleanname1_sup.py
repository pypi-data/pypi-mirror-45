...
class complex_type01(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('string_value01', 'xs:string', 0, 0, {b'name': b'string_value01', b'type': b'xs:string'}, None),
        MemberSpec_('integer_value01', 'xs:integer', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'integer_value01', b'type': b'xs:integer'}, None),
        MemberSpec_('float_value01', 'xs:float', 0, 0, {b'name': b'float_value01', b'type': b'xs:float'}, None),
        MemberSpec_('field01', 'complex-type02', 0, 0, {b'name': b'field01', b'type': b'complex-type02'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type01', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='complex-type01', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class complex_type02(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('string_value02', 'xs:string', 0, 0, {b'name': b'string_value02', b'type': b'xs:string'}, None),
        MemberSpec_('integer_value02', 'xs:integer', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'integer_value02', b'type': b'xs:integer'}, None),
        MemberSpec_('float_value02', 'xs:float', 0, 0, {b'name': b'float_value02', b'type': b'xs:float'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type02', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='complex-type02', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class complex_type03(complex_type02):
    member_data_items_ = [
        MemberSpec_('string_value03', 'xs:string', 0, 0, {b'name': b'string_value03', b'type': b'xs:string'}, None),
        MemberSpec_('integer_value03', 'xs:integer', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'integer_value03', b'type': b'xs:integer'}, None),
        MemberSpec_('float_value03', 'xs:float', 0, 0, {b'name': b'float_value03', b'type': b'xs:float'}, None),
    ]
    subclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type03', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='complex-type03', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class type_(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='type', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='type', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class complex_type04(type_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type04', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='complex-type04', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class build_(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='build', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='build', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class complex_type05(build_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type05', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='complex-type05', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

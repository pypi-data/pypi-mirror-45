...
class Type01_1(GeneratedsSuper):
    member_data_items_ = {
        'username': MemberSpec_('username', 'xs:string', 0, 0, {b'name': b'username', b'type': b'xs:string'}, None),
        'inner01': MemberSpec_('inner01', 'Type02_1', 0, 0, {b'name': b'inner01', b'type': b'Type02_1'}, None),
    }
    subclass = None
    superclass = None

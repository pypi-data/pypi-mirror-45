...
class Type00_1(GeneratedsSuper):
    member_data_items_ = {
        'inner01': MemberSpec_('inner01', 'Type01_1', 0, 0, {b'name': b'inner01', b'type': b'Type01_1'}, None),
        'inner02': MemberSpec_('inner02', 'Type02_1', 0, 0, {b'name': b'inner02', b'type': b'Type02_1'}, None),
    }
    subclass = None
    superclass = None
...
class Type00_2(GeneratedsSuper):
    ...
    def validate_IntType01_1(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if value < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on IntType01_1' % {"value" : value} )
            if value > 127:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on IntType01_1' % {"value" : value} )
    def hasContent_(self):
        if (

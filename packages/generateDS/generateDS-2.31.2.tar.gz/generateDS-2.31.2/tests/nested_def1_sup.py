...
class containerType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('item1', 'classAType', 0, 0, {b'name': b'item1', b'type': b'classAType'}, None),
        MemberSpec_('item2', 'classBType', 0, 0, {b'name': b'item2', b'type': b'classBType'}, None),
    ]
    subclass = None
    superclass = None
...
class classAType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('inner', 'innerType', 0, 0, {b'name': b'inner', b'type': b'innerType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='classAType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='classAType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class classBType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('inner', 'innerType1', 0, 0, {b'name': b'inner', b'type': b'innerType1'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, inner=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='classBType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='classBType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class innerType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='innerType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='innerType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class innerType1(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='innerType1', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='innerType1', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

...
class document1Type(GeneratedsSuper):
    ...
    docstring."""
    member_data_items_ = [
        MemberSpec_('comments', 'xs:string', 0, 0, {b'name': b'comments', b'type': b'xs:string'}, None),
        MemberSpec_('otherdoc', 'document2Type', 0, 0, {b'name': b'otherdoc', b'type': b'document2Type'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='document1Type', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='document1Type', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class document2Type(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('comments', 'xs:string', 0, 0, {b'name': b'comments', b'type': b'xs:string'}, None),
        MemberSpec_('rating', 'xs:integer', 0, 0, {b'name': b'rating', b'type': b'xs:integer'}, None),
        MemberSpec_('anotherdoc', 'document3Type', 0, 0, {b'name': b'anotherdoc', b'type': b'document3Type'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='document2Type', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='document2Type', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class document3Type(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='document3Type', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='document3Type', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

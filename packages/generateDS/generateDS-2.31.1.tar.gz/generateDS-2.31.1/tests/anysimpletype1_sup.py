...
class test1element(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('test1member', 'cimAnySimpleType', 0, 0, {b'name': b'test1member', b'type': b'cimAnySimpleType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.vmware.com/vcloud/v0.8" ', name_='test1element', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='test1element', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class cimAnySimpleType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='cimAnySimpleType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='cimAnySimpleType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

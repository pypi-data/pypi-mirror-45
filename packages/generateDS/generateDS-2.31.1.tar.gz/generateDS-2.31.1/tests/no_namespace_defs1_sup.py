...
class peopleType(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('specialperson', 'xs:string', 1, 0, {b'maxOccurs': b'unbounded', b'name': b'specialperson', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
...
class personType(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('category', 'xs:integer', 0, 1, {b'minOccurs': b'0', b'name': b'category', b'type': b'xs:integer'}, None),

...
class cdataListType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('cdatalist', 'cdataType', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'cdatalist', b'type': b'cdataType'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='cdataListType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='cdataListType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class cdataType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('script', 'xs:string', 0, 0, {b'name': b'script', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='cdataType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='cdataType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

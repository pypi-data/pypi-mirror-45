...
class oneperType00_1(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('inner01', 'oneperType01_1', 0, 0, {b'name': b'inner01', b'type': b'oneperType01_1'}, None),
        MemberSpec_('inner02', 'oneperType01_2', 0, 0, {b'name': b'inner02', b'type': b'oneperType01_2'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType00_1', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='oneperType00_1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)

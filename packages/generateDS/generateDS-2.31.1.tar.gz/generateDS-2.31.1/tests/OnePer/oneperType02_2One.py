...
class oneperType02_1(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('clientname', 'xs:string', 0, 0, {b'name': b'clientname', b'type': b'xs:string'}, None),
        MemberSpec_('inner01', 'oneperType02_2', 0, 0, {b'name': b'inner01', b'type': b'oneperType02_2'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, clientname=None, inner01=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType02_1', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='oneperType02_1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class oneperType02_2(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('clientdescription', 'xs:string', 0, 0, {b'name': b'clientdescription', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, clientdescription=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType02_2', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='oneperType02_2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

...
class dummy(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('test_ref_element', 'xs:integer', 0, 0, {b'name': b'test_ref_element', b'ref': b'test_ref_element', b'type': b'xs:integer'}, None),
        MemberSpec_('test_normal_element', 'xs:integer', 0, 0, {b'name': b'test_normal_element', b'type': b'xs:integer'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='dummy', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='dummy', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)

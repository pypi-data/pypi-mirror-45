...
class IdentifierType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='IdentifierType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='IdentifierType', pretty_print=pretty_print)
...
class BillOfResourcesIDType(IdentifierType):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BillOfResourcesIDType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='BillOfResourcesIDType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class BillOfMaterialIDType(IdentifierType):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BillOfMaterialIDType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='BillOfMaterialIDType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

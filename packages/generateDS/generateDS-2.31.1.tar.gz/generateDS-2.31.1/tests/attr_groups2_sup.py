...
class GetUserReq(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('returnedTags', 'xsd:string', 0, 1, {b'minOccurs': b'0', b'name': b'returnedTags', b'type': b'xsd:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GetUserReq', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='GetUserReq', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)

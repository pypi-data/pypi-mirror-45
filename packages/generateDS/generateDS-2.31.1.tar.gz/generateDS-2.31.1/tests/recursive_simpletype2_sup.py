...
class PersonType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('personId', 'xs:integer', 0, 0, {b'maxOccurs': b'1', b'minOccurs': b'1', b'name': b'personId', b'ref': b'personId', b'type': b'personId'}, None),
        MemberSpec_('fname', 'xs:string', 0, 0, {b'name': b'fname', b'type': b'xs:string'}, None),
        MemberSpec_('lname', 'xs:string', 0, 0, {b'name': b'lname', b'type': b'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PersonType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='PersonType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)

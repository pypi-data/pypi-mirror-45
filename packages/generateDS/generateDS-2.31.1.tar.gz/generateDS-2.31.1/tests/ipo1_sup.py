...
class PurchaseOrderType(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('shipTo', 'Address', 0, 0, {b'name': b'shipTo', b'type': b'Address'}, None),
        MemberSpec_('billTo', 'Address', 0, 0, {b'name': b'billTo', b'type': b'Address'}, None),
        MemberSpec_('comment', 'string', 0, 1, {b'minOccurs': b'0', b'name': b'comment', b'ref': b'comment', b'type': b'string'}, None),
        MemberSpec_('items', 'Items', 0, 0, {b'name': b'items', b'type': b'Items'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ipo="http://www.example.com/IPO"', name_='PurchaseOrderType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='PurchaseOrderType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class Items(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('item', 'item', 1, 1, {b'maxOccurs': b'unbounded', b'minOccurs': b'0', b'name': b'item', b'type': b'item'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ipo="http://www.example.com/IPO" xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='Items', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='Items', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class item(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('productName', 'string', 0, 0, {b'name': b'productName', b'type': b'string'}, None),
        MemberSpec_('quantity', ['quantity', 'positiveInteger'], 0, 0, {b'name': b'quantity', b'type': b'positiveInteger'}, None),
        MemberSpec_('USPrice', 'decimal', 0, 0, {b'name': b'USPrice', b'type': b'decimal'}, None),
        MemberSpec_('comment', 'string', 0, 1, {b'minOccurs': b'0', b'name': b'comment', b'ref': b'comment', b'type': b'string'}, None),
        MemberSpec_('shipDate', 'date', 0, 1, {b'minOccurs': b'0', b'name': b'shipDate', b'type': b'date'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def validate_SKU(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_SKU_patterns_, ))
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ipo="http://www.example.com/IPO" xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='item', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='item', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class quantity(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ipo="http://www.example.com/IPO"', name_='quantity', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='quantity', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class Address(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('name', 'string', 0, 0, {b'name': b'name', b'type': b'string'}, None),
        MemberSpec_('street', 'string', 0, 0, {b'name': b'street', b'type': b'string'}, None),
        MemberSpec_('city', 'string', 0, 0, {b'name': b'city', b'type': b'string'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='ipo:', namespacedef_='xmlns:ipo="http://www.example.com/IPO" xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='Address', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='Address', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class USAddress(Address):
    member_data_items_ = [
        MemberSpec_('state', ['USState', 'string'], 0, 0, {b'name': b'state', b'type': b'string'}, None),
        MemberSpec_('zip', 'positiveInteger', 0, 0, {b'name': b'zip', b'type': b'positiveInteger'}, None),
    ]
    subclass = None
    superclass = Address
    ...
    def export(self, outfile, level, namespaceprefix_='ipo:', namespacedef_='xmlns:ipo="http://www.example.com/IPO" xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='USAddress', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='USAddress', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class UKAddress(Address):
    member_data_items_ = [
        ...
        MemberSpec_('postcode', ['UKPostcode', 'string'], 0, 0, {b'name': b'postcode', b'type': b'string'}, None),
    ]
    subclass = None
    superclass = Address
    ...
    def validate_UKPostcode(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 24:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on UKPostcode' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='ipo:', namespacedef_='xmlns:ipo="http://www.example.com/IPO"', name_='UKAddress', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, '', namespacedef_, name_='UKAddress', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

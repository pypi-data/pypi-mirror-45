...
class BundleVersionMetadata(object):
    ...
    def __init__(self, link=None, id=None, bundle_id=None, bucket_id=None, version=None, timestamp=None, author=None, description=None, sha256=None, sha256_supplied=None, content_size=None, system_api_version=None, build_info=None):
        """

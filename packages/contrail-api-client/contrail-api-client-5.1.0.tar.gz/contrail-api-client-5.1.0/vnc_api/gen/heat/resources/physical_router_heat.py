...
class ContrailPhysicalRouter(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        PHYSICAL_ROUTER_CHASSIS_ID: properties.Schema(
            properties.Schema.STRING,
            _('PHYSICAL_ROUTER_CHASSIS_ID.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        PHYSICAL_ROUTER_CHASSIS_ID: attributes.Schema(
            _('PHYSICAL_ROUTER_CHASSIS_ID.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.PHYSICAL_ROUTER_CHASSIS_ID) is not None:
            obj_0.set_physical_router_chassis_id(self.properties.get(self.PHYSICAL_ROUTER_CHASSIS_ID))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.PHYSICAL_ROUTER_CHASSIS_ID) is not None:
            obj_0.set_physical_router_chassis_id(prop_diff.get(self.PHYSICAL_ROUTER_CHASSIS_ID))

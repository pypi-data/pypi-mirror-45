...
class ContrailFloatingIpPool(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        FLOATING_IP_POOL_SUBNETS: properties.Schema(
            properties.Schema.MAP,
            _('FLOATING_IP_POOL_SUBNETS.'),
            update_allowed=True,
            required=False,
            schema={
                FLOATING_IP_POOL_SUBNETS_SUBNET_UUID: properties.Schema(
                    properties.Schema.LIST,
                    _('FLOATING_IP_POOL_SUBNETS_SUBNET_UUID.'),
                    update_allowed=True,
                    required=False,
                ),
            }
    ...
    attributes_schema = {
        ...
        FLOATING_IP_POOL_SUBNETS: attributes.Schema(
            _('FLOATING_IP_POOL_SUBNETS.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.FLOATING_IP_POOL_SUBNETS) is not None:
            obj_1 = vnc_api.FloatingIpPoolSubnetType()
            if self.properties.get(self.FLOATING_IP_POOL_SUBNETS, {}).get(self.FLOATING_IP_POOL_SUBNETS_SUBNET_UUID) is not None:
                for index_1 in range(len(self.properties.get(self.FLOATING_IP_POOL_SUBNETS, {}).get(self.FLOATING_IP_POOL_SUBNETS_SUBNET_UUID))):
                    obj_1.add_subnet_uuid(self.properties.get(self.FLOATING_IP_POOL_SUBNETS, {}).get(self.FLOATING_IP_POOL_SUBNETS_SUBNET_UUID)[index_1])
            obj_0.set_floating_ip_pool_subnets(obj_1)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.FLOATING_IP_POOL_SUBNETS) is not None:
            obj_1 = vnc_api.FloatingIpPoolSubnetType()
            if prop_diff.get(self.FLOATING_IP_POOL_SUBNETS, {}).get(self.FLOATING_IP_POOL_SUBNETS_SUBNET_UUID) is not None:
                for index_1 in range(len(prop_diff.get(self.FLOATING_IP_POOL_SUBNETS, {}).get(self.FLOATING_IP_POOL_SUBNETS_SUBNET_UUID))):
                    obj_1.add_subnet_uuid(prop_diff.get(self.FLOATING_IP_POOL_SUBNETS, {}).get(self.FLOATING_IP_POOL_SUBNETS_SUBNET_UUID)[index_1])
            obj_0.set_floating_ip_pool_subnets(obj_1)

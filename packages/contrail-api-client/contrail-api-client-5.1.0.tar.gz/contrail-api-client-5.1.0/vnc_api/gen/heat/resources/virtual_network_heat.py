...
class ContrailVirtualNetwork(contrail.ContrailResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.IS_PROVIDER_NETWORK) is not None:
            obj_0.set_is_provider_network(prop_diff.get(self.IS_PROVIDER_NETWORK))

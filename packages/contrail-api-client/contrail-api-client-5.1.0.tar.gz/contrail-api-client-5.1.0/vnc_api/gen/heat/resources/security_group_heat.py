                ...
                SECURITY_GROUP_ENTRIES_POLICY_RULE: properties.Schema(
                    ...
                    schema=properties.Schema(
                        ...
                        schema={
                                ...
                                schema={
                                    ...
                                    SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO: properties.Schema(
                                        ...
                                        schema={
                                            ...
                                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING: properties.Schema(
                                                properties.Schema.BOOLEAN,
                                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING.'),
                                                update_allowed=True,
                                                required=False,
                                            ),
                                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING_VLAN: properties.Schema(
                                                properties.Schema.INTEGER,
                                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING_VLAN.'),
                                                update_allowed=True,
                                                required=False,
                                                constraints=[
                            ...
                            SECURITY_GROUP_ENTRIES_POLICY_RULE_CREATED: properties.Schema(
                                properties.Schema.INTEGER,
                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_CREATED.'),
                                update_allowed=True,
                                required=False,
                            ),
                            SECURITY_GROUP_ENTRIES_POLICY_RULE_LAST_MODIFIED: properties.Schema(
                                properties.Schema.INTEGER,
                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_LAST_MODIFIED.'),
                                update_allowed=True,
                                required=False,
                            ),
                        }
                ...
                for index_1 in range(len(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO) is not None:
                            ...
                            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING) is not None:
                                obj_4.set_nic_assisted_mirroring(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING))
                            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING_VLAN) is not None:
                                obj_4.set_nic_assisted_mirroring_vlan(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING_VLAN))
                    ...
                    if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_CREATED) is not None:
                        obj_2.set_created(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_CREATED))
                    if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_LAST_MODIFIED) is not None:
                        obj_2.set_last_modified(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_LAST_MODIFIED))
        ...
        if prop_diff.get(self.SECURITY_GROUP_ENTRIES) is not None:
            ...
            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE) is not None:
                for index_1 in range(len(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO) is not None:
                            ...
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER) is not None:
                                ...
                                obj_4.set_static_nh_header(obj_5)
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING) is not None:
                                obj_4.set_nic_assisted_mirroring(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING))
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING_VLAN) is not None:
                                obj_4.set_nic_assisted_mirroring_vlan(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NIC_ASSISTED_MIRRORING_VLAN))
                            obj_3.set_mirror_to(obj_4)
                    ...
                    if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_CREATED) is not None:
                        obj_2.set_created(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_CREATED))
                    if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_LAST_MODIFIED) is not None:
                        obj_2.set_last_modified(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_LAST_MODIFIED))
                    obj_1.add_policy_rule(obj_2)
            obj_0.set_security_group_entries(obj_1)

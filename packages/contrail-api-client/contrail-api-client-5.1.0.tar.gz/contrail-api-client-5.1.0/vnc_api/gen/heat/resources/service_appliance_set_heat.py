...
class ContrailServiceApplianceSet(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, SERVICE_APPLIANCE_DRIVER, SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE, SERVICE_APPLIANCE_SET_PROPERTIES, SERVICE_APPLIANCE_SET_PROPERTIES_KEY_VALUE_PAIR, SERVICE_APPLIANCE_SET_PROPERTIES_KEY_VALUE_PAIR_KEY, SERVICE_APPLIANCE_SET_PROPERTIES_KEY_VALUE_PAIR_VALUE, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, SERVICE_APPLIANCE_HA_MODE, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, TAG_REFS, GLOBAL_SYSTEM_CONFIG
    ) = (
        'name', 'fq_name', 'display_name', 'service_appliance_driver', 'service_appliance_set_virtualization_type', 'service_appliance_set_properties', 'service_appliance_set_properties_key_value_pair', 'service_appliance_set_properties_key_value_pair_key', 'service_appliance_set_properties_key_value_pair_value', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'service_appliance_ha_mode', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'tag_refs', 'global_system_config'
    )
    ...
    properties_schema = {
        ...
        SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE: properties.Schema(
            properties.Schema.STRING,
            _('SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE: attributes.Schema(
            _('SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE) is not None:
            obj_0.set_service_appliance_set_virtualization_type(self.properties.get(self.SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE) is not None:
            obj_0.set_service_appliance_set_virtualization_type(prop_diff.get(self.SERVICE_APPLIANCE_SET_VIRTUALIZATION_TYPE))

...
class ContrailInstanceIp(contrail.ContrailResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.INSTANCE_IP_SUBSCRIBER_TAG) is not None:
            obj_0.set_instance_ip_subscriber_tag(prop_diff.get(self.INSTANCE_IP_SUBSCRIBER_TAG))

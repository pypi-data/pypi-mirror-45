...
class ContrailLoadbalancerMember(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        LOADBALANCER_MEMBER_PROPERTIES: properties.Schema(
            ...
            schema={
                ...
                LOADBALANCER_MEMBER_PROPERTIES_SUBNET_ID: properties.Schema(
                    properties.Schema.STRING,
                    _('LOADBALANCER_MEMBER_PROPERTIES_SUBNET_ID.'),
                    update_allowed=True,
                    required=False,
                ),
            }
    ...
    def handle_create(self):
        parent_obj = None
        if parent_obj is None and self.properties.get(self.LOADBALANCER_POOL) and self.properties.get(self.LOADBALANCER_POOL) != 'config-root':
            try:
                parent_obj = self.vnc_lib().loadbalancer_pool_read(fq_name_str=self.properties.get(self.LOADBALANCER_POOL))
            except vnc_api.NoIdError:
                parent_obj = self.vnc_lib().loadbalancer_pool_read(id=str(uuid.UUID(self.properties.get(self.LOADBALANCER_POOL))))
            except:
                parent_obj = None

        if parent_obj is None and self.properties.get(self.LOADBALANCER_POOL) != 'config-root':
        ...
        if self.properties.get(self.LOADBALANCER_MEMBER_PROPERTIES) is not None:
            ...
            if self.properties.get(self.LOADBALANCER_MEMBER_PROPERTIES, {}).get(self.LOADBALANCER_MEMBER_PROPERTIES_SUBNET_ID) is not None:
                obj_1.set_subnet_id(self.properties.get(self.LOADBALANCER_MEMBER_PROPERTIES, {}).get(self.LOADBALANCER_MEMBER_PROPERTIES_SUBNET_ID))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.LOADBALANCER_MEMBER_PROPERTIES) is not None:
            ...
            if prop_diff.get(self.LOADBALANCER_MEMBER_PROPERTIES, {}).get(self.LOADBALANCER_MEMBER_PROPERTIES_SUBNET_ID) is not None:
                obj_1.set_subnet_id(prop_diff.get(self.LOADBALANCER_MEMBER_PROPERTIES, {}).get(self.LOADBALANCER_MEMBER_PROPERTIES_SUBNET_ID))
            obj_0.set_loadbalancer_member_properties(obj_1)

        ...
        if prop_diff.get(self.PERMS2) is not None:
            ...
            if prop_diff.get(self.PERMS2, {}).get(self.PERMS2_SHARE) is not None:
                for index_1 in range(len(prop_diff.get(self.PERMS2, {}).get(self.PERMS2_SHARE))):
                    ...
                    obj_1.add_share(obj_2)
            obj_0.set_perms2(obj_1)
        if prop_diff.get(self.IPAM_SUBNETTING) is not None:
            obj_0.set_ipam_subnetting(prop_diff.get(self.IPAM_SUBNETTING))
                ...
                for index_1 in range(len(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS))):
                    ...
                    if prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_ALLOCATION_POOLS) is not None:
                        for index_2 in range(len(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_ALLOCATION_POOLS))):
                            ...
                            if prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_ALLOCATION_POOLS, {})[index_2].get(self.IPAM_SUBNETS_SUBNETS_ALLOCATION_POOLS_VROUTER_SPECIFIC_POOL) is not None:
                                obj_3.set_vrouter_specific_pool(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_ALLOCATION_POOLS, {})[index_2].get(self.IPAM_SUBNETS_SUBNETS_ALLOCATION_POOLS_VROUTER_SPECIFIC_POOL))
                            obj_2.add_allocation_pools(obj_3)
                    ...
                    if prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_CREATED) is not None:
                        obj_2.set_created(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_CREATED))
                    if prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_LAST_MODIFIED) is not None:
                        obj_2.set_last_modified(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_LAST_MODIFIED))
                    if prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_SUBSCRIBER_TAG) is not None:
                        obj_2.set_subscriber_tag(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_SUBSCRIBER_TAG))
                    if prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_VLAN_TAG) is not None:
                        obj_2.set_vlan_tag(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_VLAN_TAG))
                    if prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_DHCP_RELAY_SERVER) is not None:
                        for index_2 in range(len(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_DHCP_RELAY_SERVER))):
                            obj_2.add_dhcp_relay_server(prop_diff.get(self.IPAM_SUBNETS, {}).get(self.IPAM_SUBNETS_SUBNETS, {})[index_1].get(self.IPAM_SUBNETS_SUBNETS_DHCP_RELAY_SERVER)[index_2])
                    obj_1.add_subnets(obj_2)
            obj_0.set_ipam_subnets(obj_1)

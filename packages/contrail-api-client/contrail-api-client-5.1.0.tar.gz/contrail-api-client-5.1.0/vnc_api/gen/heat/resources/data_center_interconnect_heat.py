...
class ContrailDataCenterInterconnect(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DATA_CENTER_INTERCONNECT_BGP_ADDRESS_FAMILIES, DATA_CENTER_INTERCONNECT_BGP_ADDRESS_FAMILIES_FAMILY, DISPLAY_NAME, DATA_CENTER_INTERCONNECT_BGP_HOLD_TIME, DATA_CENTER_INTERCONNECT_MODE, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, DATA_CENTER_INTERCONNECT_CONFIGURED_ROUTE_TARGET_LIST, DATA_CENTER_INTERCONNECT_CONFIGURED_ROUTE_TARGET_LIST_ROUTE_TARGET, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, TAG_REFS, LOGICAL_ROUTER_REFS, VIRTUAL_NETWORK_REFS, GLOBAL_SYSTEM_CONFIG
    ) = (
        'name', 'fq_name', 'data_center_interconnect_bgp_address_families', 'data_center_interconnect_bgp_address_families_family', 'display_name', 'data_center_interconnect_bgp_hold_time', 'data_center_interconnect_mode', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'data_center_interconnect_configured_route_target_list', 'data_center_interconnect_configured_route_target_list_route_target', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'tag_refs', 'logical_router_refs', 'virtual_network_refs', 'global_system_config'
    )

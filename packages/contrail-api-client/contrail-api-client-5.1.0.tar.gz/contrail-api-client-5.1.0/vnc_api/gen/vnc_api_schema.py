...
def generate_schema_graph():
    ...
    graph.add_edge(pydot.Edge(role_config_node, job_template_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(virtual_network_node, logical_router_node, color = 'blue', constraint = False))

...
#define SHADYLIB_MINOR_VERSION 8  /*     values, to find out the version of the code that   */
...
SHADYLIB_FUNC(  ShaDyLib_Window   ,    ShaDyLib_Window_New                                ,  ( int width, int height, int left, int top, int screen, int frame, int fullScreenMode, int visible, int openglContextVersion, int legacy, const char * glslDirectory, const char * substitutions )  ,   RETURN( NULL, ( ShaDyLib_Window )new ShaDyLib::Window( width, height, left, top, screen, frame, fullScreenMode, visible, openglContextVersion, legacy, INPUTSTRING( glslDirectory ), INPUTSTRING( substitutions ) ) )       )

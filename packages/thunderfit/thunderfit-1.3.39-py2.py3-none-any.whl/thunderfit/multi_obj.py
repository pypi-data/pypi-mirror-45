...
class ThunderBag():
    ...
    def peak_info_setter(self):
        ...
        for thund in self.thunder_bag.values():  # set these first values for all of them
            ...
            center_indices = utili.find_closest_indices(thund.x_data, peak_centres)
            peak_info_ = peak_finding.find_cents(prominence, thund.y_data, find_all=True)
            center_indices = utili.find_closest_indices(peak_info_['center_indices'],

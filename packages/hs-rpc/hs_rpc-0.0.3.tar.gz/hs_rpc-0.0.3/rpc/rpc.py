...
from rpc.exceptions import RpcFuncRegisterError
from rpc.request import rpc_request_invoke
...
class RpcServerHelper:
    ...
    def run(self, app):
        ...
        def start_loop():
            ...
            while not_started:
                try:
                    r = requests.get('http://localhost:{}/'.format(int(app.config.get('IP_PORT')) or 5000))

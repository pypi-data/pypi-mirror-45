...
class PauliInteractionGate(eigen_gate.EigenGate,
    ...
    def __init__(self,
        ...
        """
        super(PauliInteractionGate, self).__init__(exponent=exponent)
        self.pauli0 = pauli0
    ...
    def _circuit_diagram_info_(self, args
        ...
        labels = {pauli_gates.X: u'X', pauli_gates.Y: u'Y', pauli_gates.Z: u'@'}
    ...
    def __repr__(self):
        base = u'cirq.PauliInteractionGate({!r}, {!s}, {!r}, {!s})'.format(
            self.pauli0, self.invert0, self.pauli1, self.invert1)
        if self._exponent == 1:
            return base

        return u'({}**{})'.format(base, proper_repr(self._exponent))


PauliInteractionGate = value.value_equality(PauliInteractionGate)

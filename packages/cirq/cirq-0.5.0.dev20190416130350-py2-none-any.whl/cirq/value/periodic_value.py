...
class PeriodicValue(object):
    u"""Wrapper for periodic numerical values.
    ...
    def __init__(self, value, period):
        u"""Initializes the equivalence class.
    ...
    def _approx_eq_(self, other, atol):
        u"""Implementation of `SupportsApproximateEquality` protocol."""
        if not isinstance(other, type(self)):
            return NotImplemented

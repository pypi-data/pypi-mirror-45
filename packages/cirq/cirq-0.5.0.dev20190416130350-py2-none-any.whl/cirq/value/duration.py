...
u"""A typed time delta that supports picosecond accuracy."""
...
class Duration(object):
    u"""A time delta that supports picosecond accuracy."""
    ...
    def __init__(self, **_3to2kwargs):
        ...
        u"""Initializes a Duration with a time specified in ns and/or ps.
    ...
    def total_picos(self):
        u"""Returns the number of picoseconds that the duration spans."""
        return self._picos

    def total_nanos(self):
        u"""Returns the number of nanoseconds that the duration spans."""
    ...
    def __unicode__(self):
        if self._picos % 1000 == 0:
            return u'{}ns'.format(self._picos // 1000)
        return u'{}ps'.format(self._picos)

    def __repr__(self):
        return u'cirq.Duration(picos={})'.format(repr(self._picos))

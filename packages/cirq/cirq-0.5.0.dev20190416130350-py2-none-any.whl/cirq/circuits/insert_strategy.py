...
u"""Hard-coded options for adding multiple operations to a circuit."""


class InsertStrategy(object):
    u"""Indicates preferences on how to add multiple operations to a circuit."""
    ...
    def __repr__(self):
        return u'cirq.InsertStrategy.{}'.format(self.name)

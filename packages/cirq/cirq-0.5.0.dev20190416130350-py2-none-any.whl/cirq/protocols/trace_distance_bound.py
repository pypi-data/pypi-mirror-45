...
class SupportsTraceDistanceBound(Protocol):
    ...
    def _trace_distance_bound_(self):
        u"""A maximum on the trace distance between `val`'s input and output.
...
def trace_distance_bound(val):
    u"""Returns a maximum on the trace distance between this effect's input
    ...
    """
    getter = getattr(val, u'_trace_distance_bound_', None)

...
def mul(lhs, rhs, default = RaiseTypeErrorIfNotProvided):
    u"""Returns lhs * rhs, or else a default if the operator is not implemented.
    ...
    if default is not RaiseTypeErrorIfNotProvided:
        return default
    raise TypeError(u"unsupported operand type(s) for *: '{}' and '{}'".format(
        type(lhs), type(rhs)))

...
u"""An optimization pass that pushes Z gates later and later in the circuit."""
...
class EjectZ(object):
    u"""Pushes Z gates towards the end of the circuit.
    ...
    def optimize_circuit(self, circuit):
        ...
        def dump_tracked_phase(qubits,
                               index):
            u"""Zeroes qubit_phase entries by emitting Z gates."""
            for q in qubits:
                p = qubit_phase[q]

...
class Device(object):
    ...
    u"""Hardware constraints for validating circuits and schedules."""

    def decompose_operation(self, operation
                            ):
        u"""Returns a device-valid decomposition for the given operation.
    ...
    def validate_operation(self, operation):
        u"""Raises an exception if an operation is not valid.
    ...
    def validate_scheduled_operation(
        ...
        u"""Raises an exception if the scheduled operation is not valid.
    ...
    def validate_circuit(self, circuit):
        u"""Raises an exception if a circuit is not valid.
    ...
    def validate_moment(self, moment):
        u"""Raises an exception if a moment is not valid.
    ...
    def can_add_operation_into_moment(self,
                                      operation,
                                      moment):
        u"""Determines if it's possible to add an operation into a moment.
    ...
    def validate_schedule(self, schedule):
        u"""Raises an exception if a schedule is not valid.

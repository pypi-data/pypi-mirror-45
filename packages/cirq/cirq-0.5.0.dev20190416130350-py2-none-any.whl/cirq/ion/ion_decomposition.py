...
def two_qubit_matrix_to_ion_operations(q0,
                                       q1,
                                       mat,
                                       atol = 1e-8
                                       ):
    u"""Decomposes a two-qubit operation into MS/single-qubit rotation gates.
...
def _parity_interaction(q0,
                        ...
                        atol,
                        gate = None):
    u"""Yields an XX interaction framed by the given operation."""

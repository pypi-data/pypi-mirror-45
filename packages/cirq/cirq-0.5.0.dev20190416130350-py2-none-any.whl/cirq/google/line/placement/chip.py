...
def above(qubit):
    u"""Gives qubit with one unit less on the second coordinate.
...
def left_of(qubit):
    u"""Gives qubit with one unit less on the first coordinate.
...
def below(qubit):
    u"""Gives qubit with one unit more on the second coordinate.
...
def right_of(qubit):
    u"""Gives node with one unit more on the first coordinate.
...
def chip_as_adjacency_list(device,
                           ):
    u"""Gives adjacency list representation of a chip.

...
def assert_gates_implement_unitary(gates,
                                   intended_effect,
                                   atol):
...
@pytest.mark.parametrize(u'pre_turns,post_turns',

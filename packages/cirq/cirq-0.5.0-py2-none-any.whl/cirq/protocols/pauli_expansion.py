...
u"""Protocol for obtaining expansion of linear operators in Pauli basis."""
...
def pauli_expansion(
    ...
    u"""Returns coefficients of the expansion of val in the Pauli basis.
    ...
    """
    method = getattr(val, u'_pauli_expansion_', None)
    ...
    if matrix is None:
        if default is RaiseTypeErrorIfNotProvided:
            raise TypeError(u'No Pauli expansion for object {} of type {}'
                    .format(val, type(val)))
        return default

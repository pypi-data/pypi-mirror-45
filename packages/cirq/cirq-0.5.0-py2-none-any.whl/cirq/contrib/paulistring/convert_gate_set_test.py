...
@pytest.mark.parametrize(u'op,expected_ops', (lambda q0, q1: (
    ...
    (cirq.measure(q0, q1, key=u'key'), cirq.measure(q0, q1, key=u'key')),
...
def test_converts_large_circuit():
    ...
    cirq.testing.assert_has_diagram(after, u'''

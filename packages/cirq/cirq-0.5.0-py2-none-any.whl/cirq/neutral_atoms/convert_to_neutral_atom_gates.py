...
class ConvertToNeutralAtomGates(PointOptimizer):
    u"""Attempts to convert gates into native Atom gates.
    ...
    def __init__(self, ignore_failures=False):
        ...
        """
        super(ConvertToNeutralAtomGates, self).__init__()
    ...
    def convert(self, op):
        def on_stuck_raise(bad):
            return TypeError(
                ...
                u"It isn't a native atom operation, "
                u"a 1 or 2 qubit gate with a known unitary, "
                u"or composite.".format(bad))

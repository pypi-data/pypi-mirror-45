...
class PauliStringGateOperation(raw_types.Operation):
    ...
    def with_qubits(self,
        ...
        return self.map_qubits(dict(izip(self.pauli_string.qubits, new_qubits)))
    ...
    def _pauli_string_diagram_info(
        ...
        syms = tuple(
            u'[{}]'.format(self.pauli_string[qubit]) for qubit in qubits)

...
def pow(val,
    ...
    u"""Returns `val**factor` of the given value, if defined.
    ...
    if raiser is None:
        raise TypeError(u"object of type '{}' "
                        u"has no __pow__ method.".format(type(val)))
    raise TypeError(u"object of type '{}' does have a __pow__ method, "

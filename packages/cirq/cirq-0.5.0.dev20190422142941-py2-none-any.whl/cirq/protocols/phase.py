...
def phase_by(val, phase_turns, qubit_index,
    ...
    """
    getter = getattr(val, u'_phase_by_', None)
    ...
    if getter is None:
        raise TypeError(u"object of type '{}' "
                        u"has no _phase_by_ method.".format(type(val)))
    raise TypeError(u"object of type '{}' does have a _phase_by_ method, "

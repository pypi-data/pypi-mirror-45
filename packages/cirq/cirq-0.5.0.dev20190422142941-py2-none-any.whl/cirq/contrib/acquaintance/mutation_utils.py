...
def rectify_acquaintance_strategy(
    ...
    u"""Splits moments so that they contain either only acquaintance gates
...
def replace_acquaintance_with_swap_network(
    ...
    reflected = False
    reverse_map = dict((q, r) for q, r in izip(qubit_order, reversed(qubit_order)))
...
class ExposeAcquaintanceGates(optimizers.ExpandComposite):
    u"""Decomposes any permutation gates that provide acquaintance opportunities

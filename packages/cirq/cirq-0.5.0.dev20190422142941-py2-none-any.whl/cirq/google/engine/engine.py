...
class Engine(object):
    ...
    def run(
            self, **_3to2kwargs):
        if 'processor_ids' in _3to2kwargs: processor_ids = _3to2kwargs['processor_ids']; del _3to2kwargs['processor_ids']
        else: processor_ids =  (u'xmonsim',)
    ...
    def run_sweep(
        ...
        request = {
            ...
            u'scheduling_config': {
                u'priority': priority,
                u'processor_selector': {
                    u'processor_names': [
                        u'projects/%s/processors/%s' %

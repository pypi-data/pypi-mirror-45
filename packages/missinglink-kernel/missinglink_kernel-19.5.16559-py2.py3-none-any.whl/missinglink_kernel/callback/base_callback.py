...
class BaseCallback(BaseCallbackImages):
    ...
    def get_data_generator(
            ...
            volume_id=None, cache_directory=None, batch_size=32, use_threads=None, processes=-1, shuffle=True, cache_limit=None, drop_last=False):
        ...
        ml_data_generator = MLDataGeneratorFactory(query=query, data_callback=data_callback, volume_id=volume_id,
                                                   ...
                                                   cache_limit=cache_limit, drop_last=False).create()
    ...
    def bind_data_generator(
            ...
            cache_directory=None, batch_size=32, use_threads=None, processes=-1, shuffle=True, cache_limit=None, drop_last=False):

        return self.get_data_generator(
            query, data_callback, volume_id, cache_directory, batch_size, use_threads, processes, shuffle, cache_limit, drop_last)

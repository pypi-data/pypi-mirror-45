...
class DataHandler:
    ...
    def __init__(self, endpoint, session=None):
        ...
        self._items = []
        self._sending_thread_lock = threading.Lock()
    ...
    def __batch_send_items(self):
        ...
        r = self._session.post(self._endpoint, data=json.dumps(self._items[0:total_send]))

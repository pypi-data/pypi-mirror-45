...
class _Iterator(object):
    ...
    def __init__(self, data_generator, shuffle, seed):
        self.__data_generator = data_generator
        self.__batch_index = 0
        self.__iter_shuffle = _IteratorShuffle(shuffle, len(data_generator), seed)

    def reset(self):
        self.__iter_shuffle.reset()
        self.__batch_index = 0
    ...
    def __next__(self):
        results = self.__data_generator[self.__iter_shuffle[self.__batch_index]]

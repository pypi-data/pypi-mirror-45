...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-certificatemanager", "0.29.0", __name__, "aws-certificatemanager@0.29.0.jsii.tgz")
@jsii.data_type(jsii_type="@aws-cdk/aws-certificatemanager.CertificateImportProps", jsii_struct_bases=[])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-certificatemanager.DnsValidatedCertificateProps", jsii_struct_bases=[CertificateProps])

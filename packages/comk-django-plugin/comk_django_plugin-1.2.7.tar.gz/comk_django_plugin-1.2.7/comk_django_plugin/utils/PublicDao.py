...
class PublicDao():
    ...
    #     获取所有字段的信息
    #
    #     :param tables_models_str:
    #     :return:
    #     '''
    #     field_dict = dict()
    #     fields_result = self.model._meta.fields
    #     for field in fields_result:
    #         field_dict[field.name] = dict(type=type(field).__name__, label=field.verbose_name,
    #                                       options=field.choices, findex=field.db_index)
    #     return field_dict

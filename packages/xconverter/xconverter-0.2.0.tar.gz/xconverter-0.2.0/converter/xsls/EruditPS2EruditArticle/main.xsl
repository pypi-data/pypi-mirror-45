...
<xsl:stylesheet
    ...
    <xsl:template match="ref" mode="unestructured_unformated">
        <refbiblio>
            ...
            <xsl:apply-templates select="element-citation/*" mode="unestructured_unformated_elements"/>
        </refbiblio>
    </xsl:template>
    ...
    <xsl:template match="list">
        ...
        <xsl:element name="{$reference_tab/reference-tab/lists/key[@value = $list-type]}">
            <!--IMPROVEMENTS: Implement co-relation list of ordering type, Waiting Texture definitions -->
            <xsl:choose>
                <xsl:when test="$reference_tab/reference-tab/lists/key[@value = $list-type] = 'listeord'">
    ...
    <xsl:template match="fig">
        <figure>
            ...
            <objetmedia flot="bloc">
                ...
                <image xlink:href="{graphic/@xlink:href}" typeimage="figure" xlink:type="simple"></image>
            </objetmedia>
    ...
    <xsl:template match="alt-text" mode="table">
        <notetabl>
            <xsl:apply-templates select="." mode="text_with_formating"/>
        </notetabl>
    </xsl:template>
    ...
    <xsl:template match="table-wrap">
        <tableau>
            ...
            <xsl:apply-templates select="alt-text" mode="table"/>

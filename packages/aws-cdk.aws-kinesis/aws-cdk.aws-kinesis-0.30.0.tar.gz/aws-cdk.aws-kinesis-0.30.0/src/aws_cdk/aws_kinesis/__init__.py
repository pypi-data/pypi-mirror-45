...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-kinesis", "0.30.0", __name__, "aws-kinesis@0.30.0.jsii.tgz")
...
__all__ = ["CfnStream", "CfnStreamConsumer", "CfnStreamConsumerProps", "CfnStreamProps", "IStream", "Stream", "StreamEncryption", "StreamImportProps", "StreamProps", "__jsii_assembly__"]

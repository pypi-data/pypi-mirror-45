...
class Signature:
    ...
    def with_input(self, name, data_type, shape, profile_type):
        as_dict = {
            'name': name,
            'type': data_type,
            'shape': shape,
    ...
    def with_output(self, name, data_type, shape, profile_type):
        as_dict = {
            'name': name,
            'type': data_type,
            'shape': shape,
    ...
    def compile(self):
        if not self.version:
            ...
            self.inner_model = InnerModel(
                ...
                self.training_data, self.install_command, self.monitoring, self.metadata
            )

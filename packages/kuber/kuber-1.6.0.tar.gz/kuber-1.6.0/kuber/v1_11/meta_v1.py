...
class ListMeta(_kuber_definitions.Definition):
    ...
    def continue_(self) -> str:
        ...
        list may not be possible if the server configuration has
        changed or more than a few minutes have passed. The
        resourceVersion field returned when using this continue
...
class OwnerReference(_kuber_definitions.Definition):
    ...
    identify an owning object. Currently, an owning object must

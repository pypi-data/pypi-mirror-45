...
from kuber.v1_11.apimachinery.pkg.apis.meta_v1 import MicroTime
from kuber.v1_11.apimachinery.pkg.apis.meta_v1 import ObjectMeta
from kuber.v1_11.apimachinery.pkg.api_resource import Quantity
...
class Container(_kuber_definitions.Definition):
    ...
    def volume_devices(self) -> typing.List['VolumeDevice']:
        ...
        container. This is an alpha feature and may change in the
        future.
        """
...
class EndpointPort(_kuber_definitions.Definition):
    ...
    def protocol(self) -> str:
        """
        The IP protocol for this port. Must be UDP or TCP. Default
        is TCP.
        """
        return self._properties.get('protocol')
...
class LocalVolumeSource(_kuber_definitions.Definition):
    ...
    def path(self) -> str:
        ...
        VolumeMode=Filesystem. Block devices can be represented only
        by VolumeMode=Block, which also requires the BlockVolume
...
class PersistentVolumeClaimSpec(_kuber_definitions.Definition):
    ...
    def volume_mode(self) -> str:
        ...
        claim spec. This is an alpha feature and may change in the
        future.
        """
...
class PodSpec(_kuber_definitions.Definition):
    ...
    def share_process_namespace(self) -> bool:
        ...
        is alpha-level and is honored only by servers that enable

...
from kuber.v1_13.apimachinery.pkg.apis.meta_v1 import LabelSelector
from kuber.v1_13.core_v1 import Lifecycle
from kuber.v1_13.apimachinery.pkg.apis.meta_v1 import ListMeta
from kuber.v1_13.apimachinery.pkg.apis.meta_v1 import ObjectMeta
from kuber.v1_13.core_v1 import PersistentVolumeClaim
from kuber.v1_13.core_v1 import PodTemplateSpec
from kuber.v1_13.core_v1 import Probe
from kuber.v1_13.apimachinery.pkg_runtime import RawExtension
from kuber.v1_13.core_v1 import ResourceRequirements
from kuber.v1_13.core_v1 import SecurityContext
from kuber.v1_13.apimachinery.pkg.apis.meta_v1 import Status
from kuber.v1_13.apimachinery.pkg.apis.meta_v1 import StatusDetails
...
class ControllerRevision(_kuber_definitions.Resource):
    ...
    deprecated by apps/v1/ControllerRevision. See the release
    notes for more information. ControllerRevision implements an
    immutable snapshot of state data. Clients are responsible
    for serializing and deserializing the objects that contain
    their internal state. Once a ControllerRevision has been
    successfully created, it can not be updated. The API Server
    will fail validation of all requests that attempt to mutate
    the Data field. ControllerRevisions may, however, be
    deleted. Note that, due to its use by both the DaemonSet and
    StatefulSet controllers for update and rollback, this object
    is beta. However, it may be subject to name and
...
class DaemonSet(_kuber_definitions.Resource):
    ...
    by apps/v1/DaemonSet. See the release notes for more
...
class Deployment(_kuber_definitions.Resource):
    ...
    by apps/v1/Deployment. See the release notes for more
...
class ReplicaSet(_kuber_definitions.Resource):
    ...
    by apps/v1/ReplicaSet. See the release notes for more
...
class StatefulSet(_kuber_definitions.Resource):
    ...
    by apps/v1/StatefulSet. See the release notes for more

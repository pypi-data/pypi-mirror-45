...
from kuber.v1_11.core_v1 import TopologySelectorTerm
...
class StorageClass(_kuber_definitions.Resource):
    ...
    def allowed_topologies(self) -> typing.List['TopologySelectorTerm']:
        ...
        restriction. This field is alpha-level and is only honored
        by servers that enable the DynamicProvisioningScheduling
        feature.
        """
    ...
    def volume_binding_mode(self) -> str:
        ...
        VolumeBindingImmediate is used. This field is alpha-level

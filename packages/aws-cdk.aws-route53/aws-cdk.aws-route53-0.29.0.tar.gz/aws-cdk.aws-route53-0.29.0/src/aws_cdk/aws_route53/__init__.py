...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-route53", "0.29.0", __name__, "aws-route53@0.29.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-route53.HostedZoneImportProps", jsii_struct_bases=[])

...
class SubmeterRoutes(Model):
    ...
    def __init__(self, manage=None, permission_id=None, permission_code=None, permission_name=None, description=None, permission_category_name=None, is_licensed=None):
        super(SubmeterRoutes, self).__init__()
        self.manage = manage

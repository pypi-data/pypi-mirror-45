...
class MyWindowClass(QtWidgets.QMainWindow, Qt5file.Ui_MainWindow):
    ...
    def processAADConcentration(self):
        ...
        if conc > 0:
            blockICaL = conc / (conc + AADs_line1)
            blockIK1 = conc / (conc + AADs_line2)
            blockIKr = conc / (conc + AADs_line3)
            blockIKs = conc / (conc + AADs_line4)
            blockIKur = conc / (conc + AADs_line5)
            blockINa = conc / (conc + AADs_line6)
            blockINaL = conc / (conc + AADs_line7)
            blockINaK = conc / (conc + AADs_line8)
            blockINCX = conc / (conc + AADs_line9)
            blockIto = conc / (conc + AADs_line10)  
...
##########End of for bcls model 1
    ...
    def savecsv1(self):
        ...
        export_mdl1 = QtWidgets.QFileDialog.getSaveFileName(self, 'Save File', '', "CSV (*.csv);;Text (*.txt);;All Files (*.*)")[0]
    ...
    def savecsv2(self):
        ...
        export_mdl2 = QtWidgets.QFileDialog.getSaveFileName(self, 'Save File', '', "CSV (*.csv);;Text (*.txt);;All Files (*.*)")[0]

...
# =============================================================================
                    ...
                    for sample in range(genomes.shape[1]):
                        exposureAvg[:,sample], _= sub.fit_signatures(processAvg, genomes[:, sample][:,np.newaxis])
                ...
                avg_stabilities.append(round(avgSilhouetteCoefficients,2))
                ...
                loopResults = [genomes, processAvg, exposureAvg, processStd, exposureStd, avgSilhouetteCoefficients, clusterSilhouetteCoefficients, signature_total_mutations, all_similarities, signature_stats, finalgenomeErrors, finalgenomesReconstructed, finalWall, finalHall, processes]    
            ...
            all_stats.insert(1, 'Stability (Avg Silhouette)', avg_stabilities)

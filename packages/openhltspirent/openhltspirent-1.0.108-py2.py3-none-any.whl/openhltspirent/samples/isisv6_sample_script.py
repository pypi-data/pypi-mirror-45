...
#  step 2. create two devices under the port1, protocol stack: eth/vlan/vlan/ipv6/isisv6. 
print('\n  step 2. create two devices under the port1, protocol stack: eth/vlan/vlan/ipv6/isisv6.\n')
...
protocol_ipv6_1.parent_link = 'Vlan2'
...
ipv6_1_src_addr.single = '3000::1'
ipv6_1_src_addr.update()

ipv6_1_gw_addr = ipv6_1.gateway_address()
ipv6_1_gw_addr.pattern_type = 'SINGLE'
ipv6_1_gw_addr.single = '3000::11'
ipv6_1_gw_addr.update()

#create and config ISISv4 protocol
protocol_isisv6_1 = devices_1.create_protocols('ISISV61')
protocol_isisv6_1.protocol_type = 'ISIS'
protocol_isisv6_1.parent_link = 'IPV61'
protocol_isisv6_1.update()

isisv6 = protocol_isisv6_1.isis()
isisv6.update()

isis_ipversion = isisv6.ip_version()
isis_ipversion.single = 'IPV6'
isis_ipversion.update()

system_id = isisv6.system_id()
system_id.single = '00:10:94:00:00:01'
system_id.update()

router_priority = isisv6.router_priority()
router_priority.single = '1'
router_priority.update()

network_type = isisv6.network_type()
network_type.single = 'BROADCAST'
network_type.update()

hello_interval = isisv6.hello_interval()
...
networks_1 = simulated_networks_1.create_networks('ISISV6Networks1')
networks_1.flow_link = 'ISISV61'
networks_1.network_type = 'ISIS_ROUTE_RANGE'
networks_1.update()

#config the isisv6_route_range_1
isisv6_route_range_1 = networks_1.isis_route_range()
isisv6_route_range_1.update()

system_id_route = isisv6_route_range_1.system_id()
system_id_route.single = '00:10:94:00:10:01'
system_id_route.update()

isisv6_routes1 = isisv6_route_range_1.create_ipv6_routes('isisv6route1')
isisv6_routes1.update()

address = isisv6_routes1.address()
address.pattern_type = 'SINGLE'
address.single = '4000::1'
address.update()

# ISISV6 Device configuration on port2
...
protocol_ipv6_2.parent_link = 'WestVlan2'
...
ipv6_2_src_addr.single = '3000::11'
ipv6_2_src_addr.update()

ipv6_2_gw_addr = ipv6_2.gateway_address()
ipv6_2_gw_addr.pattern_type = 'SINGLE'
ipv6_2_gw_addr.single = '3000::1'
ipv6_2_gw_addr.update()

#create and config ISISv4 protocol
protocol_isisv6_2 = devices_2.create_protocols('ISISV62')
protocol_isisv6_2.protocol_type = 'ISIS'
protocol_isisv6_2.parent_link = 'IPV62'
protocol_isisv6_2.update()

isisv6 = protocol_isisv6_2.isis()
isisv6.update()
...
# create 'ISISV6 Route Range' under the simulated_networks_2
networks_2 = simulated_networks_2.create_networks('ISISV6Networks2')
networks_2.flow_link = 'ISISV62'
networks_2.network_type = 'ISIS_ROUTE_RANGE'
networks_2.update()

#config the isisv6_route_range_2
isisv6_route_range_2 = networks_2.isis_route_range()
isisv6_route_range_2.update()

system_id_route = isisv6_route_range_2.system_id()
system_id_route.single = '00:10:94:00:20:01'
system_id_route.update()

isisv6_routes2 = isisv6_route_range_2.create_ipv6_routes('isisv6route2')
isisv6_routes2.update()

address = isisv6_routes2.address()
address.pattern_type = 'SINGLE'
address.single = '4000::11'
address.update()

#  start ISISv4 protocol
print('\n  start ISISV6 protocol\n')
isisv6_control_input1 = config.IsisControlInput()
isisv6_control_input1.targets.append('ISISV61')
isisv6_control_input1.targets.append('ISISV62')
isisv6_control_input1.mode = 'START'
config.isis_control(isisv6_control_input1)
...
isisv6_statistics_1 = statistics.isis_statistics('Device1')
isisv6_statistics_2 = statistics.isis_statistics('Device2')
print(isisv6_statistics_1._values)
print(isisv6_statistics_2._values)

isis1_state = isisv6_statistics_1._values['router-state']
isis2_state = isisv6_statistics_2._values['router-state']
...
device_traffic.sources = ['Device1']
device_traffic.destinations = ['Device2']
...
isisv6_control_input2 = config.IsisControlInput()
isisv6_control_input2.targets.append('ISISV61')
isisv6_control_input2.targets.append('ISISV62')
isisv6_control_input2.mode = 'STOP'
config.isis_control(isisv6_control_input2) 

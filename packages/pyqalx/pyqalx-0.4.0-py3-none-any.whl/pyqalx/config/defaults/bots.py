...
"""Save the entity back to qalx after post-processing?"""

KILL_AFTER = None
"""The number of attempts to get a message from an empty queue before exiting. When set to None
the worker will keep asking forever."""

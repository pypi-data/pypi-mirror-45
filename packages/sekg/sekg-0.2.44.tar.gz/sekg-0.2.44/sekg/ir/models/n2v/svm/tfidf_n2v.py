...
class TFIDFNode2VectorModel(DocumentSimModel):
    ...
    def __init_embedding_size(self, embedding_size):
        ...
        self.NP_VECTOR_NOT_EXIST = LoadUtil.get_unknown_vector(embedding_size)
    ...
    def train_from_doc_collection_with_preprocessor(self,
                                                    doc_collection: PreprocessMultiFieldDocumentCollection,

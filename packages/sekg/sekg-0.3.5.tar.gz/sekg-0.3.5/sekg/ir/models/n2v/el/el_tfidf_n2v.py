...
from sekg.graph.el.combine import GlobalEntryPointLinker
...
class ELN2VModel(DocumentSimModel):
    """
    use the entity link approach to locate some entry point in kg. parse the query as a weighted novector
    of node2vec vector.
    ...
    def init_model_as_submodel(self):
        ...
        self.entry_point_linker = GlobalEntryPointLinker(preprocessor=self.preprocessor,

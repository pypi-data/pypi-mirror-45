...
class GraphNode2VecTrainer:
    def __init__(self, graph_data, directed=False):
        self.node_num = graph_data.get_node_num()
        self.nx_G_instance = None
        if directed:
            self.init_weight_graph(graph_data)
        else:
    ...
    def init_weight_graph(self, graph_data):
        '''
        ...
        self.graph_data.init_from_directed_graph(graph_data=graph_data)

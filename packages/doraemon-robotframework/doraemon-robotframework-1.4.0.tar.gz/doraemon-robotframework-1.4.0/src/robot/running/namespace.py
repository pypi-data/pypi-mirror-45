...
class Namespace(object):
    ...
    def handle_rules(self, built_in, exec_dir, env):
        ...
        if rules != None and built_in.get_variable_value("${SUITE_SOURCE}") != '':
            suite_path = built_in.get_variable_value("${SUITE_SOURCE}").split(exec_dir+'/')[1]

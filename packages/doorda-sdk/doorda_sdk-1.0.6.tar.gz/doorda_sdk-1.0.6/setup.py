...
INSTALL_REQUIRES = ['pyhive[presto]>=0.6.1', 'requests>=2.20.0', 'urllib3>=1.24.3', 'tqdm>=4.28.1']
...
setup(
     ...
     download_url="https://github.com/Doorda/doorda-python-sdk/archive/1.0.6.tar.gz",

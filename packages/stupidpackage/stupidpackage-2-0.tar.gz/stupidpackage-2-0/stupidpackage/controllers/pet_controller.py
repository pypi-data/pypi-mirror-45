...
from stupidpackage.api_helper import APIHelper
from stupidpackage.configuration import Configuration
from stupidpackage.controllers.base_controller import BaseController
from stupidpackage.models.pet import Pet
from stupidpackage.models.api_response import ApiResponse
from stupidpackage.exceptions.api_exception import APIException

class PetController(BaseController):

    """A Controller to access Endpoints in the stupidpackage API."""
    ...
    def get_pet_find_by_status_get(self,
        ...
        Args:
            status (list of Status6Enum): Status values that need to be

...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-logs", "0.29.0", __name__, "aws-logs@0.29.0.jsii.tgz")
...
class LogGroupBase(aws_cdk.cdk.Resource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-logs.LogGroupBase"):
...
class _LogGroupBaseProxy(LogGroupBase, jsii.proxy_for(aws_cdk.cdk.Resource)):
    @jsii.member(jsii_name="export")
    def export(self) -> "LogGroupImportProps":
        """Export this LogGroup."""
        return jsii.invoke(self, "export", [])
